---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-releases/overview-2600
title: 版本概览
...
| **软件包** | **发布类型** | **版本号** | **发布时间** |
| --- | --- | --- | --- |
| API版本 | Beta | 26.0.0 Beta2  *\***注意**：设备系统支持的API能力范围请以**API版本****为准。* | 2026/07/28 |
| DevEco Studio | Beta | DevEco Studio 26.0.0 Beta2 (26.0.0.621) | 2026/07/28 |
| SDK | Beta | HarmonyOS SDK 26.0.0 Beta2  基于OpenHarmony SDK Ohos\_sdk\_public 26.0.0.32 (API Version 26.0.0 Beta2) | 2026/07/28 |

### 26.0.0 Beta1

| **软件包** | **发布类型** | **版本号** | **发布时间** |
| --- | --- | --- | --- |
| API版本 | Beta | 26.0.0 Beta1  *\***注意**：设备系统支持的API能力范围请以**API版本****为准。* | 2026/06/12 |
| DevEco Studio | Beta | DevEco Studio 26.0.0 Beta1 (26.0.0.461) | 2026/06/12 |
| SDK | Beta | HarmonyOS SDK 26.0.0 Beta1  基于OpenHarmony SDK Ohos\_sdk\_public 26.0.0.23 (API Version 26.0.0 Beta1) | 2026/06/12 |
