---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-releases/js-apidiff-arengine-510
title: AR Engine
breadcrumb: 版本说明 > 历史版本 > HarmonyOS 5.1.0(18) > OS平台能力 > API变更清单 > AR Engine
category: harmonyos-releases
scraped_at: 2026-04-28T07:35:01+08:00
doc_updated_at: 2026-01-21
content_hash: sha256:e0d6717ad57ff1d18bf40f71b935a57bc65a64acd2cdafd1ac19e441435fc93f
---

| 操作 | 旧版本 | 新版本 | d.ts文件 |
| --- | --- | --- | --- |
| 新增API | NA | 类名：global；  API声明：declare namespace arEngine  差异内容：declare namespace arEngine | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARAddAugmentedImageReason  差异内容：enum ARAddAugmentedImageReason | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARAddAugmentedImageReason；  API声明：NONE = 0  差异内容：NONE = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARAddAugmentedImageReason；  API声明：SIZE\_NOT\_MATCH = 1  差异内容：SIZE\_NOT\_MATCH = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARAddAugmentedImageReason；  API声明：LIGHT\_ANOMALY = 2  差异内容：LIGHT\_ANOMALY = 2 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARAddAugmentedImageReason；  API声明：FEATURE\_LIMIT = 3  差异内容：FEATURE\_LIMIT = 3 | api/@hms.core.ar.arengine.d.ts |
...
| 新增API | NA | 类名：ARSemanticPlaneLabel；  API声明：FLOOR = 2  差异内容：FLOOR = 2 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARSemanticPlaneLabel；  API声明：SEAT = 3  差异内容：SEAT = 3 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARSemanticPlaneLabel；  API声明：TABLE = 4  差异内容：TABLE = 4 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARSemanticPlaneLabel；  API声明：CEILING = 5  差异内容：CEILING = 5 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARSemanticPlaneLabel；  API声明：DOOR = 6  差异内容：DOOR = 6 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARSemanticPlaneLabel；  API声明：WINDOW = 7  差异内容：WINDOW = 7 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARSemanticPlaneLabel；  API声明：BED = 8  差异内容：BED = 8 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARType  差异内容：enum ARType | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARType；  API声明：WORLD = 0x01  差异内容：WORLD = 0x01 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARType；  API声明：IMAGE = 0x80  差异内容：IMAGE = 0x80 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARPlaneFindingMode  差异内容：enum ARPlaneFindingMode | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlaneFindingMode；  API声明：DISABLED = 0  差异内容：DISABLED = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlaneFindingMode；  API声明：HORIZONTAL = 1  差异内容：HORIZONTAL = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlaneFindingMode；  API声明：VERTICAL = 2  差异内容：VERTICAL = 2 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlaneFindingMode；  API声明：HORIZONTAL\_AND\_VERTICAL = 3  差异内容：HORIZONTAL\_AND\_VERTICAL = 3 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARSemanticMode  差异内容：enum ARSemanticMode | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARSemanticMode；  API声明：NONE = 0  差异内容：NONE = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARSemanticMode；  API声明：PLANE = 1  差异内容：PLANE = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARFocusMode  差异内容：enum ARFocusMode | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARFocusMode；  API声明：FIXED = 0  差异内容：FIXED = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARFocusMode；  API声明：AUTO = 1  差异内容：AUTO = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARPoseType  差异内容：enum ARPoseType | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPoseType；  API声明：IDENTITY = 0  差异内容：IDENTITY = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPoseType；  API声明：ROTATE\_90 = 1  差异内容：ROTATE\_90 = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPoseType；  API声明：ROTATE\_180 = 2  差异内容：ROTATE\_180 = 2 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPoseType；  API声明：ROTATE\_270 = 3  差异内容：ROTATE\_270 = 3 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARPlaneType  差异内容：enum ARPlaneType | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlaneType；  API声明：FACING\_HORIZONTAL\_UPWARD = 0  差异内容：FACING\_HORIZONTAL\_UPWARD = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlaneType；  API声明：FACING\_HORIZONTAL\_DOWNWARD = 1  差异内容：FACING\_HORIZONTAL\_DOWNWARD = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlaneType；  API声明：FACING\_VERTICAL = 2  差异内容：FACING\_VERTICAL = 2 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlaneType；  API声明：FACING\_INVALID = 3  差异内容：FACING\_INVALID = 3 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARImageFormat  差异内容：enum ARImageFormat | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARImageFormat；  API声明：UNKNOWN = 0  差异内容：UNKNOWN = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARImageFormat；  API声明：YUV\_420\_888 = 2  差异内容：YUV\_420\_888 = 2 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARImageFormat；  API声明：Y\_8 = 3  差异内容：Y\_8 = 3 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARImageFormat；  API声明：Y\_16 = 4  差异内容：Y\_16 = 4 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARDepthMode  差异内容：enum ARDepthMode | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARDepthMode；  API声明：DISABLED = 0  差异内容：DISABLED = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARDepthMode；  API声明：AUTOMATIC = 1  差异内容：AUTOMATIC = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARTrackableType  差异内容：enum ARTrackableType | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARTrackableType；  API声明：BASE = 0x41520100  差异内容：BASE = 0x41520100 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARTrackableType；  API声明：PLANE = 0x41520101  差异内容：PLANE = 0x41520101 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARTrackableType；  API声明：POINT = 0x41520102  差异内容：POINT = 0x41520102 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARTrackableType；  API声明：AUGMENTED\_IMAGE = 0x41520104  差异内容：AUGMENTED\_IMAGE = 0x41520104 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARTrackableType；  API声明：INVALID = 0  差异内容：INVALID = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARAddAugmentedImageMode  差异内容：enum ARAddAugmentedImageMode | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARAddAugmentedImageMode；  API声明：NORMAL = 0  差异内容：NORMAL = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARAddAugmentedImageMode；  API声明：UPDATE = 1  差异内容：UPDATE = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARMeshMode  差异内容：enum ARMeshMode | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARMeshMode；  API声明：DISABLED = 0  差异内容：DISABLED = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARMeshMode；  API声明：ENABLE = 1  差异内容：ENABLE = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARTrackingState  差异内容：enum ARTrackingState | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARTrackingState；  API声明：TRACKING = 0  差异内容：TRACKING = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARTrackingState；  API声明：PAUSED = 1  差异内容：PAUSED = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARTrackingState；  API声明：STOPPED = 2  差异内容：STOPPED = 2 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARTrackingStateReason  差异内容：enum ARTrackingStateReason | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARTrackingStateReason；  API声明：NONE = 0  差异内容：NONE = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARTrackingStateReason；  API声明：EXCESSIVE\_MOTION = 1  差异内容：EXCESSIVE\_MOTION = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARTrackingStateReason；  API声明：INSUFFICIENT\_FEATURES = 2  差异内容：INSUFFICIENT\_FEATURES = 2 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARPowerMode  差异内容：enum ARPowerMode | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPowerMode；  API声明：NORMAL = 0  差异内容：NORMAL = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPowerMode；  API声明：POWER\_SAVING = 1  差异内容：POWER\_SAVING = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPowerMode；  API声明：PERFORMANCE\_FIRST = 2  差异内容：PERFORMANCE\_FIRST = 2 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPowerMode；  API声明：BOOST = 3  差异内容：BOOST = 3 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPowerMode；  API声明：ULTRA\_POWER\_SAVING = 11  差异内容：ULTRA\_POWER\_SAVING = 11 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARPointOrientationMode  差异内容：enum ARPointOrientationMode | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPointOrientationMode；  API声明：INITIALIZED\_TO\_IDENTITY = 0  差异内容：INITIALIZED\_TO\_IDENTITY = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPointOrientationMode；  API声明：ESTIMATED\_SURFACE\_NORMAL = 1  差异内容：ESTIMATED\_SURFACE\_NORMAL = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：enum ARPoseMode  差异内容：enum ARPoseMode | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPoseMode；  API声明：GRAVITY = 0  差异内容：GRAVITY = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPoseMode；  API声明：GRAVITY\_AND\_HEADING = 1  差异内容：GRAVITY\_AND\_HEADING = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：interface ARSession  差异内容：interface ARSession | api/@hms.core.ar.arengine.d.ts |
...
| 新增API | NA | 类名：ARCameraIntrinsics；  API声明：readonly fx: number;  差异内容：readonly fx: number; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARCameraIntrinsics；  API声明：readonly fy: number;  差异内容：readonly fy: number; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARCameraIntrinsics；  API声明：readonly cx: number;  差异内容：readonly cx: number; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARCameraIntrinsics；  API声明：readonly cy: number;  差异内容：readonly cy: number; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARCameraIntrinsics；  API声明：readonly distortion: Distortion;  差异内容：readonly distortion: Distortion; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：class ARCamera  差异内容：class ARCamera | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARCamera；  API声明：readonly state: ARTrackingState;  差异内容：readonly state: ARTrackingState; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARCamera；  API声明：readonly stateReason: ARTrackingStateReason;  差异内容：readonly stateReason: ARTrackingStateReason; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARCamera；  API声明：readonly viewMatrix: Matrix4;  差异内容：readonly viewMatrix: Matrix4; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARCamera；  API声明：getPose(): ARPose;  差异内容：getPose(): ARPose; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARCamera；  API声明：getDisplayOrientedPose(): ARPose;  差异内容：getDisplayOrientedPose(): ARPose; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARCamera；  API声明：getProjectionMatrix(near: number, far: number): Matrix4;  差异内容：getProjectionMatrix(near: number, far: number): Matrix4; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARCamera；  API声明：getImageIntrinsics(): ARCameraIntrinsics;  差异内容：getImageIntrinsics(): ARCameraIntrinsics; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：class ARImage  差异内容：class ARImage | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARImage；  API声明：readonly format: ARImageFormat;  差异内容：readonly format: ARImageFormat; | api/@hms.core.ar.arengine.d.ts |
...
| 新增API | NA | 类名：ImageComponent；  API声明：readonly buffer: ArrayBuffer;  差异内容：readonly buffer: ArrayBuffer; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：interface ARConfig  差异内容：interface ARConfig | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARConfig；  API声明：type: ARType;  差异内容：type: ARType; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARConfig；  API声明：planeFindingMode?: ARPlaneFindingMode;  差异内容：planeFindingMode?: ARPlaneFindingMode; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARConfig；  API声明：powerMode?: ARPowerMode;  差异内容：powerMode?: ARPowerMode; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARConfig；  API声明：focusMode?: ARFocusMode;  差异内容：focusMode?: ARFocusMode; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARConfig；  API声明：semanticMode?: ARSemanticMode;  差异内容：semanticMode?: ARSemanticMode; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARConfig；  API声明：maxMapSize?: number;  差异内容：maxMapSize?: number; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARConfig；  API声明：poseMode?: ARPoseMode;  差异内容：poseMode?: ARPoseMode; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARConfig；  API声明：depthMode?: ARDepthMode;  差异内容：depthMode?: ARDepthMode; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARConfig；  API声明：meshMode?: ARMeshMode;  差异内容：meshMode?: ARMeshMode; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARConfig；  API声明：addAugmentedImageMode?: ARAddAugmentedImageMode;  差异内容：addAugmentedImageMode?: ARAddAugmentedImageMode; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine；  API声明：class ARTrackable  差异内容：class ARTrackable | api/@hms.core.ar.arengine.d.ts |
...
| 新增API | NA | 类名：ARPlane；  API声明：extendZ: number;  差异内容：extendZ: number; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlane；  API声明：label: ARSemanticPlaneLabel;  差异内容：label: ARSemanticPlaneLabel; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlane；  API声明：getPolygonXZ(): ArrayBuffer;  差异内容：getPolygonXZ(): ArrayBuffer; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlane；  API声明：getSubsumedBy(): ARPlane;  差异内容：getSubsumedBy(): ARPlane; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlane；  API声明：isPoseInExtents(pose: ARPose): boolean;  差异内容：isPoseInExtents(pose: ARPose): boolean; | api/@hms.core.ar.arengine.d.ts |
...
| 新增API | NA | 类名：arEngine；  API声明：class ARAugmentedImage  差异内容：class ARAugmentedImage | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARAugmentedImage；  API声明：readonly extendX: number;  差异内容：readonly extendX: number; | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARAugmentedImage；  API声明：readonly extendZ: number;  差异内容：readonly extendZ: number; | api/@hms.core.ar.arengine.d.ts |
...
| 新增kit | 类名：global；  API声明：  差异内容：NA | 类名：global；  API声明：kits@kit.AREngine.d.ts  差异内容：AREngine | kits/@kit.AREngine.d.ts |
