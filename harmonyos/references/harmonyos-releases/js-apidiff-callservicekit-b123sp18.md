...
| 操作 | 旧版本 | 新版本 | d.ts文件 |
| --- | --- | --- | --- |
| 新增API | NA | 类名：global；  API声明： export interface CallerInfo  差异内容： export interface CallerInfo | api/@hms.telephony.CallerInfoQueryExtensionAbility.d.ts |
| 新增API | NA | 类名：CallerInfo；  API声明：contactName: string;  差异内容：contactName: string; | api/@hms.telephony.CallerInfoQueryExtensionAbility.d.ts |
| 新增API | NA | 类名：CallerInfo；  API声明：employeeId?: string;  差异内容：employeeId?: string; | api/@hms.telephony.CallerInfoQueryExtensionAbility.d.ts |
| 新增API | NA | 类名：CallerInfo；  API声明：department?: string;  差异内容：department?: string; | api/@hms.telephony.CallerInfoQueryExtensionAbility.d.ts |
