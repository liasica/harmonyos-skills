...
| API模型切换 | 类名：QueryType；  API声明：NON\_DELETABLE = 1  差异内容：NA | 类名：QueryType；  API声明：NON\_DELETABLE = 1  差异内容：stagemodelonly | api/@hms.enterpriseSpaceService.spaceManager.d.ts |
...
| API模型切换 | 类名：EventType；  API声明：EVENT\_WORKSPACE\_SWITCHED = 0  差异内容：NA | 类名：EventType；  API声明：EVENT\_WORKSPACE\_SWITCHED = 0  差异内容：stagemodelonly | api/@hms.enterpriseSpaceService.spaceManager.d.ts |
