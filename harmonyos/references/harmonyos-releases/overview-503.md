...
详情可参见[OS平台新增和增强特性](os-new-feature-503.md)和[DevEco Studio新增和增强特性](deveco-studio-new-features-503-release.md)。
...
| --- | --- | --- | --- | --- |
| API版本 | Release | HarmonyOS 5.0.3 Release | 5.0.3(15)  *\***注意**：设备系统支持的API能力范围请以**API版本****为准。* | 2025/03/15 |
...
* **API版本**请在设备的“设置”中点击设备名称，进入“**关于本机**”进行查询。
  ...
  当前系统版本配套的设备包括：Mate 60、Mate 60 Pro、Mate X5、MatePad Pro 13.2英寸、MatePad Pro 11英寸 2024款等。请升级至配套的版本进行应用开发。
...
| **软件包** | **发布类型** | **版本号** | Build Version | **发布时间** |
| --- | --- | --- | --- | --- |
| API版本 | Beta | HarmonyOS 5.0.3 Beta2 | 5.0.3(15) Beta2  *\***注意**：设备系统支持的API能力范围请以**API版本****为准。* | 2025/03/06 |
| DevEco Studio | Beta | DevEco Studio 5.0.3 Beta2 | 5.0.9.200 | 2025/03/06 |
| SDK | Beta | HarmonyOS 5.0.3 Beta2 SDK | 基于OpenHarmony SDK Ohos\_sdk\_public 5.0.3.131(API 15 Beta2) | 2025/03/06 |

### 5.0.3(15) Beta1

| **软件包** | **发布类型** | **版本号** | Build Version | **发布时间** |
| --- | --- | --- | --- | --- |
| API版本 | Beta | HarmonyOS 5.0.3 Beta1 | 5.0.3(15) Beta1  *\***注意**：设备系统支持的API能力范围请以**API版本****为准。* | 2025/02/28 |
| DevEco Studio | Beta | DevEco Studio 5.0.3 Beta1 | 5.0.9.100 | 2025/02/28 |
| SDK | Beta | HarmonyOS 5.0.3 Beta1 SDK | 基于OpenHarmony SDK Ohos\_sdk\_public 5.0.3.130(API 15 Beta1) | 2025/02/28 |
