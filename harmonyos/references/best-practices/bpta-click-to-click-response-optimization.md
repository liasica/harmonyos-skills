...
content_hash: sha256:ab4306ea0ef56aa55cdcdbf903502f5c15f5a8df8317861b24bc51307d902002
---
...
**图1** 点击响应起止点示意图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/ICa73BOhSTKcWWdI_4FKRg/zh-cn_image_0000002229336589.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/uY6e2WuNRnCsO5yFJUPniA/zh-cn_image_0000002456578994.png "点击放大")
...
2. 点击“手动性能页面间转场体检”按钮启动检测。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/de/v3/ABMniEw7Tf6fzeH3yDi9dQ/zh-cn_image_0000002512366839.png "点击放大")
3. 开发者需根据提示，在应用中找到待检测页面，点击工具中的开始按钮，然后在应用中手动执行转场，操作后点击停止完成本次检测。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/pPoi_3paSDSlHRPPT9PutQ/zh-cn_image_0000002514736963.png "点击放大")
4. 检测结果分析，点击响应时延应小于或等于100ms。图中存在大于100ms的点击响应时延，判断为存在性能问题。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f/v3/YupFJgkvQDGuzwMjN1JS3A/zh-cn_image_0000002554625509.png "点击放大")
...
1. 获得检测结果后，点击详情报告中的“点击响应时延”，可以查看UI线程应用自身方法耗时长的检测结果。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cc/v3/5_9W1hK4TmmmpUOsgIVdew/zh-cn_image_0000002523545578.png "点击放大")
...
1. 获得检测结果后，点击详情报告中的“点击响应时延”，可以查看UI线程应用自定义组件创建耗时检测结果。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/02/v3/BZSUXFfNTlKwDaVBokX88A/zh-cn_image_0000002554665471.png "点击放大")
2. 可点击源文件定位到创建耗时的UI组件，根据提供的可能故障原因，去对UI组件进行相应优化修改，减少该UI组件自身创建耗时。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/82/v3/lvxSOwhHQZW10pxaStQUCg/zh-cn_image_0000002523585572.png "点击放大")
...
1. 抓取操作trace：启动DevEco Studio，连接设备，打开应用，执行以下操作。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1/v3/LBak_iDuQVGxb2YFkdN09Q/zh-cn_image_0000002456418534.png "点击放大")
2. 确认响应起点和终点：
...
3. 分解时间段：点击响应的整体时延拆解后，主要分为输入阶段、应用阶段和渲染阶段。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/66/v3/gITYgBbXSKGwlKnBI1X0Dw/zh-cn_image_0000002489617765.png "点击放大")
4. 分析定位原因：针对框选的应用阶段，分析主进程泳道，观察是否存在耗时长的函数阻塞主线程或超长耗时单帧。如果有长段的ExecuteJs，查看具体的调用栈或火焰图，定位耗时函数。如果是FlushLayoutTask阶段耗时，结合UI组件树分析布局合理性，查找优化空间。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/RDn9HLZUTreLlj8wAiO2jA/zh-cn_image_0000002489537833.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1c/v3/NvSfFmRuTBSmgBwWOBeNOg/zh-cn_image_0000002194010780.gif)
...
**图4** 生命周期流程图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/Gqj4isXtSHGhYOG8IowLAw/zh-cn_image_0000002193851184.png "点击放大")
...
**图5** 应用响应的两个视角  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/34/v3/Mc9hpMV0QAaD8vba2uGFAg/zh-cn_image_0000002193851196.png)
