...
content_hash: sha256:b3f50e05bbc5167d0df19e849a2905f07481a3c166fc7180e32e18277264c12a
---
...
* 循环渲染
  ...
  **图1** ForEach渲染过程示意图  
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/gmrDVSF5SLepC474VpyK0g/zh-cn_image_0000002194010368.png "点击放大")
...
* 数据懒加载
  ...
  **图2** LazyForEach渲染过程示意图
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a/v3/ISy2x3r1TeuYv6N_QiH66w/zh-cn_image_0000002229450649.png "点击放大")
...
2. 通过Profiler调优工具抓取Trace，可以判断子组件创建的次数。如下图所示，在该帧中出现大量的BuildLazyItem切片，每一次BuildLazyItem对应一次子组件的创建，对比数量可知LazyForEach按需加载失效。关于调优的内容可参考[性能分析](bpta-optimization-tool-practice.md)。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/DzTKIMoPR6Sg0pcMYp3R3g/zh-cn_image_0000002194010376.png "点击放大")
