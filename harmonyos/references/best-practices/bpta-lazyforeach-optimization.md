...
content_hash: sha256:d3e926b6601d161ee0945eff50b88e3a2ee7f57936422ab1f037f1f8addc123d
---
...
* 循环渲染
  ...
  **图1** ForEach渲染过程示意图  
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/1pXr-rmIRrivnP5Vv3BPHw/zh-cn_image_0000002194010368.png "点击放大")
...
* 数据懒加载
  ...
  **图2** LazyForEach渲染过程示意图
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b9/v3/JthsPw2AR_GRC9cS-9GhNQ/zh-cn_image_0000002229450649.png "点击放大")
...
2. 通过Profiler调优工具抓取Trace，可以判断子组件创建的次数。如下图所示，在该帧中出现大量的BuildLazyItem切片，每一次BuildLazyItem对应一次子组件的创建，对比数量可知LazyForEach按需加载失效。关于调优的内容可参考[性能分析](bpta-optimization-tool-practice.md)。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/94lBKiEOTsu71pU8IvtOqg/zh-cn_image_0000002194010376.png "点击放大")
