...
content_hash: sha256:d7a34d6cff9f41fd056019c54c2a70f7909fa9863a798479e0c6257530d81173
---

## 概述

本章介绍一多应用在工程结构设计及应用上架配置中的方法。在开发“一多”应用时，除了需要针对手机、平板、电脑、智能穿戴、智慧屏等不同设备的硬件特性进行适配外，还需合理组织代码工程，以提升开发效率与部署灵活性。为保障多设备间一致的用户体验，系统提供了相应的配置能力。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/da/v3/CxBY9ArrTeuw7StQKGrh_g/zh-cn_image_0000002489379062.png)

配置工程名称、包名等基本信息，选择目标支持设备，完成设置后即可创建项目。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/xnSZqma6SwK8dfN0rTNvMA/zh-cn_image_0000002521538859.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/qVMeVpnFSPWMjWWmnKjPSg/zh-cn_image_0000002489539042.png)

根据业务需求，应用可以灵活规划新增或删除Module，具体操作步骤可以参考[添加和删除模块](../harmonyos-guides/ide-add-new-module.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/dRB1O9EESSyWFTgX9bweMg/zh-cn_image_0000002521658841.png)

**修改设备类型**

在新增Module时，可指定该Module支持运行的设备类型；对于已创建的Module，可通过修改其module.json5配置文件中的[deviceTypes标签](../harmonyos-guides/module-configuration-file.md#devicetypes标签)，修改支持运行的设备类型，支持"phone/tablet/2in1/tv/wearable/car"，分别对应手机、平板、电脑、智慧屏、智能穿戴、智能座舱设备。修改后需要点击右上角的"Sync Now"，否则改动不会生效。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/hPpe-z0HRJ-aHzuDtqOWmQ/zh-cn_image_0000002489379064.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/I4g9NowlQkCYV_u2wPJYJA/zh-cn_image_0000002521538863.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5b/v3/GW-mQ7ulRwWTGue4_FAigg/zh-cn_image_0000002489539046.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/ZEuW7QWHSjap2KWZpIpK9g/zh-cn_image_0000002521658845.png "点击放大")
