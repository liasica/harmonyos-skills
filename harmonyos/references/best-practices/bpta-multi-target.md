...
content_hash: sha256:531265d231724a35de0eaa258759db6c13be9994e940a44fad99435ff414b1d6
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/v5Eu7SvDR9i9FughYpcqaA/zh-cn_image_0000002523454541.png "点击放大")
...
4. 实现不同目标产物需要定制的业务逻辑。
   * 通过[source源码集-sourceRoots配置](../harmonyos-guides/ide-customized-multi-targets-and-products-guides.md#section18668905913)的差异性代码空间，实现标题（代码文件）多目标效果。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/7YxnuArlTkyWVdAGUgXiAg/zh-cn_image_0000002229335589.png) ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/kTLjiXrkQ7q6X_6JSUTu8g/zh-cn_image_0000002193850196.png)
   ...
   * 在HAR模块引用差异性资源，实现页面中资源多目标效果。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/-P4xMQ0XS6aDwW6FF_yFFQ/zh-cn_image_0000002194009792.png) ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/zCqkNvB7S_SKgQmGMnUf1g/zh-cn_image_0000002194009796.png)
   ...
   * 在HAR模块中通过不同自定义参数信息跳转到不同页面，实现路由跳转多目标效果。
     ...
     **图1** official版本  
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0a/v3/IV2Eo1gSTZ6TCas7TJ8oXA/zh-cn_image_0000002229335573.gif)

     **图2** test版本  
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/LSZYYpFNQ9SbiiviH3zUUA/zh-cn_image_0000002193850204.gif)
...
5. 选择不同的product构建出不同的目标产物。
   ...
   **图3** 构建图示  
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/eEBbMzA7TpqM1KK3k5hbjQ/zh-cn_image_0000002229450045.png)
   ...
   **图4** Official版本
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/1QEWG_HjS16HcBXIkFCr0Q/zh-cn_image_0000002194009800.gif)

   **图5** Test版本  
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/IolLnALqQqS4Yv5QYspTpw/zh-cn_image_0000002229335577.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/NXh_5FYDRy2k2mZFS1ft6g/zh-cn_image_0000002229335565.png "点击放大")

然后进入到签名配置页面，点击加号，添加签名信息：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8c/v3/OMCWlbT4RXysvjqHmQXFjQ/zh-cn_image_0000002229450081.png "点击放大")

然后选择对应的bundle name，并填写上面配置的"signingConfig"信息（每个product产物都需要配置）：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/eEdkOEFcRVObzwZEGKzymQ/zh-cn_image_0000002193850180.png "点击放大")

点击ok之后，进行签名即可。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/qFmE9vPjSImMPPDJhYXnQQ/zh-cn_image_0000002193850208.png "点击放大")
