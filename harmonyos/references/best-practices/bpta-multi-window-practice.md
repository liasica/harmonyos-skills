...
content_hash: sha256:aa8c2bc0b58666450a7482fc84d85d5dba2add0f60f40d11845a2fff99e65ad4
---
...
* **悬浮窗**：设备屏幕上悬浮的、非全屏的应用窗口。一般用于在已有全屏任务运行的基础上，临时处理另一个任务，或短时间多任务并行使用。如浏览网页的同时回复消息。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/AMp84hpiToSxFecPnxAgJg/zh-cn_image_0000002193851416.png "点击放大")
* **分屏**：分屏一般用于两个应用长时间并行使用的场景。例如边看购物攻略、边浏览商品；边看视频、边玩游戏；看学习类视频的同时做笔记等。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/L-PQWXnnS9eSdDZRS7offA/zh-cn_image_0000002193851376.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/bFzfNRSrTQWYxUOjDK5gGA/zh-cn_image_0000002193851392.png "点击放大")
...
关于不同设备悬浮窗宽高比、应用分屏窗口高度比例详细请参见[应用布局适配智慧多窗](../harmonyos-guides/multi-window-layout-adapt.md)。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/SYpMPyb5R8eaHW9hxXmNOA/zh-cn_image_0000002229451269.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/wh3iS6BTRu6a_AVQ3JjtNQ/zh-cn_image_0000002229336757.png "点击放大")

顶部横条的避让可通过以下两种方式适配，具体可以参考[顶部窗口控制条避让适配智慧多窗](../harmonyos-guides/multi-window-controlbar-adapt.md)。

* **使用窗口的避让能力**：通过[setWindowLayoutFullScreen()](../harmonyos-references/arkts-apis-window-window.md#setwindowlayoutfullscreen9)设置窗口布局是否为沉浸式布局。沉浸式布局是指应用布局不避让状态栏、导航栏以及智慧多窗顶部横条，这可能发生组件与顶部横条的重叠，导致文字遮挡、点击事件冲突等情况。非沉浸式布局是指布局避让状态栏、导航栏以及智慧多窗顶部横条，组件不会与其重叠。因此可设置setWindowLayoutFullScreen()接口的参数为false使窗口的布局为非沉浸式布局。
...
1. 界面被截断，无法上下滑动。
   ...
   **问题现象**
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/a4dY83EGRj6ZZHPnIYeiBQ/zh-cn_image_0000002229336817.gif "点击放大")
   ...
   **解决措施**
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/ejwvFq7TTYqOeDOuw3oP7w/zh-cn_image_0000002194010960.gif "点击放大")
2. Xcomponent视频画面在分屏页面显示不全。
   ...
   **问题现象**
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/Ps6zv3b1R3SVCO0nCrSmtQ/zh-cn_image_0000002229451293.gif "点击放大")
   ...
   **解决措施**
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a9/v3/iwL4VZA5TtiMn_MoEXBPnQ/zh-cn_image_0000002193851424.gif "点击放大")
3. Video组件在分屏状态下截断。
   ...
   **问题现象**
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/EJ8MeaX7Rve9e63UFqpopg/zh-cn_image_0000002193851404.gif "点击放大")
   ...
   **解决措施**
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/4wfG562hRT69tti8K5CaFQ/zh-cn_image_0000002229336797.gif "点击放大")
4. 子组件超出父组件的范围。
   ...
   **问题现象**
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/UNbeCxexRQu24yB8OXmqsw/zh-cn_image_0000002229336773.gif "点击放大")
   ...
   **解决措施**
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/tjTuBhTaTx2pABzA9_-25g/zh-cn_image_0000002194010984.gif "点击放大")
5. Image组件在分屏状态下显示异常。
   ...
   **问题现象**
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/Pxbcr8-ST8WkZvAkOHn_GA/zh-cn_image_0000002194011000.gif "点击放大")
   ...
   **解决措施**
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/jomGjio7RpOkca1F5vCslQ/zh-cn_image_0000002193851432.gif "点击放大")
6. 弹窗布局错乱。
   ...
   **问题现象**
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/XY5MUMmPTiGGcrp9S8XhiQ/zh-cn_image_0000002229336789.gif "点击放大")
   ...
   **解决措施**
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5b/v3/33B_qmuRSnad0oO8t9hrGw/zh-cn_image_0000002229336769.gif "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d1/v3/Bjf7oMqWSoKRlm_jPLDSgA/zh-cn_image_0000002193851420.gif "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/B_bvg-5iR5yFupNYPSPdJw/zh-cn_image_0000002229451253.gif "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/fnbqvE5YSoi7_SPoLe_OZw/zh-cn_image_0000002229451281.gif "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/etKSIceURwOT9k2EMk78fg/zh-cn_image_0000002194010976.gif "点击放大")
