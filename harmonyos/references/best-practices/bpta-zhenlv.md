...
content_hash: sha256:d5d71722c468c596eb8c1b5cea8e1eb3d689bfb7d61350b3f8ab649dc063a641
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/Z3-E3mDYT2C9px0qy_LRsQ/zh-cn_image_0000002464821893.png "点击放大")
...
**图2** ArkUI渲染管线结构与Frame Insight性能打点   
 ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/vNoe-KM4RXypB3MrD4j2OA/zh-cn_image_0000002324311552.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9d/v3/cSio1_fOR0ut9iQ6030KqQ/zh-cn_image_0000002431346600.png "点击放大")

**图4** Render Service卡顿导致丢帧的故障模型

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/E-TkPiNPQHeBNwvWghpHBQ/zh-cn_image_0000002464785897.png "点击放大")
...
**图5** 丢帧问题处理流程   
 ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/ehkC0KyrT2C-DHHFwfuBGw/zh-cn_image_0000002484386113.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/VqMI_98-RhOFIw0rSlmhvQ/zh-cn_image_0000002324311568.png "点击放大")
...
1. 在DevEco Studio中启动AppAnalyzer工具，详细请参考：[AppAnalyzer](bpta-performance-detection.md#section135451444171)。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/pyvieTO8TXmsTSL25HY3wg/zh-cn_image_0000002510742749.png "点击放大")
2. 执行滑动场景体检。选择场景化体检，然后点击“手动性能页面滑动体检”，工具会进行准备，自动编译、安装、运行当前工程，需要保持手机解锁状态。
   1. 当提示“准备完成，请操作手机至检测页面”等内容时，需要在手机应用中找到待检测的滑动页面，然后点击开始按钮。
      ...
      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/JPByBeWPRTmfebs09gMAog/zh-cn_image_0000002510822777.png "点击放大")
   2. 等待工具录制准备，当提示“体检中，请操作手机”时，在手机上的待检测页面执行滑动若干次。等待剩余时间结束或点击暂停按钮，再点击停止完成本次检测。

      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/2zwkE4A5RyShRJ6KxB-Agg/zh-cn_image_0000002478622848.png "点击放大")
3. 生成性能体检报告。工具分析后，若检测未通过如下所示。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0d/v3/5yjVJh9yRly487CxJztNEQ/zh-cn_image_0000002478782820.png "点击放大")
...
* 如果函数的单次调用耗时长（查看平均耗时），说明是函数本身耗时长，开发者自行优化函数，将函数放到子线程或者进行缓存，开发者可参考[其他主线程优化思路](bpta-time-optimization-of-the-main-thread.md#section4365993361)。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/RlhmWyVuScG_LjWWsIo4vQ/zh-cn_image_0000002510827059.png "点击放大")
* 如果函数本身耗时不长，但是函数调用次数多（例如在高频回调里打日志等操作）

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/HtETuI6JTV2L7dEpzCRK_g/zh-cn_image_0000002510747255.png "点击放大")
...
* 如果方法名aboutToBeDeleted调用次数过多，如下图所示：
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/kvpp7-eSTqGCfQuJROOXQA/zh-cn_image_0000002510827321.png "点击放大")

  此时需要点击**总耗时**列的超链接，打开trace向前排查主线程是否有阻塞。如下图所示也是因为前面的主线程阻塞导致的，因为destroy只会发生在idle，如果主线程阻塞一直没有idle，就会积压；

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/0_u6MrFbTseK0KrQhCXMEg/zh-cn_image_0000002484280497.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/6DmFauFqS-yPYnQrhyQeqQ/zh-cn_image_0000002478627544.png "点击放大")

**问题3：图片纹理过大**

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/cK1NKb-XQtmwu-k15acJOQ/zh-cn_image_0000002510747477.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/B6WYcwG-RdyoxUxPRmxxxg/zh-cn_image_0000002510827519.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/Lwv8SX_oRQGVZW4IfqfRJg/zh-cn_image_0000002324311644.png "点击放大")

**认识卡顿帧**

使用Frame Profiler录制了一段Trace。在时间轴上拖动鼠标选定要查看的时间段，选择了一个2.5秒的时间区段。选中Frame主泳道，查看下面的Statistics栏，发现应用在这个时间段内丢失了16帧，丢帧率为7%。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/fZbLyE8nQqmgz_u0wTGX-w/zh-cn_image_0000002358350081.png "点击放大")

丢帧问题可能出现在Render Service或App侧。上图中的丢帧主要出现在应用帧，针对这种现象，继续分析，放大右侧图表，选中超时帧查看详细数据。期望时间为8.3毫秒（当前设备为120赫兹），而实际处理时间为8.9毫秒。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/O2FQv3EiT8SAU_Q6lOOMiA/zh-cn_image_0000002324471436.png "点击放大")
...
**图7** 丢帧处应用主线程状态   
 ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5d/v3/peaRpcFkT3a5nqCQcvtSXA/zh-cn_image_0000002358270221.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/de/v3/WBagUnF9TUu8eGnAdse7JQ/zh-cn_image_0000002324311656.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/VziAU7JzQJCp7WO_lIQAzQ/zh-cn_image_0000002536911353.png "点击放大")

接下来通过Trace查看每一帧的具体耗时，点击![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/3lGQ8RfmT4SvAIMA8TAxbg/zh-cn_image_0000002504870956.png "点击放大")图标跳转到卡顿帧应用侧Trace详情，如下图所示。开发者，可以点击泳道信息区的收藏按钮，将应用帧处理的泳道收藏置顶，防止上下文信息丢失。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/uED7OWJMSASFduylEZcGOQ/zh-cn_image_0000002505041340.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/53/v3/__xwOkI0Rk-gS4tAQuK8Hg/zh-cn_image_0000002358270229.png "点击放大")

在Frame模板中，要查看ArkUI Component泳道，需在泳道录制前手动勾选，如图所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/eee4i0QzSGGDhF-1gAiltw/zh-cn_image_0000002324311668.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/GrvmXUPBRiO37dyIouhSnA/zh-cn_image_0000002358350101.png "点击放大")

以initialRenderView函数的耗时为例进行分析，展开函数后，可以看到主要耗时在列表项ListItem的子组件ArticleCardView的创建上。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/50/v3/DscZ-5fLTUmQGiyDhM65ag/zh-cn_image_0000002324471460.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7e/v3/b_Osv1ESRd-cTcBsWPIGrg/zh-cn_image_0000002358270233.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/wH1otgLWRwKJVub1CfS52A/zh-cn_image_0000002358350105.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0e/v3/O4jG6eJ3TqWN6_GT80pBaA/zh-cn_image_0000002324471464.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/m5jq1rClRC68BcGY5OnxpQ/zh-cn_image_0000002358270237.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/G-HjmtHdSm-gAwxyQPNxCw/zh-cn_image_0000002324311680.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b9/v3/A9cELwSWRRSg6BcJWTJ8sQ/zh-cn_image_0000002358350117.png "点击放大")
