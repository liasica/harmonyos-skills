...
content_hash: sha256:39305e1e19e2e7e9a949d08207be85f3cb389eaa5cc625e6086c8d2d1365785d
---
...
2. 分析报错栈，确认触发异常位置。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/AWyWXW8dQpm_IztT9KFLYA/zh-cn_image_0000002693765532.png)
...
3. 分析分配栈和首次释放栈，确认重复释放内存对象。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a9/v3/5ekK0fKHSLGDuIC7j9RKqQ/zh-cn_image_0000002723405003.png)
...
4. 分析控制流路径，如下图所示：
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/_NGM8449TWW0N0pi6rJq4w/zh-cn_image_0000002693605648.png)
...
2. 分析报错栈，确认触发异常位置。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1a/v3/Qzwk_UQERBq9O2iBKiMS6Q/zh-cn_image_0000002723285081.png)
...
3. 分析分配栈和首次释放栈，确认重复释放内存对象。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/VmZGqKFsTC61hRlMj3gp-Q/zh-cn_image_0000002693765534.png)
...
4. 分析控制流路径，如下图所示：
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/0sl1-I3iRA-qfzJMDiehIg/zh-cn_image_0000002723405037.png)
...
2. 分析报错栈，确认触发异常位置。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/2EI_ZvMgR3GLuyUyUT-PxQ/zh-cn_image_0000002693605716.png)
...
3. 分析分配栈和首次释放栈，确认重复释放的内存对象。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/YOgAloclSySH-lOH3v3Ueg/zh-cn_image_0000002723285185.png)
...
4. 分析控制流路径，如下图所示：
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/XpLS-o9sQFOGJblAktvVcA/zh-cn_image_0000002693765672.png)
   1. 定义函数内局部指针对象ptr，并申请100字节内存，地址赋值给ptr。
   2. 第一次释放ptr，释放后ptr指针未置为nullptr。
   3. 第二次释放ptr，此时ptr所指向的内存块已释放，触发异常。
...
2. 分析报错栈，确认触发异常位置。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/WBKaRhCdRs-eu_wwOwBpSg/zh-cn_image_0000002723405179.png)
...
3. 分析分配栈和首次释放栈，确认重复释放内存对象。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f4/v3/aY-cxknsR0ywaVC29RsXgw/zh-cn_image_0000002693605852.png)
...
4. 分析控制流路径，如下图所示：
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/q6xASg24TeOOkDi1NjXdDQ/zh-cn_image_0000002723285319.png)
