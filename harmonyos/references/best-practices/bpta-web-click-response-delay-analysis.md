...
content_hash: sha256:f6506a0223504cd119300598622773d0d1462b1275ec852de2b269a9351d4367
---
...
**图1** 场景动画  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/04/v3/PVyEtuN4TNa3qPb8vwXJZQ/zh-cn_image_0000002229451169.gif "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/txNuVePRToab0oK_k5kIvA/zh-cn_image_0000002194010888.png "点击放大")
...
1. 确认起点：如果是由点击触发，则首先定位到应用侧的DispatchTouchEvent，如下图虚线所示：
   ...
   **图3** Trace起点
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f2/v3/yF-SWM5YTmqb6XZehxhlwQ/zh-cn_image_0000002193851272.png "点击放大")
2. 确认终点：选择连续稳定发出的第一帧vsync信号作为终点，而非不稳定vsync信号，是因为非连续的vsync信号不一定触发界面上的渲染行为。本文旨在分析从应用元素点击到应用界面开始变化的点击时延问题，因此选择连续稳定渲染的第一帧vsync信号作为终点。
   ...
   **图4** Trace终点
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3c/v3/WRyFCPvMSc-WcjtNriiDtw/zh-cn_image_0000002193851276.png "点击放大")
...
3. 分析中途出现的H:ReceiveVsync信号可以发现，在无响应阶段出现了几帧，但每帧的耗时并不长。应用侧也是如此，说明在UI绘制过程中没有高负载。
   ...
   **图5** Trace帧率分析
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/5SJOd4QhQ9aeHXm8HQn6PA/zh-cn_image_0000002193851300.png "点击放大")
4. 在此过程中，应用长时间占用CPU，原因可能是进行了大量的计算。

   **图6** 可能耗时原因

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/g9rcqPyTQXuPoSGAsp5OQg/zh-cn_image_0000002193851280.png "点击放大")
...
**图7** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/z4ne3WzMSl-WqDIrhZiI8w/zh-cn_image_0000002193851264.png "点击放大")
...
**图8** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/24/v3/vARub_rrT2K9okcIftOotQ/zh-cn_image_0000002194010892.png "点击放大")
...
**图9** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/YqYpr4qITd-plYv0Bx8JlQ/zh-cn_image_0000002229451141.png "点击放大")
...
**图10** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/yjRV9d8TRii4_2wXqWf85A/zh-cn_image_0000002194010856.png "点击放大")

源码耗时如下图所示：

**图11** 源码耗时

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9c/v3/yGZaPfQLT4eb5cWiAlMioA/zh-cn_image_0000002229451173.png "点击放大")
...
**图12** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/B6anFjbfQkSvazq02l8SYw/zh-cn_image_0000002229336685.png "点击放大")
...
**图13** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/W5jzI00xRZ-WN4AmqayA5Q/zh-cn_image_0000002193851284.png "点击放大")
...
**图14** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/41/v3/DsUpd5YWTJ-EeIMHU4kJ4Q/zh-cn_image_0000002229336681.png "点击放大")
...
**图15** 优化后的泳道图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/D3O2WXsCSges9VdNjtBHXA/zh-cn_image_0000002229451149.png "点击放大")
