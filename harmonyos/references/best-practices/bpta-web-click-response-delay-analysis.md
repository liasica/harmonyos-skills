...
content_hash: sha256:72d53b08c16a0122b4933f02c0965bc7af3bbe5d4bca18ed7071b0c32fa10cc5
---
...
**图1** 场景动画  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/45/v3/q68Kw_e6Rc63Eg7NteADHA/zh-cn_image_0000002229451169.gif "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/08/v3/YJhun9awRvmkGg9PXMylIQ/zh-cn_image_0000002194010888.png "点击放大")
...
1. 确认起点：如果是由点击触发，则首先定位到应用侧的DispatchTouchEvent，如下图虚线所示：
   ...
   **图3** Trace起点
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/kYycRvWDRlKxZGw4Yr-vmQ/zh-cn_image_0000002193851272.png "点击放大")
2. 确认终点：选择连续稳定发出的第一帧vsync信号作为终点，而非不稳定vsync信号，是因为非连续的vsync信号不一定触发界面上的渲染行为。本文旨在分析从应用元素点击到应用界面开始变化的点击时延问题，因此选择连续稳定渲染的第一帧vsync信号作为终点。
   ...
   **图4** Trace终点
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/xuIbBrMVQtWPdgPgiW3mSw/zh-cn_image_0000002193851276.png "点击放大")
...
3. 分析中途出现的H:ReceiveVsync信号可以发现，在无响应阶段出现了几帧，但每帧的耗时并不长。应用侧也是如此，说明在UI绘制过程中没有高负载。
   ...
   **图5** Trace帧率分析
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/Csi2sMCPS0-QlIlCeRpCiA/zh-cn_image_0000002193851300.png "点击放大")
4. 在此过程中，应用长时间占用CPU，原因可能是进行了大量的计算。

   **图6** 可能耗时原因

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e3/v3/TiO3nEk-Qn6FU7u5B9qINA/zh-cn_image_0000002193851280.png "点击放大")
...
**图7** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/wDAarr5VSLahXuSLSUZD7w/zh-cn_image_0000002193851264.png "点击放大")
...
**图8** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f4/v3/-jiZzWHWS7ycu6D4TTMZSA/zh-cn_image_0000002194010892.png "点击放大")
...
**图9** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/JArVLpTKStGxSKovVgI0ww/zh-cn_image_0000002229451141.png "点击放大")
...
**图10** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/23/v3/PSfTncPwSo2g6Jfj17v0Jw/zh-cn_image_0000002194010856.png "点击放大")

源码耗时如下图所示：

**图11** 源码耗时

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/XfGjIl0sQxGmhq0Wr3aN5A/zh-cn_image_0000002229451173.png "点击放大")
...
**图12** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/0dn4NHmhSyyaoiZs2mcoHw/zh-cn_image_0000002229336685.png "点击放大")
...
**图13** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/d-xpbY9XRZGNb-nhXb2f8w/zh-cn_image_0000002193851284.png "点击放大")
...
**图14** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/zlBrmqcRQBOFDfVacRxA6A/zh-cn_image_0000002229336681.png "点击放大")
...
**图15** 优化后的泳道图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6a/v3/mjaJBigKQPyaqxqLnumU6w/zh-cn_image_0000002229451149.png "点击放大")
