...
content_hash: sha256:e675d12fb02f249626f2ceaf09b571f3effb98556367f51d996b7bc9f8112bc4
---
...
**图1** 场景动画  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/KFYQm-FKRzOCIErYGcPZJw/zh-cn_image_0000002229451169.gif "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/64/v3/ZKRupP2FROyspEtowZqTxg/zh-cn_image_0000002194010888.png "点击放大")
...
1. 确认起点：如果是由点击触发，则首先定位到应用侧的DispatchTouchEvent，如下图虚线所示：
   ...
   **图3** Trace起点
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/1m2vr4UwSv-_dtdwrMPpjQ/zh-cn_image_0000002193851272.png "点击放大")
2. 确认终点：选择连续稳定发出的第一帧vsync信号作为终点，而非不稳定vsync信号，是因为非连续的vsync信号不一定触发界面上的渲染行为。本文旨在分析从应用元素点击到应用界面开始变化的点击时延问题，因此选择连续稳定渲染的第一帧vsync信号作为终点。
   ...
   **图4** Trace终点
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/qvGfU4pcR2mJLCyBrmjq_A/zh-cn_image_0000002193851276.png "点击放大")
...
3. 分析中途出现的H:ReceiveVsync信号可以发现，在无响应阶段出现了几帧，但每帧的耗时并不长。应用侧也是如此，说明在UI绘制过程中没有高负载。
   ...
   **图5** Trace帧率分析
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/LVjqaJiDT86oEKwmJxawXg/zh-cn_image_0000002193851300.png "点击放大")
4. 在此过程中，应用长时间占用CPU，原因可能是进行了大量的计算。

   **图6** 可能耗时原因

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e8/v3/EFHyqf1ARouKiUmz2sNZOg/zh-cn_image_0000002193851280.png "点击放大")
...
**图7** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/RCSoMpzPRsaOSBEQNeYYrQ/zh-cn_image_0000002193851264.png "点击放大")
...
**图8** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/02/v3/-4ZNCDjERvec9T8Tl8nJwA/zh-cn_image_0000002194010892.png "点击放大")
...
**图9** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/DyBqEX5pSr6C3PvzcDBbFw/zh-cn_image_0000002229451141.png "点击放大")
...
**图10** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/MbuSHei_Tyi0wYshQUMEbg/zh-cn_image_0000002194010856.png "点击放大")

源码耗时如下图所示：

**图11** 源码耗时

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c9/v3/OiDZ3zApTcaW_HU1OsltDQ/zh-cn_image_0000002229451173.png "点击放大")
...
**图12** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/29cyfS7uSx2PKbeIhwuE3w/zh-cn_image_0000002229336685.png "点击放大")
...
**图13** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/X1qznAioQf-hejD4_snXdQ/zh-cn_image_0000002193851284.png "点击放大")
...
**图14** DevTools泳道图区域划分  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/KPnHKBc-QYy3vlgVGebKPg/zh-cn_image_0000002229336681.png "点击放大")
...
**图15** 优化后的泳道图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/paJeDLqeSlOSngM__a-uag/zh-cn_image_0000002229451149.png "点击放大")
