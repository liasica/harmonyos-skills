...
content_hash: sha256:539f00af08d776f62618507c1b11da99d211c37c2dd6890b565f6d3a6b498d25
---
...
* 实施策略：如果用户拒绝了某项权限申请，应用不应再次弹窗请求该权限。应在页面的适当位置添加明确的提示，指导用户开启权限或退出当前需要该权限的场景，直到用户重新触发时再引导其完成授权。例如，权限申请被拒绝后，按钮上方显示提示文字，具体效果见下图：
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/2HTFpl18Q4yaapaTJtN1nw/zh-cn_image_0000002194010136.png "点击放大")
...
* 正例1（以示例代码为例，效果图如下）
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/Zq4tZF8qQmqWXDMMRxm5ng/zh-cn_image_0000002193850544.png "点击放大")
...
3. 不允许：点击后应用无法获取该权限，且再次调用requestPermissionsFromUser()方法无法拉起该权限设置弹框。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/mK8SicUOTh-uJt96zEL0LQ/zh-cn_image_0000002194010128.png "点击放大")

具体流程图如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1b/v3/fNDACDnWQlaIbY2sD0Gsng/zh-cn_image_0000002267532549.jpg "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/m_7S_4M7TRiDkVWrmsHNPA/zh-cn_image_0000002267612717.jpg "点击放大")
