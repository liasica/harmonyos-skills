...
content_hash: sha256:aec5d99b3b3d2fb04542d83488cec0932a0df7c5dcdfda8e41e011deee0e9c64
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/VP_SaH25SQKh-M-4aPYvjw/zh-cn_image_0000002553741749.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/DphMuPx6QWCHObBYiwb-qg/zh-cn_image_0000002522821800.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/eLTzvQ5oTMCSj7oVHJo_YA/zh-cn_image_0000002553861703.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/df/v3/ZdpSvDpITdylgbihiTv9gg/zh-cn_image_0000002522661810.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/de/v3/OV8YbPsJRMm3m8zaOk-wIA/zh-cn_image_0000002553741751.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/af/v3/4VoKg1YdQw-VponlUvJAOg/zh-cn_image_0000002522821802.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/15SLS60DTOW5KGpuj-DOuA/zh-cn_image_0000002553861705.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/r98-yttjR2C1MIV-R4YiAA/zh-cn_image_0000002522661812.png "点击放大")
...
1. 使用[animateTo()](../harmonyos-references/arkts-apis-uicontext-uicontext.md#animateto)接口实现旋转动画，通过设置横屏页面的[width](../harmonyos-references/ts-universal-attributes-size.md#width)、[height](../harmonyos-references/ts-universal-attributes-size.md#height)、[translate](../harmonyos-references/ts-universal-attributes-transformation.md#translate18)和[rotate](../harmonyos-references/ts-universal-attributes-transformation.md#rotate18)属性来完成，可参考[使用animateTo产生属性动画](../harmonyos-guides/arkts-attribute-animation-apis.md#使用animateto产生属性动画)。关键信息介绍如下：
   ...
   * X值为直板机竖屏时视频节点中心点距离屏幕顶部的距离，Y值为直板机竖屏时视频节点中心点距离屏幕右侧的距离。根据竖屏页面视频中心点与横屏页面视频中心点坐标的差值，得出视频节点在X轴与Y轴的偏移值。如下图所示：
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/fqR5WAhhQX-7xrrfSwkBNg/zh-cn_image_0000002553741753.png "点击放大")
...
2. 在页面的转场动画回调方法中执行视频旋转动画。当设备状态为完全展开或半折叠时，执行doAnimationFoldable()动画，否则，执行doAnimation()动画。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/XvFg5vDOS9StEHXcBZLd1g/zh-cn_image_0000002522821804.gif "点击放大")
...
4. 在横屏页面折叠屏的折叠状态切换时，使用[display.on('foldStatusChange')](../harmonyos-references/js-apis-display.md#displayonfoldstatuschange10)接口监听并适配UI界面。
   ...
   * 当折叠屏由折叠态切换为展开态时，仍使用竖屏的方式播放视频，因此将显示方向设置为PORTRAIT。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/X24uKZy8TnOzKaaYTsXa6w/zh-cn_image_0000002553861707.gif "点击放大")
