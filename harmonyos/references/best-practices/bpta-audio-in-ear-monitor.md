...
content_hash: sha256:ef4dad0c1b40f94b955fd5c04473a85df954377cd04ca361dee4131bf40b5425
---
...
| --- | --- | --- | --- |
|  | 实现方案 | 优点 | 缺点 |
| 硬件耳返 | 基于[AudioLoopback](../harmonyos-references/arkts-apis-audio-audioloopback.md)实现音频耳返 | 1. 物理耳返，延时低。 2. 在API 21，提供混响和均衡器等音效。 | 1. 当前仅支持有线耳机，不支持蓝牙耳机。 2. 在耳返的场景下，仅支持录制麦克风。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/MGMT-MPKThWPsGfDcn8SXw/zh-cn_image_0000002544829543.gif "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/EseI7cALRqOZRH7gxeFhug/zh-cn_image_0000002513149636.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1a/v3/Msr4JnsYT3a_shS7JGMyHQ/zh-cn_image_0000002513309570.png "点击放大")
...
1. 创建AudioLoopback。
   * 通过[isAudioLoopbackSupported()](../harmonyos-references/arkts-apis-audio-audiostreammanager.md#isaudioloopbacksupported20)查询当前系统是否支持音频返听模式。若支持，则调用[audio.createAudioLoopback()](../harmonyos-references/arkts-apis-audio-f.md#audiocreateaudioloopback20)接口创建音频返听器。
     ...
     ```
   * 通过AudioLoopback的[getStatus()](../harmonyos-references/arkts-apis-audio-audioloopback.md#getstatus20)方法获取音频返听状态，当返听状态为AVAILABLE\_IDLE时，表示返听可用，此时可调用[enable()](../harmonyos-references/arkts-apis-audio-audioloopback.md#enable20)方法传入参数true，开启音频返听。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/eRYG7JIiRZy2Cho1y_Q0Xw/zh-cn_image_0000002544789547.gif "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/j8eWzC3sQrKIjeFcl_zF5g/zh-cn_image_0000002544829551.png "点击放大")
