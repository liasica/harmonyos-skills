...
content_hash: sha256:94abb40f13855679afd6dd9ed0e2ac0af849555f535656beb1b5183eca424ca7
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7c/v3/rdP_dD7gR7u8QIYDFM-8sA/zh-cn_image_0000002380185801.png "点击放大")
...
**图2** 类的实例化示意  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/idZ0sYP_TSCGfqaRP2gYZQ/zh-cn_image_0000002346386188.png "点击放大")

原型对象也有原型\_proto\_。类的继承通过原型实现。实例方法调用时，会在原型链上查找方法，找到后执行调用。具体如图3所示。

**图3** 类的原型与继承  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2c/v3/L0JFkCxSSEKKR9bNT1bVnQ/zh-cn_image_0000002346386564.png "点击放大")

插桩和替换的操作是将回调参数与原方法组合成新函数，再用新函数替换原方法。具体如图4所示。

**图4** 插桩和替换原理示意图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a5/v3/81cMT24ETWGORdGAd5u-tg/zh-cn_image_0000002346546400.png "点击放大")
