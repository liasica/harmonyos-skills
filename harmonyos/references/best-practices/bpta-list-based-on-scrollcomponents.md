...
content_hash: sha256:63d38fc13c0b51908c5d838ad65bba3ade24cd03778336d39a9e61e15bc8b4b7
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/nBN_zpB5RZC7kaeSc2OyaQ/zh-cn_image_0000002356692034.png "点击放大")
...
4. 复用子节点模板
   ...
   2. 列表项内子组件可拆分组合
      ...
      **图2** 可拆分组件复用创建流程图  
      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/mhGHoX8qRJCd9ngL5uJC2w/zh-cn_image_0000002390372089.png "点击放大")
      ...
      **图3** 日志效果图  
      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/81/v3/qUvzZ9N0TpmIVjlGDvBr2A/zh-cn_image_0000002356851962.png "点击放大")
...
**图4** 商品分类列表展示效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/81/v3/RfgripVJSNCt6uOY90bj4g/zh-cn_image_0000002390452013.gif "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/PGGW6EL2SiWSZGwWVhlTow/zh-cn_image_0000002356692062.gif "点击放大")
...
**图6** 加速首屏渲染效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0f/v3/xlUM1Uh-RA6zR29laH5j9Q/zh-cn_image_0000002390372125.gif "点击放大")
...
**图7** @Reusable测试结果  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/3ajy0Br7Soi0m8mZ-iqlpg/zh-cn_image_0000002356852002.png "点击放大")

在ScrollComponents中，网络请求期间主线程空闲时间较少，请求结束后首屏组件的绘帧耗时较短。

**图8** ScrollComponents测试结果  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/jJoabbOoRu62OzT0eLnfIQ/zh-cn_image_0000002390452049.png "点击放大")
...
**图9** 下拉刷新效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/23/v3/BBjsEaJZRh2MjNkGc9uqVA/zh-cn_image_0000002356692086.gif "点击放大")
...
**图10** 上拉加载效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/6tfF-u2fRmGrZL6UbBIorA/zh-cn_image_0000002390372141.gif "点击放大")
...
**图11** 无限滑动效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/52/v3/H4b6uFu2Q1e5Fq86woHZ6w/zh-cn_image_0000002356852014.gif "点击放大")
...
**图12** 侧滑删除效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/56/v3/zMZyk0caRI2xaUJprYQQTw/zh-cn_image_0000002390452057.gif "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4c/v3/F2KAZnUcTua1WZFIXgxJqA/zh-cn_image_0000002356692098.gif "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/3r4lzLqKQYayx_sol1gZiA/zh-cn_image_0000002390372145.gif "点击放大")
...
双列表同向联动，左侧分类列表用于快速索引，内容列表依据分类进行分组，常用于商品分类选择、通讯录、城市选择、分组选择等页面。长列表分组吸顶功能参考：[常见列表流开发实践：分组吸顶场景](../harmonyos-guides/arkts-common-list-flow.md#分组吸顶场景)。

本案例实现商品分类选择页面列表头部分类吸顶效果，如下图所示。

**图15** 分组布局组头吸顶效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/TdskQY1jSGGLdCVCYsciEQ/zh-cn_image_0000002356852018.gif "点击放大")
...
通过选择左侧的一级列表，右侧的二级列表数据将相应更新，常用于商品分类选择、编辑风格等二级类别选择页面。长列表二级联动功能参考：[常见列表流开发实践：二级联动场景](../harmonyos-guides/arkts-common-list-flow.md#二级联动场景)。

本场景以商品分类列表页面为例，分别使用List组件展示左侧分类导航和右侧导航内容。进入页面后，点击左侧分类导航，右侧将展示对应的分类详情列表数据；滑动右侧列表内容时，列表标题将吸顶显示，同时左侧对应的导航内容高亮显示。

**图16** 长列表二级联动效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b9/v3/FokhBH-4SfmNPBxV5dc3dg/zh-cn_image_0000002390452065.gif "点击放大")
...
**图17** 动态切换列数效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3f/v3/aZHO5gPpRPuEo57SU11Cxg/zh-cn_image_0000002356692102.gif "点击放大")
...
**图18** 边缘渐隐效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cc/v3/Vop-UkeGQiWUV_DtAeBlPQ/zh-cn_image_0000002390372153.gif "点击放大")
