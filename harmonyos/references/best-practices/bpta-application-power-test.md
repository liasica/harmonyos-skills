...
content_hash: sha256:05b67bd153663fe46537889624045e2160e1adcaf6eae65d2b025fb50e6474d5
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/1zwZITlZTRm_eeKamH90qg/zh-cn_image_0000002417001770.png)
...
1. 实时监控界面：可以在实时监控界面实时查看应用在静态（无操作）或者操作过程中的温度、整机电流、应用耗电以及各器件的功耗数据，如下图所示。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/eWBRqHN4Si2gNcdnsaa2Sg/zh-cn_image_0000002417454990.png)
...
2. 通过场景化模板先录制后分析：Profiler工具提供了Energy、 Frame等场景化模板，支持录制功耗等相关的数据，同时可集成hitrace、hiperf等信息，便于开发者进行深入分析，Energy泳道如下图所示。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/gcLkbT6wT9C8P3rsxC_Iag/zh-cn_image_0000002417455710.png)
