...
content_hash: sha256:cacfea68bd0c43967d971f0dda655b3f2755b36bb7ef009e3dbd697fbd510fb8
---
...
1. 在运行调试窗口，点击**Diagnostics**，勾选**Address Sanitizer**。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/3LV73fAySzSBjctOHlyJiA/zh-cn_image_0000002404045249.png)
2. 如果有引用本地library，需在library模块的build-profile.json5文件中，配置arguments字段值为“-DOHOS\_ENABLE\_ASAN=ON”，表示以ASan模式编译so文件。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/yQhlwZ2NReCg7l0ScnwMTg/zh-cn_image_0000002370565420.png)
...
1. 修改工程目录下AppScope/app.json5，添加ASan配置开关
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/08/v3/M0hMo4VJSNqTk29G6MY_jA/zh-cn_image_0000002404125085.png)
2. 设置模块级构建ASan插桩。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6e/v3/LviEkVsMRSWd3r08smyC-w/zh-cn_image_0000002370405540.png)
...
2. 当程序出现内存错误时，弹出ASan log信息，点击信息中的链接即可跳转至引起内存错误的代码处（非release版本）。release版本本地无工程代码，可以使用[AnalyzeStackTrace功能](../harmonyos-guides/ide-release-app-stack-analysis.md)，提供要解析堆栈的so，解析结果为源码地址。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/41/v3/hSrg6HUKQ6OCctwowEiSbA/zh-cn_image_0000002404045253.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3f/v3/g7T2gY_XT3qOl5oAwdfV6g/zh-cn_image_0000002537425473.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/psEzSyLbTCyi9O-hZ9CSwA/zh-cn_image_0000002505625648.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d3/v3/mdfuNPQ8QzW0t-s5ay9_HQ/zh-cn_image_0000002505465892.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e3/v3/6F1bnoccTtGpqvX0bSonVA/zh-cn_image_0000002505625820.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/39/v3/LFjNGYpzQt6pKVVFJxr6lA/zh-cn_image_0000002537425861.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/iW6AqVzRQy6fr1CsQCcWJw/zh-cn_image_0000002505626186.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4/v3/38bdTB0_TASrtuokGBTWxQ/zh-cn_image_0000002505466522.png)
