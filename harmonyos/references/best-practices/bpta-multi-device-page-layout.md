...
部分视频应用在双栏布局中，支持用户同时观看视频和阅读评论。当设备宽度≥840vp，高宽比≥0.5且＜1.2时，使用双栏显示，左侧区域为视频界面，右侧内容区显示评论区；用户单击评论区按钮时，进入单栏模式，全屏显示视频，实现沉浸式观影体验，再次单击可打开评论区。当设备宽度<840vp或高宽比<0.5或≥1.2时，使用单栏显示，界面上方为视频区域，界面下方为评论区。
