...
UI组件截屏参考：[@ohos.arkui.componentSnapshot (组件截图)](../harmonyos-references/js-apis-arkui-componentsnapshot.md)

窗口截屏参考：[snapshot](../harmonyos-references/arkts-apis-window-window.md#snapshot9)
