...
* **[DevEco Studio上使用生成NAPI功能时， 提示“Failed to generate NAPI, check the napi\_init.cpp file and try again. ”错误](faqs-coding-14.md)**
* **[DevEco Studio上使用生成NAPI功能时， 提示“Could not find usage of napi\_module\_register in napi\_init.cpp.”错误](faqs-coding-15.md)**
