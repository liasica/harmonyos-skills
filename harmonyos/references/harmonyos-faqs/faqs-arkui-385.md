...
content_hash: sha256:222b75d3c5e3d712057a559a53245f558980e77afd0d24349b511a0a7b9d59f7
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/44/v3/hIpOfM1YRaC_7DGz1TusXA/zh-cn_image_0000002337430672.png)
...
* ArkTS侧可以结合blendMode将背景色裁掉。通过**混合模式（BlendMode）**可以指定当前像素如何与其下方的像素混合，可以用来实现裁切、蒙版、提亮等效果。关于BlendMode的具体使用可以参考：[BlendMode](../harmonyos-references/arkts-apis-graphics-drawing-e.md#blendmode)。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/bGnOyTilS7CrqW9ghLdJSw/zh-cn_image_0000002371468633.png)
