---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-faqs/faqs-arkgraphics-2d-27
title: 基于Canvas的弹幕遮罩人物过滤
breadcrumb: FAQ > 图形开发 > 2D图形（ArkGraphics 2D） > 基于Canvas的弹幕遮罩人物过滤
category: harmonyos-faqs
scraped_at: 2026-09-02T14:54:46+08:00
doc_updated_at: 2026-08-13
content_hash: sha256:dc541651b5c6dc84b1812226f28051cda4830faccc12cd1bb08fa638db7db3a5
---
...
* [Canvas](../harmonyos-references/ts-components-canvas-canvas.md)提供画布组件，用于自定义绘制图形。该场景下，用于绘制人物遮罩和弹幕。
* [CanvasRenderingContext2D](../harmonyos-references/ts-canvasrenderingcontext2d.md)使用RenderingContext在Canvas组件上进行绘制，绘制对象可以是矩形、文本、图片等。其中[fillText](../atomic-ascf/apis-canvas-rendering-context-2d.md#canvasrenderingcontext2dfilltext)绘制填充类文本，实现弹幕，[fill](../harmonyos-references/ts-components-canvas-common-method.md#fill-1)对指定路径进行填充，绘制蒙层，[globalCompositeOperation](../harmonyos-references/ts-components-canvas-common-property.md#globalcompositeoperation)控制重叠区域混合效果，用于实现人物穿透。
* [Path2D](../harmonyos-references/ts-components-canvas-path2d.md)路径对象，支持通过对象的接口进行路径的描述，并通过Canvas的stroke接口或者fill接口进行绘制。通过[addPath](../harmonyos-references/ts-components-canvas-path2d.md#addpath)的Path2D和[Matrix2D](../harmonyos-references/ts-components-canvas-matrix2d.md)（矩阵对象，可以对矩阵进行缩放、旋转和平移等变换。）参数，将SVG图片可绘制化。
