---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-sm4-sym-encrypt-decrypt-gcm-ndk
title: 使用SM4对称密钥（GCM模式）加解密(C/C++)
breadcrumb: 指南 > 系统 > 安全 > Crypto Architecture Kit（加解密算法框架服务） > 加解密 > 加解密开发指导 > 使用SM4对称密钥（GCM模式）加解密(C/C++)
category: harmonyos-guides
scraped_at: 2026-04-28T07:42:27+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:5959f8071930182ec400a602246b42c36bd83b2b267531bd3317e301723d7c37
---
...
6. OH_Crypto_ErrCode doTestSm4Gcm()
7. {
...
26. // 生成对称密钥
27. OH_Crypto_ErrCode ret = OH_CryptoSymKeyGenerator_Create("SM4_128", &genCtx);
...
54. // 加密
55. ret = OH_CryptoSymCipher_Create("SM4_128|GCM|PKCS7", &encCtx);
...
72. // 解密
73. ret = OH_CryptoSymCipher_Create("SM4_128|GCM|PKCS7", &decCtx);
...
[sm4\_gcm\_encryption\_decryption.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260112/Security/CryptoArchitectureKit/EncryptionDecryption/EncryptionDecryptionGuidanceSM4/entry/src/main/cpp/types/project/sm4_gcm_encryption_decryption.cpp#L16-L120)
