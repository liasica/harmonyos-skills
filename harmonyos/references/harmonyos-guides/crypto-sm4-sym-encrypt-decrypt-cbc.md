---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-sm4-sym-encrypt-decrypt-cbc
title: 使用SM4对称密钥（CBC模式）加解密(ArkTS)
breadcrumb: 指南 > 系统 > 安全 > Crypto Architecture Kit（加解密算法框架服务） > 加解密 > 加解密开发指导 > 使用SM4对称密钥（CBC模式）加解密(ArkTS)
category: harmonyos-guides
scraped_at: 2026-04-28T07:42:26+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:0a852a5be7f873c0375aeddbe0139b712383eb2cb747f6348e6f0df62fc62dd3
---
...
* 异步方法示例：
  ...
  23. let cipher = cryptoFramework.createCipher('SM4_128|CBC|PKCS7');
  24. await cipher.init(cryptoFramework.CryptoMode.ENCRYPT_MODE, symKey, iv);
  25. let encryptData = await cipher.doFinal(plainText);
  ...
  31. let decoder = cryptoFramework.createCipher('SM4_128|CBC|PKCS7');
  ...
  39. let symGenerator = cryptoFramework.createSymKeyGenerator('SM4_128');
  40. let symKey = await symGenerator.convertKey(symKeyBlob);
  ...
  46. try {
  47. let keyData = new Uint8Array([7, 154, 52, 176, 4, 236, 150, 43, 237, 9, 145, 166, 141, 174, 224, 131]);
  ...
  58. }
  59. } catch (error) {
  60. console.error(`SM4 failed: errCode: ${error.code}, message: ${error.message}`);
  61. }
  62. }
  ```

  [sm4\_cbc\_encryption\_decryption\_asynchronous.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260112/Security/CryptoArchitectureKit/EncryptionDecryption/EncryptionDecryptionGuidanceSM4ArkTs/entry/src/main/ets/pages/sm4_cbc_encryption_decryption/sm4_cbc_encryption_decryption_asynchronous.ets#L16-L79)
* 同步方法示例：
  ...
  38. let symKeyBlob: cryptoFramework.DataBlob = { data: symKeyData };
  39. let symGenerator = cryptoFramework.createSymKeyGenerator('SM4_128');
  40. let symKey = symGenerator.convertKeySync(symKeyBlob);
  ...
  [sm4\_cbc\_encryption\_decryption\_synchronous.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260112/Security/CryptoArchitectureKit/EncryptionDecryption/EncryptionDecryptionGuidanceSM4ArkTs/entry/src/main/ets/pages/sm4_cbc_encryption_decryption/sm4_cbc_encryption_decryption_synchronous.ets#L16-L79)
