...
content_hash: sha256:d84bc9442a4d55a8d8fc6ceaeea79400eda87ed20e92df489b76880a60f6b08d
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/LP5GHiI2ScKer6Hx-glhSA/zh-cn_image_0000002530913384.png)

### 查看设备实时抛出的FaultLog日志

当设备抛出FaultLog日志时，DevEco Studio将会弹出消息提示框，开发者点击**Jump to Log**即可跳转至FaultLog窗口查看日志信息。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/BikMQ1AHS_yVII5OrpjdRQ/zh-cn_image_0000002561833305.png)

### 跳转至引起错误的代码行

若抛出的FaultLog中的堆栈信息中的链接或偏移地址指向的是当前工程中的某行代码，该段信息将会被转换为超链接形式，点击后可跳转至对应代码行。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bb/v3/Iapf2tuGTx-E2gO5cVpskw/zh-cn_image_0000002561833313.png)
...
* 保存当前选中节点的日志：
  + 在当前选中节点右键点击**Export FaultLog**。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/76/v3/ZVsgRtFoSyO3TjABeyf8sg/zh-cn_image_0000002561833285.png)
  + 点击Export FaultLog按钮![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/23/v3/wjcgCng-SpmGdWFMyErwhA/zh-cn_image_0000002561753315.png)，弹出子选项后进一步点击**Export Selected FaultLog**。

    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/rRW9SL9RSQWinh8v3AO3Lw/zh-cn_image_0000002561753299.png)
* 保存所有日志：点击Export FaultLog按钮![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/cCVlUn9PQ7S0jrMmKxHoeQ/zh-cn_image_0000002530753376.png)，弹出子选项后进一步点击**Export All FaultLog**。
...
1. 双击cppcrash日志，**Fault Info**右侧会出现**Fault Analysis**页签。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/K1dQL6mkT2OiIdB_CWJmxw/zh-cn_image_0000002530913356.png)
2. 点击**Fault Analysis**页签，会展示结构化的日志信息。
   ...
   * 页面下方包含Stacks和Logs两个页签。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/rvLMlpoxSG-lo_JQJG9ARw/zh-cn_image_0000002530753372.png "点击放大")
...
Stacks页面包含了FaultLog中的堆栈信息，并以线程为单元进行折叠，点击展开按钮![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/l11z99t7Th-Zkp0gzWZeaQ/zh-cn_image_0000002530753398.png)，可以展开对应线程。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/KViFJ9jJSUKQna5FtZlhNw/zh-cn_image_0000002561833275.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/55/v3/wL_NG9V1T6m0wcaPVofkKQ/zh-cn_image_0000002561753301.png "点击放大")
...
1. 双击appfreeze日志，**Fault Info**右侧会出现**Fault Analysis**页签。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/NhgHLLoCTb6-gdP3RbzqOw/zh-cn_image_0000002561753321.png)
2. 点击**Fault Analysis**页签，会展示结构化的日志信息。
   ...
   * 页面下方包含Stacks、Logs、System、3s/6s Compare四个页签。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/CW1RthS9S3Gmo0gxV-aThw/zh-cn_image_0000002561753323.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2c/v3/ictD64MeS26tjX7AvRnrzQ/zh-cn_image_0000002561833271.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/t1pL46McQhusMqVhcaMtUQ/zh-cn_image_0000002530913348.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/Ej5QJxSMRYady9j5xGIKsg/zh-cn_image_0000002561753295.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/s3Xw07gdSyuXMCiSRLRN5Q/zh-cn_image_0000002561753307.png)
