...
content_hash: sha256:6912e83afd595f31759af1cbb6dcc8d339933ff0fcb077b05cbfeb8dd0181054
---
...
* 模式切换动效，使用预览流截图做模糊动效过渡。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/1FPplCtBSde0jD6UjKf4Kg/zh-cn_image_0000002762834451.gif)
* 前后置切换动效，使用预览流截图做翻转模糊动效过渡。

  图片为从前置相机切换为后置相机的效果。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/G45EfoH8TP6BT-I1cByt3A/zh-cn_image_0000002733274940.gif)
* 拍照闪黑动效，使用闪黑组件覆盖预览流实现闪黑动效过渡。

  图片为点击完成拍摄的效果。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a7/v3/xQiWeWn3Rk6G-5XCj-fYQg/zh-cn_image_0000002733434816.gif)
