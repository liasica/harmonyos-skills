...
content_hash: sha256:94a38e48cc5b8d1ed756302eed519b8373bd994fba636239a6ce2895538563cc
---
...
* 模式切换动效，使用预览流截图做模糊动效过渡。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f2/v3/0TR5pmgCQIGPwDNgxXJwyw/zh-cn_image_0000002769450839.gif)
* 前后置切换动效，使用预览流截图做翻转模糊动效过渡。

  图片为从前置相机切换为后置相机的效果。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8c/v3/h05sA1C2TSKdakVdKWSjcw/zh-cn_image_0000002739891508.gif)
* 拍照闪黑动效，使用闪黑组件覆盖预览流实现闪黑动效过渡。

  图片为点击完成拍摄的效果。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4f/v3/irJzZ_a2T5azb4YINkOStw/zh-cn_image_0000002739731630.gif)
