...
scraped_at: 2026-09-18T06:46:17+08:00
doc_updated_at: 2026-08-29
content_hash: sha256:9146ba1a99a91cf3e443c53145ff540a3d13937da4e4af01f1d1549b97ac54f7
---
...
3. 进入**项目设置** > **开放能力管理**页面，点击**运动健康服务**对应的**管理**。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1a/v3/ZZ8IMVufRteiCKCt1tA1Zw/zh-cn_image_0000002727751584.png)
...
4. 单击**申请Health Service Kit服务**，同意协议后，进入数据权限申请页面。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/LCirJXdDRgKtxzp71I5miA/zh-cn_image_0000002757311299.png)
5. 产品类型选择**HarmonyOS应用**，并填写申请信息，勾选产品必需申请的数据权限。
   ...
   * 数据类型对应的OAuth权限请参见[权限说明](health-permission-description.md)。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/ZhTwIP1wRFStnvwgRJta_w/zh-cn_image_0000002757231419.png)

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/22/v3/ysL_LA82Ta6jc7pH9oVc1g/zh-cn_image_0000002727591728.png)
6. 为保障用户隐私和数据安全，运动健康服务需要开发者反馈相关材料和信息，以确保应用向用户请求数据权限是合理的。
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b5/v3/Nn_4merTTLWUCq-JnHQEPg/zh-cn_image_0000002727751586.png)
7. 申请开通测试权限。
   ...
   * 如果审批通过，即可进入“已开通测试权限”阶段，应用可调用相应的接口获取运动健康服务数据进行测试开发。
     ...
     **说明** 
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/9B8HkTAnRXa8Jiq97ejZAA/zh-cn_image_0000002757311301.png)

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/04/v3/I8tBWPMnSN-eWndv9go3Xw/zh-cn_image_0000002757231421.png)
8. 权限管理。

   若您的业务范围发生变动，需要修改相应的数据权限，您可以单击“管理”更新权限再次提交申请。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/sTy5jip-Sj6y0ZELN0xDNg/zh-cn_image_0000002727591730.png)
