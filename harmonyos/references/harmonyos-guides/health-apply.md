...
content_hash: sha256:9460cb7fd33c2822011da00816b77a32d25af1d0a621507d64ee1f7498a2a189
---
...
3. 进入**项目设置** > **开放能力管理**页面，点击**运动健康服务**对应的**管理**。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/qsL9KaFUQpi-7dqf6U_M2Q/zh-cn_image_0000002733275328.png)
...
4. 单击**申请Health Service Kit服务**，同意协议后，进入数据权限申请页面。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/GrdvvF05TbK75YpYiki_ag/zh-cn_image_0000002733435206.png)
5. 产品类型选择**HarmonyOS应用**，并填写申请信息，勾选产品必需申请的数据权限。
   ...
   * 数据类型对应的OAuth权限请参见[权限说明](health-permission-description.md)。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/67rvUI1KSm2gJt6IQGtyow/zh-cn_image_0000002762994733.png)

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cf/v3/ISG1M512RJm41DN1XdoTuA/zh-cn_image_0000002762834845.png)
6. 为保障用户隐私和数据安全，运动健康服务需要开发者反馈相关材料和信息，以确保应用向用户请求数据权限是合理的。
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/tRzPSdQJSKqC6AC6L9Y-Iw/zh-cn_image_0000002733275330.png)
7. 申请开通测试权限。
   ...
   * 如果审批通过，即可进入“已开通测试权限”阶段，应用可调用相应的接口获取运动健康服务数据进行测试开发。
     ...
     **说明** 
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/76/v3/V7J0LDBQSuyX0C1kayQVdA/zh-cn_image_0000002733435208.png)

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/AIjanTB0SfaEoNB4sR04pw/zh-cn_image_0000002762994735.png)
8. 权限管理。

   若您的业务范围发生变动，需要修改相应的数据权限，您可以单击“管理”更新权限再次提交申请。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8e/v3/rZyiYnXBSeKJmcF2UGf9xw/zh-cn_image_0000002762834847.png)
