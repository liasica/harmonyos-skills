...
content_hash: sha256:607419365760518ef8696ac2f7006657e285b7168046fa6323aea955f741bad0
---
...
3. 进入**项目设置** > **开放能力管理**页面，点击**运动健康服务**对应的**管理**。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/yRWlkECsTP-xRMMqyTu9YQ/zh-cn_image_0000002723696068.png)
...
4. 单击**申请Health Service Kit服务**，同意协议后，进入数据权限申请页面。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/Imf5xt6wTMOKBgii_bcr8g/zh-cn_image_0000002753295835.png)
5. 产品类型选择**HarmonyOS应用**，并填写申请信息，勾选产品必需申请的数据权限。
   ...
   * 数据类型对应的OAuth权限请参见[权限说明](health-permission-description.md)。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/4gKRSEdoSbeTrZ0EAHKpkA/zh-cn_image_0000002753455753.png)

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/MoKQLZivQD200PkWJnB9UA/zh-cn_image_0000002723855988.png)
6. 为保障用户隐私和数据安全，运动健康服务需要开发者反馈相关材料和信息，以确保应用向用户请求数据权限是合理的。
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/07/v3/I1V38TueTjK4c2y516hD6A/zh-cn_image_0000002723696070.png)
7. 申请开通测试权限。
   ...
   * 如果审批通过，即可进入“已开通测试权限”阶段，应用可调用相应的接口获取运动健康服务数据进行测试开发。
     ...
     **说明** 
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/9lnRBDvRR-CwDIC7JRWoOg/zh-cn_image_0000002753295837.png)

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/vc6HOMTlQ-unvYcx48i4yQ/zh-cn_image_0000002753455755.png)
8. 权限管理。

   若您的业务范围发生变动，需要修改相应的数据权限，您可以单击“管理”更新权限再次提交申请。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/I6qITAiWREqdRkvhV-MnLw/zh-cn_image_0000002723855990.png)
