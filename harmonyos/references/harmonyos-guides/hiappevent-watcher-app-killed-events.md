---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiappevent-watcher-app-killed-events
title: 应用终止事件介绍
...
| reason | string | 终止原因，原因范围详见[reason字段说明](hiappevent-watcher-app-killed-events.md#reason字段说明)。 |
...
| last\_exit\_detail\_info | string | 应用退出前的详细信息，详见[last\_exit\_detail\_info字段说明](hiappevent-watcher-app-killed-events.md#last_exit_detail_info字段说明)。  **说明**：从API版本26.0.0开始支持该参数。 |
...
### last\_exit\_detail\_info字段说明

| 名称 | 类型 | 说明 |
| --- | --- | --- |
| exit\_msg | string | 应用退出信息。 |
| kill\_reason | string | 应用退出理由。 |
| pid | string | 应用的进程ID。 |
| process\_name | string | 应用的进程名称。 |
| process\_state | string | 应用的进程状态。 |
