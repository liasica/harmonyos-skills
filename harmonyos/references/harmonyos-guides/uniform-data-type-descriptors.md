---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uniform-data-type-descriptors
title: 标准化数据类型 (ArkTS)
breadcrumb: 指南 > 应用框架 > ArkData（方舟数据管理） > 标准化数据定义 > 标准化数据类型 (ArkTS)
category: harmonyos-guides
scraped_at: 2026-04-28T07:38:12+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:94cbf9a606f10cd827f1ee3776b103041b10591cb1db2ed63d123b8033452541
---
...
标准化数据类型分为[预置数据类型](uniform-data-type-descriptors.md#预置数据类型)和[应用自定义数据类型](uniform-data-type-descriptors.md#应用自定义数据类型)。并且支持从其他类型体系，如文件扩展名和MIME type转换为UTD标准类型。
...
UTD中定义的标准化数据类型在设计原则上按物理和逻辑分为两类。HarmonyOS中预置了常用的标准化数据类型，详见[UTD预置列表](uniform-data-type-list.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/ODlM_uj3S-qQT8Mn4yndAA/zh-cn_image_0000002583477521.png?HW-CC-KV=V1&HW-CC-Date=20260427T233810Z&HW-CC-Expire=86400&HW-CC-Sign=A595BB62C31E1415B4CC7167AF4524000D1368438B184C70C2BA59939D574590)

**图2** 逻辑标准化数据类型示意图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/NdThwkmEQ2qAzdkXA_O6yg/zh-cn_image_0000002552797872.png?HW-CC-KV=V1&HW-CC-Date=20260427T233810Z&HW-CC-Expire=86400&HW-CC-Sign=F2F1A14EEE866500A279248AE7FFDCEDADAD549EFF3DBE91FAF4B60B30C27FE0)

## 标准化数据类型的定义

标准化数据类型包含了标准化数据类型的标识ID、归属类型关系、简要描述等信息，具体可见[TypeDescriptor属性](../harmonyos-references/js-apis-data-uniformtypedescriptor.md#属性)，每个类型定义具体包含以下内容：
...
以下是UTD常用接口说明，对于预置数据类型和应用自定义数据类型同样适用，更多接口和详细说明，请见 [@ohos.data.uniformTypeDescriptor (标准化数据定义与描述)](../harmonyos-references/js-apis-data-uniformtypedescriptor.md)。
