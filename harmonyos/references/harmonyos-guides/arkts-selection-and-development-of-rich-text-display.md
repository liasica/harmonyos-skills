...
content_hash: sha256:ff5daa3bd5371b9792d5e6df5afb0a6b10ddb9d724eae7bdeaa49131151fc45c
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/I4WUyGdETDSHtpCqXdmxEQ/zh-cn_image_0000002727590414.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/wnXQmUOBThC5LQGBllsXJw/zh-cn_image_0000002727750272.png)

### 实现原理

只需对文中的@昵称和#话题等文字设置高亮样式，并添加点击跳转事件，点击后跳转至相应的话题详情页面或用户详情页面。选择的方案如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/G2f2W-GvTHqM8OJH5QD7lQ/zh-cn_image_0000002757309987.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/SXOqEdU1TQ-zfNjG2NRQMg/zh-cn_image_0000002757230107.png)

### 实现原理

文本中显示为表情图片，需要调整其样式设置，而无需编辑文本信息。以下是可选方案：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/TCyL16i_QY-U9ggpfvmu8Q/zh-cn_image_0000002727590416.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fe/v3/lvHMkR5tTjO_XVzYhOTYgA/zh-cn_image_0000002727750274.png)

### 实现原理

文本中包含一个系统小图标和一段高亮显示的文字，点击可跳转至详情页面。选择方案如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cf/v3/XhAbC1ZZQQW1_Dylp3FrrA/zh-cn_image_0000002757309989.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/2StQUFmUT02s56V9DCHuqA/zh-cn_image_0000002757230109.png)

### 实现原理

文本中包含一个小图标、文字和背景颜色的复杂样式。以下是选择方案：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/Y-00CAicRGqA7tcOXpqODQ/zh-cn_image_0000002727590418.png)
