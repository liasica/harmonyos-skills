...
content_hash: sha256:0c283263d2848116f3b040f3ec8a7f54de5d1894933c3a6676951439f1edf7cd
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0d/v3/6tE466xeSPGm0TR382QvuA/zh-cn_image_0000002733274870.png)
...
1. 查询返听能力并创建AudioLoopback实例。关于音频返听模式，请查看[AudioLoopbackMode](../harmonyos-references/arkts-apis-audio-e.md#audioloopbackmode20)。
   ...
   **说明** 
   ...
   ```
2. 从API版本26.0.0开始，支持调用[getSupportedDevicePairs](../harmonyos-references/arkts-apis-audio-audioloopback.md#getsupporteddevicepairs)方法，查询当前支持返听的音频输入输出设备组合。
   ...
   * 建议优先判断返回数组是否为空，再处理输入输出设备组合信息。
   ...
   // ...
       ...
       // ...
   ```
3. 从API版本26.0.0开始，支持调用[getPreferredDevicePair](../harmonyos-references/arkts-apis-audio-audioloopback.md#getpreferreddevicepair)方法，查询当前系统推荐的返听输入输出设备组合。
   ...
   **注意** 
   ...
   // ...
       ...
       // ...
   ```
4. 调用[getStatus](../harmonyos-references/arkts-apis-audio-audioloopback.md#getstatus20)方法，查询当前返听状态。
   ...
   **注意** 
   ...
   ```
5. 调用[setVolume](../harmonyos-references/arkts-apis-audio-audioloopback.md#setvolume20)方法，设置音频返听音量。
   ...
   * 启用返听前未设置音量，启用返听时将采用默认音量0.5。
   ...
   ```
6. 从API版本26.0.0开始，支持调用[getVolume](../harmonyos-references/arkts-apis-audio-audioloopback.md#getvolume)方法，查询当前返听音量。
   ...
   **注意** 
   ...
   // ...
       ...
       // ...
   ```
7. 从API version 21开始，支持调用[setReverbPreset](../harmonyos-references/arkts-apis-audio-audioloopback.md#setreverbpreset21)方法，设置音频返听的混响模式。
   ...
   * 启用返听前未设置混响模式，启用返听时将采用默认混响模式[THEATER](../harmonyos-references/arkts-apis-audio-e.md#audioloopbackreverbpreset21)。
   ...
   ```
8. 从API version 21开始，支持调用[getReverbPreset](../harmonyos-references/arkts-apis-audio-audioloopback.md#getreverbpreset21)方法，查询当前的音频返听的混响模式。
   ...
   **注意** 
   ...
   ```
9. 从API version 21开始，支持调用[setEqualizerPreset](../harmonyos-references/arkts-apis-audio-audioloopback.md#setequalizerpreset21)方法，设置音频返听的均衡器类型。
   ...
   * 启用返听前未设置均衡器类型，启用返听时将采用默认均衡器类型[FULL](../harmonyos-references/arkts-apis-audio-e.md#audioloopbackequalizerpreset21)。
   ...
   ```
10. 从API version 21开始，支持调用[getEqualizerPreset](../harmonyos-references/arkts-apis-audio-audioloopback.md#getequalizerpreset21)方法，查询当前的音频返听的均衡器类型。
    ...
    **注意** 
    ...
    ```
11. 调用[enable](../harmonyos-references/arkts-apis-audio-audioloopback.md#enable20)方法，启用或禁用音频返听功能。
