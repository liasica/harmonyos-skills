...
content_hash: sha256:f9707a988a13572e801c3dcebbce2b9af78dd65a74fdb0cc1372ce35924353f9
---
...
1. 单击**ArkTS Snapshot**泳道的**options**下拉列表，可以设置是否需要抓取基础类型number的数据。默认不抓取。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/PQ9kgtWASQ-FF6EERWhp6g/zh-cn_image_0000002731382995.png)
2. 开始录制后观察**Memory**泳道的内存使用情况，在需要定位的时刻单击任务左上角的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/1xS5VDzqQGy_GeVuPJAOmw/zh-cn_image_0000002731382997.png "点击放大")启动一次快照，一次快照完成后会在**ArkTS Snapshot**泳道出现紫色区块。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/fyYlQSIsRvq2___1b9Dm_A/zh-cn_image_0000002701823696.png "点击放大")
   ...
   * 带![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/qYcTH0csTKSKfVEunpgcNQ/zh-cn_image_0000002731542957.png "点击放大")标识的对象，表示其为全局对象，可以通过全局window对象直接访问。

   **说明** 

   * 在任务录制过程中，单击分析窗口左上角的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/5_dmFivQSJKNy3HlRSakdA/zh-cn_image_0000002731542951.png "点击放大")可启动内存回收机制。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/af/v3/j3TqeQPuQVu8u-yP27cm5g/zh-cn_image_0000002701663762.png "点击放大")
...
* Module：模块信息。
* Class：属性名称。
* Path：编译后的源码路径。支持通过点击属性名称旁边的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/ldjHxZviRZKxLteqEqbGIQ/zh-cn_image_0000002731382973.png)图标直接跳转至工程中的代码位置，方便开发者快速调试。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a9/v3/jhmbvhkTQS-SmaVVdu5Cgg/zh-cn_image_0000002731542963.png "点击放大")

若应用编译模式是release，且启用了源码混淆，方舟应用对象将展示混淆后的数据。支持在Attributes页签查看当前所选应用对象的源码信息。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/oLXhm1W-TtaBbSK9QK5kVA/zh-cn_image_0000002731382987.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/i51rrPHpQoyDIqHq46nQbw/zh-cn_image_0000002731382975.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/jKFcKzXmQ3q5foYFHR0NZg/zh-cn_image_0000002731542949.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/nGYbWZxrTeK6y0bZLSjaEw/zh-cn_image_0000002731542953.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/44/v3/A6gSBYpPTGyLwof-pxV8zw/zh-cn_image_0000002731542947.png "点击放大")
...
从26.0.0版本开始，点击**Shortest Paths**页签左侧的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/HDtQ8t0SQvuJEAz4lUgekg/zh-cn_image_0000002731382985.png "点击放大")按钮，可将页签中的数据导出到本地进行保存。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/3nQW1soZRcinfwOAvcMiHg/zh-cn_image_0000002731382983.png "点击放大")
...
此外，若调试应用工程存在对应的SourceMap文件，点击源码路径旁边的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/cFBqpbGhQtiRuCnpElKxSg/zh-cn_image_0000002701823688.png)图标，可直接跳转至工程中的代码位置，方便开发者快速调试，否则需要导入调试应用对应的SourceMap文件后再点击按钮跳转到源码。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/VOWvVOD9RzqKXGFG_VRYZQ/zh-cn_image_0000002731382981.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/QPA-InUcTMW2lcklfjTEGg/zh-cn_image_0000002701663774.png "点击放大")

目前支持单根路径搜索、指定数量的根路径搜索和展示所有根路径三种搜索模式，默认为单根搜索。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/SRyTXhVzQvSif4TZqg-rHw/zh-cn_image_0000002731542955.png "点击放大")

设置完搜索模式后点击OK，右侧more区域会自动跳转至Shortest Paths页面展示搜索结果。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/Hyhzk5KfQLmtE68XXOzwDQ/zh-cn_image_0000002731382991.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/46/v3/EdE7_y4FQFODY_pVmKwbmw/zh-cn_image_0000002731542965.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1a/v3/6UmHCyPDSuajpNvCCrqVeQ/zh-cn_image_0000002731542969.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/FEoWmYTTQEu05DSs5ciO1Q/zh-cn_image_0000002731542967.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/_ETh5dmMSTiR-6BMzaFzSg/zh-cn_image_0000002731382977.png "点击放大")

设置完搜索模式后点击OK，底部页签会自动跳转至Graph页面展示搜索结果，红色标示的是中心节点，线段展示连接的两个节点之间的引用关系。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/l-loXE1lQs2sEF-eiWEoqg/zh-cn_image_0000002701823694.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/7p28r551TeWYYFTrV5bQOA/zh-cn_image_0000002701823686.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/XSQ_ze1kQCaL2k1r-NUVXQ/zh-cn_image_0000002731542961.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/USsWde-dSJyUrFfx4TNEvg/zh-cn_image_0000002701823684.png "点击放大")
...
* [JSLeakWatcher](../doccenter-app-quality/bpta-js-leak-watcher.md)生成的文件中，.rawheap文件和.jsleaklist文件的文件名相同，则认为是匹配的。.jsleaklist文件与.heapsnapshot文件通过文件中的hash值匹配。
...
2. 离线导入文件成功后，在**Leaks**区域展示JSLeakWatcher监控采集到的内存泄漏对象。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/t71SzFsbTyWAuJmVT_4HyA/zh-cn_image_0000002731382989.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/-cN68IHsQEaFSJYC1iw3RA/zh-cn_image_0000002731382979.png "点击放大")

点击工具栏![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/R8k6D40mQB-l6qk-9RZixQ/zh-cn_image_0000002701663764.png)按钮，导入nameCache文件，Class显示为文件名称MyAbilityStage。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/81/v3/K7fQESa8SKuz6YN8WespGw/zh-cn_image_0000002701663760.png "点击放大")
