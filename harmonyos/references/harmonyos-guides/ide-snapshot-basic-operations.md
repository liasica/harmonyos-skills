...
content_hash: sha256:6634f316b1a3b98811f375f0101b15366b999fb11d81f326289b317b7bfcb1df
---
...
1. 单击**ArkTS Snapshot**泳道的**options**下拉列表，可以设置是否需要抓取基础类型number的数据。默认不抓取。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fd/v3/9M7j-JvFRR6NSikcOAN6xA/zh-cn_image_0000002731382995.png)
2. 开始录制后观察**Memory**泳道的内存使用情况，在需要定位的时刻单击任务左上角的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0c/v3/4HWBZx9FTr2D7zhIRW8yIQ/zh-cn_image_0000002731382997.png "点击放大")启动一次快照，一次快照完成后会在**ArkTS Snapshot**泳道出现紫色区块。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f4/v3/6mviiAFhSEeKpP064TaJHQ/zh-cn_image_0000002701823696.png "点击放大")
   ...
   * 带![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/JINuFfUMTwiinWeVqbxtEw/zh-cn_image_0000002731542957.png "点击放大")标识的对象，表示其为全局对象，可以通过全局window对象直接访问。

   **说明** 

   * 在任务录制过程中，单击分析窗口左上角的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0a/v3/D-SwdQfsT4eO98Ei9B9F1Q/zh-cn_image_0000002731542951.png "点击放大")可启动内存回收机制。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/eEgL7idZQsWT3wDEQBmyGA/zh-cn_image_0000002701663762.png "点击放大")
...
* Module：模块信息。
* Class：属性名称。
* Path：编译后的源码路径。支持通过点击属性名称旁边的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/gjGNflGTST6inTrd_FwEqQ/zh-cn_image_0000002731382973.png)图标直接跳转至工程中的代码位置，方便开发者快速调试。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/MH9G17EYRNWoqdpWWHbqSg/zh-cn_image_0000002731542963.png "点击放大")

若应用编译模式是release，且启用了源码混淆，方舟应用对象将展示混淆后的数据。支持在Attributes页签查看当前所选应用对象的源码信息。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c9/v3/W8uHB2ReRAm9fcLmzC0pGw/zh-cn_image_0000002731382987.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/xUQsUWJtRxeTx88JvPygQw/zh-cn_image_0000002731382975.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/de/v3/8Uvb16OjToKqrEqsy1NMOw/zh-cn_image_0000002731542949.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/3FyIAzg9RRCtccZ6UfDGnw/zh-cn_image_0000002731542953.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/_5Ynpb8jRrCyH-7C8wGoQQ/zh-cn_image_0000002731542947.png "点击放大")
...
从26.0.0版本开始，点击**Shortest Paths**页签左侧的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3/v3/Ojs6Xy5gQDqLINz6rTev1A/zh-cn_image_0000002731382985.png "点击放大")按钮，可将页签中的数据导出到本地进行保存。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/ZIZnv_8ZSVG4LdR10Zkojw/zh-cn_image_0000002731382983.png "点击放大")
...
此外，若调试应用工程存在对应的SourceMap文件，点击源码路径旁边的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bd/v3/FideSucTS0WPYNYjsWAnhA/zh-cn_image_0000002701823688.png)图标，可直接跳转至工程中的代码位置，方便开发者快速调试，否则需要导入调试应用对应的SourceMap文件后再点击按钮跳转到源码。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/kDYQtjNBSqeTvUYXPe3sLA/zh-cn_image_0000002731382981.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/92/v3/j8pksA4WRsCldCXqkjxikQ/zh-cn_image_0000002701663774.png "点击放大")

目前支持单根路径搜索、指定数量的根路径搜索和展示所有根路径三种搜索模式，默认为单根搜索。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/W7YlXXlGQx6fvVbYm-ip6g/zh-cn_image_0000002731542955.png "点击放大")

设置完搜索模式后点击OK，右侧more区域会自动跳转至Shortest Paths页面展示搜索结果。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/DZ5MIFgdScKI3soZ6bjZVA/zh-cn_image_0000002731382991.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c/v3/Ypp1UD7tRKKfva2GezDrfw/zh-cn_image_0000002731542965.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/3WXQDUW8S7CvMRIocDGzaA/zh-cn_image_0000002731542969.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9c/v3/hynYbmCYSpGDVG6gFaQ2JQ/zh-cn_image_0000002731542967.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e2/v3/Dud3-OVkQOy9uKO56N9E4A/zh-cn_image_0000002731382977.png "点击放大")

设置完搜索模式后点击OK，底部页签会自动跳转至Graph页面展示搜索结果，红色标示的是中心节点，线段展示连接的两个节点之间的引用关系。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/F9c3hmL7S0GKW4LL_PYvHw/zh-cn_image_0000002701823694.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/-kOYqWDZSQW35R9uVZzq3A/zh-cn_image_0000002701823686.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/ah7vhcuZSQKmGeUGD4QI5Q/zh-cn_image_0000002731542961.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/eqnSS-nCR6m151kkpk-3fA/zh-cn_image_0000002701823684.png "点击放大")
...
2. 离线导入文件成功后，在**Leaks**区域展示JSLeakWatcher监控采集到的内存泄漏对象。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/NLKe68w9Rhegeg-pK2ABGw/zh-cn_image_0000002731382989.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/mBY9gnvnTc2hE_AxTTS-lA/zh-cn_image_0000002731382979.png "点击放大")

点击工具栏![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/D5U5rMYaTRCv9xYKBbczTA/zh-cn_image_0000002701663764.png)按钮，导入nameCache文件，Class显示为文件名称MyAbilityStage。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/eyLlBJCRQiS_DHQZPrlQdw/zh-cn_image_0000002701663760.png "点击放大")
