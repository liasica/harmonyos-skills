...
content_hash: sha256:6b40a217e20fb03470ec04fa56c5d84b7706a7520269f910e548e0c1c8d31983
---
...
在async修饰的异步函数中主动抛出异常，不会产生JS Crash导致应用崩溃，开发者可以通过[errorManager.on('error')](../harmonyos-references/js-apis-app-ability-errormanager.md#errormanageronerror)观测该异常，样例代码参考[Async函数内部异常的处理机制](arkts-runtime-faq.md#async函数内部异常的处理机制)。
...
| ModuleImportStack | 模块加载链路 | 26.0.0 | 否 | ARM 64位系统下，若开启[模块加载链路调试开关](arkts-module-debug.md)，则包含此字段。 |
