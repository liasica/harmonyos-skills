...
content_hash: sha256:a314d9f03762921f1395aaeb4e2c6d12daefb724169cfac687e3c707ce25e49c
---
...
1. 在模拟器关闭状态下，点击模拟器的修改按钮![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/lnXPy0h-Q5K5vtiZ-N4P6Q/zh-cn_image_0000002701661914.png)，进入Virtual Device Configure界面。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/fInYB7YBSnKMcxm_iPHNnQ/zh-cn_image_0000002731541099.png "点击放大")
2. 点击**Customize**按钮，可以自定义设备的屏幕尺寸、分辨率和DPI配置，取值范围参考界面提示。
   ...
   * **DPI**：像素密度，DPI 越高，UI组件占用的像素点越多，从而提供更精细的显示效果。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/4WIQXCJ1R1Sl2azEcFKuuw/zh-cn_image_0000002731381137.png "点击放大")
