...
content_hash: sha256:3a6e71250605e84926d64f6c629517eb89dbb0e34474c35873edb0d69d1538bc
---
...
2. 设置生成ArkTSDoc的范围，可选择整个工程、单个模块或多个模块，某个目录或单个文件进行导出。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8e/v3/Gz-tckjbRyOUIuvSo1OYoA/zh-cn_image_0000002561833351.png)
3. 在导出时，可以在**Command line arguments**设置无需被导出的目录，使用"-e"子命令进行指定。多个目录使用英文";"分隔，使用"./"开头路径代表项目根路径。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/cEEZFJzZRnCAH0hXc413Mg/zh-cn_image_0000002530753438.png)
...
5. 若勾选**Open generated documentation in browser**选项，在生成ArkTSDoc后，将自动打开相应页面查看生成的文档。配置完毕后点击Generate，开始扫描并生成ArkTSDoc文档。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/vEc25FeZS1Cmqq1DFu5jmQ/zh-cn_image_0000002561753369.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ad/v3/kgXXLSidRNGxSB9EVYKcEQ/zh-cn_image_0000002530753436.png "点击放大")
