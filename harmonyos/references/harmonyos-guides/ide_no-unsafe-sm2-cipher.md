...
content_hash: sha256:8ae52ee178c79eb8a6e174675774fcc3a5fb2a27710905c4fc43eeefa7c85203
---
...
2. {
3. "rules": {
4. "@security/no-unsafe-sm2-cipher": "warn"
5. }
6. }
```
...
2. cryptoFramework.createCipher('SM2_256|SHA256')
```
...
```
1. import cryptoFramework from '@ohos.security.cryptoFramework';
2. cryptoFramework.createCipher('SM2_256|SHA1')
3. cryptoFramework.createCipher('SM2_256|MD5')
```
