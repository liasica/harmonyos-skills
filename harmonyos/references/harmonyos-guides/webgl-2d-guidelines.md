---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/webgl-2d-guidelines
title: 使用WebGL绘制图形
breadcrumb: 指南 > 应用框架 > ArkUI（方舟UI框架） > UI开发 (兼容JS的类Web开发范式) > WebGL > 使用WebGL绘制图形
category: harmonyos-guides
scraped_at: 2026-04-28T07:40:35+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:35571fd33f09b5ce0a2bbcea165ea0f329c0625853ed35b5fc6c0d358531e714
---
...
2. 设置WebGL的上下文。
   ...
   * 当获取到canvas之后，会调用getContext函数并向它传递 "webgl" 参数，来尝试获取WebGLRenderingContext。如果浏览器不支持WebGL，getContext将会返回null，如果WebGL上下文成功初始化，变量'gl'会用来引用该上下文。
   ...
   6. // 确认WebGL支持性
   7. if (!gl) {
   8. alert("你的浏览器、操作系统或硬件等可能不支持WebGL。");
   9. return;
   10. }
   11. // 使用完全不透明的黑色清除所有图像
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/Z2f6bBqjR4KYKbvwXP4TWg/zh-cn_image_0000002583438197.png?HW-CC-KV=V1&HW-CC-Date=20260427T234034Z&HW-CC-Expire=86400&HW-CC-Sign=149658089A545955E18CA4207C1BFD68153CCD90CF5EE6ADFBBD3B1ED6CEBC11)
