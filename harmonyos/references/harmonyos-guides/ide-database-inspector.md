...
content_hash: sha256:745ccfbb6497c5275b19780f7f569b69bfbfa9197f86cfabf8ab0d73e4051a12
---
...
1. 点击菜单栏**View > Tool Windows > Database Inspector**，打开Database Inspector。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/DB8EjR1zSvOZjoNxb_tySw/zh-cn_image_0000002701822914.png)

   Database Inspector打开后，页面各区域作用如下：①选择设备，②选择应用包名，③数据库和表信息展示，④SQL执行和数据查看。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/PLWKszxiQxeecilRvIUqcw/zh-cn_image_0000002701662994.png)
...
3. 选择包名，点击右侧的**Connect to Databases**按钮，即可查看数据库相关信息。
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/cEs5KDHFRQm_KvwSP2Wjbg/zh-cn_image_0000002731542187.png)
4. 双击数据库表名，右侧区域展示表数据，默认按照20条/页展示。

   从26.0.0版本开始，支持可视化修改表中的数据（仅支持常规基础数据类型：字符串、数值、布尔等，不支持二进制数据类型）。双击单元格，输入数据后，按Enter键或点击其他区域提交。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7e/v3/60uxH3JxRZqxCTCbp8jSyQ/zh-cn_image_0000002731382213.png)
5. 左侧区域点击**New Query**后，右侧会出现**SQL Editor**页签，根据需要选择数据库，并输入SQL后，点击**Execute**按钮即可查看或修改数据。
   ...
   * 数据展示页面不支持可视化修改。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/df/v3/7FSCbDDATB6BLWSI57E-uQ/zh-cn_image_0000002701662990.png)
