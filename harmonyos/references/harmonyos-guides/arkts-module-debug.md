...
content_hash: sha256:e46d793767833409b8a53438e8660caa51f95fd4e03d3f74675b44c58c498549
---
...
1. 进入CPU Trace
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/9jyTY1nITNy64FwDpRqavA/zh-cn_image_0000002769329537.png)
2. 配置采集时间并开始采集

   采集完成后将提示文件回传，当文件较大时请耐心等待。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/uNpQb6hoQxudsYvGyvUrhg/zh-cn_image_0000002769449399.png)
3. 打开trace文件并选择需要查看的应用

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/A1MK7w0ZRZSCb_mROoV_kg/zh-cn_image_0000002739890068.png)

### trace文件分析

实例化的文件以及so在SourceTextModule::Instantiate下。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/EAXisc8YT4u6Bwjft8VomA/zh-cn_image_0000002739730190.png)

执行的文件以及so在SourceTextModule::Evaluate下。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/DHGJ6Jw5RvKFuDWPdE7Umw/zh-cn_image_0000002769329539.png)

选中需要分析的区域，会在下方生成表格。可以根据表格数据对耗时长的文件进行性能优化。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/bIStUIekSHeVwAR3UNFCrw/zh-cn_image_0000002769449401.png)
