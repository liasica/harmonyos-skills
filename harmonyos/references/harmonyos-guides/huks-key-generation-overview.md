---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/huks-key-generation-overview
title: 密钥生成介绍及算法规格
...
* 使用当前业务已有的密钥别名作为生成的密钥别名默认会把现有密钥覆盖，可以使用[HUKS\_TAG\_KEY\_OVERRIDE](../harmonyos-references/js-apis-huks.md#hukstag)指定当密钥别名冲突时返回错误。
