---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-asym-key-generation-conversion-spec
title: 非对称密钥生成和转换规格
breadcrumb: 指南 > 系统 > 安全 > Crypto Architecture Kit（加解密算法框架服务） > 密钥生成和转换 > 密钥生成和转换规格 > 非对称密钥生成和转换规格
category: harmonyos-guides
scraped_at: 2026-04-28T07:42:15+08:00
doc_updated_at: 2026-03-26
content_hash: sha256:9374692a8e55bb30d5a2ad32fd8254f18630787092ced0fbd58d554d24fd0872
---
...
* 当前ECC只支持Fp域，因此fieldType固定为"Fp"。fieldType和p构成了属性field，当前field只支持[ECFieldFp](../harmonyos-references/js-apis-cryptoframework.md#ecfieldfp10)。
* g和pk为ECC曲线上的点，属于[Point](../harmonyos-references/js-apis-cryptoframework.md#point10)类型，需要指定具体的X和Y坐标。
...
* 曲线名为要求输入的字符串参数，支持的曲线名请参考[ECC密钥字符串参数表](crypto-asym-key-generation-conversion-spec.md#使用字符串参数生成-1)中的“曲线名”一列。
...
* 当前SM2只支持Fp域，因此fieldType固定为"Fp"。fieldType和p构成了属性field，当前field只支持[ECFieldFp](../harmonyos-references/js-apis-cryptoframework.md#ecfieldfp10)。
* g和pk为SM2曲线上的点，属于[Point](../harmonyos-references/js-apis-cryptoframework.md#point10)类型，需要指定具体X，Y坐标。
