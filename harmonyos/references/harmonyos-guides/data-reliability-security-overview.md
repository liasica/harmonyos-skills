---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/data-reliability-security-overview
title: 数据可靠性与安全性概述
...
HarmonyOS数据库加密时，应用开发者无需传入密钥，只需要设置数据库加密的状态即可。系统会自动帮助开发者将数据库加密，使用[huks通用密钥库系统](../harmonyos-references/js-apis-huks.md)，完成数据库密钥的生成及加密保护。
