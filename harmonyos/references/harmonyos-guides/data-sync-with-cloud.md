---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/data-sync-with-cloud
...
* **极简集成**
  ...
  简化开发：开发者通过使用[端云同步](data-cloud-sync-of-rdb-store.md)为应用快速添加云同步功能。
...
* 已经在开发者联盟官网注册账号并通过实名认证，详细请参见[账号注册认证](../start/registration-and-verification-0000001053628148.md)。
* 已经在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)网站上创建项目和应用，详细请参见[创建项目](../AppGallery-connect-Guides/agc-harmonyos-0000001139004974.md)。
...
4. 体验设计建议。
   ...
   同步受功能开启状态、网络条件、云存储空间等方面的影响，请参考[端云同步状态码](../harmonyos-references/arkts-apis-data-relationalstore-e.md#progresscode10)设计同步状态提醒。例如：
...
2. 云侧配置与端侧配置不一致，请检查：
   * 是否设置分布式表。
   * 表名与云侧配置是否匹配。
   * 表中字段属性与云侧配置是否匹配，字段约束请参考上文[云侧操作](data-sync-with-cloud.md#云侧操作)步骤3。
