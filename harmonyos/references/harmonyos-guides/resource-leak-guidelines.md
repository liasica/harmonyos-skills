...
content_hash: sha256:3f466a29874c96fbc7a22772c9aeddf24607b78499ed37ed517127b02d588619
---
...
* 方式二：通过DevEco Studio主动采集日志。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8c/v3/Yu7fjChnQ-GALJeMwn2b8w/zh-cn_image_0000002753295345.png)
...
* 检测到泄漏后抓取**15min内的进程内存trace**，可将日志如下图通过Open File加载到DevEco Studio进行解析。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3f/v3/x0I1lnQhRbO6qNK9NXcK_Q/zh-cn_image_0000002753455263.png)
...
* **All Heap：** 选择后展示抓取15分钟内的内存情况，记录了hook malloc等系统调用的堆栈。Native日志是以so+偏移的形式展示调用栈（每一行表示一次内存分配行为调用栈），需要结合符号表进一步分析。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/dH4pLxoISmKQfdPo9-CvwA/zh-cn_image_0000002723855498.png)
...
* **All Anonymous VM：** 选择后记录了当前hook mmap系统调用的堆栈信息。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/v7hg81QxQCOflAUp8Z5CJw/zh-cn_image_0000002723695580.png)
