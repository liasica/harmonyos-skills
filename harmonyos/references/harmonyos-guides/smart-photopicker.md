...
content_hash: sha256:745b125f611e9b45d31560152e0d5f539c8382b6509fadca5528bf52c5a2ffd9
---
...
* 选择特定类型（[RecommendationType](../harmonyos-references/arkts-apis-photoaccesshelper-e.md#recommendationtype11)）的图片，如身份证、银行卡、驾驶证、行驶证、二维码等。当有符合应用指定类型的图片传入时，将显示对应的图片推荐页。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/4bDIjfDFS92qNgJhhNqPow/zh-cn_image_0000002769331037.jpg)
* 在图文编辑时选择图片，系统可以根据应用传入的文本信息，提取出时间、地点、事物或活动，并根据提取的信息，推荐对应的图片展示在PhotoPicker中。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/uxNCo8kxTpSDv7AgI3Hotg/zh-cn_image_0000002769450899.jpg)
