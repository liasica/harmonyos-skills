---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ndk-use-text-component
title: 使用Text组件
breadcrumb: 指南 > 应用框架 > ArkUI（方舟UI框架） > UI开发 (基于NDK构建UI) > 使用文本 > 使用Text组件
category: harmonyos-guides
scraped_at: 2026-09-02T14:59:20+08:00
doc_updated_at: 2026-08-29
content_hash: sha256:9af864bf5a2540aadfecc01e0e1ab7d588978993e31b39a17715f7388ffa1700
---

[ArkUI](arkui-overview.md)开发框架在[NDK](ndk-development-overview.md)接口中提供了Text组件，用于显示文本内容。Text组件支持丰富的样式设置，包括字体、颜色、对齐方式、文字效果等，还支持多种子组件，如[Span](ndk-use-text-component.md#添加span)、[ImageSpan](ndk-use-text-component.md#添加imagespan)、[StyledString](ndk-styled-string.md)等，用于实现复杂的文本显示效果。
...
使用[createNode](../harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1.md#createnode)接口创建Text组件，节点类型为ARKUI\_NODE\_TEXT。
...
* 通过[NODE\_TEXT\_CONTENT](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_content)属性设置Text组件的基本文本内容。
  ...
  ```
* 通过[NODE\_TEXT\_CONTENT\_WITH\_STYLED\_STRING](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_content_with_styled_string)属性设置文本内容。
...
| 属性 | 说明 |
| --- | --- |
| [NODE\_FONT\_SIZE](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_font_size) | 设置字体大小。 |
| [NODE\_FONT\_WEIGHT](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_font_weight) | 设置字体粗细。 |
| [NODE\_FONT\_STYLE](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_font_style) | 设置字体样式。 |
| [NODE\_FONT\_FAMILY](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_font_family) | 设置字体列表。 |
...
| 属性 | 说明 |
| --- | --- |
| [NODE\_TEXT\_ALIGN](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_align) | 设置文本水平对齐。 |
| [NODE\_TEXT\_VERTICAL\_ALIGN](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_vertical_align) | 设置文本垂直对齐。 |
...
| 属性 | 说明 |
| --- | --- |
| [NODE\_TEXT\_DECORATION](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_decoration) | 设置文本装饰线。 |
| [NODE\_TEXT\_TEXT\_SHADOW](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_text_shadow) | 设置文字阴影效果。 |
...
通过[NODE\_TEXT\_WORD\_BREAK](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_word_break)属性设置文本的断行规则。
...
| 属性 | 说明 |
| --- | --- |
| [NODE\_TEXT\_LINE\_HEIGHT](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_line_height) | 设置行高。 |
| [NODE\_TEXT\_LINE\_HEIGHT\_MULTIPLE](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_line_height_multiple) | 设置行高倍数。从API version 22开始支持。 |
| [NODE\_TEXT\_HALF\_LEADING](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_half_leading) | 设置文本垂直居中。 |
...
| 属性 | 说明 |
| --- | --- |
| [NODE\_TEXT\_MAX\_LINES](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_max_lines) | 设置最大行数。 |
| [NODE\_TEXT\_OVERFLOW](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_overflow) | 设置文本溢出方式。 |
| [NODE\_TEXT\_ELLIPSIS\_MODE](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_ellipsis_mode) | 设置省略模式。 |
...
| 属性 | 说明 |
| --- | --- |
| [NODE\_TEXT\_OPTIMIZE\_TRAILING\_SPACE](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_optimize_trailing_space) | 设置每行结尾空格是否优化。从API version 20开始支持。 |
...
| 属性 | 说明 |
| --- | --- |
| [NODE\_TEXT\_INDENT](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_indent) | 设置首行缩进。 |
| [NODE\_TEXT\_COMPRESS\_LEADING\_PUNCTUATION](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_compress_leading_punctuation) | 设置行首标点压缩。从API version 23开始支持。 |
...
| 属性 | 说明 |
| --- | --- |
| [NODE\_TEXT\_TAIL\_INDENTS](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_tail_indents) | 设置文本尾部缩进。 |
...
通过[addChild](../harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1.md#addchild)在Text中添加文本子组件，用于展示行内文本。Span组件需嵌入在Text组件中才能显示，单独使用时不会显示任何内容。
...
通过[addChild](../harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1.md#addchild)在文本中添加图片子组件。
...
| 属性 | 说明 |
| --- | --- |
| [NODE\_TEXT\_LINEAR\_GRADIENT](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_linear_gradient) | 设置线性渐变。从API version 20开始支持。 |
| [NODE\_TEXT\_RADIAL\_GRADIENT](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_radial_gradient) | 设置径向渐变。从API version 20开始支持。 |
...
从API version 23开始，Text组件支持通过[NODE\_TEXT\_MARQUEE\_OPTIONS](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_marquee_options)属性设置跑马灯效果。
...
从API version 23开始，Text组件支持通过[NODE\_TEXT\_DIRECTION](../harmonyos-references/capi-native-node-h-nodeattributetype-text.md#node_text_direction)属性设置文本方向。
