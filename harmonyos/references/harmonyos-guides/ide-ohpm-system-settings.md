...
content_hash: sha256:4774f068d3f14a8ea4f9653d8a8e556ec5e472b7293918b53bf9aa3b6db68910
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8c/v3/VALnNIlQQsilKhYQAILzBQ/zh-cn_image_0000002701822448.png "点击放大")

## 系统安全

系统安全页面中有两部分配置项：重置系统密钥和配置是否支持匿名访问。页面效果如下图所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/2PViR5J4T0KM6YVvsfl8bQ/zh-cn_image_0000002701662514.png "点击放大")
...
1. 重置系统密钥
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/w7tGtgP5TX6GUaTpyQnrFw/zh-cn_image_0000002701822442.png "点击放大")
2. ohpm-repo匿名访问配置

   ohpm-repo从5.0.5版本开始，支持配置匿名访问功能。默认情况下，ohpm-repo支持匿名访问。如果需要配置不支持匿名访问，需要点击按钮“否”后提交，页面效果如下图所示：

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/Taaq8dP6R8-ru3I4kf7cnA/zh-cn_image_0000002731381741.png "点击放大")

   * 当配置禁用匿名访问后，用户未登录状态下，不能够访问ohpm-repo管理界面首页中的包列表页面和包详情页面，只有登录后才能正常访问；首页也不能注册用户，只有登录选项。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6e/v3/TqEqBijKQy2FVnt0idP9xA/zh-cn_image_0000002701662526.png "点击放大")
