...
content_hash: sha256:ecad5c54ac5777d3ce18327275e2b55966915831664f7af150a6c6aab845c06c
---
...
1. 进入[开发者管理中心](https://developer.huawei.com/consumer/cn/console/overview)，登录[企业账号](store-attribution-config-agc.md)（暂不支持个人开发者）。企业主账号无需手动添加权限；若使用团队成员账号，请确保使用企业主账号为其添加“小艺开放平台”的管理员权限，具体添加可见下图。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/B1N93UTSTfW33zSitoTc8Q/zh-cn_image_0000002727591632.png)

   确认对应的信息后，点击下一步。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/99/v3/YpmjTEpoRbOhDB0e5g34KQ/zh-cn_image_0000002727751490.png)

   勾选小艺开放平台管理员，选择下一步。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a7/v3/L0_V1zRlRm-082ibF0i8xw/zh-cn_image_0000002757311205.png)
2. 登录成功后，在侧边栏菜单中**生态服务**下选择**智慧服务**，点击进入**小艺开放平台**。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/pgbbwKd0SNi2nXkr47lyVw/zh-cn_image_0000002757231325.png)
3. 进入页面后，选择右侧**资源管理**，点击选择**其他服务**。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/FQ_9jUS4S4u5tgjcArvYOA/zh-cn_image_0000002727591634.png)
4. 进入页面后，点击右侧**创建服务**按钮。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/z2U9URhlTI2DMXIro5bXmw/zh-cn_image_0000002727751492.png)
5. 选择服务模型。
   ...
   **默认语言**：由开发者根据业务选择配置。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0c/v3/BZ8XrvjCTiuxGpivWhnl-g/zh-cn_image_0000002757311207.png)
6. 创建完成后，填写服务的**基本信息**，点击**保存**按钮。
   ...
   **服务分级**：由开发者根据业务选择配置。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/Ejt3oC4tSVO0DBRO5tThqQ/zh-cn_image_0000002757231327.png)
7. 填写**服务呈现信息**，点击**保存**按钮。

   此页面必填字段均由开发者根据业务选择配置。建议在服务预览处上传用户界面示意图。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/jWaQO4hQS7KtVCBSPF2Eqw/zh-cn_image_0000002727591636.png)
8. 进入**配置**，选择**新增用户意图**。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a5/v3/bfaOb6bFSEeWsdKRrQp5fA/zh-cn_image_0000002727751494.png)
9. 配置意图。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/pJN-TyWES8eT-PBLafG3bw/zh-cn_image_0000002757311209.png)
10. 配置意图的**实现类型**，选择**APK/RPK/FA/H5 link**，选择**新增实现**，点击**配置**按钮。

    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7e/v3/d1g0RL0FTyiZ35ykh8iwaQ/zh-cn_image_0000002757231329.png)
11. 进入新增实现页面，填写**基本信息**和**配置方式**后，选择**保存**。
    ...
    2. 选择配置方式，勾选**HAP LINK**。
       ...
       **说明** 
       ...
       ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/INtZFe0JR9iLwYEfaRaWOg/zh-cn_image_0000002727591638.png)

       ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/TYZV5ZC_Tnyz4wrj3MJAVg/zh-cn_image_0000002727751496.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/agytDhv7Riu8QXyNslV4fQ/zh-cn_image_0000002757311211.png)
