---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkui-overview
title: ArkUI简介
breadcrumb: 指南 > 应用框架 > ArkUI（方舟UI框架） > ArkUI简介
category: harmonyos-guides
scraped_at: 2026-04-28T07:38:53+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:0f8e567616a152e53c8bae7aac84c9d9ae6f6f0a09acc4040932551f7838e1f3
---
...
* **UI：** 即用户界面。开发者可以将应用的用户界面设计为多个功能页面[NavDestination](../harmonyos-references/ts-basic-components-navdestination.md)，页面通过栈结构管理，并通过导航容器[Navigation](../harmonyos-references/ts-basic-components-navigation.md)完成页面间的调度管理如跳转、回退等操作，以实现应用内的功能解耦。
...
* **声明式开发范式**：采用基于TypeScript声明式UI语法扩展而来的[ArkTS语言](arkts-get-started.md)，从组件、动画和状态管理三个维度提供UI绘制能力。
...
* **发展趋势**：声明式开发范式后续会作为主推的开发范式持续演进，为开发者提供更丰富、更强大的能力。
  ...
  **图1** 方舟UI框架示意图
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/_09FIjzsR9KNwzSLKiO7Jw/zh-cn_image_0000002583477551.png?HW-CC-KV=V1&HW-CC-Date=20260427T233851Z&HW-CC-Expire=86400&HW-CC-Sign=CAD42772D355D8EE210DF241A076FBB696699085A6A0BA1D679046BEFD27C930)
...
* **自定义能力**：ArkUI支持多层次自定义能力，包括自定义组合、自定义扩展（[Modifier](arkts-user-defined-modifier.md)）、自定义节点（[FrameNode](../harmonyos-references/js-apis-arkui-framenode.md)、[RenderNode](../harmonyos-references/js-apis-arkui-rendernode.md)、[BuilderNode](../harmonyos-references/js-apis-arkui-buildernode.md)）、自定义渲染等。开发者可根据业务需求选择不同层级的自定义方式，实现灵活的UI定制和扩展。
