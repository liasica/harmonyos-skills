...
content_hash: sha256:8aad3cb067a6da9384a7990fc981d112ffbf39752a5822a88cbbdd7e3ef20ac1
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/rQjdV3WqQ8GU80En2TmVGg/zh-cn_image_0000002731520235.png)
...
| -d | <displayId> | 多屏场景下，获取指定ID屏幕下的截图。未指定该参数时，默认获取displayId为0的屏幕下的截图。  **说明：** 从API version 20开始支持该命令。 |
...
| -d | <displayId> | 多屏场景下，获取指定ID屏幕下的控件树。未指定该参数时，默认获取displayId为0的屏幕下的控件树。  **说明：**  1. 从API version 20开始支持该命令。  2. 可通过hidumper工具[获取应用窗口信息](hidumper.md#获取应用窗口信息)，包含应用对应窗口的DisplayId。 |
