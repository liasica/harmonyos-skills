...
content_hash: sha256:e294afeca335f36ace30cf231d446f75788b389745d583b301560313d181f4b3
---
...
1. 在菜单栏单击**View > Tool Windows > Device File Browser**，打开Device File Browser。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/rxt9WoOHREqweQ4wSVLJaw/zh-cn_image_0000002731382337.png)
2. 从下拉列表中选择设备（设备需已连接）。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/ocQbmy5TQMyNaGRnjxUyfA/zh-cn_image_0000002731382343.png)
...
* **普通文件视图**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1b/v3/izjDVGVBSDWw1w_pNAjMLA/zh-cn_image_0000002731382357.png)
...
* **应用沙箱视图**
  ...
  从DevEco Studio 6.1.0 Beta1版本开始，点击![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/5_AX5NCoSWqQcknC9-YRaw/zh-cn_image_0000002701663126.png)即可过滤出当前工程对应的沙箱目录。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/dN7QkX_4TUO9ynCbDoRczg/zh-cn_image_0000002731382351.png)

  API 15以下的版本，当需要以沙箱视图查看应用的文件结构时，需在module.json5文件内配置ohos.permission.INTERNET开启网络权限，卸载并重新安装应用。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/Q9SwdW32SaqXgQk_D0zjOg/zh-cn_image_0000002731542305.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/HCPml1xGSa2z_iiCEzqXcQ/zh-cn_image_0000002731382339.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/S5_oze0DTVy84-876Ip8_Q/zh-cn_image_0000002731542311.png)

### 公共目录

用户的桌面、文档、下载等公共目录位于/storage/media/100/local/files/Docs路径下，支持删除、上传、下载操作。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9/v3/okl1iFjGTm2oNTeJfCxyrA/zh-cn_image_0000002701823046.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0c/v3/yDb2t8cHQPmSzkqEkLtHNw/zh-cn_image_0000002701663114.png)
...
1. 执行命令，查询此路径下的崩溃日志文件列表。
   * 设备版本低于5.1.0.54时，执行以下命令。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/81/v3/fsQFJxJQRfaaUQtulSi_EA/zh-cn_image_0000002731542315.png)
   * 设备版本为5.1.0.54及以上时，崩溃日志文件名时间戳新增了毫秒级信息，执行以下命令。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/g_gr600zTwuWXZGW8OSDHg/zh-cn_image_0000002731382345.png)
2. 执行命令，查看指定的崩溃日志文件的内容。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ad/v3/YmCtvSDkRWmV_hWFboRmaw/zh-cn_image_0000002701663122.png)
3. 执行命令，将文件保存到本地计算机指定的路径下。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/Jd0U2NbxTAW7uNTl221otA/zh-cn_image_0000002701663138.png)
...
1. 在图库中查看文件名及后缀，例如a.mp4。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6b/v3/SGCFa9jqT7aUMRBevqqjeg/zh-cn_image_0000002701823052.png)
2. 查询文件路径，记录为{FilePath}。
   ...
   * 如果查询的结果中包含uri字段，则返回值第三行对应的文件路径不允许直接下载。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b4/v3/j1Z-8N1VStqBdqSXgaxJRA/zh-cn_image_0000002731542321.png)
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/4-ADUaG6QpSg2DFkOeNjPw/zh-cn_image_0000002701663130.png)
   * 如果查询结果不包含uri字段，则返回值第二行即为文件路径{FilePath}。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/T3SZW_JtS8-JpXbDNhyb1g/zh-cn_image_0000002731542329.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/gw63KQ83TkS_ybsUF5EzJQ/zh-cn_image_0000002701663118.png)
