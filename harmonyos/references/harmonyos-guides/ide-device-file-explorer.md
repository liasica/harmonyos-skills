...
content_hash: sha256:55406eb9722919dfe58ae0476ed335352d7acdf9547975b5c889c6622589ccda
---
...
1. 在菜单栏单击**View > Tool Windows > Device File Browser**，打开Device File Browser。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a9/v3/gnpygjIlSOu9wodxqp0dCw/zh-cn_image_0000002731382337.png)
2. 从下拉列表中选择设备（设备需已连接）。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/KeY7KLngTjGX82vNBJZFrw/zh-cn_image_0000002731382343.png)
...
* **普通文件视图**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/bvV2zdSwS7GDbRsRFfE0dw/zh-cn_image_0000002731382357.png)
...
* **应用沙箱视图**
  ...
  从DevEco Studio 6.1.0 Beta1版本开始，点击![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/arvgSff-Swus1lxqVE7dwA/zh-cn_image_0000002701663126.png)即可过滤出当前工程对应的沙箱目录。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/lJ-IaEuYRBKhj6vow2YslA/zh-cn_image_0000002731382351.png)

  API 15以下的版本，当需要以沙箱视图查看应用的文件结构时，需在module.json5文件内配置ohos.permission.INTERNET开启网络权限，卸载并重新安装应用。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/5PIbvnjrQCWMLvdkCM7v4w/zh-cn_image_0000002731542305.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9b/v3/B1Sg8mEETDOHiFQRJPfvqw/zh-cn_image_0000002731382339.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/0Vk-or3CRHGBQCnOBmoy3g/zh-cn_image_0000002731542311.png)

### 公共目录

用户的桌面、文档、下载等公共目录位于/storage/media/100/local/files/Docs路径下，支持删除、上传、下载操作。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/N9UCTZOzQ-eVRbc2N-0NoQ/zh-cn_image_0000002701823046.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4/v3/V-i1H2pjQw-ZYktffTxcVg/zh-cn_image_0000002701663114.png)
...
1. 执行命令，查询此路径下的崩溃日志文件列表。
   * 设备版本低于5.1.0.54时，执行以下命令。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/X0SL0iF6Sbm3c1RsPFDdaw/zh-cn_image_0000002731542315.png)
   * 设备版本为5.1.0.54及以上时，崩溃日志文件名时间戳新增了毫秒级信息，执行以下命令。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/aqQhUi5yQ8muuG5Z4LXukw/zh-cn_image_0000002731382345.png)
2. 执行命令，查看指定的崩溃日志文件的内容。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/FB_IGBZ8QfmKgdDPqDzg3g/zh-cn_image_0000002701663122.png)
3. 执行命令，将文件保存到本地计算机指定的路径下。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/92/v3/uLxFJKw5RzWnUxfPICCTjA/zh-cn_image_0000002701663138.png)
...
1. 在图库中查看文件名及后缀，例如a.mp4。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/WWgKEUd-RXeUrjG-agfB0g/zh-cn_image_0000002701823052.png)
2. 查询文件路径，记录为{FilePath}。
   ...
   * 如果查询的结果中包含uri字段，则返回值第三行对应的文件路径不允许直接下载。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cf/v3/-KgDwJw2RfqhrkU9SWg5Kw/zh-cn_image_0000002731542321.png)
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/Pj_yn7utSUmZlo3yglDNTw/zh-cn_image_0000002701663130.png)
   * 如果查询结果不包含uri字段，则返回值第二行即为文件路径{FilePath}。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8/v3/TAMZjmwqTzmqwDKMfgGZ-Q/zh-cn_image_0000002731542329.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3c/v3/FQCr93HWQWCuSqfnUqyrqw/zh-cn_image_0000002701663118.png)
