...
content_hash: sha256:eec1904bbf8edae4419e7207aa6e968b067d56f40a791c01d85866443e6a672f
---
...
1. 插件包本质上是动态共享包HSP，参考[创建HSP模块](ide-hsp.md#section79378499185)在工程中创建插件模块plugin。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/w4WbVkjUScyDYfDH-CfBuw/zh-cn_image_0000002733433256.png)
...
3. 选择DevEco Studio菜单栏中的File > Project Structure，在Signing Configs页面勾选Automatically generate signature。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/43/v3/EqC4vtDCR_WxERVIxZ3qFA/zh-cn_image_0000002762992783.png)

### 编译打包

1. 选中工程目录中插件模块的文件目录，通过DevEco Studio菜单栏的Build > Make Module ${libraryName}进行编译构建。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/8X8wq7EqT0qbUZPmnn_tmQ/zh-cn_image_0000002762832899.png)
2. 编译完成后，会在工程目录中生成对应的产物。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0d/v3/k7t2nsoYSNCOvyB5cR0fug/zh-cn_image_0000002733273382.png)
