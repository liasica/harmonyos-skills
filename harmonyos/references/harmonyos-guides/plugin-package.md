...
content_hash: sha256:6a07c9aaa964dc3d2f4e21e2256183c95951e164b337110f4a9585d4f1b1f717
---
...
1. 插件包本质上是动态共享包HSP，参考[创建HSP模块](ide-hsp.md#section79378499185)在工程中创建插件模块plugin。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/ApiJq2DXSgOZ4HjFoDIq9g/zh-cn_image_0000002747209737.png)
...
3. 选择DevEco Studio菜单栏中的File > Project Structure，在Signing Configs页面勾选Automatically generate signature。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/k1VVqoZeS3G0vDUoNi4W2w/zh-cn_image_0000002717769804.png)

### 编译打包

1. 选中工程目录中插件模块的文件目录，通过DevEco Studio菜单栏的Build > Make Module ${libraryName}进行编译构建。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cf/v3/PgSsm3hjSW2AvWZIKJ8b-Q/zh-cn_image_0000002717609870.png)
2. 编译完成后，会在工程目录中生成对应的产物。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/yidmkqQQSV2atMxuAVcTJg/zh-cn_image_0000002747289821.png)
