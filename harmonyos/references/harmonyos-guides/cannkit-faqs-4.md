...
content_hash: sha256:362e90fc550affbdc661760677af076bc3a9cdbd6a3df0fdac6b1d6bbb3c7bc5
---
...
* 方案2：可以在原始网络proto模型文件中将输出算子类型指定为SSDDetectionOutput等算子类型，如下图所示。
  ...
  **图1** 输出算子类型修改前（左）和修改后（右）
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/0YgcbTppQRCcN-dk8rTN_Q/zh-cn_image_0000002743380234.png)
