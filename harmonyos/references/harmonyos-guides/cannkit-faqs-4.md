...
content_hash: sha256:8000ea0a93d20c7c604dd709a62e417bbc3929c03fbd5bc78eaf3006361cb1c2
---
...
* 方案2：可以在原始网络proto模型文件中将输出算子类型指定为SSDDetectionOutput等算子类型，如下图所示。
  ...
  **图1** 输出算子类型修改前（左）和修改后（右）
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7e/v3/MQJEJw0KRp-4EHsIBdW_bQ/zh-cn_image_0000002747212079.png)
