...
content_hash: sha256:45c256e3ee837645d63abe411b6c7023a85ce105ce58890efc86f3387dbdfd49
---
...
* 方案2：可以在原始网络proto模型文件中将输出算子类型指定为SSDDetectionOutput等算子类型，如下图所示。
  ...
  **图1** 输出算子类型修改前（左）和修改后（右）
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/r9n3jxyZSsWnfffBCSUiMw/zh-cn_image_0000002739732440.png)
