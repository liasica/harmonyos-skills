...
content_hash: sha256:4eb6613268e8ce6bf362e8111438bccd2eb4beab541c358dfef80b99eaca6e83
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/P2ei_rKnSrOuaIItVsVAoQ/zh-cn_image_0000002701663768.png "点击放大")
...
1. **ArkWeb**子泳道聚合了Web相关线程的trace信息，通过分析Web渲染过程的关键函数的trace点，可以分析出每一帧的执行流程。聚合的Web线程信息如下：
   ...
   * Web应用Render线程：以 :render 结尾的线程，主要用于图形渲染任务，包括html、css解析，进行分层布局绘制。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/Tuz2lwuKSh2cYgQ5774_BA/zh-cn_image_0000002701823692.png "点击放大")
2. 一般结合**H:RosenWeb**泳道和**PresentFence**泳道来分析是否存在丢帧。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/Gjaq8BzMQKCf7BQHqna8gw/zh-cn_image_0000002701663766.png "点击放大")
...
3. 在ArkWeb的子泳道中，Web应用Render线程提供了分析子资源加载各阶段具体耗时的能力。切换到 **Sub Resource**区域，可查看详细信息。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/92/v3/lmycMYPCTn-RWzruhOZWrQ/zh-cn_image_0000002701823690.png "点击放大")
4. 点选某一行，可以查看该URL对应的缓存信息。包括缓存存在时长、最后修改时刻、过期时刻、缓存指令、资源的唯一标识符以及资源是否过期。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/jWt3FjsgS76XxTdVECz43A/zh-cn_image_0000002701663770.png "点击放大")
