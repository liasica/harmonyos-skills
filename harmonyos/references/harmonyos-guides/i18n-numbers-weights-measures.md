---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-numbers-weights-measures
title: 数字与度量衡国际化
...
度量衡包括长度单位、面积单位、体积单位和容量单位等，通过[I18NUtil](../harmonyos-references/js-apis-i18n.md#i18nutil9)类的[unitConvert](../harmonyos-references/js-apis-i18n.md#unitconvert9)接口实现度量衡转换和格式化。
