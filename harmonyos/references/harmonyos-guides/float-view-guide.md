...
闪控窗支持的模板类型可见[FloatViewTemplateType](../harmonyos-references/js-apis-floatview.md#floatviewtemplatetype)，不同模板类型效果可见闪控窗[视觉规格](../design-guides/floatview-0000002624640357.md#section910624871013)。
