...
content_hash: sha256:b526b1574692550d082b1f93696e2b5f242c0108d6dfa25c01d7b17d9c5114c6
---
...
* coredump文件
  ...
  2. 在2in1设备的任务管理器中右键应用进程，选择**创建转储文件**。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e/v3/bSQjObb_TdSymIjslewkUA/zh-cn_image_0000002701823714.png)
  3. 创建成功后，会提示coredump文件的保存位置。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/7Kd_CofKR3yAdTZOZ9XgXQ/zh-cn_image_0000002701823712.png)
...
1. 打开DevEco Studio的**Log**窗口，点击**AnalyzeDump**页签打开界面，选择要解析的dump文件和带调试信息的so目录（默认是模块下的build/{product}/intermediates/libs/{target}/{abi}，其中product和target默认是default，{abi}是设备CPU架构类型，如arm64-v8a），点击**Start Analyze**开始解析。
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/RQeBCpnwRKmB1tvuEr3ZQA/zh-cn_image_0000002731542983.png)
2. 等待解析成功后，默认会展示异常线程和对应的堆栈，展开堆栈可查看变量信息，支持切换查看不同线程的堆栈，点击堆栈中的超链接可以跳转到对应的源码。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e8/v3/ArbimPGbRomih8lDPFCoHw/zh-cn_image_0000002731542987.png)
3. 支持查看指定地址的内存，填写内存地址，点击**View**即可查看。也可以直接右键点击变量查看内存。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f2/v3/Az-sNMSGQoS_SVGbzQZYoQ/zh-cn_image_0000002731383011.png)

   点击**Settings**，可设置进制、偏移量和展示的内存字节数量。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7c/v3/NRcGY0qCR5aX2JbJQKCJwg/zh-cn_image_0000002701663790.png)
