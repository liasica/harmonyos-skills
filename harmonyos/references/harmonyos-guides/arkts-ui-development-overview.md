---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-ui-development-overview
...
content_hash: sha256:cef098f523894e173a13287d4fe3419e3f4280311d66ea23248a5497af71ec21
---
...
* **ArkTS**
  ...
  ArkTS是优选的主力应用开发语言，围绕应用开发在[TypeScript](https://www.typescriptlang.org/)（简称TS）生态基础上做了进一步扩展。扩展能力包含声明式UI描述、自定义组件、动态扩展UI元素、状态管理和渲染控制。状态管理作为基于ArkTS的声明式开发范式的特色，通过功能不同的装饰器给开发者提供了清晰的页面更新渲染流程和管道。状态管理包括UI组件状态和应用程序状态，两者协作可以使开发者完整地构建整个应用的数据更新和UI渲染。ArkTS语言的基础知识请参考[初识ArkTS语言](arkts-get-started.md)。
* **布局**
...
* **页面路由和组件导航**
  ...
  开发者可以将应用的用户界面设计为多个功能页面[NavDestination](../harmonyos-references/ts-basic-components-navdestination.md)，页面通过栈结构管理，并通过导航容器[Navigation](../harmonyos-references/ts-basic-components-navigation.md)完成页面间的调度管理如跳转、回退等操作，以实现应用内的功能解耦。
* **图形**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e8/v3/JTGnFX34SoGJiyxDVY6_Jg/zh-cn_image_0000002552797902.png?HW-CC-KV=V1&HW-CC-Date=20260427T233852Z&HW-CC-Expire=86400&HW-CC-Sign=B86720E35C65108FDF349B8708FC2CA04DC6ABDA61A63A3F331DE3B1DF8DF5C7)
...
| 任务 | 简介 | 相关指导 |
| --- | --- | --- |
| 学习ArkTS | 介绍了ArkTS的基本语法、状态管理和渲染控制的场景。 | - [基本语法](arkts-basic-syntax-overview.md)  - [状态管理](arkts-state-management-overview.md)  - [渲染控制](arkts-rendering-control-overview.md) |
| 设置组件导航和页面路由 | 介绍了如何设置组件间的导航以及页面路由。 | - [组件导航（推荐）](arkts-navigation-architecture.md)  - [页面路由](arkts-routing.md) |
...
| 使用文本 | 介绍了输入框、富文本和属性字符串等文本组件的使用方法。 | - [文本显示](arkts-common-components-text-display.md)  - [文本输入](arkts-common-components-text-input.md)  - [富文本](arkts-common-components-richeditor.md)  - [图标小符号](arkts-common-components-symbol.md)  - [属性字符串](arkts-styled-string.md) |
| 媒体展示 | 介绍了几种媒体展示组件的使用方法。 | - [显示图片 (Image)](arkts-graphics-display.md)  - [视频播放 (Video)](arkts-common-components-video-player.md)  - [创建轮播 (Swiper)](arkts-layout-development-create-looping.md)  - [创建弧形轮播 (ArcSwiper)](arkts-layout-development-arcswiper.md) |
...
* **默认单位**
  ...
  表示长度的入参单位默认为vp，即入参为number类型、以及[Length](../harmonyos-references/ts-types.md#length)和[Dimension](../harmonyos-references/ts-types.md#dimension10)类型中的number单位为vp。
* **异常值处理**
