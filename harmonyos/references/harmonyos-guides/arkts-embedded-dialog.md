...
content_hash: sha256:3acc50f81609a4e7b10ec7f0df1a9e60cefa18c8e6b1cfdb3eb43deecdd45b8a
---
...
在弹出框的options入参中设置[levelMode](../harmonyos-references/js-apis-promptaction.md#levelmode15)属性，值为LevelMode.EMBEDDED表示开启页面级弹出框能力。
...
如果希望弹出框显示在某个指定页面内，需在options入参中设置[levelUniqueId](../harmonyos-references/js-apis-promptaction.md#basedialogoptions11)属性来实现。此属性接收页面内的节点id，设置后，弹出框显示时会自动查询此id对应的节点所在的[Navigation](../harmonyos-references/ts-basic-components-navigation.md)页面，并将其挂载在子页面的[NavDestination](../harmonyos-references/ts-basic-components-navdestination.md)节点下。
...
如果弹出框配置了蒙层，蒙层的遮盖范围会根据页面层级的变化进行调整，默认遮罩范围为弹出框父节点的显示区域（Page页面或者Navigation页面）。此时，状态栏和导航条不会被蒙层遮挡。若希望遮挡状态栏和导航条，可将[immersiveMode](../harmonyos-references/js-apis-promptaction.md#immersivemode15)参数的值设为ImmersiveMode.EXTEND。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/Xe8knRVcTYuNejPALvpwpA/zh-cn_image_0000002712243924.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/_EcwhSLhRpCJYhH_X_9dNw/zh-cn_image_0000002742002877.gif)
