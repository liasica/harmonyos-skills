...
content_hash: sha256:dfbba073458277ec69a5796fc5ebf846a43981e8e1fc953c76a6eed82984663c
---
...
从5.0.0(12)开始，检测环境平面能力支持部分Phone、部分Tablet设备。请参考[硬件要求](arengine-preparations.md#硬件要求)判断设备是否支持运动跟踪及平面识别特性（[ARENGINE\_FEATURE\_TYPE\_SLAM](../harmonyos-references/arengine-capi-arengine.md#arengine_featuretype)）。
