...
content_hash: sha256:402388998e3469a5582e987f3b0d11a9fde2f5bd5bb1d230737997fed6972811
---
...
2. 编译构建完成后，可以在工程目录**build > outputs > {product}**下，获取应用包。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2b/v3/qtLVBhGLQ2edORApqnANzQ/zh-cn_image_0000002701663704.png)
...
1. 在DevEco Studio菜单栏，点击**Build > Upload Product。**若未登录，请点击**Sign in**登录华为开发者账号。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9b/v3/lmDYZjDTQfC5UjRSyq7Yyg/zh-cn_image_0000002731382921.png)
2. 登录成功后，返回DevEco Studio进入软件包上传界面，确认用户名称和团队信息，在当前工程已构建的App包列表中选择需要上传的软件包，点击**Distribute App**开始上传。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/kOSK-LMBS4WHcfG7rr4aRg/zh-cn_image_0000002701663712.png)
3. 选择所需的上传类型，上传类型包含AppGallery Connect、Testing Only、Custom三种，然后点击**Next**。
   ...
   * **Custom**：自定义上传配置。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/lXMaTj7XSBO0na0UxyWNdw/zh-cn_image_0000002731542889.png)
4. 检查应用是否[在AGC注册或关联创建待发布的应用](../app/agc-help-create-app-0000002247955506.md#section16423184171915)，未注册或未关联待发布的应用可在DevEco Studio中创建或关联。
   * 应用未在AGC注册，在窗口中配置应用名称、应用包名等信息，创建应用和发布应用，点击**Next**。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/76/v3/k0UPm0tfR0ehdqVKpT4F9A/zh-cn_image_0000002731542887.png)
   * 应用在AGC已注册但未关联创建待发布的应用，在窗口中配置**App name**（应用名称）、**App package name**（应用包名）、**Device Type**（设备类型）、**Language**（默认语言），点击**Next**，会同步在AGC上关联创建待发布的应用。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fe/v3/Gcos5zGEQ9OKVWMkrrcy_A/zh-cn_image_0000002701663694.png)
...
5. 选择Custom上传类型，点击**Next**，进入签名配置界面。使用场景如下：
   ...
   * **Manage Build Version**：自动管理构建版本，Build Version值由AGC计算后更新。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/K0O4gc33SrOt1jN8mBWDZw/zh-cn_image_0000002731382925.png)
6. 选择签名管理方式。
   * **Automatically manage signing**：自动管理签名，使用云管理证书和Profile，对应用重新签名。
   * **Manually manage signing**：手动管理签名，开发者自行配置签名信息。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/HDdB7dRqSXKnb5ik4pmzHA/zh-cn_image_0000002701823618.png)
   ...
   * **创建或导入证书**
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/U7uK6Jy4Q0a5RVrs7BrVgA/zh-cn_image_0000002701663714.png)
   * **导入或下载Profile**
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/0U9Dl2aySau5R69qmC-YLw/zh-cn_image_0000002731382935.png)
7. 签名成功后，在选择的软件包路径下会生成"re-signed.app"为后缀的软件包，检查软件包信息，点击**Upload**上传软件包。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/hu6PM3x-SIm_L8kn4oFLBQ/zh-cn_image_0000002701663702.png)
8. 上传软件包成功后，点击**AppGallery Connect**可进入AGC查看软件包上传记录和检测结果，具体请参考[上传软件包](../app/agc-help-release-app-upload-pkg-0000002277983368.md)。点击**OK**，关闭上传页面。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/1rI-fqfUTrS5YC4vxp0C8A/zh-cn_image_0000002701823616.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/1YiHSFBqQ66rbSGX5NF-fw/zh-cn_image_0000002731542903.png)
...
2. 填写密钥库文件，若已有的密钥库文件（存储有密钥的.p12文件），单击**Select an existing key**进行选择。下面以新创建密钥库文件为例进行说明。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/hevXtBdkQLey19EMeBQ_4g/zh-cn_image_0000002701823638.png)
3. 在**Generate Key**窗口，填写密钥库信息后，点击**Next**。
   ...
   * **Advance Setting**：密钥库文件的高级设置，选填。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b0/v3/f3RCaLv-R9WaoVyu0mMnIg/zh-cn_image_0000002701663718.png)
4. 在**Generate** **Certificate Request File (CSR)**窗口，设置CSR文件名和CSR文件存储路径后，点击**Finish**。
   ...
   * **Select file save path**：设置CSR文件存储路径。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/rW7sxC7STweOFYChX_8eOQ/zh-cn_image_0000002701823614.png)
5. 创建CSR文件成功，可以在存储路径下获取生成的密钥库文件（.p12）、证书请求文件（.csr）。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/JbD10K6rQ1-ErezLWfLJBw/zh-cn_image_0000002701663698.png)
...
2. 在**Key Store File**中，可以单击**Choose Existing**选择已有的密钥库文件（存储有密钥的.p12文件）；如果没有密钥库文件，单击**New**进行创建。下面以新创建密钥库文件为例进行说明。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3/v3/7yQwDbxjQ3ysTA6KMOOHUg/zh-cn_image_0000002731542911.png "点击放大")
3. 在**Create Key Store**窗口中，填写密钥库信息后，单击**OK**。
   * **Key Store File**：设置密钥库文件存储路径，并填写p12文件名。
   * **Password**：设置密钥库密码，必须由大写字母、小写字母、数字和特殊符号中的两种以上字符的组合，长度至少为8位。请记住该密码，后续签名配置需要使用。
   * **Confirm Password**：再次输入密钥库密码。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/St_1Kw0ASWmAY6jbN7OZ2A/zh-cn_image_0000002701663692.png "点击放大")
4. 在**Generate Key** **and CSR**界面中，继续填写密钥信息后，单击**Next**。
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/ykJ9UX1WT1qLPnjDKW2Upg/zh-cn_image_0000002701823630.png)
5. 在**Generate Key** **and CSR**界面，设置CSR文件存储路径和CSR文件名。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8/v3/RvkP8Yo4TdGoEAGgXXr33w/zh-cn_image_0000002701823634.png "点击放大")
6. 单击**OK**按钮，创建CSR文件成功，可以在存储路径下获取生成的密钥库文件（.p12）和证书请求文件（.csr）。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/fUXpEH4rQ-G1SAJPWfu9ag/zh-cn_image_0000002731542895.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/uom5p3QwQCqHpZfeMmesDA/zh-cn_image_0000002701823620.png "点击放大")
...
2. 编译构建完成后，可以在工程目录**build > outputs > default**下，获取带签名的应用包。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/z1wp27iiTcCAYcUPUMd_Gw/zh-cn_image_0000002701823626.png)
...
1. 在DevEco Studio菜单栏，点击**Build > Upload Product。**若未登录，请点击**Sign in**登录华为开发者账号。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/pWVXYyyJSX-EngDo_PWRcA/zh-cn_image_0000002731382917.png "点击放大")
2. 登录成功后，返回DevEco Studio进入软件包上传界面。确认当前工程的product信息，选择需要上传的软件包类型，点击**OK**开始上传。
   ...
   * 上传的product可以通过点击DevEco Studio编辑区域右上方![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/X05BioEWS8-ytXGPtZGhiA/zh-cn_image_0000002701663706.png)图标进行查看及切换。
   * 可通过app.json5中bundleName/versionName字段修改当前product对应的包名/版本号信息。必须使用当前开发者账号下已在AppGallery注册且真实存在的包名。
   * Build Version值由AGC计算后回传填入。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/TDsnGU8YSHKk9ipx9VvwuA/zh-cn_image_0000002731382923.png)
3. 上传完成后，出现云测试的结果，点击**View Full result in AppGallery Connect**可进入AGC查看软件包上传记录和检测结果，具体请参考[上传软件包](../app/agc-help-release-app-upload-pkg-0000002277983368.md)。点击**Close**关闭上传页面。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/ot46K0SuTjmO-71XkecVTA/zh-cn_image_0000002701823624.png)
