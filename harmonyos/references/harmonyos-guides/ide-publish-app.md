...
content_hash: sha256:5a5e0438dd0d2468885a923219f419879b2c83c69365517ab2faa3631d1f158c
---
...
2. 编译构建完成后，可以在工程目录**build > outputs > {product}**下，获取应用包。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/82JcGeUpSVG6KKtLwgTNrg/zh-cn_image_0000002701663704.png)
...
1. 在DevEco Studio菜单栏，点击**Build > Upload Product。**若未登录，请点击**Sign in**登录华为开发者账号。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0b/v3/yXRIjgOTQGq5DrOPpbgmug/zh-cn_image_0000002731382921.png)
2. 登录成功后，返回DevEco Studio进入软件包上传界面，确认用户名称和团队信息，在当前工程已构建的App包列表中选择需要上传的软件包，点击**Distribute App**开始上传。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/2cxvBdpSSdClg14EoXs8wQ/zh-cn_image_0000002701663712.png)
3. 选择所需的上传类型，上传类型包含AppGallery Connect、Testing Only、Custom三种，然后点击**Next**。
   ...
   * **Custom**：自定义上传配置。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/VKXdxJkPR3S8npxmT4MDHQ/zh-cn_image_0000002731542889.png)
4. 检查应用是否[在AGC注册或关联创建待发布的应用](../app/agc-help-create-app-0000002247955506.md#section16423184171915)，未注册或未关联待发布的应用可在DevEco Studio中创建或关联。
   * 应用未在AGC注册，在窗口中配置应用名称、应用包名等信息，创建应用和发布应用，点击**Next**。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/09/v3/5y1meGjaSASKhHniiierUw/zh-cn_image_0000002731542887.png)
   * 应用在AGC已注册但未关联创建待发布的应用，在窗口中配置**App name**（应用名称）、**App package name**（应用包名）、**Device Type**（设备类型）、**Language**（默认语言），点击**Next**，会同步在AGC上关联创建待发布的应用。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/Dqs5qoWKS0-xcgqn5Zoaaw/zh-cn_image_0000002701663694.png)
...
5. 选择Custom上传类型，点击**Next**，进入签名配置界面。使用场景如下：
   ...
   * **Manage Build Version**：自动管理构建版本，Build Version值由AGC计算后更新。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/0wdyxzxFRfezM05GoBdbEA/zh-cn_image_0000002731382925.png)
6. 选择签名管理方式。
   * **Automatically manage signing**：自动管理签名，使用云管理证书和Profile，对应用重新签名。
   * **Manually manage signing**：手动管理签名，开发者自行配置签名信息。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/vMroB8-xRXeP299StYlYDQ/zh-cn_image_0000002701823618.png)
   ...
   * **创建或导入证书**
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5b/v3/8nJpc02sSkmOAKn9iAnxAA/zh-cn_image_0000002701663714.png)
   * **导入或下载Profile**
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/9Dip_2PFTlykqf4I3kBc_A/zh-cn_image_0000002731382935.png)
7. 签名成功后，在选择的软件包路径下会生成"re-signed.app"为后缀的软件包，检查软件包信息，点击**Upload**上传软件包。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/42/v3/s8_h5WKySiWPulABXE3qug/zh-cn_image_0000002701663702.png)
8. 上传软件包成功后，点击**AppGallery Connect**可进入AGC查看软件包上传记录和检测结果，具体请参考[上传软件包](../app/agc-help-release-app-upload-pkg-0000002277983368.md)。点击**OK**，关闭上传页面。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/0ygrL1_eQA-2TF7xT9SSxw/zh-cn_image_0000002701823616.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/ZmnDKF2hSMOvnSw33sIWIg/zh-cn_image_0000002731542903.png)
...
2. 填写密钥库文件，若已有的密钥库文件（存储有密钥的.p12文件），单击**Select an existing key**进行选择。下面以新创建密钥库文件为例进行说明。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/DC0eGKt6ShGEVlNc9tPnmQ/zh-cn_image_0000002701823638.png)
3. 在**Generate Key**窗口，填写密钥库信息后，点击**Next**。
   ...
   * **Advance Setting**：密钥库文件的高级设置，选填。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/e5FxKj60RJ62Q4OKke9fgQ/zh-cn_image_0000002701663718.png)
4. 在**Generate** **Certificate Request File (CSR)**窗口，设置CSR文件名和CSR文件存储路径后，点击**Finish**。
   ...
   * **Select file save path**：设置CSR文件存储路径。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/Xg_tn2HQS5KhrQZBqTjm9Q/zh-cn_image_0000002701823614.png)
5. 创建CSR文件成功，可以在存储路径下获取生成的密钥库文件（.p12）、证书请求文件（.csr）。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/xouoYCPRQVCFAjtswXim1g/zh-cn_image_0000002701663698.png)
...
2. 在**Key Store File**中，可以单击**Choose Existing**选择已有的密钥库文件（存储有密钥的.p12文件）；如果没有密钥库文件，单击**New**进行创建。下面以新创建密钥库文件为例进行说明。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c9/v3/zhCGKihzSf2Ks8HSlrJu7Q/zh-cn_image_0000002731542911.png "点击放大")
3. 在**Create Key Store**窗口中，填写密钥库信息后，单击**OK**。
   * **Key Store File**：设置密钥库文件存储路径，并填写p12文件名。
   * **Password**：设置密钥库密码，必须由大写字母、小写字母、数字和特殊符号中的两种以上字符的组合，长度至少为8位。请记住该密码，后续签名配置需要使用。
   * **Confirm Password**：再次输入密钥库密码。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/af/v3/SXmRs-GlQ466QrSVQ0bKzQ/zh-cn_image_0000002701663692.png "点击放大")
4. 在**Generate Key** **and CSR**界面中，继续填写密钥信息后，单击**Next**。
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/Fo0mYjhNT8W2OZXYoplPqw/zh-cn_image_0000002701823630.png)
5. 在**Generate Key** **and CSR**界面，设置CSR文件存储路径和CSR文件名。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/0YLR30uWT9SDsWbGbE1n7w/zh-cn_image_0000002701823634.png "点击放大")
6. 单击**OK**按钮，创建CSR文件成功，可以在存储路径下获取生成的密钥库文件（.p12）和证书请求文件（.csr）。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/-iwwb_8jSg2Ir1DUpr7Yag/zh-cn_image_0000002731542895.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/56/v3/VaKdKhQ7SXW99POsscLAow/zh-cn_image_0000002701823620.png "点击放大")
...
2. 编译构建完成后，可以在工程目录**build > outputs > default**下，获取带签名的应用包。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/Uz7pxySnSgSq0S0H_O0vYg/zh-cn_image_0000002701823626.png)
...
1. 在DevEco Studio菜单栏，点击**Build > Upload Product。**若未登录，请点击**Sign in**登录华为开发者账号。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/be/v3/PkJaG9apThCTiwObBWD-Pw/zh-cn_image_0000002731382917.png "点击放大")
2. 登录成功后，返回DevEco Studio进入软件包上传界面。确认当前工程的product信息，选择需要上传的软件包类型，点击**OK**开始上传。
   ...
   * 上传的product可以通过点击DevEco Studio编辑区域右上方![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bf/v3/sKPOfPosRSWICZ9y5mpY2A/zh-cn_image_0000002701663706.png)图标进行查看及切换。
   * 可通过app.json5中bundleName/versionName字段修改当前product对应的包名/版本号信息。必须使用当前开发者账号下已在AppGallery注册且真实存在的包名。
   * Build Version值由AGC计算后回传填入。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/Ny9pQkUJSZmzJM2iNPJzRA/zh-cn_image_0000002731382923.png)
3. 上传完成后，出现云测试的结果，点击**View Full result in AppGallery Connect**可进入AGC查看软件包上传记录和检测结果，具体请参考[上传软件包](../app/agc-help-release-app-upload-pkg-0000002277983368.md)。点击**Close**关闭上传页面。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6b/v3/oVlXtoRTTUSGT-DJA-p7-A/zh-cn_image_0000002701823624.png)
