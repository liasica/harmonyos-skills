...
content_hash: sha256:1266056cdcd86d2db97861e28bd4f894173e8d8a15d9a4549c8005c3e3c3e9b5
---
...
2. 打开模块目录内的obfuscation-rules.txt文件配置混淆规则，具体请参考[混淆选项](source-obfuscation-rule-options.md)，对于不需要混淆的内容，请配置[保留选项](source-obfuscation-keep-options.md)。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/dYl7KUIhRceASZ-MA8_Mqw/zh-cn_image_0000002701823876.png)
...
2. 打开模块目录内的consumer-rules.txt文件配置保留选项。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/f7MvyvnbTDGD4gNNvwaezw/zh-cn_image_0000002731383197.png)
...
1. 通过以下任意一种方式打开ObfuscationHelper：
   ...
   * 在模块目录上点击鼠标右键，在弹出的菜单中选择**ObfuscationHelper**。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/08/v3/J9GtwaotQoOZ8mKRREDBZA/zh-cn_image_0000002701663958.png)
...
3. 如果模块之前被扫描过，并且生成了排查白名单，则会生成相应的历史记录。选择对应的历史记录，在本次扫描完成后，会自动关联历史的排查记录，历史已经排查过的白名单字段无需再重复排查。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d3/v3/r7quxWnzSIm_93gCuCFSQw/zh-cn_image_0000002731383193.png)
4. 根据涉及的混淆场景，选择一个或多个扫描任务，点击**开始扫描**。关于扫描任务的介绍请参考[扫描任务](ide-build-obfuscation.md#section18125192133818)。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/1glw0yq6R1adrZBlmJ9Hng/zh-cn_image_0000002731543145.png)
5. 等待扫描成功后，进入[推荐白名单](ide-build-obfuscation.md#section3989185975217)和[待排查白名单](ide-build-obfuscation.md#section42331014105310)配置页面。在扫描的过程中，也可以点击**停止扫描**按钮，结束扫描。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/rAEXF_OIRTOa8uWxIbga7A/zh-cn_image_0000002701823878.png)
...
* **使用DevEco Studio 6.0.0 Beta1及以上版本，按以下步骤操作：**
  1. 在页面上方，按照以下的树状结构呈现扫描结果。
     ...
     + **关键代码**：点击关键代码，可以跳转到代码所在的文件和代码行。
       ...
       ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/66/v3/hrah0ksuSM2CfXHR7iFE7w/zh-cn_image_0000002701663950.png)
     + **白名单字段**：点击白名单字段，可以跳转到字段所在的文件和代码行。

       ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/iCL0a65TT4mV9y5wVyAbow/zh-cn_image_0000002701663966.png)
  2. 如果需要将白名单文件生成到工程中，可以点击**生成推荐白名单**按钮，ObfuscationHelper会在对应模块下生成推荐白名单文件Hm-recommend-keep-list.txt/Hm-recommend-consumer-keep-list.txt，并提示对应的文件路径。同时在工程根目录下生成对应的白名单Excel表格obfuscation-helper-xxx.xlsx。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/53Nqlrg1TDaXazh84w94LA/zh-cn_image_0000002731383191.png)
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/27Gy0TZHSn-L7uaRmkTEOA/zh-cn_image_0000002731543159.png)
  3. 在混淆配置中添加白名单文件，有两种方式。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/NUayDKCcRSmTnFIeX5KqMQ/zh-cn_image_0000002701823872.png)
* **使用DevEco Studio 6.0.0 Beta1以下版本，按以下步骤操作：**
  1. 在页面上方，按照以下的树状结构呈现扫描结果。
     ...
     + **关键代码**：点击关键代码，可以跳转到代码所在的文件和代码行。
       ...
       ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b4/v3/72ZnGATvTYO76xkUx_vbZw/zh-cn_image_0000002731543141.png)
     + **白名单字段**：点击白名单字段，可以跳转到字段所在的文件和代码行。

       ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/AbwyQ2O4T2OjwsyQc9Cbuw/zh-cn_image_0000002701663954.png)
  2. 如果需要将白名单文件生成到工程中，可以点击**生成推荐白名单**按钮，ObfuscationHelper会在对应模块下生成Hm-recommend-keep-list.txt文件，并提示对应的文件路径。同时在工程根目录下生成对应的白名单Excel表格obfuscation-helper-xxx.xlsx。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/0xi3F4Y7Qie7Bw4wAHwANg/zh-cn_image_0000002731543151.png)
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/l7DgAW_lRHmBRAf49JnX6Q/zh-cn_image_0000002701823882.png)
  3. 在模块下的build-profile.json5中，将模块下生成的推荐白名单文件Hm-recommend-keep-list.txt加入到混淆配置files或consumerFiles字段下。关于字段的介绍请参考[字段说明](ide-build-obfuscation.md#section88021016154414)。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/8R8hp5NxScG-9Vl-8wucpA/zh-cn_image_0000002731543167.png)
...
* **使用DevEco Studio 6.0.0 Beta1及以上版本，按以下步骤操作：**
  1. 在页面上方，按照以下的树状结构呈现扫描结果。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5/v3/9ONsKYBDTNyK61sW-N45DQ/zh-cn_image_0000002701823898.png)
  2. 跳转到关键代码后，根据具体场景识别是否需要配置白名单字段，排查方式请参考[扫描任务](ide-build-obfuscation.md#section18125192133818)。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/9heEbyjcQTeO-obrYuLSPw/zh-cn_image_0000002701663972.png)
  3. 排查完成后，点击**生成排查白名单**按钮，ObfuscationHelper会在对应模块下生成排查白名单文件Hm-manual-keep-list.txt/Hm-manual-consumer-keep-list.txt，并提示对应的文件路径。同时在工程根目录下生成对应的白名单Excel表格obfuscation-helper-xxx.xlsx。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/RyH9zl76RjWL28kb6v3RkQ/zh-cn_image_0000002731543169.png)
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/eo4z6ZHFRKOTjt4dv1Snog/zh-cn_image_0000002731383169.png)
  4. 在混淆配置中添加白名单文件，有两种方式。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2b/v3/CdjENGYVS_motWt0DumuDw/zh-cn_image_0000002731543173.png)
* **使用DevEco Studio 6.0.0 Beta1以下版本，按以下步骤操作：**
  1. 在页面上方，按照以下的树状结构呈现扫描结果。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/pCCk2FcaQbmpfDbIxks6zQ/zh-cn_image_0000002731383177.png)
  2. 跳转到关键代码后，根据具体场景识别是否需要配置白名单字段，排查方式请参考[扫描任务](ide-build-obfuscation.md#section18125192133818)。如果存在需要配置的字段，在上方的输入框中，输入保留选项和对应的白名单字段。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/e-GCU0ZdQnSU5yYZ74e8Ow/zh-cn_image_0000002701823886.png)
  3. 排查完成后，点击**生成排查白名单**按钮，ObfuscationHelper会在对应模块下生成Hm-manual-keep-list.txt文件，并提示对应的文件路径。同时在工程根目录下生成对应的白名单Excel表格obfuscation-helper-xxx.xlsx。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/pb7RiIA4Rm-Mq-Ham340nw/zh-cn_image_0000002731543155.png)

     如以下模块下生成排查白名单文件：

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/jRDm0TE6Qr6d-DtZVJpk0Q/zh-cn_image_0000002731383175.png)
  4. 在模块下的build-profile.json5中，将模块下生成的排查白名单文件Hm-manual-keep-list.txt加入到混淆配置files或consumerFiles字段下。关于字段的介绍请参考[字段说明](ide-build-obfuscation.md#section88021016154414)。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/D2yono1ASmil5tCooCL8IA/zh-cn_image_0000002701663976.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/WO3zkhSRQPqmDDuDDdW5lA/zh-cn_image_0000002701823870.png)

* 保存路径是历史记录的缓存文件，鼠标悬停在保存路径上，可以查看白名单文件和Excel表格保存的路径。
* 点击查看详情图标![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/0NRa63kVS523pWOGxyVPjQ/zh-cn_image_0000002731543153.png)，可以跳转到对应的白名单场景配置页面。
...
* **har对外暴露的接口**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/ksGkOlJUTvCsILXAVfVfVg/zh-cn_image_0000002701823866.png)
