...
content_hash: sha256:122a4274dd35c030c9e45df322e4e271e15082c7a967a806b14f70ba39e95d7b
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/S9OOESNdQpiF9u2Y1Ikb2g/zh-cn_image_0000002772737331.png)
...
* 跨HSP/HAR包的场景下，需在创建Worker的模块包对应的oh-package.json5文件中，配置所需HSP/HAR包的依赖项，详见[引用共享包](ide-har-import.md)。
...
* 应用挂起切换到[后台](background-task-overview.md)后，该应用的Worker线程会暂停运行。
