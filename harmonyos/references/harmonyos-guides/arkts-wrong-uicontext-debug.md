---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-wrong-uicontext-debug
title: UI上下文异常调试
...
1. 使用[setStyledString](../harmonyos-references/ts-basic-components-text.md#setstyledstring12)方法设置字体大小时，字体大小未发生预期变化。
...
* 使用自定义组件的[getUIContext](../harmonyos-references/ts-custom-component-api.md#getuicontext)方法获取。
* 通过窗口的[getUIContext](../harmonyos-references/arkts-apis-window-window.md#getuicontext10)方法获取。
