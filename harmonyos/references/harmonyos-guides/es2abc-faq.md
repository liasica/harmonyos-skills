---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/es2abc-faq
title: 方舟字节码生成常见问题
breadcrumb: 指南 > 应用框架 > ArkTS（方舟编程语言） > ArkTS编译工具链 > 方舟字节码 > 方舟字节码生成常见问题
category: harmonyos-guides
scraped_at: 2026-04-28T07:38:47+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:be75ca58aaa49c24b82f3cc3f20216d45c22d6f3b1ca8924e3efd87b5cca9c58
---
...
```
1. hvigor Finished :entry:default@DoNativeStrip... after 258 ms
2. > hvigor Finished :entry:default@CacheNativeLibs... after 622 ms
3. > hvigor ERROR: Failed :entry:default@CompileArkTS...
4. > hvigor ERROR: ArkTS:ERROR Failed to execute es2abc.
5. Error Message: Failed to emit /Users/DevEcoStudioProjects/FastSDKDemo/entry/build/default/intermediates/loader_out/default/ets/modules.abc, error: Field {&finesdk/Index&1.0.0.moduleRecordIdx} has different value.
6. If you're using any cache file generated by older version of SDK, please try cleaning the cache files and rebuild
7. GenerateProgram Failed!
```
...
1. 在[工程级build-profile.json5文件](ide-hvigor-build-profile-app.md)中的useNormalizedOHMUrl配置为true。
...
2. 清除ohpm和编译缓存，下载ohpm包并重新编译，操作如下：
   ...
   * 点击菜单Build->Clean Project，或在控制台执行[ohpm clear](ide-ohpm-clean.md)。
   * 点击菜单File->Invalidate Caches...，弹窗选项全选执行并重启。
   * 在控制台执行[ohpm install](ide-ohpm-install.md)。
...
由于此类异常与代码结构和运行环境相关，目前无法提供完整列表；如上述情况均无法解释，可结合崩溃日志或使用[GDB](cannkit-gdb.md)/[LLDB](debug-lldb.md)进一步定位。
