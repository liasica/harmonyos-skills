...
content_hash: sha256:ad6a1ac679fdd9490c1a431014eb709ff1a3750fa51868dc93d7d51908aab991
---
...
多语言文本绘制的相关接口如下所示，详细接口说明请参考[drawing\_text\_typography.h](../harmonyos-references/capi-drawing-text-typography-h.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/brQvnwI0SCCHmDHtJKPgaA/zh-cn_image_0000002723695836.png)
...
多行文本绘制的相关接口如下所示，详细接口说明请参考[drawing\_text\_typography.h](../harmonyos-references/capi-drawing-text-typography-h.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/znUbpMxJTbin3Bk585CdXg/zh-cn_image_0000002753455523.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/39/v3/NdTuAgzHSvy343HVqIaWaw/zh-cn_image_0000002723855758.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/rPAIRGh7Ra6d6MFY6MMiOg/zh-cn_image_0000002723695840.png)
...
| OH\_Drawing\_TextShadow\* OH\_Drawing\_CreateTextShadow(void) | 创建指向文本阴影对象的指针。 |
| void OH\_Drawing\_SetTextShadow(OH\_Drawing\_TextShadow\* shadow, uint32\_t color, OH\_Drawing\_Point\* offset, double blurRadius) | 设置文本阴影对象的参数。 |
| void OH\_Drawing\_TextStyleAddShadow(OH\_Drawing\_TextStyle\* style, const OH\_Drawing\_TextShadow\* shadow) | 文本阴影容器中添加文本阴影元素。 |
| void OH\_Drawing\_DestroyTextShadow(OH\_Drawing\_TextShadow\* shadow) | 释放被文本阴影对象占据的内存。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/RTxaeuBPSvq0r-yYs0Gypw/zh-cn_image_0000002753295607.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/NnjVZT5xRwKPeZXc2vneKw/zh-cn_image_0000002753455525.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a7/v3/8NUPbPRFS228_SJ0fl-Q6A/zh-cn_image_0000002753295609.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/Q-XWk1KTQ2SvpCtoCQm4JA/zh-cn_image_0000002723855742.jpg)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/m-g_N7zwRRyeH9HMYOxBtg/zh-cn_image_0000002753295591.jpg)
...
| --- | --- | --- |
| 0 | TEXT\_HEIGHT\_ALL |  |
| 100 | TEXT\_HEIGHT\_ALL |  |
| 100 | TEXT\_HEIGHT\_DISABLE\_ALL |  |

### 省略号样式设置

从API version 22开始，支持设置省略号样式，在文本内容超出显示区域时截断文本。从API version 24开始，支持多行省略模式。

使用[OH\_Drawing\_SetTypographyStyleAttributeInt](../harmonyos-references/capi-drawing-text-typography-h.md#oh_drawing_settypographystyleattributeint)接口，传入[TYPOGRAPHY\_STYLE\_ATTR\_I\_ELLIPSIS\_MODAL](../harmonyos-references/capi-drawing-text-typography-h.md#oh_drawing_typographystyleattributeid)设置省略号模式，可选的省略号模式可见[OH\_Drawing\_EllipsisModal](../harmonyos-references/capi-drawing-text-typography-h.md#oh_drawing_ellipsismodal)。
...
| 省略号模式 | 效果 |
| --- | --- |
| ELLIPSIS\_MODAL\_TAIL |  |
| ELLIPSIS\_MODAL\_HEAD |  |
| ELLIPSIS\_MODAL\_MIDDLE |  |
| ELLIPSIS\_MODAL\_MULTILINE\_HEAD |  |
| ELLIPSIS\_MODAL\_MULTILINE\_MIDDLE |  |

### 文字换行方式设置

从API version 22开始，支持在文本排版时设置断行策略，断行策略决定了文本如何在行尾进行换行处理。

使用[OH\_Drawing\_SetTypographyTextBreakStrategy](../harmonyos-references/capi-drawing-text-typography-h.md#oh_drawing_settypographytextbreakstrategy)接口设置断行策略，可选的断行策略可见[OH\_Drawing\_BreakStrategy](../harmonyos-references/capi-drawing-text-typography-h.md#oh_drawing_breakstrategy)。
...
使用[OH\_Drawing\_SetTypographyStyleAttributeBool](../harmonyos-references/capi-drawing-text-typography-h.md#oh_drawing_settypographystyleattributebool)接口，传入[TYPOGRAPHY\_STYLE\_ATTR\_B\_COMPRESS\_HEAD\_PUNCTUATION](../harmonyos-references/capi-drawing-text-typography-h.md#oh_drawing_typographystyleattributeid)设置是否启用行首标点压缩，使用[OH\_Drawing\_GetTypographyStyleAttributeBool](../harmonyos-references/capi-drawing-text-typography-h.md#oh_drawing_gettypographystyleattributebool)接口查询是否启用了行首标点压缩。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/sK3YtZczRLOHUr6NmzwEpA/zh-cn_image_0000002723855768.png)
