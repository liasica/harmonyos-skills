...
content_hash: sha256:97a8cc9215abfec33d0d8ee74b759886d8387b590b09c335951a2d0868848e63
---

将所支持格式的图片文件解码成PixelMap，以便在应用或系统中进行图片显示或[图片处理](image-transformation.md)。

当前支持的图片文件格式包括JPEG、PNG、GIF、WebP、BMP、SVG、ICO、DNG、HEIC、WBMP23+、HEIFS23+、TIFF23+。
...
图片解码相关API的详细介绍请参见：图片解码接口文档[image\_source\_mdk.h](../harmonyos-references/capi-image-source-mdk-h.md)。
