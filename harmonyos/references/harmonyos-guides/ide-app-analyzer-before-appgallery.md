...
content_hash: sha256:97d17f12fdbe65fc53193b21e590a6edd624b297ced48d9ba2a1779332146287
---
...
1. 通过以下任意一种方式，打开AppAnalyzer。
   ...
   * 在编辑窗口右侧的工具栏，点击**AppAnalyzer**或![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/AENnfhgMRg6eX9o5HvQjEw/zh-cn_image_0000002701822910.png)，打开AppAnalyzer页面。
...
1. 在**AppAnalyzer**页面，选择**上架前体检**，点击预置的体检卡片，在弹框中选择待上架的产物和调试签名。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c9/v3/CPC2JqSWTwSFjDTfTjlnYA/zh-cn_image_0000002731382219.png)
...
4. 测试完成后，查看测试报告如下。
   * 如果测试分数是100分，可点击右上角**Sync To AG**按钮，确认弹框内容后点击**OK**，上传本次的检测报告，用于应用市场上架参考。上传报告后，无法再次上传报告。
     ...
     **说明** 
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/82/v3/ZXrH5MicSI6wND3jwX9LmQ/zh-cn_image_0000002731382215.png)
...
1. 在**AppAnalyzer**页面，选择**上架前体检**，弹出上架前检测配置的弹框，选择待上架的产物和调试签名。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/QmVRtzciRF6-pQIizLUgsg/zh-cn_image_0000002701822908.png)
...
4. 测试完成后点击**结束**按钮停止测试任务，等待数据解析完成后，查看测试结果如下。
   * 如果测试分数是100分，可点击右上角**报告同步**按钮，确认弹框内容后点击**OK**，上传本次的检测报告，用于应用市场上架参考。上传报告后，无法再次上传报告。
     ...
     **说明** 
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/LPycGJmkQCOmfWrD5_exFA/zh-cn_image_0000002701662996.png)
