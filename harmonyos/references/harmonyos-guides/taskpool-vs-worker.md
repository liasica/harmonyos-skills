...
breadcrumb: 指南 > 应用框架 > ArkTS（方舟编程语言） > ArkTS并发 > 多线程并发 > TaskPool和Worker的对比 (TaskPool和Worker)
category: harmonyos-guides
scraped_at: 2026-04-28T07:38:30+08:00
doc_updated_at: 2026-03-20
content_hash: sha256:84de1b9072f5775e82a050fac45f5c6871ff304a697193c89b6f2e7b95082a29
---

TaskPool和Worker的作用是为应用程序提供多线程运行环境，用于处理耗时计算任务或其他密集型任务，避免任务阻塞宿主线程，提高系统性能和资源利用率。

本文将从[实现特点](taskpool-vs-worker.md#实现特点对比)和[适用场景](taskpool-vs-worker.md#适用场景对比)两个方面比较TaskPool与Worker。
