...
content_hash: sha256:7cbce7e4bd04f435f00ca8269d6ed86bfe12bbc934b44386204a5101852b9edc
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/rPv4N9q-Qy6i2b3LPwGusw/zh-cn_image_0000002743219096.jpg)

### 开始网页调试

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/01/v3/1t1aDHVKQB6vfNn6fV-yyQ/zh-cn_image_0000002772738349.png)
...
2. 使用hdc命令连接上设备。
   ...
   * 如果命令返回设备的ID，表示hdc已连接上设备。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/sM-ItpXeSqy1DzpRScgvHg/zh-cn_image_0000002772898233.png)
   * 如果命令返回 [Empty]，则说明hdc还没有发现设备。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/a8WvGATxT2mNSlaF7zizbQ/zh-cn_image_0000002743378984.jpg)
3. 进入hdc shell。
...
1. 先在hdc shell里执行如下命令，查询ArkWeb在设备里创建的domain socket。
   ...
   * 如果前几步操作无误，该命令的执行结果将显示用于查询的domain socket端口。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7/v3/bZYGtyy8Qbai4zHEa44DYw/zh-cn_image_0000002743219098.jpg)
   * 如果没有查询到结果， 请再次确认。
...
2. 将查询到的domain socket转发至电脑的TCP 9222端口。
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/ZNk6YVJ1S02GAn3eI6SVDQ/zh-cn_image_0000002772738351.jpg)
3. 在命令行里执行如下命令，检查端口是否转发成功。
   ...
   * 如果有返回端口转发的任务，则说明端口转发成功。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3/v3/546k7fBhQyyk-nhulylzzQ/zh-cn_image_0000002772898235.png)
   * 如果返回 [Empty]， 则说明端口转发失败。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/ufLGe_M3RvORS7byV3X98A/zh-cn_image_0000002743378986.jpg)
...
2. 修改Chrome调试工具的配置。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/UgiGu-4OTC-Xc2QjYfx6Ag/zh-cn_image_0000002743219100.jpg)
3. 为了同时调试多个应用，请在Chrome浏览器的调试工具网页内，于“Devices”选项中的“configure”部分添加多个端口号。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/Dk4Zb34uRTuInP9STjt9zA/zh-cn_image_0000002772738353.png)

### 等待发现被调试页面

如果前面的步骤执行成功，Chrome的调试页面将显示待调试的网页。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/9z3vRcx_Tfazcuy7-lYIqw/zh-cn_image_0000002743219096.jpg)

### 开始网页调试

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/IgUh0YulRWSG_l4eYnv6Tg/zh-cn_image_0000002772738349.png)
...
* 转发成功后，请用电脑端的Chrome浏览器打开网址http://localhost:9222/json，URL里的9222需要改为自己实际配置的TCP端口。
  ...
  + 如果网页有内容， 说明端口转发成功，请在Chrome的调试页面[等待被调试页面的出现](web-debugging-with-devtools.md#等待发现被调试页面)。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/tOjZUycoRNmVyYBehwPymg/zh-cn_image_0000002772898237.jpg)
  + 如果展示的是错误网页， 说明端口转发失败， 请参阅[端口转发不成功](web-debugging-with-devtools.md#端口转发不成功)中的解决方法。

    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/w9P914LeTMOO0NESs0gvXA/zh-cn_image_0000002743378988.jpg)
