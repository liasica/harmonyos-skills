...
content_hash: sha256:fcc82a84a6715e61967ae7cfea8176cab9e348c41af833f93d165f18415afc00
---
...
* 不同的录音流类型对应着不同的系统优化处理策略，建议开发者根据需求选择合适的[SourceType](../harmonyos-references/arkts-apis-audio-e.md#sourcetype8)，具体可参考指南：[使用合适的音频流类型](using-right-streamusage-and-sourcetype.md)。
