...
[Web](../harmonyos-references/arkts-basic-components-web.md)组件支持在网页中预览PDF。但受限于性能表现，部分场景存在掉帧现象。若对流畅度有要求，建议使用[PdfView](../harmonyos-references/pdf-arkts-pdfview-component.md)，或第三方解析库[PDF.js](https://github.com/mozilla/pdf.js)。应用通过[WebOptions](../harmonyos-references/arkts-basic-components-web-i.md#weboptions)的src参数和[loadUrl()](../harmonyos-references/arkts-apis-webview-webviewcontroller.md#loadurl)接口加载PDF文档。具体场景包括：网络PDF文档、应用沙箱内PDF文档和本地PDF文档。
...
在创建[Web](../harmonyos-references/arkts-basic-components-web.md)组件时，指定默认加载的PDF文档。默认PDF文档加载完成后，若需变更Web组件显示的PDF文档，通过调用[loadUrl()](../harmonyos-references/arkts-apis-webview-webviewcontroller.md#loadurl)接口加载指定的PDF文档。[WebOptions](../harmonyos-references/arkts-basic-components-web-i.md#weboptions)的第一个参数变量src不能通过状态变量（例如：[@State](arkts-state.md)）动态更改地址，如需更改，请通过[loadUrl()](../harmonyos-references/arkts-apis-webview-webviewcontroller.md#loadurl)重新加载。
