...
content_hash: sha256:e482e0744402dd5a7bdb79e9339f9bde36f71136b797491aa37c9d4ce517e2c6
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/_-ZzlLFWSDKW2LOb1Fn6FA/zh-cn_image_0000002742123723.png)
...
3. 配置视频录制参数，调用[prepare](../harmonyos-references/arkts-apis-media-avrecorder.md#prepare9-1)接口，此时进入prepared状态。
   ...
   * 示例中配置的fileFormat视频文件封装格式、videoCodec视频编码格式请参考[AVRecorderProfile](../harmonyos-references/arkts-apis-media-i.md#avrecorderprofile9)。
