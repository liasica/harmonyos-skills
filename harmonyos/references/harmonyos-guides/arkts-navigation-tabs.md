...
content_hash: sha256:9c15db1068cd3f68a44e8afbbcb07e3941586c61e954ef06e81de09db8a7a4b7
---
...
当页面信息较多时，为了让用户能够聚焦于当前显示的内容，需要对页面内容进行分类，提高页面空间利用率。[Tabs](../harmonyos-references/ts-container-tabs.md)组件可以在一个页面内快速实现视图内容的切换，一方面提升查找信息的效率，另一方面精简用户单次获取到的信息量。为了帮助开发者更直观和全面地理解Tabs组件，本文通过将这些场景整合到一个应用首页的具体实例中，展示Tabs组件的各项功能及其协同效果，以及与其他组件或数据的联动。

本文将从以下几个方面进行介绍。

* [布局方式](arkts-navigation-tabs.md#布局方式)
* [Tabs显示排版](arkts-navigation-tabs.md#tabs显示排版)
* [Tabs滑动](arkts-navigation-tabs.md#tabs滑动)
* [Tabs页签加载/更新](arkts-navigation-tabs.md#tabs页签加载更新)
* [Tabs切换动效](arkts-navigation-tabs.md#tabs切换动效)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/41/v3/meGEcclmRtOso_dB7Fu3xA/zh-cn_image_0000002727750128.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/qYOSzn6OTOa5KEw_qFXrGw/zh-cn_image_0000002757309843.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/SbBNACr5Qg-nL6oZarf8gA/zh-cn_image_0000002757229963.gif)
...
底部导航栏可通过设置TabContent的[BottomTabBarStyle](../harmonyos-references/ts-container-tabcontent.md#bottomtabbarstyle9)来实现底部页签样式，详细示例请参考：[示例8（设置底部页签使用symbol图标）](../harmonyos-references/ts-container-tabcontent.md#示例8设置底部页签使用symbol图标)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/Ifq1BbVzTm2aa8kk7UkvsQ/zh-cn_image_0000002727590272.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/RaDryHa9TIuSBM2lDWTGLw/zh-cn_image_0000002727750130.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/5TnzClgxQ1e9Uc2dOC51lg/zh-cn_image_0000002757309845.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/GCwzBVvPSSiGzdrGDLlPDg/zh-cn_image_0000002757229965.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/GDRwQkInSTi9U1unDbDtYQ/zh-cn_image_0000002727590274.gif)
...
* 通过设置Tabs组件的[barOverlap](../harmonyos-references/ts-container-tabs.md#baroverlap10)属性，可以实现TabBar变模糊并叠加在TabContent之上，并且配合[barBackgroundBlurStyle](../harmonyos-references/ts-container-tabs.md#barbackgroundblurstyle11)属性实现毛玻璃效果。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/VCr5yGW7S6uOfWRaYmsOdw/zh-cn_image_0000002727750132.gif)
* 通过[barModifier](../harmonyos-references/ts-container-tabs.md#tabsoptions15)设置tabBar的clip属性，实现页签超出tabBar区域显示效果。详情请参见[页签超出TabBar区域显示](../harmonyos-references/ts-container-tabs.md#示例15页签超出tabbar区域显示)。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/FUTXJp27QjaW-_vDTaeaVQ/zh-cn_image_0000002757309847.gif)
* 通过配置[fadingEdge](../harmonyos-references/ts-container-tabs.md#fadingedge10)(true)实现TabBar边缘渐隐。详情请参见[设置TabBar渐隐](../harmonyos-references/ts-container-tabs.md#示例5设置tabbar渐隐)。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/wKqwWUfRSA6_uC0SwG0XyA/zh-cn_image_0000002757229967.gif)
* 通过TabsController的[setTabBarTranslate()](../harmonyos-references/ts-container-tabs.md#settabbartranslate13)、[setTabBarOpacity()](../harmonyos-references/ts-container-tabs.md#settabbaropacity13)方法可以设置TabBar偏移量及透明度。详情请参见[设置TabBar平移距离和不透明度](../harmonyos-references/ts-container-tabs.md#示例12设置tabbar平移距离和不透明度)。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/CpDxqXfiT3-oCqOftG8ugw/zh-cn_image_0000002727590276.jpg)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/pmn5h79gRXWc8C8WBTgMiA/zh-cn_image_0000002727750134.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/61/v3/nSI-Ll47S-aOvt5bTOJNtw/zh-cn_image_0000002757309849.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/08/v3/LMv1ZjawQe6V5Ign98_v6w/zh-cn_image_0000002757229969.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/l4AQrmpFTtC4J3rO2shInQ/zh-cn_image_0000002727590278.gif)
...
设置barMode属性为BarMode.Scrollable，并利用[Stack](arkts-layout-development-stack-layout.md)布局在TabBar右上角添加更多按钮。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2/v3/1mLLNtQuSJahELY2qA4Bww/zh-cn_image_0000002727750136.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/qdR0cf5CTQaNOg1bmNhUKA/zh-cn_image_0000002757309851.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/64/v3/4FzEM9PYQ1egEf13ncoUoA/zh-cn_image_0000002757229971.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/MFRpZy7mSKGr6GDjdR3tbw/zh-cn_image_0000002727590280.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/1u3rC8JyQRG2swH1gtMOQw/zh-cn_image_0000002727750138.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/46/v3/8DPcXHqZQnigOREtEtzN3Q/zh-cn_image_0000002757309853.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/iGxfDmSvSm-acAcAgKQuFA/zh-cn_image_0000002757229973.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e3/v3/yTsDStpISq6zT3QJT2HJNQ/zh-cn_image_0000002727590282.gif)
...
1. 如图所示，使用默认翻页动画，CACHE\_BOTH\_SIDE模式，n设置为2，点击TabBar切换到yellow页，TabContent1~3被缓存。再切换到red页，TabContent1、2释放，TabContent3~5被缓存。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/98/v3/aw_n7WETTfyDXxWdER0GkA/zh-cn_image_0000002727750140.png)
2. 如图所示，使用默认翻页动画，CACHE\_LATEST\_SWITCHED模式，n设置为2，点击TabBar切换到yellow页，TabContent1、3被缓存，TabContent2释放。再切换到red页，TabContent1、3、5被缓存，TabContent4释放。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/j8KSk1ufRMakkp3wiaAiYw/zh-cn_image_0000002757309855.png)
3. 如图所示，关闭翻页动画，CACHE\_BOTH\_SIDE模式，n设置为2，点击TabBar切换到yellow页，TabContent1、3被缓存。再切换到red页，TabContent3、5被缓存，TabContent1释放。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/fN6E7DIqTpSj5kqETr_oUg/zh-cn_image_0000002757229975.png)
4. 如图所示，关闭翻页动画，CACHE\_LATEST\_SWITCHED模式，n设置为2，点击TabBar切换到yellow页，TabContent1、3被缓存。再切换到red页，TabContent1、3、5被缓存。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/0Dx6zhkdTp-TJLrc2FCnnw/zh-cn_image_0000002727590284.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/wM-d8lIaTYKbeTTi33ci-g/zh-cn_image_0000002727750142.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/dAFLALhLThOrCf0UOlct0w/zh-cn_image_0000002757309857.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/jB8EfeRXTcWKhOUta8cAsA/zh-cn_image_0000002757229977.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/sFEAlkOHSNeNb_gtYpxMSg/zh-cn_image_0000002727590286.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/46/v3/vSBO0Jo8Q8ynmjCPt5qSAQ/zh-cn_image_0000002727750144.png)
