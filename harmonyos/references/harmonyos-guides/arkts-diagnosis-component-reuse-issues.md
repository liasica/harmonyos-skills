...
content_hash: sha256:59c56f7460844e14a98ea226f0e316f53cc89e011f0aaf128be354433365a687
---
...
2. 本文展示的[正反例代码](https://gitcode.com/harmonyos_samples/BestPracticeSnippets/tree/master/ComponentReuse)分别位于positive和negative模块中，检测时需选择相应模块。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/F7oHuR2fRC6Gi1rZsSJKqw/zh-cn_image_0000002747209867.png)
3. 点击工具“手动性能页面滑动体检”，按照提示进行检测操作。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/Aw4r3_UfSHKzmHEkI69Ikg/zh-cn_image_0000002717769934.png)
4. 通过分析检测结果，结合滑动过程中列表卡片的创建次数，可以分析出当前列表的组件未使用复用或者复用未生效。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0c/v3/QRCRpfw6TaeBcv5uMoliFQ/zh-cn_image_0000002717610000.png)
...
* **场景一：列表项结构类型相同**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fe/v3/j-05jtS4R9-kchRd_pURVw/zh-cn_image_0000002747289951.png)
...
* **场景二：列表项结构类型不同**
  ...
  **①"总-分式"子组件可变结构**：ListItem的根组件只有一个，且根组件整体结构组成不变，局部子组件进行替换。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/52PgiXQ7Tp-7_tIlPChC-g/zh-cn_image_0000002747209869.png)
  ...
  **②分类组合式结构**：ListItem的根组件有多种类型，不同类型的根组件布局组成不同。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/ytmcUQKsQqCuTXWDhcK65Q/zh-cn_image_0000002717769936.png)
...
* **场景三：列表项内子组件可拆分组合**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/56/v3/lMsGaagMTl67FnRM_ZG6Bw/zh-cn_image_0000002717610002.png)
...
* **场景一：父组件未使用复用，子组件使用复用**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/b0h5tLHOQZK_YRwbxngFzQ/zh-cn_image_0000002747289953.png)
...
* **场景二：复用嵌套**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/9FCi1CW8Q3eVKVhhY4PN1g/zh-cn_image_0000002747209871.png)
...
* **场景三：reuseId分类过粗**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/1F8jh6DUSbe_3Ftt6oFYOw/zh-cn_image_0000002717769938.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/07/v3/7dWwWRrtS1ymuxrb2f9mqA/zh-cn_image_0000002717610004.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5d/v3/0yy_8unER-Wg-o3MQ0dNwA/zh-cn_image_0000002747289955.png)

上述案例中，BuildRecycle是典型的复用成功回调，此处执行耗时过长造成了应用丢帧，虽然当前操作在帧间，但是长耗时仍然会影响下一帧的执行。通过耗时函数检测，可以定位到具体的耗时方法。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/3Z9jdUy5R6ux8OwBQ8TwyA/zh-cn_image_0000002747209873.png)
