...
content_hash: sha256:3919a3eff788c333348e8eeed9ab3f42ed7a432690e0c9edbb5cc8c43499864f
---
...
HAR可以作为二方库和三方库提供给其他应用使用，如果需要对代码资产进行保护，建议按照[HAR包混淆建议](source-obfuscation-practice.md#har包混淆建议)来进行源码混淆。
