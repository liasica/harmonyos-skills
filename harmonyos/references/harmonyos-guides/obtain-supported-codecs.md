...
content_hash: sha256:e8cf74c72ae53f8b510c69fc772b348953ef57576515162d5d9a7f2ba9299fb4
---
...
3. 获得音视频编解码能力实例。
   ...
   方式一：通过[OH\_AVCodec\_GetCapability](../harmonyos-references/capi-native-avcapability-h.md#oh_avcodec_getcapability)获取系统推荐的音视频编解码器能力实例。
   ...
   方式二：通过[OH\_AVCodec\_GetCapabilityByCategory](../harmonyos-references/capi-native-avcapability-h.md#oh_avcodec_getcapabilitybycategory)获取指定软硬件的编解码能力实例。
   ...
   方式三：从API version 24开始，开发者可调用[OH\_AVCodec\_GetCapabilityList](../harmonyos-references/capi-native-avcapability-h.md#oh_avcodec_getcapabilitylist)接口，获取指定编解码器类型（如视频解码器）的全量能力实例列表。
...
| 接口 | 功能描述 |
| --- | --- |
| OH\_AVCapability\_GetName | 获取对应的编解码器名称。 |
...
| OH\_AVCapability\_GetEncoderBitrateRange | 获取当前编码器支持的码率范围，适用于CBR、VBR、SQR和CBRHQ码控模式。 |
...
编解码标准包含多种编码工具，适用于不同的编码场景。对于特定应用场景，编解码标准按档次确定所需编码工具的开启与关闭情况（例如，H.264有基本档次、高档次和主档次）。详情参见 [OH\_AVCProfile](../harmonyos-references/capi-native-avcodec-base-h.md#oh_avcprofile)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/XYVs3FwTTqOAp0Hn1ctR_Q/zh-cn_image_0000002706674550.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/MccL0wRjTWKJhaTwLth9OQ/zh-cn_image_0000002736433639.png)
...
| OH\_AVCapability\_GetVideoSupportedNativeBufferFormats | 获取视频编解码器支持的OH\_NativeBuffer格式。 |
