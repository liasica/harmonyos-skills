---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ohos-abi
title: HarmonyOS ABI
...
采用IEEE754作为浮点编码格式，针对long double的格式定义，将在[支持架构ABI](ohos-abi.md#支持架构abi)具体说明。
...
当前通过[DevEco Studio构建NDK工程](build-with-ndk-ide.md)时，不支持armeabi-v7a编译环境。如需要在HarmonyOS中使用该编译环境，需要通过[CMake方式构建](build-with-ndk-cmake.md)。
