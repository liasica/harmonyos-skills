...
content_hash: sha256:fcc828420d69fc5a21f2472ac275c583981e820a235d9770db804ce035319b1b
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/JK_T3r7dT9OoDQMciat-6g/zh-cn_image_0000002583437597.gif?HW-CC-KV=V1&HW-CC-Date=20260427T233859Z&HW-CC-Expire=86400&HW-CC-Sign=5608C9B267B564B1C6B5293C6A2CF7B6E0DCF9C53DC69DE178F4650CA5AA4725)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/liW07jSKS4-SrHPCgSgOiw/zh-cn_image_0000002583437633.png?HW-CC-KV=V1&HW-CC-Date=20260427T233859Z&HW-CC-Expire=86400&HW-CC-Sign=E6E154C3FEB548E8FD6106C2F94DC9C82CAE61C9C9F3CFDAD47137C9E36B7703)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/52/v3/28kikfMARjmgs6PwdM5cKw/zh-cn_image_0000002552957588.png?HW-CC-KV=V1&HW-CC-Date=20260427T233859Z&HW-CC-Expire=86400&HW-CC-Sign=7E76EF4B134B98685123C91B73A891513842C35A7C7984AFEECFA8BFF9E7E621)
...
[管理组件拥有的状态](arkts-v1-component-state-management.md)，即图中Components级别的状态管理：
...
[管理应用拥有的状态](arkts-v1-application-state-management.md)，即图中Application级别的状态管理：
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a5/v3/E87KvLrmRbCss15gh5DerA/zh-cn_image_0000002583477589.png?HW-CC-KV=V1&HW-CC-Date=20260427T233859Z&HW-CC-Expire=86400&HW-CC-Sign=566D48E64C799831670665D3C9FDF4A3AC7E1F97A8BA416C92DE24734ED6B107)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6a/v3/r2-NM7HxR8yObcXBgSLKJg/zh-cn_image_0000002552797940.png?HW-CC-KV=V1&HW-CC-Date=20260427T233859Z&HW-CC-Expire=86400&HW-CC-Sign=A1577EA03B2B86BD506DF702FC582E07182596153C0A40E400983938265B82EA)
...
| 自定义组件生命周期 | 自定义组件生命周期 | 均支持。[aboutToAppear](../harmonyos-references/ts-custom-component-lifecycle.md#abouttoappear)、[onDidBuild](../harmonyos-references/ts-custom-component-lifecycle.md#ondidbuild12)、[aboutToDisappear](../harmonyos-references/ts-custom-component-lifecycle.md#abouttodisappear)。 |
| 页面生命周期 | 页面生命周期 | 均支持。[onPageShow](../harmonyos-references/ts-custom-component-lifecycle.md#onpageshow)、[onPageHide](../harmonyos-references/ts-custom-component-lifecycle.md#onpagehide)、[onBackPress](../harmonyos-references/ts-custom-component-lifecycle.md#onbackpress)。 |
| @Reusable | @ReusableV2 | 组件复用。包括：[aboutToReuse](../harmonyos-references/ts-custom-component-lifecycle.md#abouttoreuse10)、[aboutToRecycle](../harmonyos-references/ts-custom-component-lifecycle.md#abouttorecycle10)。 |
| $$ | !! | 双向绑定。V2建议使用!!实现双向绑定。 |
| @CustomDialog | [openCustomDialog](../harmonyos-references/arkts-apis-uicontext-promptaction.md#opencustomdialog12)接口 | 自定义弹窗。V2建议使用openCustomDialog实现自定义弹窗功能。 |
| WithTheme | WithTheme | 主题。用于设置应用局部页面自定义主题风格。包括：[onWillApplyTheme](../harmonyos-references/ts-custom-component-lifecycle.md#onwillapplytheme12)。  从API version 18开始，该接口支持在状态管理V2组件中使用。 |
| 系统预置UI组件库 | 系统预置UI组件库 | 系统预置UI组件库 。支持V1的系统预置UI组件，例如：[Dialog](../harmonyos-references/ohos-arkui-advanced-dialog.md)、[ProgressButton](../harmonyos-references/ohos-arkui-advanced-progressbutton.md)、[SegmentButton](../harmonyos-references/ohos-arkui-advanced-segmentbutton.md)。  从API version 18开始，系统预置UI组件支持在状态管理V2组件中使用，例如：[DialogV2](../harmonyos-references/ohos-arkui-advanced-dialogv2.md)、[ProgressButtonV2](../harmonyos-references/ohos-arkui-advanced-progressbuttonv2.md)、[SegmentButtonV2](../harmonyos-references/ohos-arkui-advanced-segmentbuttonv2.md)。 |
...
有关V1向V2的迁移可参考[迁移指导](arkts-v1-v2-migration.md)，有关V1与V2的混用可参考[状态管理V1和V2混用场景](v1v2-mixing.md)。
