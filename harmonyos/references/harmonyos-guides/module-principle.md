---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-principle
title: 模块化运行简介
breadcrumb: 指南 > 应用框架 > ArkTS（方舟编程语言） > ArkTS运行时 > ArkTS模块化 > 模块化运行简介
category: harmonyos-guides
scraped_at: 2026-04-28T07:38:44+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:b655d73ed5f96a5a8e4a9785b985a6ae795434142930b7911b6b04b42aea4af3
---

为了解决大型或复杂应用开发过程中，部分代码编译时被多次拷贝导致包体积增大、文件依赖、代码与资源共享困难以及单例和全局变量污染等问题，ArkTS支持应用模块化编译、打包和运行，简化代码的编写与维护。

模块化是将ArkTS/TS/JS模块（一个文件对应一个模块）以及so模块通过编译工具或运行时机制将这些[模块加载](module-principle.md#模块化运行加载流程)、解析、组合并执行的过程。

ArkTS支持的模块类型包括ets/ts/js文件、json文件、Native模块。ArkTS中支持[ECMAScript模块规范](module-principle.md#ecmascript模块)及[CommonJS模块规范](module-principle.md#commonjs模块)，此外，ArkTS也对加载方式进行了拓展，包含[动态加载](arkts-dynamic-import.md)、静态加载、[延迟加载](arkts-lazy-import.md)、[同步动态加载Native模块](js-apis-load-native-module.md)和[Node-API接口加载文件](load-module-base-nodeapi.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/sZRcmhcASJicXvlSO2M6rw/zh-cn_image_0000002552957540.png?HW-CC-KV=V1&HW-CC-Date=20260427T233843Z&HW-CC-Expire=86400&HW-CC-Sign=0FEA6041F1B58E4542D8BBD040C3F989EC98529DEC5F77D9A6932A12A9A419F5)
...
ArkTS中export和import用法详见[ArkTS语言介绍](introduction-to-arkts.md#模块)。
...
加载ets/ts/js模块类型时，需遵循[ECMAScript模块规范](module-principle.md#ecmascript模块)及[CommonJS模块规范](module-principle.md#commonjs模块)。
