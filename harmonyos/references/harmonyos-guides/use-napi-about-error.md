...
content_hash: sha256:ba0f117295ec0ca08b75120744c19083b9fbe1a4278a97b663ff9a71e41a0a05
---
...
[napi\_throw\_business\_error](../harmonyos-references/napi.md#napi_throw_business_error)用于抛出一个带文本信息的ArkTS Error，其错误对象的code属性类型为number。该接口抛出的是一个原生的Error对象，并不是ArkTS的SDK中声明的BusinessError对象。
