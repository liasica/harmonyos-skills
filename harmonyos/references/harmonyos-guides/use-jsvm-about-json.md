...
content_hash: sha256:8c5ee11200f7918cac169ebbda59fbea62b859a58a01c3ae2463b03bee69e280
---
...
| 接口 | 功能说明 |
| --- | --- |
| OH\_JSVM\_JsonParse | 解析JSON字符串，并将结果存储在JSON对象中。 |
| OH\_JSVM\_JsonStringify | 将对象字符串化，并将结果存储在JSVM字符串对象中。 |
