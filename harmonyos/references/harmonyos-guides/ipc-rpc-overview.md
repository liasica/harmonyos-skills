---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ipc-rpc-overview
title: IPC Kit简介
...
* 单个设备上跨进程通信时，传输的数据量最大为200KB。超过200KB的数据量传输可以使用[匿名共享内存](../harmonyos-references/js-apis-rpc.md#ashmem8)。
