...
content_hash: sha256:6149570fdf65196e5b0ea4a5e0afa673b1f008a877beedc17b75a8465302dfee
---
...
1. 新建工程时选择API 10及以上的Stage模型，工程创建完成后，新建“Static Library”模块。模块创建方法可参考[在工程中添加Module](ide-add-new-module.md)。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/sw7O-ixkS26ThNxxDxL-Cw/zh-cn_image_0000002701823236.png)
2. 编写代码。
...
2. 在HAR模块的build-profile.json5中，将byteCodeHar设置为true。
   ...
   ```
3. 点击DevEco Studio右上角图标![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/vDEwhjJ_QIKlqRxoGt_Znw/zh-cn_image_0000002731382523.png)，选择**Build Mode，**默认为**<Default>**模式：在编译App时使用release模式，编译HAP/HSP/HAR时使用debug模式。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/99/v3/GdrSeaJeTzOo0f_nw4-qOg/zh-cn_image_0000002701663318.png)
...
6. 选中HAR模块的根目录，点击**Build > Make Module '<module-name>'**启动构建。
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/45/v3/KsN5VshFSdyN5dkpOjtrOw/zh-cn_image_0000002731542499.png)

   构建完成后，build目录下生成HAR包产物。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/hHTlBnVFQjiInks5frUhRA/zh-cn_image_0000002701663296.png)

   HAR包产物解压后，结构如下：

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e8/v3/2jaQNTusSVqRCgVMfsmnRA/zh-cn_image_0000002731382529.png)
...
2. 点击DevEco Studio右上角图标![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f7/v3/VhroOiimTxK2bBT1L_Gr-Q/zh-cn_image_0000002731542495.png)，**Build Mode**选择**debug。**默认为**<Default>**模式：在编译App时使用release模式，编译HAP/HSP/HAR时使用debug模式。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/VuKdMEyqRY2awb_-BgKPrQ/zh-cn_image_0000002731542511.png)
3. （可选）若部分工程源文件无需构建到HAR包中，可在模块目录下新建.ohpmignore文件，或者在模块目录下的.gitignore文件中，配置打包时要忽略的文件，.ohpmignore文件中支持正则表达式写法，.gitignore文件中支持glob语法。DevEco Studio构建时将过滤掉.ohpmignore或.gitignore文件中所包含的文件/文件夹。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a/v3/tjAg-BlWS_K6s2duIMQaNA/zh-cn_image_0000002731542513.png)
...
5. 选中HAR模块的根目录，点击**Build > Make Module '<module-name>'**启动构建。
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/Qo7bpvP2S3aRnB5qR79yNQ/zh-cn_image_0000002701663312.png)

   构建完成后，build目录下生成HAR包产物。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/AAPtWM2aT9eXeKvIZY8laA/zh-cn_image_0000002731382521.png)

   HAR包产物解压后，结构如下：

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/Ton4NLEdQ16XcehJXcQtrA/zh-cn_image_0000002731542505.png)
...
1. 在HAR模块的build-profile.json5中，将byteCodeHar设置为false。
   ...
   **说明** 
   ...
   使用DevEco Studio NEXT Beta1（5.0.3.800）之前的版本，模块级build-profile.json5的byteCodeHar字段的缺省默认值为false，无需执行本步骤。
2. 点击DevEco Studio右上角图标![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e8/v3/m1DszQh7QceoVN03mAjRKg/zh-cn_image_0000002701823240.png)，**Build Mode**中选择**release。**默认为**<Default>**模式：在编译App时使用release模式，编译HAP/HSP/HAR时使用debug模式。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/XUgxv_AQQaaa_qMdAxFbmw/zh-cn_image_0000002701663322.png)
...
5. 选中HAR模块的根目录，点击**Build > Make Module '<module-name>'**启动构建。
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/PCiKShdLQzaNijnu05KBVQ/zh-cn_image_0000002701823220.png)

   构建完成后，build目录下生成HAR包产物。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/liVp49CfT3yhuCqckSftqg/zh-cn_image_0000002701663314.png)

   HAR包产物解压后，结构如下：

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/IQCGxL05QR2ARAIUCN0HBA/zh-cn_image_0000002731542515.png)
...
3. 选中HAR模块的根目录，点击**Build > Make Module '<module-name>'**启动构建。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/0DDvIKOPT--ZO9WEoqQOWw/zh-cn_image_0000002701823226.png)

   构建完成后，build目录下生成签名HAR包产物。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/fkMqul_QRUWaVYClHod48A/zh-cn_image_0000002701823222.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/oZLmI14LRyen10n-miRKVA/zh-cn_image_0000002701823232.png)

配置bundledAllDependencies为true后，HAR包的oh-package.json5中的dependencies也会被消除：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/ab7DnvlUSMacULKnDL7Zfw/zh-cn_image_0000002731542497.png)
