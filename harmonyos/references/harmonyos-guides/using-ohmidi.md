---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/using-ohmidi
...
* 客户端管理接口：[OH\_MIDIClient\_Create](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_create)、[OH\_MIDIClient\_Destroy](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_destroy)。
* 设备管理接口：[OH\_MIDIClient\_GetDeviceCount](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_getdevicecount)、[OH\_MIDIClient\_GetDeviceInfos](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_getdeviceinfos)、[OH\_MIDIClient\_OpenDevice](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_opendevice)、[OH\_MIDIClient\_CloseDevice](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_closedevice)。
* 端口管理接口：[OH\_MIDIClient\_GetPortCount](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_getportcount)、[OH\_MIDIClient\_GetPortInfos](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_getportinfos)、[OH\_MIDIDevice\_OpenInputPort](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_openinputport)、[OH\_MIDIDevice\_OpenOutputPort](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_openoutputport)、[OH\_MIDIDevice\_CloseInputPort](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_closeinputport)、[OH\_MIDIDevice\_CloseOutputPort](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_closeoutputport)。
* 数据传输接口：[OH\_MIDIDevice\_Send](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_send)、[OH\_MIDIDevice\_SendSysEx](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_sendsysex)。
* 回调接口：[OH\_MIDICallback\_OnDeviceChange](../harmonyos-references/capi-native-midi-base-h.md#oh_midicallback_ondevicechange)、[OH\_MIDIDevice\_OnReceived](../harmonyos-references/capi-native-midi-base-h.md#oh_mididevice_onreceived)。
...
系统已定义[OH\_MIDICallbacks](../harmonyos-references/capi-ohmidi-oh-midicallbacks.md)结构体，开发者需要实现其中的回调函数：

* onDeviceChange：当MIDI设备连接或断开时由系统自动调用。开发者在此回调中处理设备的接入和移除逻辑。
* onError：当MIDI服务发生错误时调用。开发者在此回调中处理错误日志记录和异常恢复逻辑，如重新创建客户端。

通过调用[OH\_MIDIClient\_Create](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_create)接口创建MIDI客户端实例，传入回调结构体和用户数据。
...
通过调用[OH\_MIDIClient\_Destroy](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_destroy)接口销毁MIDI客户端实例，释放所有关联资源。
...
1. 获取设备数量：调用[OH\_MIDIClient\_GetDeviceCount](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_getdevicecount)接口获取当前连接的设备数量。
2. 获取设备信息：分配足够大的缓冲区，调用[OH\_MIDIClient\_GetDeviceInfos](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_getdeviceinfos)接口填充设备详细信息。
...
通过[OH\_MIDIClient\_GetDeviceCount](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_getdevicecount)接口获取设备数量，再通过[OH\_MIDIClient\_GetDeviceInfos](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_getdeviceinfos)接口获取设备详细信息。
...
需要打开设备才能进行数据传输。根据设备类型不同，打开方式有所区别：USB MIDI设备通过[OH\_MIDIClient\_OpenDevice](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_opendevice)接口同步打开，BLE MIDI设备通过[OH\_MIDIClient\_OpenBLEDevice](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_openbledevice)接口异步打开。

**打开USB MIDI设备（同步）**

通过[OH\_MIDIClient\_OpenDevice](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_opendevice)接口同步打开USB MIDI设备，传入设备ID获取设备句柄。
...
BLE MIDI设备的打开是异步操作，使用[OH\_MIDIClient\_OpenBLEDevice](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_openbledevice)接口。
...
通过[OH\_MIDIClient\_OpenBLEDevice](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_openbledevice)接口异步打开BLE MIDI设备，传入设备MAC地址和结果回调。
...
通过[OH\_MIDIClient\_OnDeviceOpened](../harmonyos-references/capi-native-midi-base-h.md#oh_midiclient_ondeviceopened)回调接收BLE设备打开结果，在回调中获取设备句柄和设备信息。
...
通过[OH\_MIDIClient\_CloseDevice](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_closedevice)接口关闭已打开的MIDI设备，释放设备资源。
...
通过[OH\_MIDIClient\_GetPortCount](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_getportcount)接口获取端口数量，再通过[OH\_MIDIClient\_GetPortInfos](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_getportinfos)接口获取端口详细信息。
...
通过[OH\_MIDIDevice\_OnReceived](../harmonyos-references/capi-native-midi-base-h.md#oh_mididevice_onreceived)回调接收MIDI数据，回调中获取事件数组及其数据。
...
通过[OH\_MIDIDevice\_OpenInputPort](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_openinputport)接口打开输入端口，传入[OH\_MIDIPortDescriptor](../harmonyos-references/capi-ohmidi-oh-midiportdescriptor.md)结构配置端口参数，并注册数据接收回调。
...
使用[OH\_MIDIDevice\_CloseInputPort](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_closeinputport)接口关闭已打开的输入端口。关闭端口后，该端口将不再接收MIDI消息，注册的回调函数也将不再被调用。
...
通过[OH\_MIDIDevice\_OpenOutputPort](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_openoutputport)接口打开输出端口，传入[OH\_MIDIPortDescriptor](../harmonyos-references/capi-ohmidi-oh-midiportdescriptor.md)结构配置端口参数和协议。
...
使用[OH\_MIDIDevice\_CloseOutputPort](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_closeoutputport)接口关闭已打开的输出端口。关闭端口后，将无法再通过该端口发送MIDI消息。
...
发送MIDI消息需要先构造UMP（Universal MIDI Packet）格式的数据，再通过[OH\_MIDIDevice\_Send](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_send)接口发送。UMP是Universal MIDI Packet的缩写，是MIDI 2.0标准统一使用的数据包格式。

**发送自定义MIDI消息**

构造[OH\_MIDIEvent](../harmonyos-references/capi-ohmidi-oh-midievent.md)事件数组，通过[OH\_MIDIDevice\_Send](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_send)接口发送MIDI消息。
...
系统独占消息（System Exclusive）：用于传输制造商特定的数据。使用[OH\_MIDIDevice\_SendSysEx](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_sendsysex)接口可以发送超过常规MIDI消息长度的SysEx消息。
...
通过[OH\_MIDIDevice\_FlushOutputPort](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_flushoutputport)接口清空指定端口的输出缓冲区，丢弃所有待发送消息。
...
11. 资源释放顺序：OH\_MIDIClient\_Destroy()会自动关闭所有已打开的设备和端口。但如果初始化过程中发生错误需要提前退出函数，应按以下顺序手动释放资源：
    ...
    第一步：关闭已打开的端口（[OH\_MIDIDevice\_CloseInputPort](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_closeinputport)/[OH\_MIDIDevice\_CloseOutputPort](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_closeoutputport)）。详见[midi端口管理](using-ohmidi.md#midi端口管理)中的关闭输入端口和关闭输出端口示例

    第二步：关闭已打开的设备（[OH\_MIDIClient\_CloseDevice](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_closedevice)）。详见[关闭MIDI设备](using-ohmidi.md#关闭midi设备)示例。

    第三步：销毁客户端（[OH\_MIDIClient\_Destroy](../harmonyos-references/capi-native-midi-h.md#oh_midiclient_destroy)）。详见[销毁MIDI客户端](using-ohmidi.md#销毁midi客户端)示例。
...
2. 缓冲区未及时处理：考虑使用[OH\_MIDIDevice\_FlushOutputPort](../harmonyos-references/capi-native-midi-h.md#oh_mididevice_flushoutputport)接口清空缓冲区。
...
* [OH\_MIDI开发概述(C/C++)](midi-overview.md)
* [OHMIDI](../harmonyos-references/capi-ohmidi.md)API参考
* [native\_midi.h](../harmonyos-references/capi-native-midi-h.md)
* [native\_midi\_base.h](../harmonyos-references/capi-native-midi-base-h.md)
* [通用错误码](../harmonyos-references/errorcode-universal.md)说明
* 蓝牙BLE开发指南：[查找设备](ble-development-guide.md)
