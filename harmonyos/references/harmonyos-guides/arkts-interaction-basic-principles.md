...
content_hash: sha256:a02af7e241db57dd34dffdff12c2d8dd237c7e88dde09a77d3d952492970c1c9
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/LEYTEU7GRouf8FtdoUKSfQ/zh-cn_image_0000002743378612.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4f/v3/WsN0RA1tQ1afg4Q73V9zTw/zh-cn_image_0000002743218726.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/P6pxwzXEQz6xc34ORLl6Cw/zh-cn_image_0000002772737979.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/davjkOh4Q06r6iQgl_eq4g/zh-cn_image_0000002772897863.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/7uN31iheQkmUH-6Rdv-QMA/zh-cn_image_0000002743378614.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/YjEw8-XHTKWEZimo2HZcnQ/zh-cn_image_0000002743218728.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4e/v3/vXLJlDGDQamMTxMb45hYYw/zh-cn_image_0000002772737981.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/18/v3/nWs_IY1EQHy3Lt_fZuWYUw/zh-cn_image_0000002772897865.png)
...
1. 触摸热区设置
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/ZQQ0jk6YS8SNd2INgUX2EA/zh-cn_image_0000002743378616.png)
2. 触摸测试控制
   ...
   * HitTestMode.Default：默认不配置hitTestBehavior属性，自身如果命中会阻塞兄弟组件，但是不阻塞子组件。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/39/v3/dG9epY9sRB-2mSMO_zBZZQ/zh-cn_image_0000002743218730.png)
   * HitTestMode.None：自身不接收事件，但不会阻塞兄弟组件或子组件继续做触摸测试。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/XlH4wO-PQP6CILrIzkyQ-Q/zh-cn_image_0000002772737983.png)
   * HitTestMode.Block：阻塞子组件的触摸测试，如果自身触摸测试命中，会阻塞兄弟组件及父组件的触摸测试。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/PYNNCY_VTNazh3SxOnBGdg/zh-cn_image_0000002772897867.png)
   * HitTestMode.Transparent：自身进行触摸测试，同时不阻塞兄弟组件及父组件。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/64/v3/nBujHRKjTFqDhfNKkNELyA/zh-cn_image_0000002743378618.png)
   * HitTestMode.BLOCK\_HIERARCHY（从API version 20开始支持）: 自身和子节点响应触摸测试，阻止所有优先级较低的兄弟节点和父节点参与触摸测试。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/08/v3/ripW__VnSHi0BWbXhKT7Rw/zh-cn_image_0000002743218732.png)
   * HitTestMode.BLOCK\_DESCENDANTS（从API version 20开始支持）: 自身不响应触摸测试，并且所有的后代（孩子，孙子等）也不响应触摸测试，不会影响祖先节点的触摸测试。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7e/v3/1Ndoog-zS1qSjHrKf40kvg/zh-cn_image_0000002772737985.png)
3. 自定义事件拦截
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/yE7VMPBjRjCYDw2TaUqhBg/zh-cn_image_0000002772897869.png)
