...
content_hash: sha256:f15b4b4ad9b60d8f6599107a32a2fe8f8fb68e56002735a5bd00d8ae19ae7b2a
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/JdA_kHFWSTCnTXfcoYn8GQ/zh-cn_image_0000002757310107.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/61/v3/oYfrg9FcReexXttSQAc1jg/zh-cn_image_0000002757230227.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/66/v3/MrgKgjFhSeebAMilqhhxTg/zh-cn_image_0000002727590536.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/tICV-9RdRFCJsTYS9hUDHQ/zh-cn_image_0000002727750394.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9d/v3/0ul1KMLyS_yiokSxgMoOFg/zh-cn_image_0000002757310109.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/5g3xTE4mSoaC35s0j29u6g/zh-cn_image_0000002757230229.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0/v3/Ag9tjGDZSxGvKEyshoLcAg/zh-cn_image_0000002727590538.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/JwOVE4FkRYSdLPVadcS6GQ/zh-cn_image_0000002727750396.png)
...
1. 触摸热区设置
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/U8zxztfSRr-FDv8QE5zkFg/zh-cn_image_0000002757310111.png)
2. 触摸测试控制
   ...
   * HitTestMode.Default：默认不配置hitTestBehavior属性，自身如果命中会阻塞兄弟组件，但是不阻塞子组件。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/Ko63z1yoR9y980YDR7dAww/zh-cn_image_0000002757230231.png)
   * HitTestMode.None：自身不接收事件，但不会阻塞兄弟组件或子组件继续做触摸测试。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f7/v3/AYWAVeiVQyCj2qlb66O7jw/zh-cn_image_0000002727590540.png)
   * HitTestMode.Block：阻塞子组件的触摸测试，如果自身触摸测试命中，会阻塞兄弟组件及父组件的触摸测试。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/82/v3/isD1paEhTeyZFgZ2Xro3Yg/zh-cn_image_0000002727750398.png)
   * HitTestMode.Transparent：自身进行触摸测试，同时不阻塞兄弟组件及父组件。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/ClP3eBx2ScarmGvXsF9FXQ/zh-cn_image_0000002757310113.png)
   * HitTestMode.BLOCK\_HIERARCHY（从API version 20开始支持）: 自身和子节点响应触摸测试，阻止所有优先级较低的兄弟节点和父节点参与触摸测试。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/Xl8tUT7PRyKQrfPKB8_slQ/zh-cn_image_0000002757230233.png)
   * HitTestMode.BLOCK\_DESCENDANTS（从API version 20开始支持）: 自身不响应触摸测试，并且所有的后代（孩子，孙子等）也不响应触摸测试，不会影响祖先节点的触摸测试。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/DARBImTpTxuwl-jS04V4JA/zh-cn_image_0000002727590542.png)
3. 自定义事件拦截
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/zkkWVKZZTiG-o1-uje1k_A/zh-cn_image_0000002727750400.png)
