...
content_hash: sha256:3884f49b99bffd7c2be104008473e9d9110959bf4a18dc13cf46db2e804f15ec
---
...
* **使用函数类型限定符**
  ...
  **图1** 核函数（device侧执行）、host侧执行函数、device侧执行函数（除核函数之外的）调用关系
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6b/v3/aoqyYS2fQjOoXyoJEJbp8w/zh-cn_image_0000002727592092.png)
* **使用变量类型限定符**
