...
content_hash: sha256:bbd1ad8ffaad1a0b975c33596bcab12d47d3ecb2b522c1e4084b2bbdb84399b7
---
...
* **使用函数类型限定符**
  ...
  **图1** 核函数（device侧执行）、host侧执行函数、device侧执行函数（除核函数之外的）调用关系
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/EPKgimDhS72t0mhFGQp5fg/zh-cn_image_0000002723856352.png)
* **使用变量类型限定符**
