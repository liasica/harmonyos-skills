...
content_hash: sha256:b5c0ff74205ea5c9452e6094a3b287be2fda7798ffe5269765a70d7a2c34f8cb
---
...
* **GM**->**VECIN/VECOUT**
  ...
  **配置示例1：**
  ...
  + blockLen+leftPadding+rightPadding不满足32字节对齐时，框架会填充一些假数据dummy，保证左右填充的数据和blockLen、假数据为32字节对齐。leftPadding/rightPadding不为0：若isPad为false，左右两侧填充的数据值和dummy值均为随机值，否则为paddingValue。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/l6TUPBSDQYG45WIwUk2yMw/zh-cn_image_0000002717772128.png)
  ...
  **配置示例2：**
  ...
  + blockLen+leftPadding+rightPadding不满足32字节对齐，leftPadding/rightPadding不为0：若isPad为false，左右两侧填充的数据值和dummy值均为随机值，否则为paddingValue。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/A4ezy43eTiWVRGd_ZmF00g/zh-cn_image_0000002717612196.png)
* **VECIN/VECOUT**->**GM**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/3az6AVizSqy-8EXHmozDDw/zh-cn_image_0000002747292149.png)
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/bjLn0XY6RrK_IpS-gJotXw/zh-cn_image_0000002747212065.png)
* **VECIN/VECOUT->TSCM**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0d/v3/1sDsjLlfThW1hTyTdeufhA/zh-cn_image_0000002717772130.png)
