...
content_hash: sha256:571a797859b8dde2e8e0df858bf090f34cf58bcfceb6936a57bb9596784f3806
---
...
* **GM**->**VECIN/VECOUT**
  ...
  **配置示例1：**
  ...
  + blockLen+leftPadding+rightPadding不满足32字节对齐时，框架会填充一些假数据dummy，保证左右填充的数据和blockLen、假数据为32字节对齐。leftPadding/rightPadding不为0：若isPad为false，左右两侧填充的数据值和dummy值均为随机值，否则为paddingValue。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/Q9lcCmDSQrWnW220j4AB_w/zh-cn_image_0000002743220332.png)
  ...
  **配置示例2：**
  ...
  + blockLen+leftPadding+rightPadding不满足32字节对齐，leftPadding/rightPadding不为0：若isPad为false，左右两侧填充的数据值和dummy值均为随机值，否则为paddingValue。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d1/v3/0ySsuxojQN64a22AZ6Tbrw/zh-cn_image_0000002772739585.png)
* **VECIN/VECOUT**->**GM**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/v2jet__LRb2bJZlzm3P6PQ/zh-cn_image_0000002772899469.png)
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/i2hDj2e1Qt-S1qT_XYeu6g/zh-cn_image_0000002743380220.png)
* **VECIN/VECOUT->TSCM**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/20/v3/J_0j-m29T1eoup7KJIeJaQ/zh-cn_image_0000002743220334.png)
