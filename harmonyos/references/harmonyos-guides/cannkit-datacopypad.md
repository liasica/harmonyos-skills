...
content_hash: sha256:e4214ef46c96148ca3f41369d84ac46e130f3692e9a87180b43143fe173929dd
---
...
* **GM**->**VECIN/VECOUT**
  ...
  **配置示例1：**
  ...
  + blockLen+leftPadding+rightPadding不满足32字节对齐时，框架会填充一些假数据dummy，保证左右填充的数据和blockLen、假数据为32字节对齐。leftPadding/rightPadding不为0：若isPad为false，左右两侧填充的数据值和dummy值均为随机值，否则为paddingValue。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/55o0OnERTAG0ONUMzKK8bw/zh-cn_image_0000002717772128.png)
  ...
  **配置示例2：**
  ...
  + blockLen+leftPadding+rightPadding不满足32字节对齐，leftPadding/rightPadding不为0：若isPad为false，左右两侧填充的数据值和dummy值均为随机值，否则为paddingValue。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/dOIEKuaDQrGnI6eyJNksMg/zh-cn_image_0000002717612196.png)
* **VECIN/VECOUT**->**GM**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2c/v3/eeF7ocfMRIavoeJqINNnew/zh-cn_image_0000002747292149.png)
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/09/v3/gQxKBtg7T8KoKe0te6DYyw/zh-cn_image_0000002747212065.png)
* **VECIN/VECOUT->TSCM**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/tcfr6hsbSXKWxCVCa_cRAw/zh-cn_image_0000002717772130.png)
