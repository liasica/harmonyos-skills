...
| generateBuildHash | 标识当前HAP/HSP是否由打包工具生成哈希值。  该字段配置为true时，当前HAP/HSP会由打包工具生成对应的哈希值。系统OTA升级时，若应用的[version下的code](app-structure.md#version对象内部结构)保持不变时，可根据哈希值判断应用是否需要升级。  - true：表示当前HAP/HSP是由打包工具生成对应的哈希值。  - false：表示当前HAP/HSP不会由打包工具生成对应的哈希值。  **说明：**  该字段仅对预置应用生效。 | 布尔值 | 该标签可缺省，缺省值为false。 |
...
| 属性名称 | 含义 | 数据类型 | 是否可缺省 |
| --- | --- | --- | --- |
| moduleName | 标识当前HAP的名称，最大长度为31个字节。 在应用升级时，该名称允许修改，但需要应用适配Module相关数据目录的迁移，可使用[@ohos.file.fs (文件管理)](../harmonyos-references/js-apis-file-fs.md)接口。 | 字符串 | 不可缺省。 |
...
4. "type" : "Float",
5. "description" : "$string:parameters_description"
6. }],
7. "results" : [{
8. "name" : "a test for metadata result",
9. "type" : "Float",
10. "description" : "$string:results_description"
11. }],
12. "customizeData" : [{
13. "name" : "a customizeData",
14. "value" : "string",
15. "extra" : "$string:customizeData_description"
16. }]
17. }
```
...
5. "icon": "$media:ic_launcher",
6. "label": "$string:example",
...
29. "startWindowBackground": "$color:red",
30. "removeMissionAfterTerminate": true
31. },
32. {
33. "name": ".PlayService",
34. "description": "example play ability",
35. "icon": "$media:ic_launcher",
36. "label": "$string:example",
37. "launchType": "multiton",
38. "orientation": "unspecified",
39. "visible": false,
40. "skills": [
41. {
42. "actions": [
43. "action.play.music",
44. "action.stop.music"
45. ],
46. "entities": [
47. "entity.audio"
48. ]
...
55. },
56. {
57. "name": ".UserADataAbility",
58. "type": "data",
59. "uri": "dataability://com.example.world.test.UserADataAbility",
60. "visible": true
61. }
62. ]
```
...
5. "intents": [
6. {
7. "targetBundle": "com.example.world.test",
8. "targetClass": "com.example.world.test.entry.EntryAbility"
9. }
10. ]
11. }
12. ]
