...
content_hash: sha256:8f336c990811367158882b6b405d9efc8d513059e52ba706f63ebfd8c1064f48
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/YEPA9lK6R-GMJuBYdPR1TA/zh-cn_image_0000002762833995.png)
...
* 涉及界面交互的ArkUI组件（如TextInput等）：建议在页面布局中使用Stack包裹同层组件容器与BuilderNode，并使两者位置一致，NodeContainer要与<embed>/<object>标签对齐，以保障组件正常交互。如两者位置不一致，可能出现的问题有：TextInput/TextArea等附属的文本选择框位置错位（如下图）、LoadingProgress/Marquee等组件的动画启停与组件可见状态不匹配。
  ...
  **图2** 未使用Stack包裹，TextInput的位置错位
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a2/v3/6U21c59hQ9uWiVtsFryfmA/zh-cn_image_0000002733274476.png)

  **图3** 使用Stack包裹，TextInput的位置正常

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/4g5s_Q7fTcyuPPzdU610JA/zh-cn_image_0000002733434358.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/ZODflbwpRRmj2nWmpe9YKw/zh-cn_image_0000002762993881.png)
...
* 实现效果：
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/vENDwsN8Q4iMLg4PqKYKeg/zh-cn_image_0000002762833997.png)
...
* 实现效果：
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/xDa-mE9hStilGDbQyinjqQ/zh-cn_image_0000002733274478.png)

  设置arkwebnativestyle的display属性：

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/X_eJgRdcSlqy6Czi150Iaw/zh-cn_image_0000002733434360.png)
