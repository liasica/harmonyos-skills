...
content_hash: sha256:424b6c0d2a3a6422d78ce83f6ba5a4a6b223d8a55c11a2d220e6589434097f4b
---
...
1. 申请对应权限，请见[申请账号权限](account-config-permissions.md)章节。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6b/v3/ySxbknBxRtG3D0ze6oVwhw/zh-cn_image_0000002717771542.png)
2. 权限申请通过后，您可通过修改应用工程 > app.json5中的versionCode触发权限生效。

   **图1** 修改前

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/OmcLNckTRp24MRYVcjBlJQ/zh-cn_image_0000002747291561.png)

   **图2** 修改后

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/d5bA2JJ6SSS1UqJMreENMg/zh-cn_image_0000002747211479.png)
