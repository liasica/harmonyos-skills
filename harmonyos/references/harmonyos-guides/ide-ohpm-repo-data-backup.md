...
content_hash: sha256:f6a0dcdec96dae6e0f0b7c10c49989ee40928bb8d37fa0df642cb5d7d8615d75
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/JOrot-eYR16kba9B-KTKHw/zh-cn_image_0000002731381419.png "点击放大")
...
* 如果您的配置项db使用了mysql存储，请根据配置的数据库名，备份结构和数据。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/lbjpszUATPywGH_PVHS-rw/zh-cn_image_0000002731381413.png "点击放大")

* 如果您的配置项store使用了Sftp存储或自定义存储插件存储，请根据配置的存储目录，进行备份（图片以sftp存储举例）

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/xkls0GH8TPyJh_LJy3Bp7g/zh-cn_image_0000002701822100.png "点击放大")
