...
content_hash: sha256:06fb52992d2cee062eb1883c49257d9d84c7fb683fef2c0055710d2f6b4ceb9e
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/QdedO5foQnmAmemjMOjMVA/zh-cn_image_0000002561751237.png "点击放大")
...
* 如果您的配置项db使用了mysql存储，请根据配置的数据库名，备份结构和数据。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7c/v3/5WbXl3aDS8Wxp49Ctlj8aA/zh-cn_image_0000002530911286.png "点击放大")

* 如果您的配置项store使用了Sftp存储或自定义存储插件存储，请根据配置的存储目录，进行备份（图片以sftp存储举例）

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f7/v3/OJH9BhABTMqehbMDK-Zclg/zh-cn_image_0000002530911288.png "点击放大")
