...
content_hash: sha256:ee926faa6d7cfa9ec80a7c920c1d29c7de74583c679f547a9b4a7bc7748529cb
---
...
录制前应用的启动模式分为![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/50/v3/NqgqvZRARKa4_rfwJ19otw/zh-cn_image_0000002731542043.png "点击放大")自动启动和![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/0oCMcDuASkG0VUOK4LCT_g/zh-cn_image_0000002731542049.png "点击放大")手动启动，可点击图标切换两种不同模式：
...
1. 框选**Launch**泳道图区域的一个阶段或多个阶段，在下方的**Details**区域中，可查看到所选阶段的耗时统计情况。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/qSZwYY2bSTKhvXdm3ttHoQ/zh-cn_image_0000002701662840.png "点击放大")
2. DevEco Studio 6.0.0 Beta1版本新增**Load ETS Files**区域，支持查看冷启动过程中ets文件的加载情况。各字段含义如下：
   ...
   * Path：该ets文件构建产物的路径。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/m8WMMz3dRdS78l_Kt1aQ-A/zh-cn_image_0000002701822764.png "点击放大")
3. 切换到**TOP Redundant**区域，可查看冷启动过程中TOP 100冗余ETS加载文件信息。若File Name字段显示为蓝色，双击可快速跳转至对应工程源文件。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/07/v3/P5Y7i7QrTZWYC-tRs9CCrQ/zh-cn_image_0000002701662846.png "点击放大")
...
2. 单击单个静态资源库色块，或框选多个静态资源库**色块**，下方的**Details**区域展示所选对象的耗时统计信息。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/52/v3/ZrJYXPhnRtuUEcHWKm6jiQ/zh-cn_image_0000002701822772.png "点击放大")
...
2. 单击单个进程色块或框选多个进程色块，下方的**Details**区域展示所选对象的运行情况统计信息，单击CPU的跳转按钮，可跳转到CPU Core泳道查看详细的调度信息。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/oCAsu_jGRsKREouI_YWlGQ/zh-cn_image_0000002731382075.png "点击放大")
...
2. 单击单个切片色块或框选多个切片色块，可查看所选对象的详情。
   ...
   * **Load Statistics**区域展示所选对象的中载和重载信息。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3f/v3/mgioL92TTMqsIkcZbt2hcw/zh-cn_image_0000002701662844.png "点击放大")
