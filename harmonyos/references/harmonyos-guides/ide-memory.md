...
content_hash: sha256:b7f0bae3607d43043f381e8bff1a5f99f8ccbdc8cacb0340bd8cd8240a8904aa
---
...
1. 点击界面右上方**Settings**![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/s_YFbmuISwGSZc55MKLNlw/zh-cn_image_0000002701662968.png)按钮，选择**Memory**，进入配置页面。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/vbYNfjnuS56MRtKedeE5mg/zh-cn_image_0000002731542161.png)
2. 点击Memory后开关，开启和关闭记忆。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/bhudlBe9StqwRwrINZDRPg/zh-cn_image_0000002731542165.png "点击放大")
3. 在**Memory List**（记忆列表）下展示所有记忆，包括**Global**（记录用户相关信息）、**Project**（记录项目相关信息）。将鼠标悬浮在记忆上会显示具体信息，以及出现编辑、删除按钮，方便开发者管理记忆。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d7/v3/8FqMGZn7QheE1xLdAHMSyg/zh-cn_image_0000002731542167.png "点击放大")
