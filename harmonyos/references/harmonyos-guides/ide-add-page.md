...
content_hash: sha256:fe5ed612941abcee6566c74b28be682d14e635e75f56b43de6b62a30415f329f
---
...
1. 在Stage工程中选中ets文件夹下的pages，单击鼠标右键，选择**New > Page**，当前提供如下Page类型：
   ...
   * Iap Page：IAP Kit场景化模板，支持快速创建应用内支付购买虚拟数字商品相关代码。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/_PtOtJlPSVGP0tGrxq0UmA/zh-cn_image_0000002563315237.png)
...
2. 输入Page name（由大小写字母、数字和下划线组成），单击**Finish**完成添加。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/Lp47NuhBT9-stCQfr65krQ/zh-cn_image_0000002530753248.png "点击放大")
