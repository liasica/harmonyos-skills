...
content_hash: sha256:6e849c454acf9c7e38d585d4c343bfd82765d14eb0378f3dcb6897f3e3e7781f
---
...
1. 在Stage工程中选中ets文件夹下的**pages**，单击鼠标右键，选择**New > Page**，当前提供如下Page类型：
   ...
   * Iap Page：IAP Kit场景化模板，支持快速创建应用内支付购买虚拟数字商品相关代码。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/90/v3/9U31UAwpS3G9kqh87osf9w/zh-cn_image_0000002701823608.png)
...
2. 输入Page name（由大小写字母、数字和下划线组成），单击**Finish**完成添加。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/LIAvz-ACQJOsFnF0q4P3DQ/zh-cn_image_0000002731542881.png "点击放大")
