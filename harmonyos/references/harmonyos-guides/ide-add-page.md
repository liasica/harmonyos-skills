...
content_hash: sha256:0f25221765ceded04cdfa5cd18c840b7d83a3eaa45d5f99ecc7f22970625bf39
---
...
1. 在Stage工程中选中ets文件夹下的**pages**，单击鼠标右键，选择**New > Page**，当前提供如下Page类型：
   ...
   * Iap Page：IAP Kit场景化模板，支持快速创建应用内支付购买虚拟数字商品相关代码。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b4/v3/s_1S8T0hScaPu2HyrdZmaA/zh-cn_image_0000002701823608.png)
...
2. 输入Page name（由大小写字母、数字和下划线组成），单击**Finish**完成添加。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/0s2qJLyoR5yXG_yJkmtjaQ/zh-cn_image_0000002731542881.png "点击放大")
