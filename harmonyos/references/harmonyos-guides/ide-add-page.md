...
content_hash: sha256:8484e250a992776371c3b0fc062857f903e93ebd4cf4db70475adda511aab09b
---
...
1. 在Stage工程中选中ets文件夹下的**pages**，单击鼠标右键，选择**New > Page**，当前提供如下Page类型：
   ...
   * Iap Page：IAP Kit场景化模板，支持快速创建应用内支付购买虚拟数字商品相关代码。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d3/v3/pa-kUOnUTI6Y2lCmM6Bszg/zh-cn_image_0000002701823608.png)
...
2. 输入Page name（由大小写字母、数字和下划线组成），单击**Finish**完成添加。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/vZ5Y32LdSbSnp0p2MxTfIw/zh-cn_image_0000002731542881.png "点击放大")
