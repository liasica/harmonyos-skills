...
content_hash: sha256:93fe174d8fa33094d4ed2adf52ecb0eccbd6f8aa67dda938a72357923a105f59
---
...
* 远程调试（**主要调试方式**）
  ...
  + 手动调试：
    ...
    - PC上准备lldb，如windows系统则使用**lldb.exe**, 稍后将使用lldb与OH设备上的lldb-server远程连接进行调试。
      ...
      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/frIjLgQ2RiyaVlx2Keulxg/zh-cn_image_0000002753296401.png)
  + 设备状态与调试支持矩阵（分三种情况）：
