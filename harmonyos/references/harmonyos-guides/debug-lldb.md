...
content_hash: sha256:1bf6e4cdd099f43e634d12b32aa1bea83505ff82f1763162ac08fa0c905ac0e8
---
...
* 远程调试（**主要调试方式**）
  ...
  + 手动调试：
    ...
    - PC上准备lldb，如windows系统则使用**lldb.exe**, 稍后将使用lldb与OH设备上的lldb-server远程连接进行调试。
      ...
      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/JVCDIc-fSPqzqFPtP6FfQQ/zh-cn_image_0000002558606252.png)
  + 设备状态与调试支持矩阵（分三种情况）：
