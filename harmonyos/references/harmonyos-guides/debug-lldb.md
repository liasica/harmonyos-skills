...
content_hash: sha256:dd41a667cfd46c227fa0d0c289fb6e58e9400d24318b2c4be90218f2a27f3c2d
---
...
* 远程调试（**主要调试方式**）
  ...
  + 手动调试：
    ...
    - PC上准备lldb，如windows系统则使用**lldb.exe**, 稍后将使用lldb与OH设备上的lldb-server远程连接进行调试。
      ...
      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/if2r5Q-DQpyE3j0PD-ZPfA/zh-cn_image_0000002747212215.png)
  + 设备状态与调试支持矩阵（分三种情况）：
