...
content_hash: sha256:0c65fc2059289e96f7c475f2b6c81b9e8ff50ddbc25be2756a1d75d406ca8c42
---
...
* 远程调试（**主要调试方式**）
  ...
  + 手动调试：
    ...
    - PC上准备lldb，如windows系统则使用**lldb.exe**, 稍后将使用lldb与OH设备上的lldb-server远程连接进行调试。
      ...
      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/FmfXOLeXT-SFkSWphG3hCA/zh-cn_image_0000002757311865.png)
  + 设备状态与调试支持矩阵（分三种情况）：
