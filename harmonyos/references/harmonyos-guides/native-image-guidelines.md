...
content_hash: sha256:f5e3213b91de3334b48064c8f7fb8ec6d5cb3484ec7e608592269c2964209718
---
...
| 接口名 | 描述 |
| --- | --- |
| OH\_NativeImage\_Create (uint32\_t textureId, uint32\_t textureTarget) | 创建一个OH\_NativeImage实例，该实例与OpenGL ES的纹理ID和纹理目标相关联。本接口需要与OH\_NativeImage\_Destroy接口配合使用，否则会存在内存泄漏。 |
...
| OH\_NativeImage\_GetTransformMatrixV2 (OH\_NativeImage \*image, float matrix[16]) | 获取最近调用OH\_NativeImage\_UpdateSurfaceImage的纹理图像的变换矩阵。 |
...
详细的接口说明请参考[OH\_NativeImage](../harmonyos-references/capi-oh-nativeimage.md)。
