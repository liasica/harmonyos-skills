...
ArkUI提供@ohos.arkui.UIContext([UIContext](../harmonyos-references/arkts-apis-uicontext-uicontext.md))扩展能力，通过[getFilteredInspectorTree](../harmonyos-references/arkts-apis-uicontext-uicontext.md#getfilteredinspectortree12)获取组件树及组件属性，通过[getFilteredInspectorTreeById](../harmonyos-references/arkts-apis-uicontext-uicontext.md#getfilteredinspectortreebyid12)获取指定的组件及其子组件的属性。支持设置过滤条件进行查询。
