...
通过OHAudio提供OH\_AudioStreamBuilder接口，遵循构造器设计模式，构建播放音频流。指定对应的[OH\_AudioStream\_Type](../harmonyos-references/capi-native-audiostream-base-h.md#oh_audiostream_type)，设置为AUDIOSTREAM\_TYPE\_RENDERER。
