...
content_hash: sha256:da79d2e004845a55200a49c8424de842880c8ab2e5ec1d3954b7e0778bdf84f6
---
...
从API version 24开始，可通过在应用工程的[module.json5配置文件](module-configuration-file.md)中配置[metadata标签](module-configuration-file.md#metadata标签)来使能自定义组件支持跨[Ability](../harmonyos-references/js-apis-app-ability-ability.md)迁移。具体配置方式为：新增[name](module-configuration-file.md#metadata标签)为"enableCustomComponentCrossAbility"，[value](module-configuration-file.md#metadata标签)为"true"。因为自定义组件提供的是UI能力，所以这里的Ability也特指[UIAbility](../harmonyos-references/js-apis-app-ability-uiability.md)。具体示例参考[自定义组件支持跨Ability迁移](arkts-create-custom-components.md#自定义组件支持跨ability迁移)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/R0rHVm4FQGKPk-ZlMp1LBQ/zh-cn_image_0000002706833106.gif)
...
[@Entry](../harmonyos-references/ts-universal-entry.md#entry)装饰的自定义组件将作为[UI页面](arkts-router-to-navigation.md#页面结构)的入口。在单个UI页面中，仅允许存在一个由@Entry装饰的自定义组件作为页面的入口。
...
| useSharedStorage12+ | boolean | 否 | 是 | 是否使用[loadContent](../harmonyos-references/arkts-apis-window-windowstage.md#loadcontent9)传入的LocalStorage实例对象。默认值false。值为true时：若loadContent传入了LocalStorage实例，则使用该LocalStorage实例对象，否则会新建一个LocalStorage实例。值为false时：不使用共享的LocalStorage实例对象。 |
...
[@Component](../harmonyos-references/ts-custom-component-decorator-component.md#component)装饰的struct为V1自定义组件，可以使用[状态管理V1版本](arkts-state-management-overview.md#状态管理v1)装饰器的能力。
...
[@ComponentV2](../harmonyos-references/ts-custom-component-decorator-componentv2.md#componentv2)装饰的struct为V2自定义组件，可以使用[状态管理V2版本](arkts-state-management-overview.md#状态管理v2)装饰器的能力。
...
* @ComponentV2支持一个可选的[ComponentOptions参数](../harmonyos-references/ts-custom-component-parameter.md#componentoptions)，来实现[组件冻结](arkts-custom-components-freezev2.md)。
* 一个简单的@ComponentV2装饰的自定义组件应具有以下部分：
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9b/v3/l9FbTQKUQDqyWZwNmvGyVQ/zh-cn_image_0000002736312215.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/bIu8BnY7Sg2-Ou8XQlhKKg/zh-cn_image_0000002706673172.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/m3ZtjxU9QPW4wNh7GK7jtg/zh-cn_image_0000002736432261.gif)
...
* 不允许直接改变状态变量，反例如下。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/23/v3/6gP8RQafRsekOmHOBcZz8Q/zh-cn_image_0000002706833108.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/wJfweq3sTBO3jqHaILgIew/zh-cn_image_0000002736312217.png)
...
2. 仅支持组件树上的自定义组件迁移。对于未挂载在组件树上的自定义组件将不支持迁移。例如使用[OH\_ArkUI\_GetNodeHandleFromNapiValue](../harmonyos-references/capi-native-node-napi-h.md#oh_arkui_getnodehandlefromnapivalue)获取[ArkUI\_NodeHandle](../harmonyos-references/capi-arkui-nativemodule-arkui-node8h.md)场景中，如果OH\_ArkUI\_GetNodeHandleFromNapiValue接收的参数为[ComponentContent](../harmonyos-references/js-apis-arkui-componentcontent.md)，获取到的ArkUI\_NodeHandle为ComponentContent下子树的第一个[FrameNode](../harmonyos-references/js-apis-arkui-framenode.md)节点，中间跳过的自定义组件将不会在组件树上，不支持迁移。
...
下面的示例包含了创建新的Ability流程，具体示例可参考[startAbility](../harmonyos-references/js-apis-inner-application-uiabilitycontext.md#startability)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/GynzVlMHQPGx9gyZjCTRhg/zh-cn_image_0000002706673174.gif)
