...
content_hash: sha256:85491c15d4277a549f16e45ed04f7e855ade1a7c9a40d18ee175a69fd0f699a9
---
...
2. 在**New Project Module**界面中，选择需要创建的模板，单击**Next**。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/yNXpm4aFQT2znhDzjq7umw/zh-cn_image_0000002701662998.png)
3. 在模块配置页面，设置新增模块的基本信息，然后单击**Next**。
   ...
   * **C++ Standard：**C++标准库，取值包括：Toolchain Default、C++11、C++14。从DevEco Studio 6.0.1 Beta1开始支持。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/4mmS_W1kQoebSHogjb8DWg/zh-cn_image_0000002731542193.png)
