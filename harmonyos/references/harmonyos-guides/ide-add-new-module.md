...
content_hash: sha256:965d592ce5656a0aa00ce71c308f01cb9826d5c5be9e6951721de183bd3be38d
---
...
2. 在**New Project Module**界面中，选择需要创建的模板，单击**Next**。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/rhoJcmL0RlmUwK-7u4oU5Q/zh-cn_image_0000002530752976.png)
3. 在模块配置页面，设置新增模块的基本信息，然后单击**Next**。从DevEco Studio 6.0.1 Beta1开始，支持选择C++版本。
   ...
   * **C++ Standard：**C++标准库，取值包括：Toolchain Default、C++11、C++14。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/_av20zlmScKSmX_ds960mQ/zh-cn_image_0000002561832893.png)
...
1. 在菜单栏单击**File > New > Import... > Import Module。**
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cf/v3/wWaU2fGhQ0yoqTFnUIqC1Q/zh-cn_image_0000002530912964.png)
2. 选择导入的模块。

   在指定路径下，选择导入的模块，单击**OK**。导入的模块可以为文件夹，也可以为zip格式。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/xYlx0lGeQEqx_HDMCJQpqw/zh-cn_image_0000002530752972.png)

### srcPath方式引用模块

在工程级build-profile.json5文件中，如下图所示在modules > srcPath字段下配置工程外模块的相对路径，即可引用模块相关信息，不会将模块代码完全复制至本工程中。当前支持引用其他工程下的HAR和HSP模块。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/aDTtFHwPQxS1dqazxPOvJw/zh-cn_image_0000002530752974.png)
