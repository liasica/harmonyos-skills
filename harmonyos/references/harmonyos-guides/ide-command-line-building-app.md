...
content_hash: sha256:224875e28bf72b8fbb5eb0788db44ed2baf6539158a01c314e72fa31ec854efd
---
...
4. 执行如下命令，检查JDK安装结果。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/7lFhp7VCRlWmH4mW9sHG2Q/zh-cn_image_0000002701662860.png)
...
2. 执行如下命令，解压命令行工具commandline-tools-linux-xxx.zip，工具名称请根据实际情况进行修改。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/QKDwNm9qRj-pGomc6Mb3BQ/zh-cn_image_0000002731382083.png)
...
2. 执行如下命令，查询Node.js版本信息，确认配置成功。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/32/v3/lYGmgPuzS_aURI-QR6r5Hw/zh-cn_image_0000002731542057.png)
...
2. 先配置[环境变量](ide-command-line-building-app.md#section159168531288)，再打开[命令行工具](ide-commandline-get.md)，在文件夹下执行npm install命令，会生成node\_modules文件夹。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/E8CHtkXQR1CTDEe8FvAfew/zh-cn_image_0000002731542053.png)
...
2. 打开[命令行工具](ide-commandline-get.md)，在文件夹下执行npm install命令，会生成node\_modules文件夹。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/8przB_8aTzGJQumZLk64bQ/zh-cn_image_0000002701822784.png)
