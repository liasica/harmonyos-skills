...
content_hash: sha256:bb6eb6099852379a7ccd43c7b6f918f69fef9c821041cf17a583b6e3cc9078f5
---
...
1. 进入意图注册配置入口。
   ...
   1. 登录[华为开发者联盟](https://developer.huawei.com/consumer/cn/) ，选择“管理中心 > 生态服务 > 智慧服务 > 小艺开放平台”，在管理中心找到小艺开放平台。
      ...
      ![](https://media:401788444083210692)
   2. 点击“立即体验”按钮，进入项目管理页面。

      ![](https://media:401788444083370693)
   3. 在资源库中点击“意图框架”页签，即可到达意图注册配置操作入口。

      ![](https://media:401788444083445694)
2. 点击“注册意图”，新增意图集。

   ![](https://media:401788444083517695)

   1. 填写意图注册信息，点击“创建”。

      ![](https://media:401788444083666696)
   ...
   2. 编辑意图集基本信息并保存。
      ...
      ![](https://media:401788444083806697)
...
3. 添加意图。
   ...
   1. 切换至意图页签，点击“添加”，进行添加意图。
      ...
      ![](https://media:401788444083933698)
   2. 选择自定义意图并填入意图信息（根据接入方案进行填入），填写完成后点击“确定”。

      ![](https://media:401788444084108699)
   3. 展开已创建的意图，新增自定义意图输入参数和自定义意图输出参数，新增完毕后点击“保存”。

      ![](https://media:401788444084364700)
