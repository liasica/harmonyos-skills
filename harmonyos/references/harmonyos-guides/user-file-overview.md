---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-overview
title: 用户文件概述
breadcrumb: 指南 > 应用框架 > Core File Kit（文件基础服务） > 用户文件 > 用户文件概述
category: harmonyos-guides
scraped_at: 2026-04-28T07:41:16+08:00
doc_updated_at: 2026-04-03
content_hash: sha256:8d8558165a56edbf3a0be781b2b5912a138629264999a33511659942596bfb6f
---

用户文件：登录到该终端设备的用户所拥有的文件，包括用户私有的[图片、视频](photoaccesshelper-overview.md)、音频、文档等。

1. 用户文件存放在用户目录下，归属于该设备上登录的用户。
2. 用户文件存储位置主要分为[内置存储](user-file-overview.md#内置存储)、[外置存储](user-file-overview.md#外置存储)。
