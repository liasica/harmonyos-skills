---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/unpacking-tool
title: 拆包工具
breadcrumb: 指南 > 系统 > 调测调优 > 调试命令 > 打包拆包工具 > 拆包工具
category: harmonyos-guides
scraped_at: 2026-04-28T07:45:26+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:c0d9317541f29a2e414bb5badeb1b074fa75545a2afa86ebb0db5cb57314d87c
---
...
```
1. java -jar app_unpacking_tool.jar --mode hap --hap-path <path> --out-path <path> [--force true]
```
...
```
1. java -jar app_unpacking_tool.jar --mode app --app-path <path> --out-path <path> [--force true]
```
...
```
1. java -jar app_unpacking_tool.jar --mode hap --rpcid true --hap-path <path> --out-path <path> [--force true]
```
...
```
1. java -jar app_unpacking_tool.jar --mode hap --hap-path <path> --out-path <path> [--force true] [--libs true] [--cpu-abis option]
```
...
```
1. java -jar app_unpacking_tool.jar --mode hsp --hsp-path <path> --out-path <path> [--force true]
```
...
```
1. java -jar app_unpacking_tool.jar --mode hsp --hsp-path <path> --out-path <path> [--force true] [--libs true] [--cpu-abis option]
```
...
```
1. java -jar app_unpacking_tool.jar --mode appqf --appqf-path <path> --out-path <path> [--force true]
```
