...
content_hash: sha256:784d5d2cdb2b2954233870d217c8310bd86078d2f122c83391f1ae301966a28b
---
...
* 关键资产删除时机
  ...
  + 应用卸载时，会清除对应的数据。[IS\_PERSISTENT](../harmonyos-references/js-apis-asset.md#tag)属性设置为true的数据将保留。
