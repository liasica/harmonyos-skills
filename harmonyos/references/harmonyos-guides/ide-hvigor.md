---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor
title: 概述
...
Hvigor可独立于DevEco Studio运行，这意味着，你可以在DevEco Studio内、[命令行工具](ide-hvigor-commandline.md)或是集成服务器上构建应用。无论您从命令行工具或是DevEco Studio上构建项目，构建过程的输出都将相同。
