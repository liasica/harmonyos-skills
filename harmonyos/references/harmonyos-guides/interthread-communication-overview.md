...
content_hash: sha256:51a40c6d1ee562a5db88cf7c780d4da4734e1d2c03fa5a1a5fb5255a7b31287c
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/78UJI2RWRNiT5M6BbhxgQg/zh-cn_image_0000002706833074.png)
...
基于ArkTS提供的TaskPool和Worker并发接口，支持多种线程间通信能力，可以满足不同线程间通信场景。如[使用TaskPool执行的独立的耗时任务](independent-time-consuming-task.md)、[使用TaskPool执行多个耗时任务](multi-time-consuming-tasks.md)、[TaskPool任务与宿主线程通信](taskpool-communicates-with-mainthread.md)、[Worker与宿主线程的即时消息通信](worker-communicates-with-mainthread.md)、[Worker同步调用宿主线程的接口](worker-invoke-mainthread-interface.md)等。此外，通过[Node-API](napi-introduction.md)机制，C++线程可以跨线程调用ArkTS接口。
