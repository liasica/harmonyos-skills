...
content_hash: sha256:9ba75d8f7fe3085c2906c47bbf78d54e42a82ab821177bf01115ab50023a38aa
---
...
2. 设置资源：需要设置属性fdSrc（表示文件描述符）。
   ...
   * 可以使用ResourceManager.getRawFd打开HAP资源文件描述符，使用方法可参考ResourceManager API中的[getRawFd](../harmonyos-references/js-apis-resource-manager.md#getrawfd9)。
