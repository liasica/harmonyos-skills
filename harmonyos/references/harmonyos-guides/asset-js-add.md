...
开发者可以查阅API文档，获取关键资产新增接口的详细说明：异步接口[add(attributes: AssetMap)](../harmonyos-references/js-apis-asset.md#assetadd)、同步接口[addSync(attributes: AssetMap)](../harmonyos-references/js-apis-asset.md#assetaddsync12)。
