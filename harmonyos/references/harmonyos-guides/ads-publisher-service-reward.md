...
content_hash: sha256:5d7b444d8dca86756160c7b7b8c89a91efce3f5bec35cad7de6fca2e1e39c66b
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/22/v3/WuC3u6RMQvCei2yDc3ufUQ/zh-cn_image_0000002757231273.png)
...
3. 请求单广告位广告。
   ...
   | adId | string | 是 | 广告位ID。  - 如果仅调测广告，可使用测试广告位ID：j2mh81xmqs。  - 如果要接入正式广告，则需要申请正式的广告位ID。可在应用发布前进入[流量变现官网](https://developer.huawei.com/consumer/cn/monetize)，点击“开始变现”，登录[鲸鸿动能媒体服务平台](https://developer.huawei.com/consumer/cn/service/ads/publisher/html/index.html?lang=zh)进行申请，具体操作详情请参见[展示位创建](../monetize/zhanshiweichuangjian-0000001132700049.md)。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/Goe83JcySW6ekCojSu1B6Q/zh-cn_image_0000002727591582.png)
...
1. 设置激励广告的奖励配置。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/gAeO_RgGQ2ifOZwb5OVSSg/zh-cn_image_0000002727751440.png)
...
5. 获取公钥列表。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0/v3/mI8WQe2MQOarlpkvrb__YA/zh-cn_image_0000002757311155.png)

   通过点击上图所示的“获取密钥”按钮弹出如下所示的弹框，获取“开发者ID”和“密钥”。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/KNu8kh9YSXqf37yYjJtzKQ/zh-cn_image_0000002757231275.png)
