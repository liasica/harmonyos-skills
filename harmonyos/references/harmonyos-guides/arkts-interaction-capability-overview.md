---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-interaction-capability-overview
title: 交互响应概述
...
包括：[触摸事件](../harmonyos-references/ts-universal-events-touch.md)，[鼠标事件](../harmonyos-references/ts-universal-mouse-key.md)，[轴事件](../harmonyos-references/ts-universal-events-axis.md)。
