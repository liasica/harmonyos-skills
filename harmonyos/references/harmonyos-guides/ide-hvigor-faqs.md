...
content_hash: sha256:802b8bec4dc2dcc5e99bdb8151d59210005d799af2a14befb6cf29e3eeb6ad2c
---
...
* 如果以上修改没有取得明显的效果，可以使用非并行的模式来执行编译。
  + 在菜单栏点击“File > Settings（macOS为DevEco Studio > Preferences/Settings） > Build, Execution, Deployment > Build Tools > Hvigor”，取消勾选“Execute tasks in parallel mode (may require larger heap size)”。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/0riwpOZVT0SApRCf1P4s5Q/zh-cn_image_0000002731382759.png)
...
* **场景一：**
  ...
  **处理措施**
  ...
  1. 确保XXX是当前的HvigorNode里存在的任务。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/2kvgyIRHS4S8tA2X_rfo6Q/zh-cn_image_0000002701663584.png)
...
* **场景八：**
  ...
  **问题确认**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/Bzaoy2cqROaKWTfN7e-pfg/zh-cn_image_0000002731542741.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/IxCFvvyrQaKhoYwFDv8RVA/zh-cn_image_0000002731382805.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d7/v3/QfwNcPzEThqkKenNEkTKIw/zh-cn_image_0000002701823460.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/66/v3/8YA7tm4ERX27WNUi0ADH7Q/zh-cn_image_0000002701663578.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/3wjR4CzNQf201EMLOTBeHQ/zh-cn_image_0000002701663518.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9d/v3/PoSBIZCyQqWF_IO3G8yVzw/zh-cn_image_0000002701823428.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e8/v3/Q8rAyp5cQw-51hdxGX39TQ/zh-cn_image_0000002701663524.png)

2.编译工具根据设置的Build Mode选项生成debug标识，如图所示，可以通过此处进行设置。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/OSuds65nSJqhw6Yy09LGKA/zh-cn_image_0000002731542709.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/09/v3/oZOdsTEjSvS-nSmFxQ2cig/zh-cn_image_0000002731382753.png)

**解决措施**

proxyData标识模块提供的数据代理列表，只允许entry和feature配置，不同的proxyData中配置的URI不可重复。遇到此问题，检查模块间是否配置了相同uri的proxyData。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/92/v3/3G1lLNMHSSeLLFGomwIfKA/zh-cn_image_0000002731542713.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/41/v3/NYLmOiFKR2-pUID2-HjABA/zh-cn_image_0000002731542745.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1b/v3/xtHk9oqrQb-UBMmu1RqQog/zh-cn_image_0000002701663544.png)
...
* **场景一：**
  ...
  **处理措施**
  ...
  1. 在对应cpp目录下新建types/libxxx目录，并在该目录下新增index.d.ts用于声明native的类型符号；新增oh-package.json5配置文件用于校验工具的模块查询。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/qj1eVmeuTkOom-w6YgZ0QQ/zh-cn_image_0000002701663522.png)

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/cD20uEwjREupQX78F-ppmg/zh-cn_image_0000002701823466.png)
  2. 在native引用的模块内的oh-package.json5中添加native模块的本地依赖，并根据提示点击**Sync Now**同步工程，下图以entry模块引用native模块为例。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/24/v3/21PGQcGBSaKt9WZZAmUdPA/zh-cn_image_0000002731542723.png)
...
* 场景二：
  ...
  **问题现象**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/6hPK7iJgQgaO7ig5o5xesw/zh-cn_image_0000002701823476.png)
...
* 场景三：
  ...
  **问题现象**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/9JsOFCg9SLKfiQqpFupcDQ/zh-cn_image_0000002701663506.png)

  代码中这样引用

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5b/v3/RbTopJPlSgWHLvi_bbfHnA/zh-cn_image_0000002701823482.png)这样引用会找不到模块，导致报错。

  **处理措施**

  修改引用方式，改为推荐的引用方式

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/1M9kbhNgTIe7bE8jQjaP1w/zh-cn_image_0000002701823490.png)
* 场景四：
  ...
  **问题现象**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b/v3/Pr2wsvv1RdWKPGOtcya35Q/zh-cn_image_0000002701663594.png)

  被引用模块的 oh\_package.json5 中配置了错误的types字段。

  该字段优先于main字段。 如果 types 字段配置的不存在，就会报错模块找不到。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/42/v3/iQCZX3BURlWTwVCQzpWfKw/zh-cn_image_0000002731542743.png)
...
* 场景七：
  ...
  **问题现象**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/88/v3/vS5cpDLFSqSCAi1NWZH4TA/zh-cn_image_0000002701663592.png)
  ...
  **解决措施**
  ...
  1. 通过在build目录中搜索'rollup\_plugin\_ignore\_empty\_module\_placeholder'，找到报错的中间文件，并根据中间文件找到对应工程文件。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/JZy5rdlaR-qOu9mbyRzFSg/zh-cn_image_0000002701823480.png)

     在输入栏中输入rollup\_plugin\_ignore\_empty\_module\_placeholder，找到问题模块的中间文件。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5b/v3/HX5ajD7jQrekFpMd1RpsAg/zh-cn_image_0000002701823440.png)
  2. 在引用类型文件中通过添加type显式声明符号类型引用：
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/e1oiluhHT1Oa8b2VUMjKyw/zh-cn_image_0000002731542781.png)
  3. 同时排查是否从d.ts/d.ets中引用值类型符号，禁止在声明文件中声明值变量。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/_-3Yr45VTDW1MICdVAWXZw/zh-cn_image_0000002701663530.png)
...
* 方法2：新增x.js对应的声明文件(.d.ts)，并在引用时不指定后缀。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/6rc3AiXqSrSR23IF5wEsNQ/zh-cn_image_0000002701663590.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a5/v3/ZBKOr2paR_iM-u55YsNmkA/zh-cn_image_0000002701823514.png)

**处理措施**

该问题是由于file1为当前工程外的代码：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/66/v3/BK7KYYveTCS4f0sAEUdRsg/zh-cn_image_0000002701823506.png)
...
* **场景一：**
  ...
  **问题现象**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ea/v3/bPKiuxGTTQKJh-oxLGH2hg/zh-cn_image_0000002701823516.png)

  **问题确认**
  1. 进入上面报黄色的源码文件中，可以看到依赖有红色告警信息。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/0onEnDuyTMuTE5t-XIcNjg/zh-cn_image_0000002731382757.png "点击放大")
  2. 进入包下的oh-package.json5文件，查看依赖配置为devDependencies。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/UvZw3zZATXC_FuXdM_kQog/zh-cn_image_0000002731382795.png)
...
* **场景二：**
  ...
  **问题现象**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/WSMMSRuYQJ2mccfef0jpiw/zh-cn_image_0000002731382743.png)
...
* **场景三：**
  ...
  **问题现象**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/42/v3/FebkCreMT3m7TMgeIqlEEg/zh-cn_image_0000002731382779.png)

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/7uOjmnOZSo-7yM7iPP_n0g/zh-cn_image_0000002701663560.png)![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/mrDzJRCxSCC4PZZ7wbsIqA/zh-cn_image_0000002731542751.png)**处理措施**
...
* **场景五：**
  ...
  **问题现象**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b5/v3/UIHlow-tT5mWvXtCTmfvNw/zh-cn_image_0000002731542727.png "点击放大")
  ...
  **处理措施**
  ...
  + 将xxx依赖配置到yyy模块oh\_package.json5的dependencies中。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/90/v3/gVtMZzXuRpeb5aG_jiw5Xg/zh-cn_image_0000002701823452.png "点击放大")
...
* **场景六：**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/Q78yo4IzQkS1OMpojt0gWQ/zh-cn_image_0000002731382823.png)
* **场景七：**
  ...
  **问题现象：**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2b/v3/Vcy0G3brTha3JgHcCI0Qqw/zh-cn_image_0000002731542735.png)
  ...
  **处理措施**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b/v3/iOJlB5F0T8GMEnTsxhVzWw/zh-cn_image_0000002701823442.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/44/v3/BpTBDN84SreJXjDnXjhyhg/zh-cn_image_0000002731542765.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/24/v3/FW_OCeDQSCSvn4MjImJBeg/zh-cn_image_0000002731542701.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/DKtd6waPSHaqUDqpuUwn_A/zh-cn_image_0000002731382821.png)
...
2. 然后在config.json中重新引用该字符串资源。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/EiyIH4luTz2aMJlz1SCsBA/zh-cn_image_0000002731382813.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/-3R2ReMkQIOsOU_gICT7OQ/zh-cn_image_0000002701823432.png)
...
1. 在模块下的**resources > base > element**下，点击右键选择**New > Element Resource File**创建资源文件。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/FPTDgJMqTEyerpO-VWTcvQ/zh-cn_image_0000002731542697.png)
2. 在弹出的对话框中，“File name”开发者可自定义，如color；“Root element”请选择**color。**

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/l-yWwJ5RQ66zo8VVjdLIOA/zh-cn_image_0000002701823464.png)

   创建完成后，color.json文件如下图所示：

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9d/v3/KBT_DgXcQQy6pJd0q9smow/zh-cn_image_0000002731382737.png)
3. 将[2](ide-hvigor-faqs.md#li124901748185712)创建的color.json文件拷贝至模块的**ohosTest > resources > base > element**目录下。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/QNLVxjQfTSe7HtBxFApzwg/zh-cn_image_0000002731542731.png)
4. 在模块的**src > main > module.json5**文件的abilities数组中，添加startWindowIcon和startWindowBackground字段（若缺少任一字段，将出现ERROR: Schema validate failed报错）。其中，startWindowIcon字段索引模块下**resources > base > media**中的图标资源，startWindowBackground字段索引**resources > base > element** **> color.json**中的color。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/09/v3/1t7Mopg4TFSMzZuu6MFacg/zh-cn_image_0000002701823512.png)
...
* keyword：标识当前报错字段的可选配属性，当前报错中包括'required'、'oneOf'、'enum'、'propertyNames'。
  ...
  + oneOf：表示当前配置不符合oneOf要求。通过instancePath已经确认报错出现在abilities标签，在DevEco Studio中，按住Ctrl点击"abilities"跳转到对应的module.json文件，可以查看到必须配置以下两组中的一组。根据对比排查，可识别到因拼写错误导致"name"属性未配置。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/LRqSjNwGSMSCnB6otfUtmA/zh-cn_image_0000002701663574.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/24/v3/67wpKrGIToCDSYtoSgZkxw/zh-cn_image_0000002701823426.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/Zu5r0zXxQUeEHVsrw6IV1w/zh-cn_image_0000002701823448.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/qqkIc7ZhReOYubBHafJrUQ/zh-cn_image_0000002731382781.png)
...
* Module: (xxx) and Module: (xxx) are entry, please check deviceType or distroFilter of the module.
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/44/v3/JSPN_P4YRfOba_My-AQpTw/zh-cn_image_0000002731382807.png)
* Module: (xxx) and Module: (xxx) have the same moduleName, please check deviceType or distroFilter of the module.

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/qdKMfwFJQVqrd7BBXEsybA/zh-cn_image_0000002701663564.png)
* Module: (xxx) and Module: (xxx) have the same packageName, please check deviceType or distroFilter of the module.

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0a/v3/9xYh8vQnQse0Sz0-QcZ4Cg/zh-cn_image_0000002731382797.png)
* Module: (xxx) and Module: (xxx) have the same ability name.

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/32/v3/7kk9zKsQQy6CcRBOYcrX7w/zh-cn_image_0000002701823438.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/KvSg4V0KQbKSe3rd9h9ZXA/zh-cn_image_0000002701823496.png)

**解决措施**

请删除报错模块下的.cxx文件夹，然后选中需要构建的模块，执行**Make Module** **${moduleName}**完成单独构建，避免同时构建多个模块。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/D55HPLodSYGK7ltyP2dAeg/zh-cn_image_0000002701663528.png)
...
4. 将定义的三方so声明给目标。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/DnT4N0QCQzyUs2iLSb-JRA/zh-cn_image_0000002701823462.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/fTJBVo1dRQO0p3ktz5_0FQ/zh-cn_image_0000002701823500.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/wJy3aXXrTCGvC8MVQNF-Xg/zh-cn_image_0000002701663536.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/aE7SNzADRma4dY33ZFuzCQ/zh-cn_image_0000002701663562.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/nr3t8spvQ6KShoZpBUXEUA/zh-cn_image_0000002731542769.png "点击放大")

出现编译报错“ninja: error: mkdir(xxx): No such file or directory”，示例如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/98/v3/e8V9jnAsQfGyTK_ege0IVg/zh-cn_image_0000002731542759.png "点击放大")
...
* 方法二：根据object file实际路径长度计算CMAKE\_OBJECT\_PATH\_MAX大小。
  ...
  + 总路径长度 = object file directory长度 + object file长度，object file directory、object file如下图所示，两个长度之和为297字符，以实际为准
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/QTxFGvZoRd26f8gwEL14HQ/zh-cn_image_0000002731542725.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/hrJj8t0nRY2kESZPCIvCBg/zh-cn_image_0000002701823484.png "点击放大")

出现编译报错“(is the command line too long?)”，示例如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/af/v3/q5cgMRKrSUOrtZPoVgQaaQ/zh-cn_image_0000002731382801.png)
...
* 方法二：根据object file实际路径长度计算CMAKE\_OBJECT\_PATH\_MAX大小。
  ...
  + 总路径长度 = object file directory长度 + object file长度，object file directory、object file如下图所示，两个长度之和为297字符，以实际为准
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/1Oyspm8lQCqdieQrlhYIww/zh-cn_image_0000002701823488.png "点击放大")
  + object file中目录部分长度：示例中“\_\_/\_\_/\_\_/\_\_/\_\_/third-party/rn/ReactCommon/react/renderer/textlayoutmanager”长度为74字符，以实际为准
  + cmake哈希值字符数：cmake将长路径转换为哈希值时哈希值的长度，固定为32
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/be/v3/RchsvCM0RPuu1x_35RyaCw/zh-cn_image_0000002701663510.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3c/v3/tvpUeEeNTlyidnc4R9oXHA/zh-cn_image_0000002731542791.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/jy-k-2qaQC6DdEusHUdrEg/zh-cn_image_0000002701663552.png)![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/TVeeSkXWQZKhysHVY09Q3Q/zh-cn_image_0000002701823446.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/SWuVEIubQeC_38_32ExyqA/zh-cn_image_0000002731382739.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/Cv6BQ8j9SdOUviT6hTEuVg/zh-cn_image_0000002701663546.png)**问题确认**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/20/v3/YaD2-xeuQxSsEnWpGXvbHQ/zh-cn_image_0000002701663586.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/01/v3/GiJjLp0TRT2NlN6GPQVekA/zh-cn_image_0000002701823474.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/Iuyc87kJSq6G15wHkP_wQw/zh-cn_image_0000002731382755.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/P-FnhIZrQz-mPTbrJOCG-Q/zh-cn_image_0000002731542775.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/GkambmPpQ6SuKC-YPoueEg/zh-cn_image_0000002731542767.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/QzdHf0wQQdycDaZDjir2Aw/zh-cn_image_0000002731382775.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/SXxPBsX0SbCkZ9C8Ux3Dpw/zh-cn_image_0000002731542719.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b4/v3/O7i9QS6JQD2HeCtuArbbtA/zh-cn_image_0000002747298915.png)
