...
content_hash: sha256:31946dd071071b71cbe97feaf11ef58dfae6918562873aebd9fd5820ce4e13fe
---
...
1. 创建服务账号密钥文件。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/6hPKhw9jToGiJFtvQ4Im3w/zh-cn_image_0000002743220144.png)
...
2. 请确认以上密钥文件中的project\_id是否与您的应用所属项目一致。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/ATM0a_FTRL2czGlRE64NOw/zh-cn_image_0000002772739397.png)
3. 生成JWT Header数据。
...
1. 完成上述[开发步骤](push-jwt-token.md#开发步骤)中的步骤1创建服务账号密钥文件后，从华为开发者联盟的[API Console](https://developer.huawei.com/consumer/cn/console/api/myApi)上创建并下载推送服务API的服务账号密钥文件（.json文件），格式如下：
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/nRsuGgMPRqarf25tfnDAMg/zh-cn_image_0000002772899281.png)
