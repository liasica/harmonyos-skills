...
content_hash: sha256:4267de6cdb31d3a14d2e3c05e545c1290cad4898616284f07f840362ee33d051
---
...
3. 在左侧导航栏中选择“增长 > App Linking > 应用链接”，点击“创建”。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/apzS7mO5Qi60dBu5h6Bp2A/zh-cn_image_0000002717611672.png)
4. 填写[建立域名与应用关联关系](app-linking-startupapp.md#建立域名与应用关联关系)的网址域名，例如：https://www.example.com。必须输入精确的域名，不可输入包含特殊字符的模糊网址。
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6a/v3/FWPi-CnqQtCtI0L7wnB-xw/zh-cn_image_0000002747291625.png)
5. 设置完成后点击“发布”，AGC会对该网站域名的配置文件所包含的应用与本项目内的应用列表进行交集校验。
   ...
   **说明** 
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/XrjbimexQg-CU7Yo0vjAgA/zh-cn_image_0000002747211541.png)

   * 如果域名的配置文件中存在本项目中的应用，则发布成功，点击“查看”可显示该域名关联的应用信息。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/nGTJ7VBkQICMCJhWDumomQ/zh-cn_image_0000002717771606.png)
   * 如果还在校验中，则状态为“发布中”。
   * 如果配置文件中没有包含任何本项目中的应用，则发布失败，点击“查看”可显示发布失败原因。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/92/v3/0ki4rHsETau0IXUwhYK8Zg/zh-cn_image_0000002717611674.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/EgGSeWUdQYejYkp7NqF1pA/zh-cn_image_0000002747291627.gif)
