...
content_hash: sha256:46ff799ef1aaaaa60f0561ac0b9b4841b45be96aebd1386bb85962e3b2e76d74
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5d/v3/oS1Zm1vOTUGNuyD_5FCtmw/zh-cn_image_0000002731382535.png)
...
单击右上角的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/wHxBZOtgTGqdjestSvy-xw/zh-cn_image_0000002731382527.png)图标，指定需要打包的**Product**及**Target**，然后单击**Apply**保存。例如选择"ProductA"中，entry模块对应的"free" Target。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/71/v3/gD26zmOESMSrShAcOTBVCA/zh-cn_image_0000002701663304.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fe/v3/KJLF4BzpT-67jZdM1C63xw/zh-cn_image_0000002701823224.png)

## 调试和运行指定的Target

使用DevEco Studio调试或运行应用/元服务时，每个模块只能选择其中的一个target运行，可以通过单击右上角的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/af/v3/6b1QxerLQamxmZclTTXK_w/zh-cn_image_0000002701823228.png)图标，指定需要调试或运行的**Product**下对应的**Module Target**，然后单击**Apply**保存。

**说明** 

在选择需要调试或运行的target时，需要注意选择该target所属的Product，否则将找不到可调试和运行的target。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/45/v3/LkzjCUL5RAGZss2nT5_i_Q/zh-cn_image_0000002701663306.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/BQPFd5qKT46cJlfZZrXfbQ/zh-cn_image_0000002731542507.png)
...
5. 再次执行Sync即可导入插件。导入成功后，可在Hvigor任务树中看到以Seq结尾的新增任务。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/8I6kZPCRTWSu6G6Rtyer_A/zh-cn_image_0000002731382531.png)
