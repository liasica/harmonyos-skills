---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-scalar-binocular-maxs
title: Maxs
...
content_hash: sha256:ffa993b6167c6c4c4e4a8ce35ffa6485a989510402382fa825d5fc88389edbd7
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/sM-abxfETxGlOz6U-idD2w/zh-cn_image_0000002727592130.png)
...
| scalarValue | 输入 | 源操作数，数据类型需要与目的操作数Tensor中元素的数据类型保持一致  Kirin9020系列处理器、Kirin9030系列处理器、KirinX90系列处理器，支持的数据类型为：Tensor（int16\_t、int32\_t、half、float）。 |
