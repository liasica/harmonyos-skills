---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-aes-sym-encrypt-decrypt-gcm-by-segment
title: 使用AES对称密钥（GCM模式）分段加解密(ArkTS)
breadcrumb: 指南 > 系统 > 安全 > Crypto Architecture Kit（加解密算法框架服务） > 加解密 > 加解密开发指导 > 使用AES对称密钥（GCM模式）分段加解密(ArkTS)
category: harmonyos-guides
scraped_at: 2026-04-28T07:42:24+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:467afcd2ded431f20a1f5a2f6b884e53caccc18da473237dfe196ebc91e044e9
---
...
* 异步方法示例：
  ...
  33. let cipher = cryptoFramework.createCipher('AES128|GCM|PKCS7');
  ...
  56. let decoder = cryptoFramework.createCipher('AES128|GCM|PKCS7');
  ...
  81. let aesGenerator = cryptoFramework.createSymKeyGenerator('AES128');
  82. let symKey = await aesGenerator.convertKey(symKeyBlob);
  83. console.info('convertKey result: success.');
  84. return symKey;
  85. }

  87. async function aes() {
  ...
  [aes\_gcm\_seg\_encryption\_decryption\_asynchronous.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260112/Security/CryptoArchitectureKit/EncryptionDecryption/EncryptionDecryptionGuidanceAesArkTs/entry/src/main/ets/pages/aes_gcm_seg_encryption_decryption/aes_gcm_seg_encryption_decryption_asynchronous.ets#L16-L117)
* 同步方法示例：
  ...
  80. let symKeyBlob: cryptoFramework.DataBlob = { data: symKeyData };
  81. let aesGenerator = cryptoFramework.createSymKeyGenerator('AES128');
  82. let symKey = aesGenerator.convertKeySync(symKeyBlob);
  ...
  [aes\_gcm\_seg\_encryption\_decryption\_synchronous.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260112/Security/CryptoArchitectureKit/EncryptionDecryption/EncryptionDecryptionGuidanceAesArkTs/entry/src/main/ets/pages/aes_gcm_seg_encryption_decryption/aes_gcm_seg_encryption_decryption_synchronous.ets#L16-L117)
