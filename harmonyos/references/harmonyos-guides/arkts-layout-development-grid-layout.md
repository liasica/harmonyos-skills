...
content_hash: sha256:891afde96148233dd3feac075c6054b7d92e0371cfeb1be0cf026f9580ae2007
---
...
* 栅格容器通过监听窗口或容器的尺寸变化进行断点，通过[reference](../harmonyos-references/ts-container-gridrow.md#breakpoints)设置断点切换参考物。考虑到应用可能以非全屏窗口的形式显示，以应用窗口宽度为参照物更为通用。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a7/v3/kTkRfwRMS2ecBuQzf5sDUg/zh-cn_image_0000002753294359.gif)
...
* API version 20及以后，columns默认值为{ xs: 2, sm: 4, md: 8, lg: 12, xl: 12, xxl: 12 }。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/XWSGc-5jSv6syPSoLQ4NGA/zh-cn_image_0000002753454277.png)

  API version 20及以后布局显示（以sm设备为例，默认栅格列数为4）：

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/kEN45RI5TUqp3ruf3RB-Zw/zh-cn_image_0000002723854512.png)
...
* 当columns类型为number时，栅格布局在任何尺寸设备下都被分为同一列数。下面分别设置栅格布局列数为4和8，子元素占一列，效果如下：
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/l20Pq7kkQP-dVc6HlTvcFQ/zh-cn_image_0000002723694594.png)
* 当columns类型为[GridRowColumnOption](../harmonyos-references/ts-container-gridrow.md#gridrowcolumnoption)时，支持下面6种不同尺寸（xs，sm，md，lg，xl，xxl）设备的栅格列数设置，不同尺寸的设备支持配置不同的栅格列数。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a2/v3/24VuNdJXRimbNriQRMBLGg/zh-cn_image_0000002753294361.gif)

  API version 20及以后布局显示（xs设备继承sm设备栅格列数）：

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/55BMn_FxQ_2kN04aAhYoUA/zh-cn_image_0000002753454279.gif "点击放大")
...
* 子组件默认从左往右排列。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/04/v3/5jfHGRQfTkaJcnfg-X05pA/zh-cn_image_0000002723854514.png)
* 子组件从右往左排列。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e3/v3/KL-ioC4PR5qWSAxJCOusdg/zh-cn_image_0000002723694596.png)
...
* 当gutter类型为number时，同时设置栅格子组件间水平和垂直方向边距且相等。下例中，设置子组件水平与垂直方向距离相邻元素的间距为10。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/q1U4ZyJITwKQgxWUBUeIxw/zh-cn_image_0000002753294363.png)
* 当gutter类型为[GutterOption](../harmonyos-references/ts-container-gridrow.md#gutteroption)时，单独设置栅格子组件水平垂直边距，x属性为水平方向间距，y为垂直方向间距。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/iApO9FL9Tx2qlQ-1XYFwjQ/zh-cn_image_0000002753454281.png)
...
* 当span类型为number时，子组件在所有尺寸设备下占用的列数相同。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/tZXJbQ_xSvOs-nWWbLZ-_g/zh-cn_image_0000002723854516.png)
* 当span类型为GridColColumnOption时，支持6种不同尺寸（xs，sm，md，lg，xl，xxl）设备中子组件所占列数设置，不同尺寸的设备下子组件支持配置不同列数。若仅部分设置sm、md的列数，未配置的xs、lg、xl、xxl设备根据列数补全（见[GridColColumnOption](../harmonyos-references/ts-container-gridcol.md#gridcolcolumnoption)）取默认值。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/IU46YptXT-W-mBaO-TWjBA/zh-cn_image_0000002723694598.gif)
...
* 当offset类型为number时，子组件偏移相同列数。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/6XE1x25CTKeWeK2A8F4hGw/zh-cn_image_0000002753294365.png)
...
* 当offset类型为GridColColumnOption时，支持6种不同尺寸（xs，sm，md，lg，xl，xxl）设备中子组件所占列数设置，各个尺寸下数值可不同。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/AymO5IlySceqIuXA5AiSVg/zh-cn_image_0000002753454283.gif)
...
* 当order类型为number时，子组件在任何尺寸下排序次序一致。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/CNiYRr9hS4G2LvIyad87tQ/zh-cn_image_0000002723854518.png)
* 当order类型为GridColColumnOption时，支持6种不同尺寸（xs，sm，md，lg，xl，xxl）设备中子组件排序次序设置。在xs设备中，子组件排列顺序为1234；sm为2341，md为3412，lg为2431。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/pqrpHiaYQ6WIqyUzrk4XKA/zh-cn_image_0000002723694600.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/j3ULNY-cSlyXSCVdbZnYow/zh-cn_image_0000002753294367.png)
