...
content_hash: sha256:d42f99f478329b43d12550ee4348a9f1999e1affa2f7129ef6eca2128ad5cf6f
---

## 概述

从API version 24开始，支持动态布局容器组件[DynamicLayout](../harmonyos-references/ts-container-dynamiclayout.md)。DynamicLayout支持在运行时动态切换不同的布局算法，同时保持子组件的状态不变。通过DynamicLayout，开发者可以灵活实现同一种内容在不同场景下的多种布局展示。DynamicLayout组件支持的布局算法类包括[RowLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#rowlayoutalgorithm)、[ColumnLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#columnlayoutalgorithm)、[StackLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#stacklayoutalgorithm)、[GridLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#gridlayoutalgorithm)和自定义布局算法类[CustomLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#customlayoutalgorithm)。

## 约束与限制

1. 布局算法类使用[@ObservedV2](arkts-new-observedv2-and-trace.md)装饰，不支持[@State](arkts-state.md)装饰器。
2. 切换布局算法时，子组件的状态（如输入框内容、滚动位置等）保持不变。
3. 在自定义布局算法的[onMeasure](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#onmeasure)和[onLayout](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#onlayout)方法中不允许修改状态变量，避免不可预期的行为。

## 创建DynamicLayout

通过传入[LayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#layoutalgorithm-1)类型入参，创建[DynamicLayout](../harmonyos-references/ts-container-dynamiclayout.md#接口)组件并设置布局算法。[LayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#layoutalgorithm-1)类型变量支持赋值具体的布局算法类对象，包括[内置布局算法](arkts-layout-development-dynamiclayout.md#内置布局算法)和[自定义布局算法](arkts-layout-development-dynamiclayout.md#自定义布局算法)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d7/v3/_K_kZSGaTsuwqV2PxLgwCg/zh-cn_image_0000002736312557.gif)

## 内置布局算法

线性布局算法[RowLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#rowlayoutalgorithm)和[ColumnLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#columnlayoutalgorithm)具有自适应拉伸、缩放的能力，可以用于界面元素自适应布局的场景。堆叠布局算法[StackLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#stacklayoutalgorithm)具有较强的页面层叠、位置定位能力，可以用于广告、卡片层叠等页面场景。网格布局算法[GridLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#gridlayoutalgorithm)具有较好的规律结构，适合展示同类项目集合，例如显示图片、视频、音乐、新闻、商品等。

### RowLayoutAlgorithm

[RowLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#rowlayoutalgorithm)是水平方向线性布局算法，子组件沿水平方向依次排列。该算法支持设置子组件间距、子组件在主轴（水平方向）上的对齐方式、在交叉轴（垂直方向）上的对齐方式，以及是否反转子组件的排列方向。该布局算法与[Row](../harmonyos-references/ts-container-row.md)组件布局效果一致，详细效果说明请参考[线性布局（Row/Column）](arkts-layout-development-linear.md)。下述示例通过修改RowLayoutAlgorithm对象的space、justifyContent、alignItems和isReverse成员变量，调整子组件间距、主轴（水平方向）对齐方式、交叉轴（竖直方向）对齐方式和排列方向。

从API version 24开始，新增[RowLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#rowlayoutalgorithm)的[space](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#属性)、[justifyContent](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#属性)、[alignItems](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#属性)、[isReverse](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#属性)属性。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a2/v3/cPIPRHPBRpuBuLy1k7r3xw/zh-cn_image_0000002706673514.gif)

### ColumnLayoutAlgorithm

[ColumnLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#columnlayoutalgorithm)是垂直方向线性布局算法，子组件沿垂直方向依次排列。该算法支持设置子组件间距、子组件在主轴（垂直方向）上的对齐方式、在交叉轴（水平方向）上的对齐方式，以及是否反转子组件的排列方向。该布局算法与[Column](../harmonyos-references/ts-container-column.md)组件布局效果一致，详细效果说明请参考[线性布局（Row/Column）](arkts-layout-development-linear.md)。下述示例通过修改ColumnLayoutAlgorithm的space、justifyContent、alignItems和isReverse属性，调整子组件间距、主轴（竖直方向）对齐方式、交叉轴（水平方向）对齐方式和排列方向。

从API version 24开始，新增[ColumnLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#columnlayoutalgorithm)的[space](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#属性-1)、[justifyContent](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#属性-1)、[alignItems](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#属性-1)、[isReverse](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#属性-1)属性。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/0zUDxfnBT4WcoDmtJ_AGYQ/zh-cn_image_0000002736432605.gif)

### StackLayoutAlgorithm

[StackLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#stacklayoutalgorithm)是堆叠布局算法，子组件堆叠排列，后添加的子组件覆盖先添加的子组件。该算法支持通过alignContent设置子组件在容器中的九宫格对齐位置，子组件可以通过[layoutGravity](../harmonyos-references/ts-universal-attributes-location.md#layoutgravity20)属性单独设置自己的对齐方式，优先级高于容器的alignContent。该布局算法与[Stack](../harmonyos-references/ts-container-stack.md)组件布局效果一致，详细效果说明请参考[堆叠布局](arkts-layout-development-stack-layout.md)。下述示例通过修改[StackLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#stacklayoutalgorithm)的[alignContent](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#属性-2)属性，调整子组件在容器中的九宫格对齐位置。

从API version 24开始，新增[StackLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#stacklayoutalgorithm)的[alignContent](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#属性-2)属性。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/71/v3/DQCT-GHJQM6UBBewqAWrrQ/zh-cn_image_0000002706833450.gif)

### GridLayoutAlgorithm

[GridLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#gridlayoutalgorithm)是垂直方向网格布局算法。该算法支持通过[columnsTemplate](../harmonyos-references/ts-container-lazyvgridlayout.md#columnstemplate)或[ItemFillPolicy](../harmonyos-references/ts-types.md#itemfillpolicy22)设置列数，设置[ItemFillPolicy](../harmonyos-references/ts-types.md#itemfillpolicy22)为BREAKPOINT\_DEFAULT时行为与[Grid](../harmonyos-references/ts-container-grid.md)一致，行数由子节点数量和列数决定。该算法支持通过[LengthMetrics](../harmonyos-references/js-apis-arkui-graphics.md#lengthmetrics12)设置行间距和列间距，通过[align](../harmonyos-references/ts-universal-attributes-location.md#align20)设置组件在网格中的对齐方式。下述示例修改GridLayoutAlgorithm的columnsTemplate属性调整网格列数。

从API version 24开始，新增[GridLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#gridlayoutalgorithm)的[columnsTemplate](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#属性-3)属性。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/tct3Dp1jS8mFKmOI2o9s8A/zh-cn_image_0000002736312559.gif)

## 自定义布局算法

自定义布局算法通过继承[CustomLayoutAlgorithm](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#customlayoutalgorithm)类，重写[onMeasure](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#onmeasure)和[onLayout](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#onlayout)方法实现。开发者可以根据具体业务需求，自定义子组件的大小测量和位置排列，实现内置布局算法无法满足的个性化布局效果，如瀑布流、标签云等不规则布局。

### 自定义布局算法实现指导

通过调用[FrameNode](../harmonyos-references/js-apis-arkui-framenode.md#framenode-1)的[getChildrenCount()](../harmonyos-references/js-apis-arkui-framenode.md#getchildrencount12)和[getChild()](../harmonyos-references/js-apis-arkui-framenode.md#getchild12)方法，开发者可以获取所有子组件FrameNode。在onMeasure方法中，调用[measure()](../harmonyos-references/js-apis-arkui-framenode.md#measure12)方法可以自定义测量子组件大小。在onLayout方法中，调用[getMeasuredSize()](../harmonyos-references/js-apis-arkui-framenode.md#getmeasuredsize12)可以获取子组件测量后的尺寸，调用[layout()](../harmonyos-references/js-apis-arkui-framenode.md#layout12)方法可以自定义排列子组件位置。下述示例展示如何重写[onMeasure](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#onmeasure)和[onLayout](../harmonyos-references/js-apis-arkui-layoutalgorithm.md#onlayout)方法，调用[FrameNode](../harmonyos-references/js-apis-arkui-framenode.md#framenode-1)的相关方法实现水平方向线性布局的效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/NPp0X1uyRfGJZ4jLg3r53w/zh-cn_image_0000002706673516.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a2/v3/SNC7IpcsTxCNTeDyDmb89A/zh-cn_image_0000002736432607.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8c/v3/vHpHvBUJSWGZmJZXHRTljw/zh-cn_image_0000002706833452.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/NzMIDnjATn2-dFZgKEpsag/zh-cn_image_0000002736312561.png)

## 切换布局算法

DynamicLayout在切换布局算法时会保持子组件的状态不变，比如输入框内容、开关状态、进度条值等。下述示例展示[TextInput](../harmonyos-references/ts-basic-components-textinput.md#接口)、[Toggle](../harmonyos-references/ts-basic-components-toggle.md#接口)、[Slider](../harmonyos-references/ts-basic-components-slider.md#接口)和[CheckBox](../harmonyos-references/ts-basic-components-checkbox.md)组件在布局切换过程中保持状态，同时使用[animateTo](../harmonyos-references/arkts-apis-uicontext-uicontext.md#animateto)为布局切换添加平滑的动画效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/D9MUGvCLToa9Qsj9nbM61Q/zh-cn_image_0000002706673518.gif)

DynamicLayout支持以下几种方式触发重新布局：

* 通过状态变量切换布局算法。

  开发者使用[@Local](arkts-new-local.md)装饰器修饰布局算法变量，可以实现运行时动态切换布局。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/34/v3/VrJGRohvTNqgUqr8rSx6BA/zh-cn_image_0000002736432609.gif)
* 通过条件运算符切换布局算法。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/76/v3/ixber97WQqGf32NKtKkgbQ/zh-cn_image_0000002706833454.gif)
* 通过修改算法属性触发重新布局。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/50/v3/W20z3NyuQXuzIqps-XeUoQ/zh-cn_image_0000002736312563.gif)
* 响应式布局算法切换。
  ...
  此示例在运行前需要在工程配置文件[module.json5](module-configuration-file.md)中的abilities字段里配置"orientation": "auto\_rotation"。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/sJd6fgA8R22Lzs_3OPR9Hw/zh-cn_image_0000002706673520.gif)
