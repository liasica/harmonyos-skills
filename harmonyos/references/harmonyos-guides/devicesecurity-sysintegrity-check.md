...
content_hash: sha256:e041d4337ab42d6449872047af4399e2e6cda4ca3f1a7a28df2a7698915e45e8
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/QoBWyI4pTRywYEu-UVx6fg/zh-cn_image_0000002558605228.png)
...
以下是系统完整性检测相关接口，包括ArkTS API，更多接口及使用方法请参见[API参考](../harmonyos-references/devicesecurity-safetydetectenhanced-api.md#checksysintegrity)。

| 接口名 | 描述 |
| --- | --- |
| [checkSysIntegrity](../harmonyos-references/devicesecurity-safetydetectenhanced-api.md#checksysintegrity)(req: [SysIntegrityRequest](../harmonyos-references/devicesecurity-safetydetectenhanced-api.md#sysintegrityrequest)): Promise<[SysIntegrityResponse](../harmonyos-references/devicesecurity-safetydetectenhanced-api.md#sysintegrityresponse)> | 检测系统完整性 |
...
2. 调用接口获取系统完整性检测结果。
   ...
   9. const data: safetyDetect.SysIntegrityResponse = await safetyDetect.checkSysIntegrity(req);
   10. hilog.info(0x0000, TAG, 'Succeeded in checkSysIntegrity: %{public}s', data.result);
   11. } catch (err) {
   12. let e: BusinessError = err as BusinessError;
   13. hilog.error(0x0000, TAG, 'CheckSysIntegrity failed: %{public}d %{public}s', e.code, e.message);
   14. }
   ```
3. 在您的应用服务器中验证检测结果。
