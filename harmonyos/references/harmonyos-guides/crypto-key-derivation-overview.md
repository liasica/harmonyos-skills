...
title: 密钥派生
breadcrumb: 指南 > 系统 > 安全 > Crypto Architecture Kit（加解密算法框架服务） > 密钥派生
...
| --- | --- | --- | --- |
| HKDF | SHA1 | [EXPAND\_ONLY|EXTRACT\_ONLY|EXTRACT\_AND\_EXPAND] | 12+ |
| HKDF | SHA224 | [EXPAND\_ONLY|EXTRACT\_ONLY|EXTRACT\_AND\_EXPAND] | 12+ |
