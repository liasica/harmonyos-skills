...
content_hash: sha256:9b0e5953b45bf1315278200e001017afa3202fcc7ae9bad421c41c54191721a8
---
...
* [主体分割](core-vision-subject-segmentation.md)：可以检测出图片中区别于背景的前景物体或区域（即“显著主体”），并将其从背景中分离出来，适用于需要识别和提取图像主要信息的场景，广泛使用于前景目标检测和前景主体分离的场景。
