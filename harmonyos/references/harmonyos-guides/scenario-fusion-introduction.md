---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/scenario-fusion-introduction
...
content_hash: sha256:9d317bde82d05333fbd1e96a367c741edd910d9b2782678ec20690b1f4fbeb3a
---
...
| 场景化API | 请参见[支持的国家/地区](scenario-fusion-appendix-support-regions.md)。 |
...
| 打开APP Button | 支持（5.0.1(13)+） | 支持（5.0.1(13)+） | 支持（5.0.1(13)+） | 不支持 | 支持（5.1.1(19)+） |
| 选择收货地址Button | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 选择发票抬头Button | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 地图选点Button | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 权限设置Button | 支持（5.0.2(14)+） | 支持（5.0.2(14)+） | 支持（5.0.5(17)+） | 不支持 | 支持（5.1.1(19)+） |
...
| 通过API获取系统信息属性 | 支持（5.0.1(13)+） | 支持（5.0.1(13)+） | 支持（5.0.5(17)+） | 支持（6.1.0(23)+） | 支持（5.1.1(19)+） |
| 通过API异步获取系统信息属性 | 支持（5.0.1(13)+） | 支持（5.0.1(13)+） | 支持（5.0.5(17)+） | 支持（6.1.0(23)+） | 支持（5.1.1(19)+） |
| 通过API获取系统设置属性 | 支持（5.0.1(13)+） | 支持 （5.0.1(13)+） | 支持 （5.0.5(17)+） | 支持（6.1.0(23)+） | 支持（5.1.1(19)+） |
| 通过API展示关注组件 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 省市区选择器Input | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 智能填充服务 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 文件路径转换API | 支持（5.0.2(14)+） | 支持（5.0.2(14)+） | 不支持 | 不支持 | 不支持 |

macOS(ARM)系统支持的设备类型见下表。

| 场景 | Phone | Tablet | 2in1 | Wearable | TV |
| --- | --- | --- | --- | --- | --- |
| 快速验证手机号Button | 支持（5.0.1(13)+） | 支持（5.0.1(13)+） | 支持（5.0.5(17)+） | 不支持 | 支持（5.1.1(19)+） |
| 选择头像Button | 支持（5.0.1(13)+） | 支持（5.0.1(13)+） | 支持（5.0.5(17)+） | 不支持 | 不支持 |
| 打开APP Button | 支持（5.0.1(13)+） | 支持（5.0.1(13)+） | 支持（5.0.5(17)+） | 不支持 | 支持（5.1.1(19)+） |
| 选择收货地址Button | 支持（5.0.1(13)+） | 支持（5.0.1(13)+） | 支持（5.0.5(17)+） | 不支持 | 不支持 |
| 选择发票抬头Button | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 地图选点Button | 支持（5.0.1(13)+） | 支持（5.0.1(13)+） | 支持（5.0.5(17)+） | 不支持 | 不支持 |
| 权限设置Button | 支持（5.0.2(14)+） | 支持（5.0.2(14)+） | 支持（5.0.5(17)+） | 不支持 | 支持（5.1.1(19)+） |
| 获取手机号和风险等级Button | 支持（6.0.2(22)+） | 支持（6.0.2(22)+） | 支持（6.0.2(22)+） | 不支持 | 支持（6.1.1(24)+） |
| 服务动态授权码Button | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 元服务分享Button | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 反馈与投诉Button | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 通过API获取系统信息属性 | 支持（5.0.1(13)+） | 支持（5.0.1(13)+） | 支持（5.0.5(17)+） | 支持（6.1.0(23)+） | 支持（5.1.1(19)+） |
