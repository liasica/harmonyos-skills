...
content_hash: sha256:85c75db0c628264ded0c8306b601229ff05b63d5841b81494a93c029e1eadc17
---
...
| 通过API获取系统信息属性 | 支持 | 支持 | 支持 | 支持（6.1.0(23)+） | 支持 |
| 通过API异步获取系统信息属性 | 支持 | 支持 | 支持 | 支持（6.1.0(23)+） | 支持 |
| 通过API获取系统设置属性 | 支持 | 支持 | 支持 | 支持（6.1.0(23)+） | 支持 |
