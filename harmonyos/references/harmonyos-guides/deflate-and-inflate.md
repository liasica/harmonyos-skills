...
content_hash: sha256:198b8e01c17414a612ca668d2b9928d4f58359a2269834881702c89431f369d2
---
...
以下是示例中使用的主要接口，更多接口及使用方式请见[@ohos.zlib (Zip模块)](../harmonyos-references/js-apis-zlib.md)。
...
1. 17800005 传入的数据错误
   ...
   可能原因和处理步骤，请参见错误码[17800005](../harmonyos-references/errorcode-zlib.md#section17800005-传入的数据错误)。
2. 17800007 传入的缓冲区错误

   可能原因和处理步骤，请参见错误码[17800007](../harmonyos-references/errorcode-zlib.md#section17800007-传入的缓冲区错误)。
