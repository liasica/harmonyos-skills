...
content_hash: sha256:e78e6193b7a7460912e5c4680ee3018fa603e8a868b0b27c3dda006f29e26b7e
---
...
1. 确认获取authorizationCode时，调用[AuthorizationWithHuaweiIDRequest](../harmonyos-references/account-api-authentication.md#authorizationwithhuaweiidrequest)接口是否传入正确的scope：'profile'。
   ...
   ```
2. 确保[AuthorizationWithHuaweiIDRequest](../harmonyos-references/account-api-authentication.md#authorizationwithhuaweiidrequest)接口传入正确scope后获取到的authorizationCode/IdToken是否在有效期内。
