...
content_hash: sha256:dfa9c2525124048d954e4534da51ceff74ebc8aa0779b599d608a7e88fb32893
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/ELcLMtZ8Squ647Ev-k5OaQ/zh-cn_image_0000002723856362.png)
...
1. 明确算子的数学表达式及计算逻辑。
   ...
   **图2** 算子计算逻辑
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/06/v3/LnPvPLdARA2gHdDx4eXgPA/zh-cn_image_0000002723696444.png)
2. 明确输入和输出。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/90/v3/_mU7IooUSKu9bmh2CvNhKA/zh-cn_image_0000002753296211.png)
...
* 设置输入输出Global Tensor的Global Memory内存地址。
  ...
  **图4** 多核并行处理示意图
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2c/v3/qQlx4-9PSlqQHYiQ0EwrCQ/zh-cn_image_0000002753456129.png)
* 通过Pipe内存管理对象为输入输出Queue分配内存。
  ...
  **图5** 单核数据切分示意图
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/0nqnX6-JTKu_Fyx6Fb__Dg/zh-cn_image_0000002723856364.png)
