...
content_hash: sha256:ff7694f482a5ba48346820df41cce71f34f874afd11e9354088bf55ae1d7b649
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/4qXBa37ZTxOtXb-dETLZdg/zh-cn_image_0000002717612156.png)
...
1. 明确算子的数学表达式及计算逻辑。
   ...
   **图2** 算子计算逻辑
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cc/v3/OEqqnWrzQoSBKh4DoiwAzA/zh-cn_image_0000002747292109.png)
2. 明确输入和输出。
...
根据[核函数定义](cannkit-kernel-function.md#核函数定义)中介绍的规则进行核函数的定义。
...
根据矢量编程范式对Add算子的实现流程进行设计的思路如下，矢量编程范式请参考[Vector编程范式](cannkit-programming-paradigm.md#vector编程范式)，设计完成后得到的Add算子实现流程图参见图3：
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/AAJ8BnhtQYWRYQAjessA1A/zh-cn_image_0000002747212025.png)
...
* 设置输入输出Global Tensor的Global Memory内存地址。
  ...
  **图4** 多核并行处理示意图
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/uubi8lg5Se6PRFKYbu7ENw/zh-cn_image_0000002717772090.png)
* 通过Pipe内存管理对象为输入输出Queue分配内存。
  ...
  **图5** 单核数据切分示意图
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/4pjG0W2yTvK7lbiXydKvyg/zh-cn_image_0000002717612158.png)
