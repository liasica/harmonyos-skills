...
content_hash: sha256:b285ce6e589d08783fa258daf8e0a9526c922f09434d1489e83323bbc1ab8c58
---
...
| 类型 | 说明 |
| --- | --- |
| [RequestInfo](js-apis-app-ability-dialogrequest.md#requestinfo) | 请求方RequestInfo，用于绑定模态弹框。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| windowRect10+ | [WindowRect](js-apis-app-ability-dialogrequest.md#windowrect10) | 否 | 是 | 表示模态弹框的属性。当需要自定义模态弹框的位置和尺寸时传入此参数；不传入时使用系统默认的弹窗位置和尺寸。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| result | [ResultCode](js-apis-app-ability-dialogrequest.md#resultcode) | 否 | 否 | 表示结果码，用于判断请求是否成功。 |
