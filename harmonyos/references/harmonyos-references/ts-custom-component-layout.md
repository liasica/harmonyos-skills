...
content_hash: sha256:8e667e6fb574d74757cb6153a7432ee405a9256255666c2ff6c80c6e756fb41e
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| selfLayoutInfo | [GeometryInfo](ts-custom-component-layout.md#geometryinfo10) | 是 | 父组件（自定义组件）布局信息。  **说明：**  第一次布局时以自身设置的属性为准。 |
| children | Array<[Measurable](ts-custom-component-layout.md#measurable10)> | 是 | 计算子组件大小后的测量信息。  **说明：**  如果没有设置子组件的尺寸信息，子组件会维持上一次的尺寸，当子组件从来没有设置过尺寸时，尺寸默认为0。 |
...
| 类型 | 说明 |
| --- | --- |
| [SizeResult](ts-custom-component-layout.md#sizeresult10) | 自定义组件自身的尺寸信息，包含测量后的宽度和高度。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| selfLayoutInfo | [GeometryInfo](ts-custom-component-layout.md#geometryinfo10) | 是 | 父组件（自定义组件）布局信息。 |
| children | Array<[Layoutable](ts-custom-component-layout.md#layoutable10)> | 是 | 计算子组件大小后的子组件布局信息。 |
| constraint | [ConstraintSizeOptions](ts-types.md#constraintsizeoptions) | 是 | 父组件传入的布局约束信息，包含minWidth、maxWidth、minHeight、maxHeight等约束条件。取值原则：minWidth≤maxWidth，minHeight≤maxHeight；单位：vp。 |

**示例：**

示例请参考[自定义布局代码示例](ts-custom-component-layout.md#示例1自定义布局代码示例)。

## GeometryInfo10+

父组件（自定义组件）布局信息，继承自[SizeResult](ts-custom-component-layout.md#sizeresult10)。在onMeasureSize和onPlaceChildren方法中，可通过selfLayoutInfo参数获取GeometryInfo对象，其中包含父组件的边框宽度、外边距和内边距信息，开发者在计算子组件布局时需要考虑这些信息。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| borderWidth | [EdgeWidth](ts-types.md#edgewidth10) | 否 | 否 | 父组件边框宽度。  单位：vp。 |
| margin | [Margin](ts-types.md#margin) | 否 | 否 | 父组件margin信息。  单位：vp。 |
| padding | [Padding](ts-types.md#padding) | 否 | 否 | 父组件padding信息。  单位：vp。 |
...
| 类型 | 说明 |
| --- | --- |
| [MeasureResult](ts-custom-component-layout.md#measureresult10) | 测量后的组件布局信息，包含测量后的宽度和高度。 |
...
从API version 9开始支持，从API version 10开始废弃。建议使用[onPlaceChildren](ts-custom-component-layout.md#onplacechildren10)替代。
...
从API version 9开始支持，从API version 10开始废弃。建议使用[onMeasureSize](ts-custom-component-layout.md#onmeasuresize10)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| childLayoutInfo | [LayoutInfo](ts-custom-component-layout.md#layoutinfodeprecated) | 是 | 子组件layout信息，包含position（位置坐标）和constraint（约束尺寸）。其中position用于设置子组件的位置，constraint用于传递约束信息给子组件。 |
...
从API version 9开始支持，从API version 10开始废弃。建议使用[getBorderWidth](ts-custom-component-layout.md#getborderwidth12)、[getMargin](ts-custom-component-layout.md#getmargin12)、[getPadding](ts-custom-component-layout.md#getpadding12)替代。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| borderWidth | [EdgeWidths](ts-types.md#edgewidths9) | 否 | 否 | 边框宽度类型，用于描述组件边框不同方向的宽度。  单位：vp。 |
| margin | [Margin](ts-types.md#margin) | 否 | 否 | 外边距类型，用于描述组件不同方向的外边距。  单位：vp。 |
| padding | [Padding](ts-types.md#padding) | 否 | 否 | 内边距类型，用于描述组件不同方向的内边距。  单位：vp。 |
...
从API version 9开始支持，从API version 10开始废弃。建议使用[Layoutable](ts-custom-component-layout.md#layoutable10)替代。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/92/v3/PRk0FoOVQNyVQjJ1KX5bPw/zh-cn_image_0000002736435411.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/sBaVWM7bSv27S7XYlPDtvA/zh-cn_image_0000002706836260.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/p-Nicsn0Sdiai498jCWIZg/zh-cn_image_0000002736315365.jpg)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/4peoSyGGQbu_O-FC0Jna3g/zh-cn_image_0000002706676326.jpg)
