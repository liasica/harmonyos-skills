---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/gameservice-error-code
title: ArkTS API错误码
...
3. 未配置白名单，请参见[开发准备](../harmonyos-guides/gameservice-nearbytransfer-config-agc.md)联系运营申请开通。
