---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-uiextensionability
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| launchParam12+ | [AbilityConstant.LaunchParam](js-apis-app-ability-abilityconstant.md#launchparam) | 是 | 应用启动参数，包含应用启动原因、应用上次退出原因等。 |
