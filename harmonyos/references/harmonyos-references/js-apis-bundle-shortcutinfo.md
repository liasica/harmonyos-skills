...
content_hash: sha256:13c57f20857bf0d6e16c4945e914224630609d0f28039018cf4e30ee9545fac7
---

应用配置文件中定义的快捷方式信息，[FA模型](../harmonyos-guides/ability-terminology.md#fa模型)配置在[config.json](../lite-wearable-guides/application-configuration-file-overview-fa.md)文件中进行配置，[Stage模型](../harmonyos-guides/ability-terminology.md#stage模型)配置在开发视图的resources/base/profile下面定义配置文件即可。
