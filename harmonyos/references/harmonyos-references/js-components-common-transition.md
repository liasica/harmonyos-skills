...
content_hash: sha256:9c0569805f1c73b573a2dae63900efb8957ecd9068af0c49e94e3f99f1bebc0d
---
...
2. 共享元素的exchange效果类似下图。
   ...
   **图1** 共享元素转场默认效果
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/SOoYnydpTSGeWu-GlXbnmQ/zh-cn_image_0000002772900505.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/TE7QMGYZQSaU_m3xOwHWdg/zh-cn_image_0000002743381254.gif)
...
3. transition-enter/transition-exit说明如下：
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a7/v3/vYQSMWM9TiKsoa9zZFPfWQ/zh-cn_image_0000002743221366.png)

   b. back场景下：退出页面栈的Page2.js应用transition-enter描述的动画配置，并进行倒播；从页面栈第二位置进入栈顶位置的Page1.js应用transition-exit描述的动画配置，并进行倒播。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/MtwZ09sBQ8iFrVxK5y7xbw/zh-cn_image_0000002772740621.png)
...
2. Page2
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/dTNVNmYZQ9-UXPcTLoiR9Q/zh-cn_image_0000002772900507.gif)
