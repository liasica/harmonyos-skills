...
content_hash: sha256:69adb7adc8c11dcdb690ba001dedff64f2eec90b34b7522f087de1815c39de15
---
...
2. 共享元素的exchange效果类似下图。
   ...
   **图1** 共享元素转场默认效果
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/QEjEZiwwRqap5mAlzySn3Q/zh-cn_image_0000002769332807.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bf/v3/JrYUky7tS9GWR8GxVmq0jw/zh-cn_image_0000002769452669.gif)
...
3. transition-enter/transition-exit说明如下：
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/aH9uYdzxQDS51h2cma4UOw/zh-cn_image_0000002739893338.png)

   b. back场景下：退出页面栈的Page2.js应用transition-enter描述的动画配置，并进行倒播；从页面栈第二位置进入栈顶位置的Page1.js应用transition-exit描述的动画配置，并进行倒播。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cc/v3/Xy7FH9WkQbyu0-VX-nYD2Q/zh-cn_image_0000002739733462.png)
...
2. Page2
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/oPA-MJ5JRiunGtXE0T13lw/zh-cn_image_0000002769332809.gif)
