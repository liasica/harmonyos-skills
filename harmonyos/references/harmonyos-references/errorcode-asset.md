---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-asset
title: 关键资产存储服务错误码
...
2. 调用[asset.add](js-apis-asset.md#assetadd)时，指定参数asset.Tag.CONFLICT\_RESOLUTION的值为asset.ConflictResolution.OVERWRITE。
...
1. 业务手动删除了设备中data/service/el1/public/asset\_service某一级目录。
2. 文件系统损坏。
