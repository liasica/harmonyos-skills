...
scraped_at: 2026-09-05T06:21:27+08:00
doc_updated_at: 2026-08-29
content_hash: sha256:c7d8edeb1f741bd030adfdd5edd70b910f0f1539c70ac4eb10e116aea8eda564
---
...
请求体示例请参见[通知消息](push-scenariozed-api-request-example.md#通知消息)。

| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| notification | 是 | [Notification](push-scenariozed-api-request-param.md#notification) Object | 通知消息结构体，详情请参见[Notification](push-scenariozed-api-request-param.md#notification)结构体。 |
...
请求体示例请参见[语音播报消息](push-scenariozed-api-request-example.md#语音播报消息)。
...
请求体示例请参见[卡片刷新消息](push-scenariozed-api-request-example.md#卡片刷新消息)。
...
| abilityName | 是 | String | 服务卡片Ability名称。  项目模块级别下的**src/main/module.json5**中的[extensionAbilities](../harmonyos-guides/module-configuration-file.md#extensionabilities标签)标签下的服务卡片的ability名称。 |
| formData | 是 | Object | 待刷新服务卡片的业务数据，key-value格式。  该数据来源于**卡片页面文件**中的声明式范式组件名称，**卡片页面文件**位于项目模块级别下的**src/main/ets/widgets**，请参见[指南](../harmonyos-guides/push-form-update.md#推送卡片刷新消息-1)。  **说明：**  · formData中的key不能以**datashareproxy://** 开头。  · formData中的value如果是数值类型，不能超过**253-1**。  · formData中的value取值不允许为**null**。 |

### FormImage

| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| keyName | 否 | String | 图片的对应的key，该值不能与formData中自定义的变量数据的key重复。  该数据来源于**卡片页面文件**中的图片组件名称，**卡片页面文件**位于项目模块级别下的**src/main/ets/widgets**，请参见[指南](../harmonyos-guides/push-form-update.md#推送卡片刷新消息-1)。 |
| url | 否 | String | 图片下载地址，URL使用的协议必须是HTTPS协议。  **说明：**  支持图片的格式为PNG、JPG、JPEG、WEBP，图片文件最大为512KB，若超过则图片不展示。（注意消息体大小限制，详情参见[使用约束](push-scenariozed-api-intro.md#使用约束)） |
...
请求体示例请见[后台消息](push-scenariozed-api-request-example.md#后台消息)。

| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| extraData | 是 | String | 传递给应用的数据。（注意消息体大小限制，详情参见[使用约束](push-scenariozed-api-intro.md#使用约束)）  Push检测应用是否在前台，应用如果在前台则传递到目标应用，如果不在前台，则缓存或静默写入应用自身缓存。  extraData数据获取请参考[示例代码](https://gitcode.com/HarmonyOS_Samples/push-kit-sample-code-clientdemo-arkts/blob/master/entry/src/main/ets/abilities/PushMessageAbility.ets)。 |
...
| 布局类型 | 字段 |
| --- | --- |
| 进度可视化类型  赛事类型 | activityData.notificationData.[contentTitle](push-scenariozed-api-request-param.md#notificationdata)  activityData.notificationData.[contentText](push-scenariozed-api-request-param.md#notificationdata).[text](push-scenariozed-api-request-param.md#richtext)  activityData.notificationData.[extend](push-scenariozed-api-request-param.md#notificationdata).[text](push-scenariozed-api-request-param.md#extend) |
| 强调文本模板类型 | activityData.notificationData.[contentTitle](push-scenariozed-api-request-param.md#notificationdata)  activityData.notificationData.[contentText](push-scenariozed-api-request-param.md#notificationdata).[text](push-scenariozed-api-request-param.md#richtext)  activityData.notificationData.[extend](push-scenariozed-api-request-param.md#notificationdata).[text](push-scenariozed-api-request-param.md#extend)  activityData.notificationData.[singleTextBlock](push-scenariozed-api-request-param.md#notificationdata).[firstLine](push-scenariozed-api-request-param.md#singletextblock)  activityData.notificationData.[singleTextBlock](push-scenariozed-api-request-param.md#notificationdata).[secondLine](push-scenariozed-api-request-param.md#singletextblock) |
| 左右文本模板类型 | activityData.notificationData.[contentTitle](push-scenariozed-api-request-param.md#notificationdata)  activityData.notificationData.[contentText](push-scenariozed-api-request-param.md#notificationdata).[text](push-scenariozed-api-request-param.md#richtext)  activityData.notificationData.[extend](push-scenariozed-api-request-param.md#notificationdata).[text](push-scenariozed-api-request-param.md#extend)  activityData.notificationData.[firstTextBlock](push-scenariozed-api-request-param.md#notificationdata).[firstLine](push-scenariozed-api-request-param.md#firsttextblock)  activityData.notificationData.[firstTextBlock](push-scenariozed-api-request-param.md#notificationdata).[secondLine](push-scenariozed-api-request-param.md#firsttextblock)  activityData.notificationData.[lastTextBlock](push-scenariozed-api-request-param.md#notificationdata).[firstLine](push-scenariozed-api-request-param.md#lasttextblock)  activityData.notificationData.[lastTextBlock](push-scenariozed-api-request-param.md#notificationdata).[secondLine](push-scenariozed-api-request-param.md#lasttextblock) |
...
| **FLIGHT** | WAITING\_FOR\_CHECK\_IN | 未值机 | 未值机。 |
| **FLIGHT** | CHECKED\_IN | 已值机 | 已值机。 |
| **FLIGHT** | PASSED\_SECURITY\_CHECK | 已安检 | 已安检。 |
| **FLIGHT** | START\_BOARDING | 开始登机 | 开始登机。 |
| **FLIGHT** | URGE\_BOARDING | 催促登机 | 催促登机。 |
| **FLIGHT** | BOARDED | 已登机 | 已登机。 |
| **FLIGHT** | END\_BOARDING | 结束登机 | 结束登机。 |
| **FLIGHT** | ABOUT\_TO\_TAKE\_OFF | 即将起飞 | 即将起飞。 |
| **FLIGHT** | TAKEN\_OFF | 起飞 | 航班起飞。用户关注了某个航班后，向用户提醒航班已经起飞。 |
| **FLIGHT** | ARRIVED | 到达 | 航班到达。 |
| **FLIGHT** | TRANSFER | 中转提醒 | 中转提醒。用户有多趟航班中转，在到达后提醒用户下一趟航班的信息。  若是新航班信息，建议新建一张实况窗卡片承载。 |
| **FLIGHT** | NEW\_ITINERARY | 新行程开启 | 中转航班新行程提醒 |
| **FLIGHT** | GATE\_CHANGE | 登机口变更 | 登机口变更。 |
| **FLIGHT** | FLIGHT\_DELAY | 延误 | 航班延误。 |
| **FLIGHT** | FLIGHT\_CANCEL | 取消 | 航班取消。 |
| **FLIGHT** | FLIGHT\_DIVERSION | 备降 | 航班备降。 |
| **FLIGHT** | FLIGHT\_RETURN | 返航 | 航班返航。 |
| **TAXI** | CALLING | 呼叫车辆中 | 呼叫车辆中。 |
| **TAXI** | ABOUT\_TO\_BEGIN | 行程即将开始 | 行程即将开始。预约订单、顺风车订单的场景，在行程即将开始时，提醒用户出发。 |
| **TAXI** | DRIVER\_ON\_THE\_WAY | 司机正在赶来 | 司机正在赶来。 |
| **TAXI** | DRIVER\_ARRIVE | 司机已到达上车点 | 司机已到达上车点。 |
| **TAXI** | HEADING\_TO\_DESTINATION | 正在去往目的地 | 正在去往目的地。订单有多个目的地时，可持续使用本状态直到行程结束。 |
| **TAXI** | COMPLETED | 行程结束 | 行程结束。 |
| **TAXI** | RE\_CALLING | 重新呼叫车辆中 | 重新呼叫车辆中。订单改派、司机取消订单等导致的车辆重新呼叫。 |
| **TAXI** | CANCELED | 订单已取消 | 订单已取消。用户取消订单、因周边运力不足无法成单的订单，均属于订单已取消。 |
| **TRAIN** | DEPART | 计划出发 | 列车计划出发前一段时间，提醒用户准备出发。 |
| **TRAIN** | PASSED\_SECURITY\_CHECK | 已安检 | 用户已完成安检。 |
| **TRAIN** | TICKET\_CHECK | 检票提醒 | 列车开始检票。 |
| **TRAIN** | CHECKED | 已检票 | 用户已完成检票。 |
| **TRAIN** | CHECK\_IN\_CLOSED | 停止检票 | 检票口截止检票进站。 |
| **TRAIN** | SET\_OFF | 已出发 | 列车驶离出发点。 |
| **TRAIN** | HEADING\_TO\_DESTINATION | 列车运行中 | 列车运行过程中，可以同步向用户展示途径站点、预计剩余时间。 |
| **TRAIN** | ARRIVED | 已到达 | 列车到达目的地。 |
| **TRAIN** | GATE\_CHANGE | 检票口变更 | 检票口变更。 |
| **TRAIN** | TRAIN\_DELAY | 列车晚点 | 列车晚点。 |
| **TRAIN** | TRAIN\_CANCEL | 列车停运 | 列车停运。 |

### ActivityData

| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| notificationData | 是 | [NotificationData](push-scenariozed-api-request-param.md#notificationdata) Object | 消息通知布局数据，具体字段请参见[NotificationData](push-scenariozed-api-request-param.md#notificationdata)结构体。 |
| capsuleData | 否 | [CapsuleData](push-scenariozed-api-request-param.md#capsuledata) Object | 胶囊通知布局数据，具体字段请参见[CapsuleData](push-scenariozed-api-request-param.md#capsuledata)结构体。 |
| externalData | 否 | [ExternalData](push-scenariozed-api-request-param.md#externaldata) Object | 小折叠外屏展示数据，具体字段请参见[ExternalData](push-scenariozed-api-request-param.md#externaldata)结构体。 |
...
| condition | 是 | [Geofence](push-scenariozed-api-request-param.md#geofence) Object | 地理围栏结构或者其他触发条件结构。 |
...
| singleTextBlock | 否 | [SingleTextBlock](push-scenariozed-api-request-param.md#singletextblock) Object | 强调文本模板样式中，强调的文本块，type为4时必填，默认占据左侧扩展区，具体字段请参见[SingleTextBlock](push-scenariozed-api-request-param.md#singletextblock)结构体。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/Y-d1gdiFTLO6lL6l3bCOCA/zh-cn_image_0000002712407378.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/uekYN_CQT5mLFtZx5NMgsA/zh-cn_image_0000002742126329.png)
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| host | 是 | [Team](push-scenariozed-api-request-param.md#team) Object | 扩展区左侧样式，具体字段请参见[Team](push-scenariozed-api-request-param.md#team)结构体。 |
| guest | 是 | [Team](push-scenariozed-api-request-param.md#team) Object | 扩展区右侧样式，具体字段请参见[Team](push-scenariozed-api-request-param.md#team)结构体。 |
| competition | 是 | [Competition](push-scenariozed-api-request-param.md#competition) Object | 扩展区中部样式，具体字段请参见[Competition](push-scenariozed-api-request-param.md#competition)结构体。 |
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| desc | 否 | String | 扩展区中间上方描述文本，当operation为0时，和richDesc至少有一个，且不可为空字符串。（注意消息体大小限制，详情参见[使用约束](push-scenariozed-api-intro.md#使用约束)） |
| richDesc | 否 | Array [[RichText](push-scenariozed-api-request-param.md#richtext) Object] | 扩展区中间上方描述富文本，当operation为0时，和desc至少有一个，且不可为空Array，且Array中的text拼接完后，不能为空串。（注意消息体大小限制，详情参见[使用约束](push-scenariozed-api-intro.md#使用约束)） |
| time | 否 | String | 扩展区中间下方比赛时间，当operation为0时必填，且不可为空字符串。（注意消息体大小限制，详情参见[使用约束](push-scenariozed-api-intro.md#使用约束)） |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/rtMKa4n9QfGUUas5-Z294Q/zh-cn_image_0000002712247422.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/1J45FAMhTlORU3gxkA1ruw/zh-cn_image_0000002742006369.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/53/v3/I95j1qmIRzK--GyrVKYXPQ/zh-cn_image_0000002712407382.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/gK9cMUrqRje_IAzvtanjAw/zh-cn_image_0000002742126333.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/dqNEXxB8QTieASwyh2EKAQ/zh-cn_image_0000002712247424.png)
...
| body | 否 | Array [[RichText](push-scenariozed-api-request-param.md#richtext) Object] | 自定义的外屏通知内容，由多段富文本RichText组成，文本长度总和不超过128字符，若设置文本颜色，只允许设置为同一种颜色。  当operation为0时必填，且不为空Array。 |

### RichText

| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| text | 是 | String | 文本。（注意消息体大小限制，详情参见[使用约束](push-scenariozed-api-intro.md#使用约束)） |
...
请求体示例请见[应用内通话消息](push-scenariozed-api-request-example.md#应用内通话消息)。
