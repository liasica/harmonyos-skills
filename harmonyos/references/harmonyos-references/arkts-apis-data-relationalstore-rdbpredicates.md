...
content_hash: sha256:dee37acf9f9032628ae785c42232d4a9baf6457ca5c829f14a5e61a76ce5cbf6
---
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](arkts-apis-data-relationalstore-rdbpredicates.md) | 返回带有OR条件的Rdb谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](arkts-apis-data-relationalstore-rdbpredicates.md) | 返回带有AND条件的Rdb谓词。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| conditions | string | 是 | 用于过滤使用[groupBy](arkts-apis-data-relationalstore-rdbpredicates.md#groupby)获得的数据，conditions参数不能为空字符串且必须与[groupBy](arkts-apis-data-relationalstore-rdbpredicates.md#groupby)配合使用。 |
