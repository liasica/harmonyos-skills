...
content_hash: sha256:785ec0c64b7bdd50d4758433f5e85ed323a52b36c949fb9f12ebc0dcc2497bfb
---
...
1. Want参数配置错误；
2. type类型不一致，具体请参考[EmbeddedComponent组件](ts-container-embedded-component.md#接口)；
3. 提供方应用未安装；
4. 设备类型不支持；
