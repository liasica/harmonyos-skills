...
content_hash: sha256:2a67c0894faaea4099628eed6fc0d2c2e12e3f800cf470cbf86e5de7395c1621
---
...
| AVCODEC\_BUFFER\_FLAGS\_DISCARD = 1 << 4 | 表示缓冲区被解码器依赖，解码之后的数据可丢弃。  **起始版本：** 12 |
| AVCODEC\_BUFFER\_FLAGS\_DISPOSABLE = 1 << 5 | 表示缓冲区不被参考，可直接丢弃。  **起始版本：** 12 |
