...
content_hash: sha256:fd046a3caeea3fc90612b7faad139dd5ff53b5f0e325f13bef73e77d7a1b6794
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [TextMenuOptions](ts-text-common.md#textmenuoptions16对象说明) | 是 | 设置菜单选项。  默认值:{showMode: TextMenuShowMode.DEFAULT} |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| items | Array<[TextMenuItemId](ts-text-common.md#textmenuitemid12)> | 是 | 禁用菜单项的列表。  默认值: []  默认不禁用任何菜单。 |
