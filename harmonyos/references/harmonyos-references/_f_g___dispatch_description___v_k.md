...
content_hash: sha256:1f95ee59224308f4a4bb22908f05d4c0d509025bab8377badd69ccdba4488700
---
...
| uint8\_t [frameIdx](_f_g___dispatch_description___v_k.md#frameidx) | 当前帧序号，序号计数从0开始。该值必须小于[FG\_ContextDescription\_VK](_f_g___context_description___v_k.md)中的framesInFlight，否则会返回错误码FG\_INVALID\_PARAMETER。 |
...
当前帧序号，序号计数从0开始。该值必须小于[FG\_ContextDescription\_VK](_f_g___context_description___v_k.md)中的framesInFlight，否则会返回错误码FG\_INVALID\_PARAMETER。
