---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-partner-combined-orders-close
title: 关闭合单支付订单
breadcrumb: API参考 > 应用服务 > Payment Kit（鸿蒙支付服务） > REST API > 平台类商户/服务商 > 合单支付（仅支持平台类商户） > 关闭合单支付订单
category: harmonyos-references
scraped_at: 2026-04-28T08:18:08+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:e9eac1601cc98e18279ce8aefb4126bea4ebab3f7e906f5647b2234a67d2d498
---
...
* **接口URL：** https://petalpay-developer.cloud.huawei.com.cn/api/v1/partner/combined/orders/close
  ...
  说明：元服务预下单接口请使用<https://petalpay-developer.cloud.huawei.com.cn/api/v1/partner/combined/orders/close>
* **数据格式：**
...
```
1. POST /api/v1/partner/combined/orders/close HTTP/1.1
...
5. {
6. "combinedMercOrderNo": "czl00120240705***"
7. }
```
