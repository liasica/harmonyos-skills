...
scraped_at: 2026-09-10T06:25:31+08:00
doc_updated_at: 2026-09-09
content_hash: sha256:fbca53c64e1f5bc7a52c1d2c2650b626a02168cb0df3d982df2a66c31d00f158
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextInputOptions](ts-basic-components-textinput.md#textinputoptions对象说明) | 否 | TextInput组件参数。默认值undefined。不设置该参数时，输入框初始化为空。 |
...
| text | [ResourceStr](ts-types.md#resourcestr) | 否 | 是 | 设置输入框当前的文本内容。不设置时默认为空字符串。  建议通过onChange事件将状态变量与文本实时绑定，  避免组件刷新时TextInput中的文本内容异常。  从API version 10开始，该参数支持[$$](../harmonyos-guides/arkts-two-way-sync.md)双向绑定变量。  从API version 18开始，该参数支持[!!](../harmonyos-guides/arkts-new-binding.md#系统组件参数双向绑定)双向绑定变量。 |
| controller8+ | [TextInputController](ts-basic-components-textinput.md#textinputcontroller8) | 否 | 是 | 设置TextInput控制器。当需要通过控制器调用光标设置、文本选择等方法时传入此参数。不设置时默认无控制器，无法使用控制器相关方法。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [InputType](ts-basic-components-textinput.md#inputtype枚举说明) | 是 | 输入框类型。 |

**说明** 

密码填充服务需要密码相关的[输入框类型](ts-basic-components-textinput.md#inputtype枚举说明)(如InputType.Password、InputType.NUMBER\_PASSWORD、InputType.NEW\_PASSWORD、InputType.USER\_NAME)。如何使用密码填充服务参考[快速适配](../harmonyos-guides/passwordvault-quick-adaptation.md)。

设置[密码模式](../harmonyos-guides/arkts-common-components-text-input.md#密码模式)时，装饰线[decoration](ts-basic-components-textinput.md#decoration12)、下划线[showUnderline](ts-basic-components-textinput.md#showunderline10)、行高[lineHeight](ts-basic-components-textinput.md#lineheight12)、文字特性[fontFeature](ts-basic-components-textinput.md#fontfeature12)不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](ts-types.md#font) | 否 | placeholder文本样式。  省略该参数时使用系统默认字体样式。  Wearable设备上字体大小默认值为18fp |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | [FontWeight](ts-appendix-enums.md#fontweight) | [ResourceStr](ts-types.md#resourcestr) | 是 | 文本的字体粗细，number类型取值[100,900]，取值间隔为100，取值越大，字体越粗。string类型仅支持number类型取值的字符串形式，例如“400”，以及“bold”、“bolder”、“lighter”、“regular”、“medium”，分别对应FontWeight中相应的枚举值。  从API version 20开始，支持Resource类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](ts-types.md#resourcestr) | 是 | 字体列表。使用多个字体时，请用逗号','分隔，字体的优先级按顺序生效。例如：'Arial,HarmonyOS Sans'。  应用当前支持'HarmonyOS Sans'字体和自定义字体。  卡片当前仅支持'HarmonyOS Sans'字体。  Wearable设备支持'HarmonyOS Sans'字体和自定义字体。 |
...
输入框类型介绍请参考[type](ts-basic-components-textinput.md#type)接口。未通过该接口设置时，默认为TextInputStyle.Default。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextInputStyle](ts-basic-components-textinput.md#textinputstyle9枚举说明) | [TextContentStyle](ts-appendix-enums.md#textcontentstyle10) | 是 | 输入框为默认风格或内联输入风格。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](ts-types.md#resourcestr) | undefined | 否 | 错误状态下提示的错误文本或者不显示错误状态。  默认不显示错误状态。  Wearable设备上字体大小为：13fp，对齐方式为：居中对齐  **说明：**  从API version 12开始，value支持Resource类型。  不支持[TextInputStyle](ts-basic-components-textinput.md#textinputstyle9枚举说明)的内联模式。 |
...
* 下划线只支持[InputType.Normal](ts-basic-components-textinput.md#inputtype枚举说明)类型。
* 设置[密码模式](../harmonyos-guides/arkts-common-components-text-input.md#密码模式)时，装饰线[decoration](ts-basic-components-textinput.md#decoration12)、下划线[showUnderline](ts-basic-components-textinput.md#showunderline10)、行高[lineHeight](ts-basic-components-textinput.md#lineheight12)、文字特性[fontFeature](ts-basic-components-textinput.md#fontfeature12)不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [PasswordIcon](ts-basic-components-textinput.md#passwordicon10对象说明) | 是 | 密码输入模式时，输入框末尾的图标。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | 是 | 内联输入风格编辑态时文本可显示的最大行数。仅设置内联模式且处于编辑态时该属性生效。  取值范围：(0, UINT32\_MAX]。传入0或负数时，按默认值3处理；超出UINT32\_MAX时，自动修正为UINT32\_MAX。 |
...
| options12+ | [KeyboardOptions](ts-basic-components-richeditor.md#keyboardoptions12) | 否 | 设置自定义键盘是否支持避让功能。  不设置该参数时，自定义键盘默认不支持避让功能。 |

### enableAutoFill11+

enableAutoFill(value: boolean)

设置是否启用自动填充。未通过该接口设置时，默认启用自动填充。典型场景参考[密码自动填充服务](../harmonyos-guides/passwordvault.md)、[智能填充服务](../harmonyos-guides/scenario-fusion-intelligent-filling.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | 是 | 定义生成密码的规则。  **说明：**  需先设置[enableAutoFill](ts-basic-components-textinput.md#enableautofill11)启用自动填充功能，并设置[contentType](ts-basic-components-textinput.md#contenttype12)为NEW\_PASSWORD类型，该属性在触发自动填充时生效。 |

### cancelButton11+

cancelButton(options: CancelButtonOptions)

设置右侧清除按钮样式，仅支持图片类型的图标。不支持[TextInputStyle](ts-basic-components-textinput.md#textinputstyle9枚举说明)的内联模式。示例请参考[示例4（设置右侧清除按钮样式）](ts-basic-components-textinput.md#示例4设置右侧清除按钮样式)。未通过该接口设置时，默认为{
...
设置初始状态时，是否全选文本。不支持[TextInputStyle](ts-basic-components-textinput.md#textinputstyle9枚举说明)的内联模式。未通过该接口设置时，默认不会全选文本。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ContentType](ts-basic-components-textinput.md#contenttype12枚举说明) | 是 | 自动填充类型。取值范围：详见ContentType枚举说明。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](ts-types.md#resourcecolor) | [UnderlineColor](ts-basic-components-textinput.md#underlinecolor12对象说明) | undefined | 是 | 设置下划线颜色。  当设置下划线颜色模式时，修改下划线颜色。当只设定非特殊状态下的颜色，可以直接输入ResourceColor。设定值为undefined、null、无效值时，所有下划线恢复为默认值。 |
...
设置文本断行规则。该属性在组件设置[TextInputStyle](ts-basic-components-textinput.md#textinputstyle9枚举说明)的内联模式时样式生效，但对placeholder文本无效。未通过该接口设置时，默认为WordBreak.BREAK\_WORD。
...
设置文本超长时的显示方式。仅在[TextInputStyle](ts-basic-components-textinput.md#textinputstyle9枚举说明)值为内联模式的编辑态、非编辑态下支持。未通过该接口设置时，内联模式非编辑态下默认为TextOverflow.Ellipsis，内联模式编辑态下默认为TextOverflow.Clip。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](ts-types.md#resource) | 是 | 文本最小显示字号。  单位：[fp](ts-pixel-units.md#基本像素单位)  需大于0，小于或等于0时自适应字号不生效，按fontSize属性值生效。  需配合maxFontSize使用，单独设置不生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](ts-types.md#resource) | 是 | 文本最大显示字号。  单位：[fp](ts-pixel-units.md#基本像素单位)  需大于0且大于minFontSize，否则自适应字号不生效，按fontSize属性值生效。  需配合minFontSize使用，单独设置不生效。 |

### heightAdaptivePolicy12+

heightAdaptivePolicy(value: TextHeightAdaptivePolicy)

组件设置为内联输入风格时，设置文本自适应高度的方式。未通过该接口设置时，默认为TextHeightAdaptivePolicy.MAX\_LINES\_FIRST。
...
当[InputType](ts-basic-components-textinput.md#inputtype枚举说明)设置为Password、NEW\_PASSWORD和NUMBER\_PASSWORD模式时，密码保护功能才能生效。非密码输入模式则不会触发该功能。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| visible | boolean | 是 | 是否显示密码。  true表示会显示密码，false表示不会显示密码。  建议在[onSecurityStateChange](ts-basic-components-textinput.md#onsecuritystatechange12)回调中同步状态，避免末尾图标状态异常。 |

### lineBreakStrategy12+

lineBreakStrategy(strategy: LineBreakStrategy)

设置折行规则。该属性在wordBreak不等于BREAK\_ALL的时候生效，不支持连字符。未通过该接口设置时，默认为LineBreakStrategy.GREEDY。

适用于需要优化文本换行效果的场景：LineBreakStrategy.GREEDY适用于优先填充每行的快速换行；LineBreakStrategy.HIGH\_QUALITY适用于追求更优视觉效果的排版；LineBreakStrategy.BALANCED适用于需要均匀分配各行内容的布局。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| strategy | [LineBreakStrategy](ts-appendix-enums.md#linebreakstrategy12) | 是 | 文本的折行规则。  LineBreakStrategy.GREEDY表示贪婪折行，优先填充每行；LineBreakStrategy.HIGH\_QUALITY表示高质量折行，平衡行长；LineBreakStrategy.BALANCED表示均衡折行，优化排版美观。  **说明：**  仅设置[TextInputStyle](ts-basic-components-textinput.md#textinputstyle9枚举说明)的内联模式时该属性生效。 |
...
设置输入框拉起的键盘样式，需要输入法适配后生效。具体参考[输入法应用沉浸模式](../harmonyos-guides/inputmethod-immersive-mode-guide.md)。未通过该接口设置时，默认为KeyboardAppearance.NONE\_IMMERSIVE。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| width | [Optional](ts-universal-attributes-custom-property.md#optionalt)<[LengthMetrics](js-apis-arkui-graphics.md#lengthmetrics12)> | 是 | 文本描边的宽度。当LengthMetrics对象的unit属性为LengthUnit.PERCENT时，当前设置不生效，按默认值处理。  若设置值小于0，显示实心字；若大于0，显示空心字。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isStopped | [Optional](ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否阻止返回键。  true表示阻止，false表示不阻止。 |
...
设置右侧清除按钮样式，仅支持symbol图标。不支持[TextInputStyle](ts-basic-components-textinput.md#textinputstyle9枚举说明)的内联模式。示例请参考[示例15（设置symbol类型清除按钮）](ts-basic-components-textinput.md#示例15设置symbol类型清除按钮)。未通过该接口设置时，默认为{
...
设置省略位置。ellipsisMode属性仅在[TextInputStyle](ts-basic-components-textinput.md#textinputstyle9枚举说明)的内联模式下生效，需要配合[textOverflow](ts-basic-components-textinput.md#textoverflow12)设置为TextOverflow.Ellipsis使用，单独设置ellipsisMode属性不生效。未通过该接口设置时，默认为EllipsisMode.END。

非编辑态时正常生效，编辑态时EllipsisMode.START和EllipsisMode.CENTER仅在maxLines设置为1时生效，EllipsisMode.END、EllipsisMode.MULTILINE\_START和EllipsisMode.MULTILINE\_CENTER正常生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否启用自动填充动效。  true表示启用，false表示不启用。  **说明：**  需先设置[enableAutoFill](ts-basic-components-textinput.md#enableautofill11)启用自动填充功能。启用之后，仅输入模式[InputType](ts-basic-components-textinput.md#inputtype枚举说明)设置为Password、NEW\_PASSWORD或NUMBER\_PASSWORD的输入框在进行自动填充时动效可生效。 |
...
使能后，会调整换行点以尽可能避免孤立字符（段落尾行首字符），改善文本布局。该特性需在wordBreak为非BREAK\_ALL且待排版文本首个[TextStyle](js-apis-graphics-text.md#textstyle)的[locale](js-apis-graphics-text.md#textstyle)为"zh-Hans"或"zh-Hant"时生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 段落最后一行是否使能孤字优化。  true表示使能孤字优化，false表示不使能孤字优化。  值为undefined或null时，不使能孤字优化。  孤字优化需在wordBreak为非BREAK\_ALL并且待排版文本首个TextStyle的locale为"zh-Hans"或"zh-Hant"时生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| strokeJoinStyle | [StrokeJoinStyle](ts-text-common.md#strokejoinstyle) | undefined | 是 | 设置文本描边拐角样式，仅在使用strokeWidth设置文本描边时生效。  值为undefined时，按照StrokeJoinStyle.MITER\_JOIN处理，请参考[StrokeJoinStyle](ts-text-common.md#strokejoinstyle)，文本拐角处表现为锐角。 |
...
当同时设置shaderStyle和[strokeWidth](ts-basic-components-textinput.md#strokewidth20)时，shaderStyle不生效。

shaderStyle的优先级高于[fontColor](ts-basic-components-textinput.md#fontcolor)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shader | [ShaderStyle](ts-text-common.md#shaderstyle20) | undefined | 是 | 文本着色器效果，用于设置文本的渐变或特殊颜色效果。支持线性渐变、径向渐变、纯色等类型。  当同时设置shaderStyle和strokeWidth时，shaderStyle不生效。  值为undefined时，无渐变效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 行高是否基于文字实际高度自适应。  true表示行高基于文字实际高度自适应；false表示行高不基于文字实际高度自适应。  此接口仅当行高小于文字实际高度时生效。 |
...
| Password | 7 | 密码输入模式。  默认输入文字短暂显示后变成圆点。从API version 12开始，PC/2in1设备上输入文字直接显示为圆点。  TV设备上输入框末尾默认不显示小眼睛图标，其他设备输入框末尾默认显示小眼睛图标。  密码输入模式中，[decoration](ts-basic-components-textinput.md#decoration12)、[showUnderline](ts-basic-components-textinput.md#showunderline10)、[lineHeight](ts-basic-components-textinput.md#lineheight12)、[fontFeature](ts-basic-components-textinput.md#fontfeature12)不生效。  在已启用密码保险箱的情况下，支持用户名、密码的自动保存和自动填充。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| NUMBER\_PASSWORD11+ | 8 | 纯数字密码输入模式。  默认输入文字短暂显示后变成圆点。从API version 12开始，PC/2in1设备上输入文字直接显示为圆点。  TV设备上输入框末尾默认不显示小眼睛图标，其他设备输入框末尾默认显示小眼睛图标。  密码输入模式中，[decoration](ts-basic-components-textinput.md#decoration12)、[showUnderline](ts-basic-components-textinput.md#showunderline10)、[lineHeight](ts-basic-components-textinput.md#lineheight12)、[fontFeature](ts-basic-components-textinput.md#fontfeature12)不生效。在已启用密码保险箱的情况下，支持用户名、密码的自动保存和自动填充。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。  **模型约束：** 此接口仅可在Stage模型下使用。 |
| USER\_NAME11+ | 10 | 用户名输入模式，无特殊限制。  在已启用密码保险箱的情况下，支持用户名的自动保存和自动填充，用于配合[InputType.Password](ts-basic-components-textinput.md#inputtype枚举说明)、[InputType.NUMBER\_PASSWORD](ts-basic-components-textinput.md#inputtype枚举说明)、[InputType.NEW\_PASSWORD](ts-basic-components-textinput.md#inputtype枚举说明)完成用户名密码配对填充。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。  **模型约束：** 此接口仅可在Stage模型下使用。 |
| NEW\_PASSWORD11+ | 11 | 新密码输入模式。  默认输入文字短暂显示后变成圆点。从API version 12开始，PC/2in1设备上输入文字直接显示为圆点。  TV设备上输入框末尾默认不显示小眼睛图标，其他设备输入框末尾默认显示小眼睛图标。  密码输入模式中，[decoration](ts-basic-components-textinput.md#decoration12)、[showUnderline](ts-basic-components-textinput.md#showunderline10)、[lineHeight](ts-basic-components-textinput.md#lineheight12)、[fontFeature](ts-basic-components-textinput.md#fontfeature12)不生效。在已启用密码保险箱的情况下，支持自动生成新密码。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。  **模型约束：** 此接口仅可在Stage模型下使用。 |
| NUMBER\_DECIMAL11+ | 12 | 带小数点的数字输入模式。  支持数字，小数点（只能存在一个小数点）。不支持负数（包括负数整数和负数小数）。若需支持负数输入，请使用[inputFilter](ts-basic-components-textinput.md#inputfilter8)属性实现负数过滤。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。  **模型约束：** 此接口仅可在Stage模型下使用。 |
| URL12+ | 13 | 带URL的输入模式，无特殊限制。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。  **模型约束：** 此接口仅可在Stage模型下使用。 |
| ONE\_TIME\_CODE20+ | 14 | 验证码输入模式，无特殊限制。该模式下组件获焦后会默认拉起系统输入法。  **元服务API：** 从API version 20开始，该接口支持在元服务中使用。  **模型约束：** 此接口仅可在Stage模型下使用。 |
...
| LICENSE\_CHASSIS\_NUMBER18+ | 37 | 【车架号】暂不支持自动保存和自动填充。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| onIconSrc | string | [Resource](ts-types.md#resource) | 否 | 是 | 密码输入模式时，能够切换密码可见时显示的图标。默认为系统提供的密码图标。  string格式可用于加载网络图片和本地图片。  网络图片支持http或https协议的URL格式；本地图片支持应用资源路径格式。 |
| offIconSrc | string | [Resource](ts-types.md#resource) | 否 | 是 | 密码输入模式时，能够切换密码不可见时显示的图标。默认为系统提供的密码图标。  string格式可用于加载网络图片和本地图片。  网络图片支持http或https协议的URL格式；本地图片支持应用资源路径格式。 |
...
| NEW\_LINE11+ | 8 | 显示为换行样式。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。  **模型约束：** 此接口仅可在Stage模型下使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[InsertValue](ts-text-common.md#insertvalue12对象说明), boolean> | 是 | 在将要输入时调用的回调。  回调参数类型为InsertValue时，包含将要插入的文本内容等信息。回调参数类型为boolean时，表示是否允许此次插入，返回true：允许文本正常插入到输入框中；返回false：拦截此次插入操作，文本不会被插入。开发者可通过此回调实现对输入内容的过滤和拦截。  在预上屏和候选词操作时，该回调不触发。  仅支持系统输入法输入的场景。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[DeleteValue](ts-text-common.md#deletevalue12对象说明), boolean> | 是 | 在将要删除时调用的回调。  回调参数类型为DeleteValue时，包含将要删除的文本内容等信息。回调参数类型为boolean时，表示是否允许此次删除，返回true：允许文本正常删除；返回false：拦截此次删除操作，文本不会被删除。开发者可通过此回调实现对删除操作的拦截和控制。  在预上屏删除操作时，该回调不触发。  仅支持系统输入法输入的场景。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[EditableTextChangeValue](ts-text-common.md#editabletextchangevalue15), boolean> | 是 | 在文本内容将要发生变化时的回调。  回调参数类型为EditableTextChangeValue时，包含文本变化的相关信息。回调参数类型为boolean时，表示是否允许此次文本变化，返回true：允许文本正常修改，变化会生效；返回false：拦截此次文本变化操作，文本内容不会发生改变。开发者可通过此回调实现对文本变化的拦截和控制。 |
...
| options12+ | [SelectionOptions](ts-universal-attributes-text-style.md#selectionoptions12对象说明) | 否 | 选中文字时的配置，用于控制文本选择菜单的显示策略。  配置项包括menuPolicy，用于指定菜单显示方式：MenuPolicy.DEFAULT表示按系统默认行为显示菜单；MenuPolicy.SHOW表示强制显示菜单；MenuPolicy.HIDE表示强制隐藏菜单。  默认值MenuPolicy.DEFAULT  从API version 12开始，该接口中的options参数支持在元服务中使用。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/lXpBaIhRSfi8Y0A14oYs0w/zh-cn_image_0000002717772720.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/dKvm32ikSA6R43Qo3cnaBw/zh-cn_image_0000002717612788.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/eiefiwR0TvmdXJbSUHQnHQ/zh-cn_image_0000002747292741.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/82/v3/DsOtCQf3SGWdU7QTnnJWAA/zh-cn_image_0000002747212657.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/5NEcn4OvQnacT1IQ1qbwig/zh-cn_image_0000002717772722.jpg)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/22/v3/5NK7Shq9QCyn0wTbnJmoAg/zh-cn_image_0000002717612790.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/88/v3/jAoU_UQtRFmZTcubtPyU4Q/zh-cn_image_0000002747292743.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4e/v3/qcQwgnFISMekQizPWfGvGg/zh-cn_image_0000002747212659.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3c/v3/Jik9e_xJSqGlDKA5SONPJQ/zh-cn_image_0000002717772724.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/D8eM6KEdTWqjJHJiC5kNGQ/zh-cn_image_0000002717612792.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/p4b1wjumRiyLTM_bynxtzw/zh-cn_image_0000002747292745.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/qXBRyhsPQ6yPqES1B0WOPQ/zh-cn_image_0000002747212661.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/QA8eNGR2SCOSz4Gdg93L3g/zh-cn_image_0000002717772726.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a7/v3/Cb8IyMuIQM2gRm2DT9cYaw/zh-cn_image_0000002717612794.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bb/v3/m0Ss65LiRwK8BP1zq83Fng/zh-cn_image_0000002747292747.jpg)

### 示例16（文本设置省略模式）

该示例通过[textOverflow](ts-basic-components-textinput.md#textoverflow12)、[ellipsisMode](ts-basic-components-textinput.md#ellipsismode18)、[style](ts-basic-components-textinput.md#style9)属性展示了文本超长省略以及调整省略位置的效果，通过MULTILINE\_START和MULTILINE\_CENTER两种类型实现了单行文本和多行文本场景下的省略号在行首和行中的效果。

从API version 9开始，通过[style](ts-basic-components-textinput.md#style9)设置输入框的风格。

从API version 12开始，通过[textOverflow](ts-basic-components-textinput.md#textoverflow12)设置文本超长时的显示方式。

从API version 18开始，通过[ellipsisMode](ts-basic-components-textinput.md#ellipsismode18)设置省略号位置。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/44/v3/_7Bg8LC1QxC53-sQoEIn8Q/zh-cn_image_0000002747212663.gif)

### 示例17（输入框支持输入状态变化等回调）

从API version 8开始，该示例通过[onEditChange](ts-basic-components-textinput.md#oneditchange8)、[onCopy](ts-basic-components-textinput.md#oncopy8)、[onCut](ts-basic-components-textinput.md#oncut8)、[onPaste](ts-basic-components-textinput.md#onpaste8)、[onContentScroll](ts-basic-components-textinput.md#oncontentscroll10)（从API version 10开始）、[onWillCopy](ts-basic-components-textinput.md#onwillcopy)、[onWillCut](ts-basic-components-textinput.md#onwillcut)接口实现了输入框监测输入状态变化、复制、剪切、粘贴、文本内容滚动回调的效果、如何屏蔽系统复制功能，以及如何屏蔽系统剪切功能，同时，可以通过设置[selectAll](ts-basic-components-textinput.md#selectall11)（从API version 11开始）属性，输入框初始状态下是否全选文本。

从API版本26.0.0开始，新增[onWillCopy](ts-basic-components-textinput.md#onwillcopy)、[onWillCut](ts-basic-components-textinput.md#onwillcut)接口。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/NKjs4rKuTX-xyVMq7Xs0QQ/zh-cn_image_0000002717772728.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/LrUS_57RRFGx39_6mZ3NEg/zh-cn_image_0000002747212665.png)
...
从API版本26.0.0开始，新增[strokeJoinStyle](ts-basic-components-textinput.md#strokejoinstyle)接口，支持设置文本描边拐角样式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/E-66GRZ-SJG8e7rtbMS6Ow/zh-cn_image_0000002717772730.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/noYKI3YBRbG78chjEmhjSg/zh-cn_image_0000002717612798.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2b/v3/GeYF9BJSRt24JzHYu15S8g/zh-cn_image_0000002747292751.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5/v3/CypVCxWVTMi8D__yKBU9zw/zh-cn_image_0000002747212667.jpg)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/2M4s2SVtSeaBQNZ6-M_5Kg/zh-cn_image_0000002717772732.gif)

### 示例26（设置行首标点符号压缩和行尾标点符号悬挂）

本示例通过[compressLeadingPunctuation](ts-basic-components-textinput.md#compressleadingpunctuation23)接口设置行首标点符号压缩，通过[punctuationOverflow](ts-basic-components-textinput.md#punctuationoverflow)设置行尾标点符号悬挂。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/WgeDPfieQ22nQJVRxsNBpA/zh-cn_image_0000002717612800.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/2tn0M8BSQsy6IYF2xLNr_A/zh-cn_image_0000002747292753.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/rXSCCGKCQkSbfGIBzPAw3g/zh-cn_image_0000002747212669.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/wQ8LerSsRfCG_9LoZiz1xA/zh-cn_image_0000002717772734.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9c/v3/NYjmt7XPSemcEytNoRZc0A/zh-cn_image_0000002717612802.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/VHtp8psoS_qqev2TvpIh4Q/zh-cn_image_0000002747292755.gif)

### 示例32（设置文本排版时是否使能孤字优化）

该示例通过[orphanCharOptimization](ts-basic-components-textinput.md#orphancharoptimization)接口设置使能孤字优化，确保段落最后一行不出现孤字。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/z98gjN27QSG02IUyF8rrOw/zh-cn_image_0000002747212671.png)

开启孤字优化：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/iTAgTTGURvSQFFFRDkBSdw/zh-cn_image_0000002717772736.png)

### 示例33（设置文本着色器效果）

该示例通过[shaderStyle](ts-basic-components-textinput.md#shaderstyle)接口实现对TextInput组件内文本着色效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/mkoQYuYgSj2pScPxs6686g/zh-cn_image_0000002717612804.png)

### 示例34（设置文本选择的AI菜单）

该示例通过[enableSelectedDataDetector](ts-basic-components-textinput.md#enableselecteddatadetector22)，配置文本选择AI菜单功能。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/hIAGCMy3R-KwO3q5HYcQaA/zh-cn_image_0000002747292757.gif)
