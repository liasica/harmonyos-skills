...
content_hash: sha256:e3519dbb681a0fa6ae08bd9f05bdad0c762103713ae77b37f3fc0a76e3aa9ffa
---
...
| 名称 | 描述 |
| --- | --- |
| ArkWeb\_BlanklessErrorCode errCode | 无白屏加载的错误码，取值为0表示无错误，非0值表示错误类型，见[ArkWeb\_BlanklessErrorCode](capi-arkweb-error-code-h.md#arkweb_blanklesserrorcode)定义。 |
...
| int32\_t loadingTime | 根据历史加载首屏耗时预测本次加载耗时，单位：ms，取值范围需大于0。 |
