---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-completionhandlerforabilitystartcallback
...
content_hash: sha256:a5c5eeacf719109aa499246f406777fed94e27c91d240fb0ed21347476cc9060
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| onRequestSuccess | [OnRequestSuccessFn](js-apis-app-ability-completionhandlerforabilitystartcallback.md#onrequestsuccessfn) | 否 | 是 | 拉起指定类型的Ability组件成功时的回调函数。  **元服务API**：从API version 21开始，该接口支持在元服务中使用。 |
| onRequestFailure | [OnRequestFailureFn](js-apis-app-ability-completionhandlerforabilitystartcallback.md#onrequestfailurefn) | 否 | 是 | 拉起指定类型的Ability组件失败时的回调函数。  **元服务API**：从API version 21开始，该接口支持在元服务中使用。 |
...
参见[OnRequestFailureFn](js-apis-app-ability-completionhandlerforabilitystartcallback.md#onrequestfailurefn)。
...
| failureCode | [AbilityStartFailureCode](js-apis-app-ability-completionhandlerforabilitystartcallback.md#abilitystartfailurecode) | 是 | 失败原因的错误码。 |
