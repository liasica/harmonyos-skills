...
content_hash: sha256:249ccbaa07b7e9879f3618c44f40674222ef7ac741503cf6bad46febc3678e58
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/pR7Nc9H-R0WCN-fMCf1HJw/zh-cn_image_0000002712406234.png)
...
| <g> | 分组 | width：宽度；  height：高度。  x、y轴偏移分量：可通过transform属性的translate(x, y)实现，参考[SVG标签解析能力增强](ts-image-svg2-capabilities.md)。 | fill、fill-rule、fill-opacity、stroke、stroke-dasharray、stroke-dashoffset、stroke-opacity、stroke-width、stroke-linecap、stroke-linejoin、stroke-miterlimit、transform |
