...
content_hash: sha256:bd95b22022903c0e88f83a40291e165799d3d7ec76f226f6038a3d86ea175e19
---
...
| fds15+ | Record<string, number> | 是 | 是 | 表示文件描述符的集合。在应用启动场景中，拉起方通过[startAbility](js-apis-inner-application-uiabilitycontext.md#startability)传递Want时，需在parameters中以固定键值对形式传入文件描述符，被拉起方可通过该字段获取文件描述符，具体使用方式见“文件描述符（FD）”示例。  **元服务API**：从API version 15开始，该接口支持在元服务中使用。 |
