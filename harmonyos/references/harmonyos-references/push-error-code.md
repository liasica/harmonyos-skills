---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-error-code
title: ArkTS API错误码
...
执行ExtensionAbility的[onReceiveMessage](push-remote-notification-extension-ability.md#onreceivemessage)()回调时出现执行异常。

**处理步骤**

请检查ExtensionAbility的[onReceiveMessage](push-remote-notification-extension-ability.md#onreceivemessage)()回调中的代码执行逻辑。
...
执行ExtensionAbility的[onReceiveMessage](push-remote-notification-extension-ability.md#onreceivemessage)()回调超时。
...
重复调用pushService.[receiveMessage](push-pushservice.md#pushservicereceivemessage)()注册相同类型的场景化消息。

**处理步骤**

请删除多余的pushService.[receiveMessage](push-pushservice.md#pushservicereceivemessage)()调用，仅在同一个回调中处理接收到的场景化消息。
...
* 应用配置错误：
  ...
  + 在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)的“项目设置 > 开放能力管理”中未启用“推送服务”。请参见[开通推送服务](../harmonyos-guides/push-config-setting.md#操作步骤)步骤5、步骤6完成对应阶段的签名。
  + 在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)的“项目设置 > 开放能力管理”中已启用“推送服务”，但未重新申请Profile文件。请参见[开通推送服务](../harmonyos-guides/push-config-setting.md#操作步骤)步骤5、步骤6完成对应阶段的签名。
* 网络不可用。
* 华为服务端异常。
* 不支持云真机调试。
...
请在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)网站，打开项目，在左侧导航栏选择“增长 > 推送服务”开通推送服务，详情参考指导[操作步骤](../harmonyos-guides/push-config-setting.md#操作步骤)第3点。
...
元服务基于账号订阅时，请从服务通知中选用合法模板。详情见[选用订阅模板](../atomic-guides/push-as-service-noti.md#section880418143379)。
...
请先[申请推送服务token](../harmonyos-guides/push-get-token.md)后再请求该接口。
