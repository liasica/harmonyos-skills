...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| values | [collections.Array](arkts-apis-arkts-collections-array.md)<[ValueType](js-apis-data-sendablerelationalstore.md#valuetype)> | 是 | 可跨线程传递的数组数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [collections.Array](arkts-apis-arkts-collections-array.md)<[ValueType](js-apis-data-sendablerelationalstore.md#valuetype)> | 可跨线程传递的数组数据。 |
