...
scraped_at: 2026-09-10T06:26:57+08:00
...
| ERR\_RUNTIME\_ERROR | 19020002 | 运行时错误。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| ERR\_MAYBE\_WRONG\_PASSWORD18+ | 19030008 | 私钥密码可能不正确。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
| ERR\_CERT\_UNTRUSTED | 19030009 | 证书不受信任。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_CERT\_HAS\_REVOKED | 19030010 | 证书已被吊销。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_UNKNOWN\_CRITICAL\_EXTENSION | 19030011 | 未知的关键扩展。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_CERT\_HOSTNAME\_MISMATCH | 19030012 | 证书主机名不匹配。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_CERT\_EMAIL\_ADDRESS\_MISMATCH | 19030013 | 证书邮箱地址不匹配。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_CERT\_KEYUSAGE\_MISMATCH | 19030014 | 证书密钥用途不匹配。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_CRL\_NOT\_FOUND | 19030015 | 无法获取证书吊销列表。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_CRL\_NOT\_YET\_VALID | 19030016 | 证书吊销列表尚未生效。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_CRL\_HAS\_EXPIRED | 19030017 | 证书吊销列表已过期。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_CRL\_SIGNATURE\_FAILURE | 19030018 | 证书吊销列表签名验证失败。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_CRL\_ISSUER\_NOT\_FOUND | 19030019 | 无法获取证书吊销列表颁发者。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_OCSP\_RESPONSE\_NOT\_FOUND | 19030020 | 无法获取在线证书状态协议（OCSP）响应。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_OCSP\_RESPONSE\_INVALID | 19030021 | OCSP响应无效。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_OCSP\_SIGNATURE\_FAILURE | 19030022 | OCSP签名验证失败。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_OCSP\_CERT\_STATUS\_UNKNOWN | 19030023 | OCSP证书状态未知。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| ERR\_NETWORK\_TIMEOUT | 19030024 | 网络连接超时。  **起始版本**：26.0.0  **模型约束**：此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| subject | [X500DistinguishedName](js-apis-cert.md#x500distinguishedname12) | 否 | 否 | 主体名称。 |
...
| outFormat | [EncodingBaseFormat](js-apis-cert.md#encodingbaseformat18) | 否 | 是 | 输出类型。默认值为PEM格式。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| EXTENSION\_OID\_TYPE\_ALL | 0 | 所有OID。 |
| EXTENSION\_OID\_TYPE\_CRITICAL | 1 | critical为true的OID。 |
| EXTENSION\_OID\_TYPE\_UNCRITICAL | 2 | critical为false的OID。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| EXTENSION\_ENTRY\_TYPE\_ENTRY | 0 | 整个扩展项。 |
| EXTENSION\_ENTRY\_TYPE\_ENTRY\_CRITICAL | 1 | 扩展项的critical属性。 |
| EXTENSION\_ENTRY\_TYPE\_ENTRY\_VALUE | 2 | 扩展项的值（扩展特定数据）。 |
...
| encodingFormat | [EncodingFormat](js-apis-cert.md#encodingformat) | 否 | 否 | 编码格式。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [GeneralNameType](js-apis-cert.md#generalnametype12) | 否 | 否 | GeneralName类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| x509Cert | [X509Cert](js-apis-cert.md#x509cert) | 否 | 是 | 指定具体的证书对象。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| publicKey | [DataBlob](js-apis-cert.md#datablob) | 否 | 是 | 指定证书公钥，DER编码格式。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| publicKeyAlgID | string | 否 | 是 | 指定证书公钥的算法。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| subjectAlternativeNames12+ | Array<[GeneralName](js-apis-cert.md#generalname12)> | 否 | 是 | 指定证书主体备用名称。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| validationResult | [CertChainValidationResult](js-apis-cert.md#certchainvalidationresult11) | 是 | 否 | 证书链校验结果。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| CERT\_REVOCATION\_PREFER\_OCSP | 0 | 优先OCSP检查。仅当CERT\_REVOCATION\_CRL\_CHECK与CERT\_REVOCATION\_OCSP\_CHECK同时设置时，该标志生效。  设置后先执行OCSP检查，未找到响应或超时时回退CRL；  不设置则先执行CRL检查，未找到CRL或超时时回退OCSP。 |
| CERT\_REVOCATION\_CRL\_CHECK | 1 | 启用CRL检查。使用证书吊销列表检查证书状态。  首先使用[X509CertRevokedParams](js-apis-cert.md#x509certrevokedparams)的crls参数，未匹配到CRL且[X509CertRevokedParams](js-apis-cert.md#x509certrevokedparams)的allowDownloadCrl参数设置为true则尝试使用证书的CDP扩展下载CRL。 |
| CERT\_REVOCATION\_OCSP\_CHECK | 2 | 启用OCSP检查。使用在线证书状态协议检查证书状态。  首先使用[X509CertRevokedParams](js-apis-cert.md#x509certrevokedparams)的ocspResponses参数，未匹配到响应且[X509CertRevokedParams](js-apis-cert.md#x509certrevokedparams)的allowOcspCheckOnline参数设置为true则尝试从证书AIA扩展获取OCSP URL并发送请求获取响应。  始终使用系统当前时间校验ocsp响应的有效期，并允许前后5分钟的时间容差。  始终使用系统当前时间校验ocsp签名者证书链的有效期。  允许ocsp响应缺少nonce和nextUpdate。 |
| CERT\_REVOCATION\_CHECK\_ALL\_CERT | 3 | 检查所有证书的吊销状态。  设置后对证书链中所有证书执行吊销检查（跳过自签名证书）；  不设置则仅检查终端证书（证书链第一个证书）。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| revocationFlags | Array<[CertRevocationFlag](js-apis-cert.md#certrevocationflag)> | 否 | 否 | 吊销检查标志。数量范围：[1, 4]。数组必须包含CERT\_REVOCATION\_CRL\_CHECK或CERT\_REVOCATION\_OCSP\_CHECK。 |
| crls | Array<[X509CRL](js-apis-cert.md#x509crl11)> | 否 | 是 | CRL列表。最大数量：100。 |
...
| ocspDigest | [OcspDigest](js-apis-cert.md#ocspdigest) | 否 | 是 | OCSP请求使用的摘要算法，默认值为SHA256。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| untrustedCerts | Array<[X509Cert](js-apis-cert.md#x509cert)> | 否 | 是 | 非信任证书列表。仅用于构建证书链的中间证书，不作为信任锚点。最大数量：100。 |
| trustedCerts | Array<[X509Cert](js-apis-cert.md#x509cert)> | 否 | 是 | 信任证书列表。指定信任的根证书或中间CA证书，作为验证的信任锚点。最大数量：100。  验证时，证书链须追溯至信任证书，必须设置此参数或将trustSystemCa设为true。 |
...
| allowDownloadIntermediateCa | boolean | 否 | 是 | 是否允许从网络下载中间CA证书。默认值为false。  true：当构建证书链缺失中间证书时，尝试使用证书AIA扩展中颁发者地址下载颁发者证书，解决证书链不完整的问题；  false：不允许从网络下载中间的CA证书。  下载地址从证书的AIA扩展中获取，仅支持HTTP。若要使用网络进行下载，需要申请ohos.permission.INTERNET权限。关于权限配置的详细信息，请参见声明权限[Declaring Permissions](../harmonyos-guides/declare-permissions.md)。 |
...
| ignoreErrs | Array<[CertResult](js-apis-cert.md#certresult)> | 否 | 是 | 允许忽略特定的验证错误。最大数量：8。  可忽略的错误包括：ERR\_CERT\_NOT\_YET\_VALID、ERR\_CERT\_HAS\_EXPIRED、ERR\_UNKNOWN\_CRITICAL\_EXTENSION、ERR\_CRL\_NOT\_FOUND、ERR\_CRL\_NOT\_YET\_VALID、ERR\_CRL\_HAS\_EXPIRED、ERR\_OCSP\_RESPONSE\_NOT\_FOUND、ERR\_NETWORK\_TIMEOUT。 |
| hostnames | Array<string> | 否 | 是 | 主机名列表。验证证书的主体备用名（SAN）或通用名（CN）是否包含指定的主机名。最大数量：100，每个主机名最大长度：128。  用于HTTPS等场景。  只要匹配其中一个主机名即校验成功。 |
| emailAddresses | Array<string> | 否 | 是 | 邮箱地址列表。验证证书是否包含指定的邮箱地址。最大数量：1，邮箱地址最大长度：128。 |
| keyUsage | Array<[KeyUsageType](js-apis-cert.md#keyusagetype12)> | 否 | 是 | 密钥用途列表。验证证书的密钥用途扩展是否包含指定的用途。最大数量：9。  证书必须包含所有指定的密钥用途才校验成功。 |
...
| revokedParams | [X509CertRevokedParams](js-apis-cert.md#x509certrevokedparams) | 否 | 是 | 证书吊销检查参数。用于检查证书是否被吊销。包含CRL列表、OCSP响应数据、是否允许在线检查等配置。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| certChain | Array<[X509Cert](js-apis-cert.md#x509cert)> | 是 | 否 | 验证后的证书链。验证成功时返回完整的证书链，从终端证书到信任锚点。可用于后续的证书信息查询或其他验证操作。 |
...
| certCRLs | Array<[CertCRLCollection](js-apis-cert.md#certcrlcollection11)> | 否 | 是 | 用于检查证书是否被吊销的CRL集合。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| revocationCheckParam12+ | [RevocationCheckParameter](js-apis-cert.md#revocationcheckparameter12) | 否 | 是 | 表示需要校验证书吊销状态的参数对象。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| cert | [X509Cert](js-apis-cert.md#x509cert) | 否 | 是 | 和私钥匹配的证书。 |
| otherCerts | Array<[X509Cert](js-apis-cert.md#x509cert)> | 否 | 是 | 其他证书。 |
...
| macDigestAlgorithm | [Pkcs12MacDigestAlgorithm](js-apis-cert.md#pkcs12macdigestalgorithm21) | 否 | 是 | 表示PKCS #12的MAC的摘要算法。默认为SHA256。 |
...
| ENVELOPED\_DATA22+ | 1 | 封装数据，包含带认证的封装数据。  **元服务API：** 从API version 22开始，该接口支持在元服务中使用。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| PKCS1\_PADDING | 0 | PKCS #1 v1.5填充方式。 |
| PKCS1\_PSS\_PADDING | 1 | PKCS #1 PSS填充方式。 |
...
| rsaSignaturePadding22+ | [CmsRsaSignaturePadding](js-apis-cert.md#cmsrsasignaturepadding22) | 否 | 是 | RSA签名填充方式。默认值为：PKCS1\_PADDING。  当设置为 PKCS1\_PSS\_PADDING 时，mdName 必须为 "SHA256"、"SHA384" 或 "SHA512"。  **说明**：仅当签名者私钥类型为RSA时有效。  **元服务API：** 从API version 22开始，该接口支持在元服务中使用。 |
...
| signerCerts | Array<[X509Cert](js-apis-cert.md#x509cert)> | 否 | 是 | 签名者证书。默认为空。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| inStream | [EncodingBlob](js-apis-cert.md#encodingblob) | 是 | X.509证书序列化数据。 |
| callback | AsyncCallback<[X509Cert](js-apis-cert.md#x509cert)> | 是 | 回调函数。当创建X.509证书对象成功时，err为undefined，data为获取到的X509Cert实例；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[X509Cert](js-apis-cert.md#x509cert)> | Promise对象，返回创建的X509Cert实例。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[EncodingBlob](js-apis-cert.md#encodingblob)> | 是 | 回调函数。当获取X.509证书序列化数据成功时，err为undefined，data为获取到的X.509证书序列化数据；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[EncodingBlob](js-apis-cert.md#encodingblob)> | Promise对象，返回X.509证书序列化数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [cryptoFramework.PubKey](js-apis-cryptoframework.md#pubkey) | X.509证书公钥对象：仅用于X509Cert的verify接口。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cert.md#datablob) | 表示X.509证书颁发者名称。 |
...
建议设置encodingType参数为EncodingType.ENCODING\_UTF8，获取的证书主体名称是以逗号（,）分隔相对可分辨名称的可分辨名称字符串。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| encodingType | [EncodingType](js-apis-cert.md#encodingtype12) | 否 | 编码类型。设置参数表示获取UTF-8格式编码；不设置默认获取ASCII格式编码。  API 12后支持设置此参数。 |

**返回值**：

| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cert.md#datablob) | 表示X.509证书主体名称。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cert.md#datablob) | 表示X.509证书签名数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cert.md#datablob) | 表示X.509证书签名算法参数。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cert.md#datablob) | 表示X.509证书密钥用途。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataArray](js-apis-cert.md#dataarray) | 表示X.509证书扩展密钥用途。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataArray](js-apis-cert.md#dataarray) | 表示X.509证书主体可选名称。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataArray](js-apis-cert.md#dataarray) | 表示X.509证书颁发者可选名称。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cert.md#datablob) | 表示X.509证书对应的字段，返回值为DER格式。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataArray](js-apis-cert.md#dataarray) | 表示X.509证书CRL的分发点统一资源标识符。 |
...
| 类型 | 说明 |
| --- | --- |
| [X500DistinguishedName](js-apis-cert.md#x500distinguishedname12) | X.500可分辨对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [CertExtension](js-apis-cert.md#certextension10) | 证书扩展对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| inStream | [EncodingBlob](js-apis-cert.md#encodingblob) | 是 | 表示序列化的证书扩展数据。 |
| callback | AsyncCallback<[CertExtension](js-apis-cert.md#certextension10)> | 是 | 回调函数。当创建证书扩展对象成功时，err为undefined，data为获取到的CertExtension实例；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[CertExtension](js-apis-cert.md#certextension10)> | Promise对象，返回创建的CertExtension实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [EncodingBlob](js-apis-cert.md#encodingblob) | 获取的证书扩展序列化数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| valueType | [ExtensionOidType](js-apis-cert.md#extensionoidtype10) | 是 | 指定要获取的OID类型。 |

**返回值**：

| 类型 | 说明 |
| --- | --- |
| [DataArray](js-apis-cert.md#dataarray) | 获取的证书扩展OID列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| valueType | [ExtensionEntryType](js-apis-cert.md#extensionentrytype10) | 是 | 指定要获取的扩展信息类型。 |
| oid | [DataBlob](js-apis-cert.md#datablob) | 是 | 指定要获取的扩展项OID。 |

**返回值**：

| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cert.md#datablob) | 获取的证书扩展项数据。 |
...
| callback | AsyncCallback<[X509Crl](js-apis-cert.md#x509crldeprecated)> | 是 | 回调函数。当创建X.509证书吊销列表对象成功时，err为undefined，data为获取到的X509Crl实例；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[X509Crl](js-apis-cert.md#x509crldeprecated)> | Promise对象，返回创建的X509Crl实例。 |
...
| callback | AsyncCallback<[X509CRL](js-apis-cert.md#x509crl11)> | 是 | 回调函数。当创建X.509证书吊销列表对象成功时，err为undefined，data为获取到的X509CRL实例；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[X509CRL](js-apis-cert.md#x509crl11)> | Promise对象，返回创建的X509CRL实例。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[EncodingBlob](js-apis-cert.md#encodingblob)> | 是 | 回调函数。当获取X.509证书吊销列表序列化数据成功时，err为undefined，data为获取到的X.509证书吊销列表序列化数据；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[EncodingBlob](js-apis-cert.md#encodingblob)> | Promise对象，返回X.509证书吊销列表的序列化数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cert.md#datablob) | 表示X.509证书吊销列表颁发者名称。 |
...
| 类型 | 说明 |
| --- | --- |
| [X509CrlEntry](js-apis-cert.md#x509crlentrydeprecated) | 表示证书吊销条目。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[X509CrlEntry](js-apis-cert.md#x509crlentrydeprecated)>> | 是 | 回调函数。当获取证书吊销条目列表成功时，err为undefined，data为获取到的证书吊销条目列表；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[X509CrlEntry](js-apis-cert.md#x509crlentrydeprecated)>> | Promise对象，返回证书吊销条目列表。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cert.md#datablob) | 表示X.509证书吊销列表的签名数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cert.md#datablob) | 表示X.509证书吊销列表签名的算法参数。 |
...
| 类型 | 说明 |
| --- | --- |
| [X509CRLEntry](js-apis-cert.md#x509crlentry11) | 表示证书吊销条目。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[X509CRLEntry](js-apis-cert.md#x509crlentry11)>> | 是 | 回调函数。当获取证书吊销条目列表成功时，err为undefined，data为获取到的证书吊销条目列表；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[X509CRLEntry](js-apis-cert.md#x509crlentry11)>> | Promise对象，返回证书吊销条目列表。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cert.md#datablob) | 表示CRL扩展的DER格式数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [X500DistinguishedName](js-apis-cert.md#x500distinguishedname12) | X.500可分辨名称对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [CertExtension](js-apis-cert.md#certextension10) | CRL扩展对象。 |
...
由于端侧系统时间不可信，证书链校验不包含对证书有效时间的校验。如果需要检查证书的时间有效性，可使用X.509证书的[checkValidityWithDate](js-apis-cert.md#checkvaliditywithdate)方法进行检查。详见[证书规格](../harmonyos-guides/certificate-framework-overview.md#证书规格)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| certChain | [CertChainData](js-apis-cert.md#certchaindata) | 是 | 表示X.509证书链序列化数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cert | [X509Cert](js-apis-cert.md#x509cert) | 是 | 待验证的证书。 |
| params | [CertValidationParams](js-apis-cert.md#certvalidationparams) | 是 | 证书验证参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[CertValidationResult](js-apis-cert.md#certvalidationresult)> | Promise对象，返回验证结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[EncodingBlob](js-apis-cert.md#encodingblob)> | 是 | 回调函数。当获取证书吊销条目序列化数据成功时，err为undefined，data为获取到的证书吊销条目序列化数据；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[EncodingBlob](js-apis-cert.md#encodingblob)> | Promise对象，返回被吊销证书的序列化数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cert.md#datablob) | 被吊销的证书的颁发者名称。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[EncodingBlob](js-apis-cert.md#encodingblob)> | Promise对象，返回证书吊销条目的序列化数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cert.md#datablob) | 表示被吊销证书的颁发者名称。 |
...
| 类型 | 说明 |
| --- | --- |
| [CertExtension](js-apis-cert.md#certextension10) | CRL条目的扩展对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [CertCRLCollection](js-apis-cert.md#certcrlcollection11) | 证书和证书吊销列表集合。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[X509Cert](js-apis-cert.md#x509cert)>> | Promise对象，返回匹配到的证书对象数组。 |
...
| --- | --- | --- | --- |
| param | [X509CertMatchParameters](js-apis-cert.md#x509certmatchparameters11) | 是 | 表示证书需匹配的参数。 |
| callback | AsyncCallback<Array<[X509Cert](js-apis-cert.md#x509cert)>> | 是 | 回调函数。当查找证书对象成功时，err为undefined，data为获取到的匹配的证书对象数组；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[X509CRL](js-apis-cert.md#x509crl11)>> | Promise对象，返回匹配到的证书吊销列表对象数组。 |
...
| callback | AsyncCallback<Array<[X509CRL](js-apis-cert.md#x509crl11)>> | 是 | 回调函数。当查找证书吊销列表成功时，err为undefined，data为获取到的匹配的证书吊销列表对象数组；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[X509CertChain](js-apis-cert.md#x509certchain11)> | Promise对象，返回创建的X509CertChain实例。 |
...
| --- | --- | --- | --- |
| inStream | [EncodingBlob](js-apis-cert.md#encodingblob) | 是 | X.509证书序列化数据。 |
| callback | AsyncCallback<[X509CertChain](js-apis-cert.md#x509certchain11)> | 是 | 回调函数。当创建X.509证书链对象成功时，err为undefined，data为获取到的X509CertChain实例；否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| certs | Array<[X509Cert](js-apis-cert.md#x509cert)> | 是 | X.509证书对象数组。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [X509CertChain](js-apis-cert.md#x509certchain11) | 表示X.509证书链对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [CertChainBuildParameters](js-apis-cert.md#certchainbuildparameters12) | 是 | 构建证书链的参数对象。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[CertChainBuildResult](js-apis-cert.md#certchainbuildresult12)> | Promise对象，返回创建的CertChainBuildResult实例。 |
...
| config | [Pkcs12ParsingConfig](js-apis-cert.md#pkcs12parsingconfig18) | 是 | PKCS #12文件的解析配置。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Pkcs12Data](js-apis-cert.md#pkcs12data18) | 表示PKCS #12文件解析后的证书、私钥及其他证书合集。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Pkcs12Data](js-apis-cert.md#pkcs12data18)> | Promise对象，返回解析后的P12数据。返回的Pkcs12Data中的私钥采用PEM编码。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [Pkcs12Data](js-apis-cert.md#pkcs12data18) | 是 | 要打包的PKCS #12数据对象。 |
| config | [Pkcs12CreationConfig](js-apis-cert.md#pkcs12creationconfig21) | 是 | PKCS #12的创建配置。 |
...
表示从PKCS #12中读取ca证书来构造[TrustAnchor](js-apis-cert.md#x509trustanchor11)对象数组。使用Promise异步回调。
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[X509TrustAnchor](js-apis-cert.md#x509trustanchor11)>> | Promise对象，返回X509TrustAnchor对象数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[X509Cert](js-apis-cert.md#x509cert)> | X.509证书数组。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [CertChainValidationParameters](js-apis-cert.md#certchainvalidationparameters11) | 是 | 表示校验X.509证书链的参数。 |
...
| --- | --- | --- | --- |
| param | [CertChainValidationParameters](js-apis-cert.md#certchainvalidationparameters11) | 是 | 表示校验X.509证书链的参数。 |
| callback | AsyncCallback<[CertChainValidationResult](js-apis-cert.md#certchainvalidationresult11)> | 是 | 回调函数。当校验证书链成功时，err为undefined，data为获取到的证书链校验结果；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[X500DistinguishedName](js-apis-cert.md#x500distinguishedname12)> | Promise对象，返回X500DistinguishedName实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [EncodingBlob](js-apis-cert.md#encodingblob) | X.500可分辨名称的DER编码数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cert | [X509Cert](js-apis-cert.md#x509cert) | 是 | 指定X.509证书。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cert | [X509Cert](js-apis-cert.md#x509cert) | 是 | 要添加的X.509证书。 |
...
| 类型 | 说明 |
| --- | --- |
| [CmsContentType](js-apis-cert.md#cmscontenttype18) | 返回CMS内容类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [CmsEnvelopedDecryptionConfig](js-apis-cert.md#cmsenvelopeddecryptionconfig22) | 是 | CMS解密的配置。 |
