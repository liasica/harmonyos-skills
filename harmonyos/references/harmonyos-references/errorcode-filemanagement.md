---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-filemanagement
title: 文件管理错误码
...
文件管理子系统错误码由五部分组成，分别是[基础文件IO错误码](errorcode-filemanagement.md#基础文件io错误码)、[用户数据管理错误码](errorcode-filemanagement.md#用户数据管理错误码)、[公共文件访问错误码](errorcode-filemanagement.md#公共文件访问错误码)、[空间统计错误码](errorcode-filemanagement.md#空间统计错误码)和[端云同步错误码](errorcode-filemanagement.md#端云同步错误码)。
