---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-manager
...
| 类型 | 说明 |
| --- | --- |
| [NearlinkState](js-apis-nearlink-manager.md#nearlinkstate) | 表示星闪开关状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[NearlinkState](js-apis-nearlink-manager.md#nearlinkstate)> | 是 | 回调函数，返回星闪的开关状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[NearlinkState](js-apis-nearlink-manager.md#nearlinkstate)> | 否 | 回调函数，返回星闪的开关状态。  填写该参数则取消当前callback订阅。不填写该参数则取消该事件对应的所有回调。 |
