...
content_hash: sha256:781ccd9733f8b86e5c205b5f2a934e5dba65c6640806d5be9e0110065a5e7555
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | Nullable<[Color](ts-appendix-enums.md#color) | number | string> | 是 | 元服务menuBar的背景颜色，undefined代表使用默认颜色。number为HEX格式颜色，支持rgb或者argb，示例：0xffffff。string为rgb或者argb格式颜色，示例：'#ffffff'。从API version 12开始，在元服务中该参数将被忽略。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| font | [FontStyle](ts-appendix-enums.md#fontstyle) | 是 | 元服务menuBar标题中的字体样式。从API version 12开始，在元服务中该参数将被忽略。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | Nullable<[Color](ts-appendix-enums.md#color) | number | string> | 是 | 元服务menuBar图标的颜色，undefined代表使用默认颜色。number为HEX格式颜色，支持rgb或者argb，示例：0xffffff。string为rgb或者argb格式颜色，示例：'#ffffff'。从API version 12开始，在元服务中该参数将被忽略。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](js-apis-base.md#callback)<[Frame](js-apis-arkui-graphics.md#frame)> | 是 | AtomicServiceMenuBar布局变化时的回调，返回变化后的布局信息。 |
