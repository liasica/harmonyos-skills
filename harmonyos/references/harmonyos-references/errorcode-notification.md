---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-notification
title: 通知错误码
...
应用未设置或未正确设置[NotificationSubscriberExtensionAbility](js-apis-notificationsubscriberextensionability.md)。
