...
| color | [ParticleColorPropertyOptions](ts-particle-animation.md#particlecolorpropertyoptions)<COLOR\_UPDATER> | 否 | 是 | 粒子颜色配置。  **说明**：  默认值：{ range:[Color.White,Color.White] }。图片粒子不支持设置颜色。 |
