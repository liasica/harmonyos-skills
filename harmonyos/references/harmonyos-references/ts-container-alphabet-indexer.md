...
content_hash: sha256:5eac064375bb8f2bd245674142077cc08486d27e34831df1abaded8451b4596d
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](ts-types.md#resourcecolor) | 是 | 未选中项文本颜色。  默认值：0x99182431，显示为略带透明的深暗蓝色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](ts-types.md#resourcecolor) | 是 | 选中项文本颜色。  默认值：0xFF007DFF，显示为半透明蓝色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](ts-types.md#resourcecolor) | 是 | 提示弹窗一级索引项文本颜色。  默认值：0xFF007DFF，显示为半透明蓝色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](ts-types.md#resourcecolor) | 是 | 选中项背景颜色。  默认值：0x1A007DFF，显示为半透明的蓝色。 |
...
从API版本26.0.0开始，如果和[popupBackgroundBlurStyle](ts-container-alphabet-indexer.md#popupbackgroundblurstyle12)均未被主动调用或参数value传入undefined，高算力、中算力设备默认显示为沉浸式材质[ImmersiveStyle](arkts-apis-uimaterial.md#immersivestyle)的THICK样式，低算力设备默认显示为白色背景。如果popupBackgroundBlurStyle被主动调用且参数value传入有效值，提示弹窗背景颜色默认为#66808080，显示为半透明的灰色。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](ts-types.md#resourcecolor) | 是 | 提示弹窗背景颜色。  弹窗的背景模糊材质效果会对背景色产生影响，可通过设置[popupBackgroundBlurStyle](ts-container-alphabet-indexer.md#popupbackgroundblurstyle12)属性值为NONE关闭背景模糊材质效果。 |
...
设置提示弹窗的背景模糊材质。API版本26.0.0之前版本，未通过该接口设置时，默认为组件普通材质模糊，对应取值为BlurStyle中的COMPONENT\_REGULAR。从API版本26.0.0开始，[popupBackground](ts-container-alphabet-indexer.md#popupbackground)和popupBackgroundBlurStyle均未被主动调用或者传入undefined时，在高算力、中算力设备默认显示为沉浸式材质[ImmersiveStyle](arkts-apis-uimaterial.md#immersivestyle)的THICK样式，低算力设备默认显示为白色背景。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/81/v3/B51XaZqLS1OCduAgIrBaeg/zh-cn_image_0000002769332515.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/TPf4XcgJRHipY_S7ALuh3g/zh-cn_image_0000002769452377.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/55/v3/K7UTqH0AQYKIgFzY-RTNhg/zh-cn_image_0000002739893046.gif)
...
从API版本26.0.0开始，索引条参数[popupBackground](ts-container-alphabet-indexer.md#popupbackground)和[popupBackgroundBlurStyle](ts-container-alphabet-indexer.md#popupbackgroundblurstyle12)均未主动设置（或参数value传入undefined）时，提示弹窗默认开启沉浸光感，默认材质样式为THICK。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f7/v3/ziuPwKq5Td6hx8pLfRCVyQ/zh-cn_image_0000002739733168.gif)

设置系统材质后：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/Mgta90PtT8a7S2xX9GPa5w/zh-cn_image_0000002769332517.gif)
