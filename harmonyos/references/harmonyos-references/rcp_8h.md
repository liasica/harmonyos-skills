...
content_hash: sha256:1951df03d60369390c282307532d81d86fb4d7c993aedd375a906a971f40a400
---
...
| struct [Rcp\_OnGetDataCallback](_rcp___on_get_data_callback.md) | 获取数据的回调。使用[HMS\_Rcp\_SetRequestGetDataCallback](remote-communication-overview.md#hms_rcp_setrequestgetdatacallback)给请求设置。 |
...
| typedef struct [Rcp\_OnStatusCodeReceiveCallback](_rcp___on_status_code_callback.md) [Rcp\_OnStatusCodeReceiveCallback](remote-communication-overview.md#rcp_onstatuscodereceivecallback) | 用于接收响应状态码的回调函数。 |
| typedef struct [Rcp\_OnGetDataCallback](_rcp___on_get_data_callback.md)  [Rcp\_OnGetDataCallback](_rcp___on_get_data_callback.md) | 获取数据的回调。 |
...
| uint32\_t [HMS\_Rcp\_SetRequestConnectOnly](remote-communication-overview.md#hms_rcp_setrequestconnectonly) ([Rcp\_Request](_rcp___request.md) \*request, bool connectOnly) | 设置请求仅用于建立连接，而不进行数据传输。 |
