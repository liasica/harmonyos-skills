---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-ability-abilityresult
title: AbilityResult
breadcrumb: API参考 > 应用框架 > Ability Kit（程序框架服务） > ArkTS API > 接口依赖的元素及定义 > ability > AbilityResult
category: harmonyos-references
scraped_at: 2026-04-28T07:58:36+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:247acc70b259ad9c1f33af4ea370991d661f7cd601971991d89365e4bf4e5512
---
...
[Stage模型](../harmonyos-guides/ability-terminology.md#stage模型)下：

```
1. import { common } from '@kit.AbilityKit';
```

[FA模型](../harmonyos-guides/ability-terminology.md#fa模型)下：
