---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-i18n
title: "@ohos.i18n (国际化-I18n)"
breadcrumb: API参考 > 应用框架 > Localization Kit（本地化开发服务） > ArkTS API > @ohos.i18n (国际化-I18n)
category: harmonyos-references
scraped_at: 2026-09-10T06:26:41+08:00
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| country | string | 是 | 国家地区，要求是[合法的国家地区码](../harmonyos-guides/i18n-locale-culture.md#实现原理)。 |
| locale | string | 是 | [表示区域ID的字符串](../harmonyos-guides/i18n-locale-culture.md#实现原理)，由语言、脚本、国家地区组成。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | 语言，要求是[合法的语言ID](../harmonyos-guides/i18n-locale-culture.md#实现原理)。 |
| locale | string | 是 | [表示区域ID的字符串](../harmonyos-guides/i18n-locale-culture.md#实现原理)，由语言、脚本、国家地区组成。 |
| sentenceCase | boolean | 否 | true表示按照首字母大写的格式显示文本，false表示按照区域默认的大小写格式显示文本。默认值：true。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | [合法的语言ID](../harmonyos-guides/i18n-locale-culture.md#实现原理)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | [合法的语言ID](../harmonyos-guides/i18n-locale-culture.md#实现原理)，例如zh。 |
| region | string | 否 | [合法的国家地区码](../harmonyos-guides/i18n-locale-culture.md#实现原理)，例如CN。  默认值：SIM卡国家地区。 |
...
获取系统当前设置的语言。若要监听系统语言变化，可以监听[公共事件](commoneventmanager-definitions.md#common_event_locale_changed)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_LOCALE\_CHANGED，具体可参考[系统语言与区域](../harmonyos-guides/i18n-system-language-region.md#开发步骤)。
...
获取系统当前设置的国家地区。若要监听系统地区变化，可以监听[公共事件](commoneventmanager-definitions.md#common_event_locale_changed)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_LOCALE\_CHANGED，具体可参考[系统语言与区域](../harmonyos-guides/i18n-system-language-region.md#开发步骤)。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[System.getSystemLocaleInstance](js-apis-i18n.md#getsystemlocaleinstance20)代替。
...
获取系统当前设置的区域对象。若要监听系统区域变化，可以监听[公共事件](commoneventmanager-definitions.md#common_event_locale_changed)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_LOCALE\_CHANGED，具体可参考[系统语言与区域](../harmonyos-guides/i18n-system-language-region.md#开发步骤)。
...
判断系统时制是否为24小时制。若要监听系统时制变化，可以监听[公共事件](commoneventmanager-definitions.md#common_event_time_changed)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_TIME\_CHANGED，具体可参考[用户偏好](../harmonyos-guides/i18n-user-preferences.md#开发步骤)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | [合法的语言ID](../harmonyos-guides/i18n-locale-culture.md#实现原理)或'default'。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 否 | [合法的语言ID](../harmonyos-guides/i18n-locale-culture.md#实现原理)。默认值：系统语言。 |
...
| 类型 | 说明 |
| --- | --- |
| [TemperatureType](js-apis-i18n.md#temperaturetype18) | 温度单位。 |
...
| 类型 | 说明 |
| --- | --- |
| [WeekDay](js-apis-i18n.md#weekday18) | 周起始日。 |
...
判断语言是否为镜像语言。在镜像语言下，UI界面需要[镜像显示](../harmonyos-guides/i18n-ui-design.md#界面镜像)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 否 | [表示区域ID的字符串](../harmonyos-guides/i18n-locale-culture.md#实现原理)，由语言、脚本、国家地区组成，例如zh-Hans-CN。  默认值：系统当前区域ID。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[EntityInfoItem](js-apis-i18n.md#entityinfoitem11)> | 文本中的实体信息列表。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | string | 否 | 否 | 实体的类型，当前支持phone\_number和date类型。phone\_number表示实体类型是电话号码，date表示实体类型是时间日期。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| field | string | 是 | 指定的日历属性，目前支持的属性值有 year, month, week\_of\_year, week\_of\_month, date, day\_of\_year, day\_of\_week, day\_of\_week\_in\_month, hour, hour\_of\_day, minute, second, millisecond。  各取值代表的含义请参考[get](js-apis-i18n.md#get8)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 否 | [表示区域ID的字符串](../harmonyos-guides/i18n-locale-culture.md#实现原理)，由语言、脚本、国家地区组成。  默认值：系统当前区域ID。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [IndexUtil](js-apis-i18n.md#indexutil8) | 根据区域ID创建的IndexUtil对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | [表示区域ID的字符串](../harmonyos-guides/i18n-locale-culture.md#实现原理)，由语言、脚本、国家地区组成。  生成的[BreakIterator](js-apis-i18n.md#breakiterator8)将按照指定区域的规则计算可换行点的位置。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [BreakIterator](js-apis-i18n.md#breakiterator8) | 可换行点处理器。 |
...
| 类型 | 说明 |
| --- | --- |
| [TimeZone](js-apis-i18n.md#timezone) | 时区ID对应的时区对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[TimeZone](js-apis-i18n.md#timezone)> | 时区对象数组，数组中对象对应的时区为该地理位置推荐的时区。 |
...
获取时区跳变规则，时区的跳变逻辑参考[夏令时跳变](../harmonyos-guides/i18n-dst-transition.md)。
...
| 类型 | 说明 |
| --- | --- |
| [ZoneRules](js-apis-i18n.md#zonerules20) | 时区跳变规则，包含跳变的时间点、跳变前后的偏移量信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [ZoneOffsetTransition](js-apis-i18n.md#zoneoffsettransition20) | 时区跳变对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Transliterator](js-apis-i18n.md#transliterator9) | 音译对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fromUnit | [UnitInfo](js-apis-i18n.md#unitinfo8) | 是 | 需要转换的单位。 |
| toUnit | [UnitInfo](js-apis-i18n.md#unitinfo8) | 是 | 转换成的目标单位。 |
| value | number | 是 | 需要转换的单位的数量值。 |
| locale | string | 是 | [表示区域ID的字符串](../harmonyos-guides/i18n-locale-culture.md#实现原理)，由语言、脚本、国家地区组成，如：zh-Hans-CN。 |
| style | string | 否 | 格式化使用的风格，取值包括：'long', 'short', 'narrow'。默认值：short。  不同取值显示效果请参考[数字与度量衡国际化](../harmonyos-guides/i18n-numbers-weights-measures.md)。 |
...
| locale | string | 否 | [表示区域ID的字符串](../harmonyos-guides/i18n-locale-culture.md#实现原理)，由语言、脚本、国家地区组成。如：zh-Hans-CN。  默认值：系统当前区域ID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | 待匹配的[区域ID字符串](../harmonyos-guides/i18n-locale-culture.md#实现原理)，如：zh-Hans-CN。 |
...
从API version 18开始支持，从API version 20开始废弃，建议使用[getUnicodeWrappedFilePath](js-apis-i18n.md#getunicodewrappedfilepath20)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [NormalizerMode](js-apis-i18n.md#normalizermode10) | 是 | 文本标准化范式。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Normalizer](js-apis-i18n.md#normalizer10) | 返回指定范式的文本标准化对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[HolidayInfoItem](js-apis-i18n.md#holidayinfoitem11)> | 返回节假日信息列表。 |
...
| localNames | Array<[HolidayLocalName](js-apis-i18n.md#holidaylocalname11)> | 否 | 是 | 节假日的本地名称列表。 |
...
通过模式字符串获取SimpleDateTimeFormat对象。与[getSimpleDateTimeFormatBySkeleton](js-apis-i18n.md#i18ngetsimpledatetimeformatbyskeleton20)接口获取的对象在格式化后显示差异请参考[SimpleDateTimeFormat.format](js-apis-i18n.md#format18)的示例。
...
| 类型 | 说明 |
| --- | --- |
| [SimpleDateTimeFormat](js-apis-i18n.md#simpledatetimeformat18) | SimpleDateTimeFormat对象。 |
...
从API version 18开始支持，从API version 20开始废弃，建议使用[getSimpleDateTimeFormatByPattern](js-apis-i18n.md#i18ngetsimpledatetimeformatbypattern20)替代。

通过模式字符串获取SimpleDateTimeFormat对象。与[getSimpleDateTimeFormatBySkeleton](js-apis-i18n.md#i18ngetsimpledatetimeformatbyskeletondeprecated)接口获取的对象在格式化后显示差异请参考[SimpleDateTimeFormat.format](js-apis-i18n.md#format18)的示例。
...
通过框架字符串获取SimpleDateTimeFormat对象。与[getSimpleDateTimeFormatByPattern](js-apis-i18n.md#i18ngetsimpledatetimeformatbypattern20)接口获取的对象在格式化后显示差异请参考[SimpleDateTimeFormat.format](js-apis-i18n.md#format18)的示例。
...
从API version 18开始支持，从API version 20开始废弃，建议使用[getSimpleDateTimeFormatBySkeleton](js-apis-i18n.md#i18ngetsimpledatetimeformatbyskeleton20)替代。

通过框架字符串获取SimpleDateTimeFormat对象。与[getSimpleDateTimeFormatByPattern](js-apis-i18n.md#i18ngetsimpledatetimeformatbypatterndeprecated)接口获取的对象在格式化后显示差异请参考[SimpleDateTimeFormat.format](js-apis-i18n.md#format18)的示例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dateTimeFormat | [Intl.DateTimeFormat](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/DateTimeFormat) | [SimpleDateTimeFormat](js-apis-i18n.md#simpledatetimeformat18) | 是 | 用于格式化时间日期的对象。 |
| options | [StyledDateTimeFormatOptions](js-apis-i18n.md#styleddatetimeformatoptions23) | 否 | 指定时间日期格式化对象的配置项。默认值：默认的文本样式。 |
...
| 类型 | 说明 |
| --- | --- |
| [StyledString](ts-universal-styled-string.md#styledstring) | 格式化后的富文本对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| year | [TextStyle](ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定年的文本样式。默认值：StyledString默认的文本样式。 |
| month | [TextStyle](ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定月的文本样式。默认值：StyledString默认的文本样式。 |
| day | [TextStyle](ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定日的文本样式。默认值：StyledString默认的文本样式。 |
| hour | [TextStyle](ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定时的文本样式。默认值：StyledString默认的文本样式。 |
| minute | [TextStyle](ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定分的文本样式。默认值：StyledString默认的文本样式。 |
| second | [TextStyle](ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定秒的文本样式。默认值：StyledString默认的文本样式。 |
| dayPeriod | [TextStyle](ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定时段的文本样式。默认值：StyledString默认的文本样式。 |
| weekday | [TextStyle](ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定星期的文本样式。默认值：StyledString默认的文本样式。 |
...
| 类型 | 说明 |
| --- | --- |
| [SimpleNumberFormat](js-apis-i18n.md#simplenumberformat18) | SimpleNumberFormat对象。 |
...
从API version 18开始支持，从API version 20开始废弃，建议使用[getSimpleNumberFormatBySkeleton](js-apis-i18n.md#i18ngetsimplenumberformatbyskeleton20)替代。
...
从API version 18开始支持，从API version 20开始废弃，建议使用[constructor](js-apis-i18n.md#constructor20)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| numberFormat | [intl.NumberFormat](js-apis-intl.md#numberformat) | [SimpleNumberFormat](js-apis-i18n.md#simplenumberformat18) | 是 | 用于格式化数字的对象。 |
| options | [StyledNumberFormatOptions](js-apis-i18n.md#stylednumberformatoptions18) | 否 | 指定数字格式化对象的配置项。默认值：默认的文本样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| numberFormat | [Intl.NumberFormat](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat) | [SimpleNumberFormat](js-apis-i18n.md#simplenumberformat18) | 是 | 用于格式化数字的对象。 |
| options | [StyledNumberFormatOptions](js-apis-i18n.md#stylednumberformatoptions18) | 否 | 指定数字格式化对象的配置项。默认值：默认的文本样式。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| integer | [TextStyle](ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定整数部分的文本样式。默认值：StyledString默认的文本样式。 |
| decimal | [TextStyle](ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定小数点的文本样式。默认值：StyledString默认的文本样式。 |
| fraction | [TextStyle](ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定小数部分的文本样式。默认值：StyledString默认的文本样式。 |
| unit | [TextStyle](ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定单位部分的文本样式。默认值：StyledString默认的文本样式。 |
...
| options | [AdvancedMeasureFormatOptions](js-apis-i18n.md#advancedmeasureformatoptions23) | 否 | 指定数字格式化对象的配置项。默认值：与[numberFormat](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat)格式化效果一样。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| AREA\_LAND\_AGRICULT | 1 | 农业土地面积。 |
| AREA\_LAND\_COMMERCL | 2 | 商业土地面积。 |
| AREA\_LAND\_RESIDNTL | 3 | 居住土地面积。 |
| LENGTH\_PERSON | 4 | 身高。 |
| LENGTH\_PERSON\_SMALL | 5 | 高精度的身高。 |
| LENGTH\_RAINFALL | 6 | 降雨量。 |
| LENGTH\_ROAD | 7 | 道路长度。 |
| LENGTH\_ROAD\_SMALL | 8 | 高精度的道路长度。 |
| LENGTH\_SNOWFALL | 9 | 降雪量。 |
| LENGTH\_VEHICLE | 10 | 交通工具长度。 |
| LENGTH\_VISIBLTY | 11 | 能见度。 |
| LENGTH\_VISIBLTY\_SMALL | 12 | 高精度的能见度。 |
| LENGTH\_PERSON\_INFORMAL | 13 | 口语化身高。 |
| LENGTH\_PERSON\_SMALL\_INFORMAL | 14 | 高精度的口语化身高。 |
| LENGTH\_ROAD\_INFORMAL | 15 | 口语化道路长度。 |
| SPEED\_ROAD\_TRAVEL | 16 | 车速。 |
| SPEED\_WIND | 17 | 风速。 |
| TEMPERATURE\_PERSON | 18 | 体温。 |
| TEMPERATURE\_WEATHER | 19 | 气温。 |
| VOLUME\_VEHICLE\_FUEL | 20 | 交通工具燃料容积。 |
| ELAPSED\_TIME\_SECOND | 21 | 过去的时间。 |
| SIZE\_FILE\_BYTE | 22 | 文件大小。 |
| SIZE\_SHORTFILE\_BYTE | 23 | 简短的文件大小。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[System.getDisplayLanguage](js-apis-i18n.md#getdisplaylanguage9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[System.getSystemLanguage](js-apis-i18n.md#getsystemlanguage9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[System.getSystemRegion](js-apis-i18n.md#getsystemregion9)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[System.is24HourClock](js-apis-i18n.md#is24hourclock9)替代。
...
**需要权限**：ohos.permission.UPDATE\_CONFIGURATION
...
从API version 8开始支持，从API version 9开始废弃，建议使用[System.getPreferredLanguageList](js-apis-i18n.md#getpreferredlanguagelist9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[System.getFirstPreferredLanguage](js-apis-i18n.md#getfirstpreferredlanguage9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[unitConvert](js-apis-i18n.md#unitconvert9)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fromUnit | [UnitInfo](js-apis-i18n.md#unitinfo8) | 是 | 要被转换的单位。 |
| toUnit | [UnitInfo](js-apis-i18n.md#unitinfo8) | 是 | 要转换为的单位。 |
...
从API version 8开始支持，从API version 9开始废弃，建议使用[isDigit](js-apis-i18n.md#isdigit9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[isWhitespace](js-apis-i18n.md#iswhitespace9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[isIdeograph](js-apis-i18n.md#isideograph9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[isLowerCase](js-apis-i18n.md#islowercase9)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[getType](js-apis-i18n.md#gettype9)替代。
