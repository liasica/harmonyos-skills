...
content_hash: sha256:5d642ded65ee9663fff7aa98b5bccdc59956afd8d95f0ad7d3f82003a8f88ca9
---
...
开发者执行命令hdc shell param get persist.sys.default\_ime查看默认输入法参数。若参数可正常显示则系统参数配置模块正常，建议重启设备后重试。
