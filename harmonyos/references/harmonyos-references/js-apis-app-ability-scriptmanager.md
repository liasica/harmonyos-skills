---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-scriptmanager
...
| flags | number | 否 | 是 | 表示URI的读写权限，与[Want](js-apis-app-ability-want.md)的flags字段含义一致。取值范围如下：  - [wantConstant.Flags.FLAG\_AUTH\_READ\_URI\_PERMISSION](js-apis-app-ability-wantconstant.md#flags)：读权限。  - [wantConstant.Flags.FLAG\_AUTH\_WRITE\_URI\_PERMISSION](js-apis-app-ability-wantconstant.md#flags)：写权限。  - 以上两个标志的组合：同时授权读写权限。 |
...
| result | [ExecuteResult](js-apis-app-ability-scriptmanager.md#executeresult) | 是 | ArkTS脚本的执行结果。 |
