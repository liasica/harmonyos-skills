...
content_hash: sha256:f4e3054ab4d7ca23a415e842870639043f36ab9897a4807cb8d4520568355c87
---
...
回调返回的信息为[BusinessError](js-apis-base.md#businesserror)类型的错误参数。
...
错误参数为[BusinessError](js-apis-base.md#businesserror)类型。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| err | [BusinessError](js-apis-base.md#businesserror) | 是 | 接口调用失败的公共错误信息。接口调用成功时，此参数返回null |
