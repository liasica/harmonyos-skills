---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-key-code-h
title: oh_key_code.h
...
**引用文件：** <multimodalinput/oh\_key\_code.h>
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [Input\_KeyCode](capi-oh-key-code-h.md#input_keycode) | Input\_KeyCode | 键值。 |
...
| KEYCODE\_HOME = 1 | 功能（Home）键  **起始版本：** 22 |
| KEYCODE\_BACK = 2 | 返回键  **起始版本：** 22 |
| KEYCODE\_SEARCH = 9 | 搜索键  **起始版本：** 22 |
| KEYCODE\_MEDIA\_PLAY\_PAUSE = 10 | 多媒体键：播放/暂停。  **起始版本：** 22  与KEYCODE\_PLAYPAUSE的区别为：  KEYCODE\_PLAYPAUSE是较早的定义，KEYCODE\_MEDIA\_PLAY\_PAUSE为现代媒体键设备设计，常见于较新的媒体键设备。 |
| KEYCODE\_MEDIA\_STOP = 11 | 光盘停止键  **起始版本：** 22 |
| KEYCODE\_MEDIA\_NEXT = 12 | 多媒体键：下一首  **起始版本：** 22 |
| KEYCODE\_MEDIA\_PREVIOUS = 13 | 多媒体键：上一首  **起始版本：** 22 |
| KEYCODE\_MEDIA\_REWIND = 14 | 多媒体键：快退  **起始版本：** 22 |
| KEYCODE\_MEDIA\_FAST\_FORWARD = 15 | 多媒体键：快进  **起始版本：** 22 |
...
| KEYCODE\_MEDIA\_PLAY = 2085 | 多媒体键：播放 |
| KEYCODE\_MEDIA\_PAUSE = 2086 | 光盘暂停键 |
...
| KEYCODE\_VIRTUAL\_MULTITASK = 2210 | 虚拟多任务键  **起始版本：** 22 |
| KEYCODE\_BUTTON\_A = 2301 | 游戏手柄按键'A'  **起始版本：** 22 |
| KEYCODE\_BUTTON\_B = 2302 | 游戏手柄按键'B'  **起始版本：** 22 |
| KEYCODE\_BUTTON\_X = 2304 | 游戏手柄按键'X'  **起始版本：** 22 |
| KEYCODE\_BUTTON\_Y = 2305 | 游戏手柄按键'Y'  **起始版本：** 22 |
| KEYCODE\_BUTTON\_L1 = 2307 | 游戏手柄按键'L1'  **起始版本：** 22 |
| KEYCODE\_BUTTON\_R1 = 2308 | 游戏手柄按键'R1'  **起始版本：** 22 |
| KEYCODE\_BUTTON\_L2 = 2309 | 游戏手柄按键'L2'  **起始版本：** 22 |
| KEYCODE\_BUTTON\_R2 = 2310 | 游戏手柄按键'R2'  **起始版本：** 22 |
| KEYCODE\_BUTTON\_SELECT = 2311 | 游戏手柄按键'Select'  **起始版本：** 22 |
| KEYCODE\_BUTTON\_START = 2312 | 游戏手柄按键'Start'  **起始版本：** 22 |
| KEYCODE\_BUTTON\_MODE = 2313 | 游戏手柄按键'Mode'  **起始版本：** 22 |
| KEYCODE\_BUTTON\_THUMBL = 2314 | 游戏手柄按键'THUMBL'  **起始版本：** 22 |
| KEYCODE\_BUTTON\_THUMBR = 2315 | 游戏手柄按键'THUMBR'  **起始版本：** 22 |
| KEYCODE\_SLEEP = 2600 | 睡眠键  **起始版本：** 22 |
| KEYCODE\_ZENKAKU\_HANKAKU = 2601 | 日文全宽/半宽键  **起始版本：** 22 |
| KEYCODE\_102ND = 2602 | 国际键盘扩展键  **起始版本：** 22 |
| KEYCODE\_RO = 2603 | 日文Ro键  **起始版本：** 22 |
| KEYCODE\_KATAKANA = 2604 | 日文片假名键  **起始版本：** 22 |
| KEYCODE\_HIRAGANA = 2605 | 日文平假名键  **起始版本：** 22 |
| KEYCODE\_HENKAN = 2606 | 日文转换键  **起始版本：** 22 |
| KEYCODE\_KATAKANA\_HIRAGANA = 2607 | 日语片假名/平假名键  **起始版本：** 22 |
| KEYCODE\_MUHENKAN = 2608 | 日文非转换键  **起始版本：** 22 |
| KEYCODE\_LINEFEED = 2609 | 换行键  **起始版本：** 22 |
...
| KEYCODE\_PLAYPAUSE = 2630 | 多媒体键：播放/暂停。  **起始版本：** 22  与KEYCODE\_MEDIA\_PLAY\_PAUSE的区别为：  KEYCODE\_PLAYPAUSE是较早的定义，KEYCODE\_MEDIA\_PLAY\_PAUSE为现代媒体键设备设计，常见于较新的媒体键设备。 |
| KEYCODE\_PREVIOUS = 2631 | Page Up键  **起始版本：** 22 |
| KEYCODE\_STOPCD = 2632 | CD停止键  **起始版本：** 22 |
| KEYCODE\_CONFIG = 2634 | 配置键  **起始版本：** 22 |
| KEYCODE\_REFRESH = 2635 | 刷新键  **起始版本：** 22 |
| KEYCODE\_EXIT = 2636 | 退出键  **起始版本：** 22 |
| KEYCODE\_EDIT = 2637 | 编辑键  **起始版本：** 22 |
| KEYCODE\_SCROLLUP = 2638 | 向上滚动键  **起始版本：** 22 |
| KEYCODE\_SCROLLDOWN = 2639 | 向下滚动键  **起始版本：** 22 |
| KEYCODE\_NEW = 2640 | 新建键  **起始版本：** 22 |
| KEYCODE\_REDO = 2641 | 恢复键  **起始版本：** 22 |
| KEYCODE\_CLOSE = 2642 | 关闭键  **起始版本：** 22 |
| KEYCODE\_PLAY = 2643 | 播放键  **起始版本：** 22 |
| KEYCODE\_BASSBOOST = 2644 | 低音增强键  **起始版本：** 22 |
| KEYCODE\_PRINT = 2645 | 打印键  **起始版本：** 22 |
| KEYCODE\_CHAT = 2646 | 聊天键  **起始版本：** 22 |
| KEYCODE\_FINANCE = 2647 | 金融键  **起始版本：** 22 |
| KEYCODE\_CANCEL = 2648 | 取消键  **起始版本：** 22 |
| KEYCODE\_KBDILLUM\_TOGGLE = 2649 | 键盘灯光切换键  **起始版本：** 22 |
| KEYCODE\_KBDILLUM\_DOWN = 2650 | 键盘灯光调暗键  **起始版本：** 22 |
| KEYCODE\_KBDILLUM\_UP = 2651 | 键盘灯光调亮键  **起始版本：** 22 |
| KEYCODE\_SEND = 2652 | 发送键  **起始版本：** 22 |
| KEYCODE\_REPLY = 2653 | 答复键  **起始版本：** 22 |
| KEYCODE\_FORWARDMAIL = 2654 | 邮件转发键  **起始版本：** 22 |
| KEYCODE\_SAVE = 2655 | 保存键  **起始版本：** 22 |
| KEYCODE\_DOCUMENTS = 2656 | 文件键  **起始版本：** 22 |
| KEYCODE\_VIDEO\_NEXT = 2657 | 下一个视频键  **起始版本：** 22 |
| KEYCODE\_VIDEO\_PREV = 2658 | 上一个视频键  **起始版本：** 22 |
| KEYCODE\_BRIGHTNESS\_CYCLE = 2659 | 背光渐变键  **起始版本：** 22 |
| KEYCODE\_BRIGHTNESS\_ZERO = 2660 | 亮度调节为0键  **起始版本：** 22 |
| KEYCODE\_DISPLAY\_OFF = 2661 | 显示关闭键  **起始版本：** 22 |
| KEYCODE\_BTN\_MISC = 2662 | 游戏手柄上的各种按键  **起始版本：** 22 |
| KEYCODE\_GOTO = 2663 | 进入键  **起始版本：** 22 |
| KEYCODE\_INFO = 2664 | 信息查看键  **起始版本：** 22 |
| KEYCODE\_PROGRAM = 2665 | 程序键  **起始版本：** 22 |
| KEYCODE\_PVR = 2666 | 个人录像机（PVR）键  **起始版本：** 22 |
| KEYCODE\_SUBTITLE = 2667 | 字幕键  **起始版本：** 22 |
| KEYCODE\_FULL\_SCREEN = 2668 | 全屏键  **起始版本：** 22 |
| KEYCODE\_KEYBOARD = 2669 | 键盘  **起始版本：** 22 |
| KEYCODE\_ASPECT\_RATIO = 2670 | 屏幕纵横比调节键  **起始版本：** 22 |
| KEYCODE\_PC = 2671 | 端口控制键  **起始版本：** 22 |
| KEYCODE\_TV = 2672 | TV键  **起始版本：** 22 |
| KEYCODE\_TV2 = 2673 | TV键2  **起始版本：** 22 |
| KEYCODE\_VCR = 2674 | 录像机开启键  **起始版本：** 22 |
| KEYCODE\_VCR2 = 2675 | 录像机开启键2  **起始版本：** 22 |
| KEYCODE\_SAT = 2676 | SIM卡应用工具包（SAT）键  **起始版本：** 22 |
| KEYCODE\_CD = 2677 | CD键  **起始版本：** 22 |
| KEYCODE\_TAPE = 2678 | 磁带键  **起始版本：** 22 |
| KEYCODE\_TUNER = 2679 | 调谐器键  **起始版本：** 22 |
| KEYCODE\_PLAYER = 2680 | 播放器键  **起始版本：** 22 |
| KEYCODE\_DVD = 2681 | DVD键  **起始版本：** 22 |
| KEYCODE\_AUDIO = 2682 | 音频键  **起始版本：** 22 |
...
| KEYCODE\_RESTART = 2693 | 重启键  **起始版本：** 22 |
| KEYCODE\_SLOW = 2694 | 慢速键  **起始版本：** 22 |
| KEYCODE\_SHUFFLE = 2695 | 随机播放键  **起始版本：** 22 |
| KEYCODE\_VIDEOPHONE = 2696 | 可视电话键  **起始版本：** 22 |
| KEYCODE\_GAMES = 2697 | 游戏键  **起始版本：** 22 |
| KEYCODE\_ZOOMIN = 2698 | 放大键  **起始版本：** 22 |
| KEYCODE\_ZOOMOUT = 2699 | 缩小键  **起始版本：** 22 |
| KEYCODE\_ZOOMRESET = 2700 | 缩放重置键  **起始版本：** 22 |
| KEYCODE\_WORDPROCESSOR = 2701 | 文字处理键  **起始版本：** 22 |
| KEYCODE\_EDITOR = 2702 | 编辑器键  **起始版本：** 22 |
...
| KEYCODE\_SCREENSAVER = 2721 | 屏幕保护程序键  **起始版本：** 22 |
| KEYCODE\_ASSISTANT = 2722 | 智慧键  **起始版本：** 22 |
...
| KEYCODE\_DELETEFILE = 2804 | 删除文件按键  **起始版本：** 22 |
| KEYCODE\_XFER = 2805 | 文件传输（XFER）按键  **起始版本：** 22 |
| KEYCODE\_PROG1 = 2806 | 程序键1  **起始版本：** 22 |
| KEYCODE\_PROG2 = 2807 | 程序键2  **起始版本：** 22 |
| KEYCODE\_MSDOS = 2808 | DOS面板键  **起始版本：** 22 |
| KEYCODE\_SCREENLOCK = 2809 | 屏幕锁定键  **起始版本：** 22 |
| KEYCODE\_DIRECTION\_ROTATE\_DISPLAY = 2810 | 方向旋转显示键  **起始版本：** 22 |
| KEYCODE\_CYCLEWINDOWS = 2811 | 窗口切换键  **起始版本：** 22 |
| KEYCODE\_COMPUTER = 2812 | 按键  **起始版本：** 22 |
| KEYCODE\_EJECTCLOSECD = 2813 | 弹出CD键  **起始版本：** 22 |
| KEYCODE\_ISO = 2814 | ISO键  **起始版本：** 22 |
| KEYCODE\_MOVE = 2815 | 移动键  **起始版本：** 22 |
| KEYCODE\_F13 = 2816 | 按键'F13'  **起始版本：** 22 |
| KEYCODE\_F14 = 2817 | 按键'F14'  **起始版本：** 22 |
| KEYCODE\_F15 = 2818 | 按键'F15'  **起始版本：** 22 |
| KEYCODE\_F16 = 2819 | 按键'F16'  **起始版本：** 22 |
| KEYCODE\_F17 = 2820 | 按键'F17'  **起始版本：** 22 |
| KEYCODE\_F18 = 2821 | 按键'F18'  **起始版本：** 22 |
| KEYCODE\_F19 = 2822 | 按键'F19'  **起始版本：** 22 |
| KEYCODE\_F20 = 2823 | 按键'F20'  **起始版本：** 22 |
| KEYCODE\_F21 = 2824 | 按键'F21'  **起始版本：** 22 |
| KEYCODE\_F22 = 2825 | 按键'F22'  **起始版本：** 22 |
| KEYCODE\_F23 = 2826 | 按键'F23'  **起始版本：** 22 |
...
| KEYCODE\_QUESTION = 2834 | 疑问按键  **起始版本：** 22 |
| KEYCODE\_CONNECT = 2836 | 连接键  **起始版本：** 22 |
