---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-drawing-components-common
title: 图形绘制通用属性
breadcrumb: API参考 > 应用框架 > ArkUI（方舟UI框架） > ArkTS组件 > 图形绘制 > 图形绘制通用属性
category: harmonyos-references
scraped_at: 2026-09-02T15:01:06+08:00
doc_updated_at: 2026-08-29
content_hash: sha256:e5cb23790e596b098d3ccc7e89c7759272dcc85d03f68fe31c646092354c3a1b
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](ts-types.md#resource) | 是 | 边框透明度。  默认值：[stroke](ts-drawing-components-common.md#stroke)接口设置的透明度。  异常值NaN按0.0处理，undefined、null和Infinity按1.0处理。 |
