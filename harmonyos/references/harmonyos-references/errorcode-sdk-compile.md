---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-sdk-compile
title: SDK编译校验错误码
...
参考API文档说明：[apiAvailable](js-apis-device-info.md#deviceinfoapiavailable)。
...
4. 参考API文档说明：[apiAvailable](js-apis-device-info.md#deviceinfoapiavailable)。
...
4. 参考API文档说明：[Available](js-apis-annotation.md#available)。
