...
| 类型 | 说明 |
| --- | --- |
| Promise<[osAccount.OsAccountInfo](js-apis-osaccount.md#osaccountinfo)> | Promise对象，返回添加的账号信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [DomainAccountPolicy](js-apis-enterprise-accountmanager.md#domainaccountpolicy19) | 域账号策略。 |
