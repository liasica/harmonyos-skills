...
Sendable上下文，符合[Sendable协议](../harmonyos-guides/arkts-sendable.md#sendable协议)，继承自[lang.ISendable](js-apis-arkts-lang.md#isendable)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.Context](js-apis-inner-application-context.md) | 是 | Context对象。其中，EventHub支持传递的序列化数据类型参见[序列化支持类型](js-apis-taskpool.md#序列化支持类型)，数据大小不超过16MB。 |
