...
content_hash: sha256:21d27e26693e0b82e673a5f732705e640df6acff4d035cc5552f99ea9006d5b8
---
...
| 类型 | 说明 |
| --- | --- |
| [NativeMediaPlayerBridge](arkts-apis-webview-nativemediaplayerbridge.md) | 接管网页媒体播放器和ArkWeb内核之间的一个接口类。  应用需要实现该接口类。  ArkWeb内核通过该接口对象控制应用创建的媒体播放器。  如果应用返回了null，则表示应用不接管这个媒体的播放，由ArkWeb内核来播放该媒体。 |
