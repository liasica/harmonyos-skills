---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-defaultappmanager
...
根据系统已定义的应用类型或者[UniformDataType](js-apis-data-uniformtypedescriptor.md#uniformdatatype)类型判断当前应用是否是该类型的默认应用。使用Promise异步回调。
