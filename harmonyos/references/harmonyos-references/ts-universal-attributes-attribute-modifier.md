...
content_hash: sha256:9e421e4fccd00b0c6b7fe4e6dc1c5ac73f9e8d5bbdaaccefbee362e394ba2acd
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| instance | T | 是 | 组件的属性类，用来标识进行属性设置的组件的类型，比如[Button](ts-basic-components-button.md)组件的[属性](ts-basic-components-button.md#属性)（ButtonAttribute），[Text](ts-basic-components-text.md)组件的[属性](ts-basic-components-text.md#属性)（TextAttribute）等。具体取值请参考[Attribute类型支持范围](ts-universal-attributes-attribute-modifier.md#attribute类型支持范围)。 |
...
开发者可根据需要自定义实现上述回调方法，通过传入的参数识别组件类型，对instance设置属性，支持使用if/else语法进行动态设置。参考[示例7（组件绑定Modifier选中状态样式）](ts-universal-attributes-attribute-modifier.md#示例7组件绑定modifier选中状态样式)。
...
组件悬浮状态的样式。参考[示例9（组件绑定Modifier实现鼠标悬浮态效果）](ts-universal-attributes-attribute-modifier.md#示例9组件绑定modifier实现鼠标悬浮态效果)。
...
| UIPickerComponentAttribute22+ | UIPickerComponent的[属性](ts-container-ui-picker-component.md#属性)。 |
| UIExtensionComponentAttribute | UIExtensionComponent的[属性](js-apis-arkui-uiextension.md#属性)。 |
| ContainerReaderAttribute | ContainerReader的[属性](ts-container-containerreader.md#属性)。  **起始版本：** 26.0.0 |
...
2. 不支持入参为[modifier](../harmonyos-guides/arkts-user-defined-modifier.md)类型的属性，具体为以下属性方法：[attributeModifier](ts-universal-attributes-attribute-modifier.md#attributemodifier)、[drawModifier](ts-universal-attributes-draw-modifier.md#drawmodifier)和[gestureModifier](ts-universal-attributes-gesture-modifier.md#gesturemodifier)。
...
* StepperModifier从API version 20开始支持，从API version 22开始废弃。建议使用[SwiperModifier](ts-universal-attributes-attribute-modifier.md#自定义modifier)替代。
* StepperItemModifier从API version 12开始支持，从API version 22开始废弃。建议使用[SwiperModifier](ts-universal-attributes-attribute-modifier.md#自定义modifier)替代。
* NavigatorModifier从API version 12开始支持，从API version 20开始废弃。建议使用[NavigationModifier](ts-universal-attributes-attribute-modifier.md#自定义modifier)替代。
* NavRouterModifier从API version 12开始支持，从API version 20开始废弃。建议使用[NavigationModifier](ts-universal-attributes-attribute-modifier.md#自定义modifier)替代。
...
5. 自定义Modifier不支持@State装饰的状态数据的变化感知，见[示例3（自定义Modifier不支持感知@State装饰的状态数据变化）](ts-universal-attributes-attribute-modifier.md#示例3自定义modifier不支持感知state装饰的状态数据变化)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/02/v3/TcyzS14hTnat1kHl5o6--Q/zh-cn_image_0000002723696862.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1c/v3/r0go_RzeQIOACB1f8brv5A/zh-cn_image_0000002723696862.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d1/v3/5FQopJOkQlGMPgdmDXUpKg/zh-cn_image_0000002753296629.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4f/v3/cokVL0GETDmp73PRScPhdA/zh-cn_image_0000002753456547.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/K4JwILmaQhCr6f22RNVHuQ/zh-cn_image_0000002723856782.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/a_2VcAK9Q4u1Mep7WfW9hA/zh-cn_image_0000002723696864.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b9/v3/2Odg5ATkTcaMDwvxH7lthw/zh-cn_image_0000002753296631.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/90/v3/oSUOUGyFTBeiiQaIV7S7kw/zh-cn_image_0000002753456549.gif)

### 示例9（组件绑定Modifier实现鼠标悬浮态效果）

该示例通过Button绑定Modifier实现了鼠标悬浮态的效果。当鼠标移动到Button上时，Button的背景颜色变为红色，此时为悬浮态效果；当鼠标离开Button时，Button的背景颜色变为黑色，此时为普通态效果；同时通过[applyHoveredAttribute](ts-universal-attributes-attribute-modifier.md#applyhoveredattribute)接口设置悬浮态样式。

从API版本26.0.0开始，新增[applyHoveredAttribute](ts-universal-attributes-attribute-modifier.md#applyhoveredattribute)接口。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/YPZ4N3DJQRCI4PfT0CVPtg/zh-cn_image_0000002723856784.gif)
