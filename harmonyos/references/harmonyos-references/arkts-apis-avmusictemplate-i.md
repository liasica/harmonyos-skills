---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i
title: Interfaces (其他)
...
| tabIcon | [image.PixelMap](arkts-apis-image-pixelmap.md) | 否 | 是 | 标签页的图标（接入模板时在主界面的标签页中必填）。 |
...
媒体标签页内容的定义。继承自[OperResult](arkts-apis-avmusictemplate-i.md#operresult)。
...
| compilations | [Compilation](arkts-apis-avmusictemplate-i.md#compilation)[] | 否 | 否 | 页面内容的合集数组。 |

## Compilation

合集的定义。继承自[OperResult](arkts-apis-avmusictemplate-i.md#operresult)。
...
| topElements | [MediaEntity](arkts-apis-avmusictemplate-i.md#mediaentity)[] | 否 | 否 | 合集的内容。 |

## Banner

海报的定义。继承自[MediaEntity](arkts-apis-avmusictemplate-i.md#mediaentity)。
...
专辑的定义。继承自[MediaEntity](arkts-apis-avmusictemplate-i.md#mediaentity)。
...
| favSubscribeData | [FavoriteData](arkts-apis-avmusictemplate-i.md#favoritedata) | 否 | 否 | 收藏或订阅的信息。 |
| episodeCounts | string | 否 | 是 | 专辑的总音频数。 |

## Ranking

排行榜的定义。继承自[MediaEntity](arkts-apis-avmusictemplate-i.md#mediaentity)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| topElements | [MediaEntity](arkts-apis-avmusictemplate-i.md#mediaentity)[] | 否 | 否 | 榜单下的推荐歌曲。 |

## MediaEntity

媒体实例的定义。继承自[OperResult](arkts-apis-avmusictemplate-i.md#operresult)。
...
| episodeRange | [EpisodeRange](arkts-apis-avmusictemplate-i.md#episoderange) | 否 | 是 | 要查询的剧集区间。 |
...
标签页媒体的定义。继承自[OperResult](arkts-apis-avmusictemplate-i.md#operresult)。
...
| elements | [MediaEntity](arkts-apis-avmusictemplate-i.md#mediaentity)[] | 否 | 否 | 查询数据内容（根据类型传递相应的结构数据）。 |
| sort | [Sort](arkts-apis-avmusictemplate-e.md#sort) | 否 | 是 | 数据排序。 |
| episodeRange | [EpisodeRange](arkts-apis-avmusictemplate-i.md#episoderange) | 否 | 是 | 剧集区间。 |

## Single

单曲的定义。继承自[MediaEntity](arkts-apis-avmusictemplate-i.md#mediaentity)。
...
| playInfo | [PlayInfo](arkts-apis-avmusictemplate-i.md#playinfo) | 否 | 否 | 播放歌曲信息。 |
| favSubscribeData | [FavoriteData](arkts-apis-avmusictemplate-i.md#favoritedata) | 否 | 否 | 收藏或订阅的歌曲的信息。 |
| tags | string[] | 否 | 是 | 歌曲标签信息的数组。 |
| settings | [SettingItem](arkts-apis-avmusictemplate-i.md#settingitem)[] | 否 | 是 | 歌曲设置项的数组。 |
...
| settingValue | string | boolean | [SettingContent](arkts-apis-avmusictemplate-i.md#settingcontent)[] | [WantAgent](js-apis-app-ability-wantagent.md#wantagent) | 否 | 是 | 设置项的值。  - 当settingType为SettingType.SWITCH时，该值为boolean类型。  - 当settingType为SettingType.LIST时，该值为SettingContent数组。  - 当settingType为SettingType.JUMP时，该值为string类型。 |
...
| imageTags | [image.PixelMap](arkts-apis-image-pixelmap.md)[] | 否 | 是 | 设置内容的图片标签数组。 |
...
| icon | [image.PixelMap](arkts-apis-image-pixelmap.md) | 否 | 是 | 与二维码关联的应用图标，用于应用登录的二维码应显示目标应用的图标。 |
| content | string | 否 | 否 | 二维码的内容。 |
| codeData | [image.PixelMap](arkts-apis-image-pixelmap.md) | 否 | 是 | 二维码图片。 |
...
| buttons | [DialogButtonInfo](arkts-apis-avmusictemplate-i.md#dialogbuttoninfo)[] | 否 | 是 | 对话框按钮的数组。 |
| qrCodes | [QrCodeInfo](arkts-apis-avmusictemplate-i.md#qrcodeinfo)[] | 否 | 是 | 对话框二维码的数组。  当设置了二维码信息时，此对话框将被识别为二维码对话框，并将优先显示二维码信息。最多可以设置两个。 |
...
| diagramData | [image.PixelMap](arkts-apis-image-pixelmap.md) | 否 | 是 | 会员购买图片。 |
...
“我的主页”（应用内用户个人主页）自定义元素的定义。继承自[OperResult](arkts-apis-avmusictemplate-i.md#operresult)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| userInfo | [UserInfo](arkts-apis-avmusictemplate-i.md#userinfo) | 否 | 是 | 用户信息。 |
| tabs | [MediaTab](arkts-apis-avmusictemplate-i.md#mediatab)[] | 否 | 是 | 标签页信息。 |
| customCompilations | [Compilation](arkts-apis-avmusictemplate-i.md#compilation)[] | 否 | 是 | 合集数组。 |
| settings | [SettingItem](arkts-apis-avmusictemplate-i.md#settingitem)[] | 否 | 是 | 设置项数组。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| musicInfo | [SearchPlayMusicInfo](arkts-apis-avmusictemplate-i.md#searchplaymusicinfo) | 否 | 是 | 搜播的音频信息。 |
| videoInfo | [SearchPlayVideoInfo](arkts-apis-avmusictemplate-i.md#searchplayvideoinfo) | 否 | 是 | 搜播的视频信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| items | [SearchPlayMusicItem](arkts-apis-avmusictemplate-i.md#searchplaymusicitem)[] | 否 | 否 | 音频列表。 |
