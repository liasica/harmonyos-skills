...
在设备上指定用户重启应用包并终止其所有进程，将会触发事件通知服务发布该[系统公共事件](../harmonyos-guides/common-event-glossary.md#system-common-event系统公共事件)。
...
三方应用默认只能监听自身应用的安装事件。若三方应用需要监听InHouse应用的安装事件，需要被监听的InHouse应用在app.json5的[allowListenBundleChangedEvent](../harmonyos-guides/app-configuration-file.md)中配置本应用的[appIdentifier](../harmonyos-guides/common-problem-of-application.md#什么是appidentifier)。
...
三方应用默认只能监听自身应用的卸载事件。若三方应用需要监听InHouse应用的卸载事件，需要被监听的InHouse应用在app.json5的[allowListenBundleChangedEvent](../harmonyos-guides/app-configuration-file.md)中配置本应用的[appIdentifier](../harmonyos-guides/common-problem-of-application.md#什么是appidentifier)。
...
三方应用默认只能监听自身应用的更改事件。若三方应用需要监听InHouse应用的更新事件，需要被监听的InHouse应用在app.json5的[allowListenBundleChangedEvent](../harmonyos-guides/app-configuration-file.md)中配置本应用的[appIdentifier](../harmonyos-guides/common-problem-of-application.md#什么是appidentifier)。
...
三方应用默认只能监听自身应用的缓存清理事件。若三方应用需要监听InHouse应用的缓存清理事件，需要被监听的InHouse应用在app.json5的[allowListenBundleChangedEvent](../harmonyos-guides/app-configuration-file.md)中配置本应用的[appIdentifier](../harmonyos-guides/common-problem-of-application.md#什么是appidentifier)。
...
申请ohos.permission.MANAGE\_SKILL\_PRIVILEGE权限后能接收自身应用和其他应用的skill变化事件。
...
在设备上开启未成年人模式，将会触发事件通知服务发布该[系统公共事件](../harmonyos-guides/common-event-glossary.md#system-common-event系统公共事件)。
...
datashare服务启动完成后，将会触发事件通知服务发布该[系统公共事件](../harmonyos-guides/common-event-glossary.md#system-common-event系统公共事件)。
...
启动最近任务窗口、创建或销毁分屏条，都会触发通知服务发布这个[系统公共事件](../harmonyos-guides/common-event-glossary.md#system-common-event系统公共事件)。
...
表示[通知渠道](../harmonyos-guides/notification-glossary.md#notification-slot通知渠道)或通知开关发生变化。

[通知设置](../harmonyos-guides/notification-glossary.md#notification-setting通知设置)里修改应用的渠道参数、渠道开关，或者开启、关闭通知使能开关时，都会触发通知服务发布这个[系统公共事件](../harmonyos-guides/common-event-glossary.md#system-common-event系统公共事件)。
...
如果用户一段时间没有使用设备且屏幕已经关闭情况下，系统延迟后台应用程序CPU和网络访问，将会触发[公共事件服务](../harmonyos-guides/common-event-glossary.md#common-event-service-ces公共事件服务)发布该[系统公共事件](../harmonyos-guides/common-event-glossary.md#system-common-event系统公共事件)。
...
当USB断开或者连接时状态发生变化，将会触发事件通知服务发布该[系统公共事件](../harmonyos-guides/common-event-glossary.md#system-common-event系统公共事件)。
...
从API version 9 开始支持，从API version 10 开始废弃，建议使用[COMMON\_EVENT\_SCREEN\_UNLOCKED](commoneventmanager-definitions.md#common_event_screen_unlocked)代替。
...
### COMMON\_EVENT\_VOLUME\_DECRYPTED
...
**取值：** "usual.event.VOLUME\_DECRYPTED"

### COMMON\_EVENT\_VOLUME\_ENCRYPTED
...
**取值：** "usual.event.VOLUME\_ENCRYPTED"

### COMMON\_EVENT\_VOLUME\_ENCRYPTION\_POLICY\_SET
...
**订阅者所需权限：** ohos.permission.QUERY\_VOLUME\_ENCRYPTION\_STATUS

**取值：** "usual.event.VOLUME\_ENCRYPTION\_POLICY\_SET"
...
当蓝牙HFP AG连接状态变化时，将会触发事件通知服务发布该[系统公共事件](../harmonyos-guides/common-event-glossary.md#system-common-event系统公共事件)。
...
当浏览器托管策略发生变化，将会触发事件通知服务发布该[系统公共事件](../harmonyos-guides/common-event-glossary.md#system-common-event系统公共事件)。
...
当设置系统语言时，将会触发事件通知服务发布该[系统公共事件](../harmonyos-guides/common-event-glossary.md#system-common-event系统公共事件)。
...
各类网络（以太网、Wi-Fi、蜂窝等）在连接状态变化时（断开、断开中、连接中、已连接等），将会触发事件通知服务发布该[系统公共事件](../harmonyos-guides/common-event-glossary.md#system-common-event系统公共事件)。
...
电话服务子系统面向应用发布如下[系统公共事件](../harmonyos-guides/common-event-glossary.md#system-common-event系统公共事件)。
...
AppGallery Kit面向应用发布如下[系统公共事件](../harmonyos-guides/common-event-glossary.md#system-common-event系统公共事件)。
...
Multimodalinput Kit面向应用发布如下[系统公共事件](../harmonyos-guides/common-event-glossary.md#system-common-event系统公共事件)。
