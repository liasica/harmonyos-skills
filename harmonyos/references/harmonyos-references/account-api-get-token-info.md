...
content_hash: sha256:fb2894698a9ac836e631df4b9d22386219d58885e7da930af28efd34a48dbb42
---
...
| **参数** | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| access\_token | 是 | String | 通过如下场景获取到的access\_token值。  - [获取用户级凭证](account-api-obtain-user-token.md)  - [刷新用户级凭证](account-api-obtain-refresh-token.md)  - [获取应用级凭证](account-api-obtain-app-token.md)  - [扫码授权登录-获取用户级凭证](account-api-obtain-user-token-for-qrcode.md) |
...
| expire\_in | 是 | Integer | Access Token的过期时间，单位：s。 |
...
| type | 是 | Integer | 凭证类型。  0：通过[获取用户级凭证](account-api-obtain-user-token.md)、[刷新用户级凭证](account-api-obtain-refresh-token.md)、[扫码授权登录-获取用户级凭证](account-api-obtain-user-token-for-qrcode.md)获取到的Access Token。  1：通过[获取应用级凭证](account-api-obtain-app-token.md)获取的Access Token。 |
