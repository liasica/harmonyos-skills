...
content_hash: sha256:f5aabaa0600def7aaed8d13209743025a45f54fdc63ab79f54784d14d579a45e
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rawfile | [Resource](ts-types.md#resource) | 是 | 指定字体文件对应的资源对象。当前只支持$rawfile格式引用的资源对象，传入非$rawfile格式的资源对象时返回空指针。对应格式写为$rawfile('filePath')，其中filePath为指定字体文件相对于工程中resources/rawfile目录的相对路径。 |
| typefaceArguments | [TypefaceArguments](arkts-apis-graphics-drawing-typefacearguments.md) | 是 | 字体属性参数。 |
