...
content_hash: sha256:9c42bda3b61d1dfb420ffd61202510ef4edaa85fe6f75e2512490cc49eb4bb59
---

```
1. typedef struct Camera_Rect {...} Camera_Rect
```
...
预览流的数据获取请参考[预览流二次处理(C/C++)](../harmonyos-guides/native-camera-preview-imagereceiver.md)。
...
| 名称 | 描述 |
| --- | --- |
| int32\_t topLeftX | 左上角的X坐标，范围[0, 1]。 |
| int32\_t topLeftY | 左上角的Y坐标，范围[0, 1]。 |
| int32\_t width | 矩形宽度，范围[0, 1]。 |
| int32\_t height | 矩形高度，范围[0, 1]。 |
