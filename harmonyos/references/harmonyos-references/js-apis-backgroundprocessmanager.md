---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-backgroundprocessmanager
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pid | number | 是 | 需要被压制子进程的进程号，[OH\_Ability\_StartNativeChildProcess](capi-native-child-process-h.md#oh_ability_startnativechildprocess)接口创建子进程后的pid参数，即为子进程进程号。 |
| priority | [ProcessPriority](js-apis-backgroundprocessmanager.md#processpriority) | 是 | 压制档位。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pid | number | 是 | 子进程的进程号，[OH\_Ability\_StartNativeChildProcess](capi-native-child-process-h.md#oh_ability_startnativechildprocess)接口创建子进程后的pid参数，即为子进程进程号。 |
...
**需要权限**： ohos.permission.BACKGROUND\_MANAGER\_POWER\_SAVE\_MODE
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PowerSaveMode](js-apis-backgroundprocessmanager.md#powersavemode20)> | Promise对象。返回进程能效模式状态。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| EFFICIENCY\_MODE | 1 | 效率模式，不会跟随系统进入能效模式，进入能效模式后获取到的CPU资源更少。 |
| DEFAULT\_MODE | 2 | 跟随系统，可能会进入能效模式。 |
