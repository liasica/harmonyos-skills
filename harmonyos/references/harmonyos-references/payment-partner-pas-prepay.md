---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-partner-pas-prepay
title: 预下单
breadcrumb: API参考 > 应用服务 > Payment Kit（鸿蒙支付服务） > REST API > 平台类商户/服务商 > 支付并签约 > 预下单
category: harmonyos-references
scraped_at: 2026-04-28T08:17:59+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:8ce2f38ce335caa2efa17208e103b165583fc2dbadd1c8e8e2cda37e9fd39229
---
...
开发者首先需要调用该接口获取到预支付ID（prepayId），用prepayId构建[orderStr](payment-model.md#orderstr)参数返回给客户端调用支付接口拉起华为支付收银台。
...
* **接口URL：** https://petalpay-developer.cloud.huawei.com.cn/api/v1/partner/aggr/pay-and-sign/preorder/create/app
  ...
  说明：元服务预下单接口请使用<https://petalpay-developer.cloud.huawei.com.cn/api/v1/partner/aggr/pay-and-sign/preorder/create/fa>
* **数据格式：**
...
| allocationType | 否 | String | 分账类型。  - NO\_ALLOCATION：不分账（默认）  - DELAY\_ORDER\_ALLOCATION：延时分账  **说明：** 使用该字段需联系开发者的商户对接人协助申请开通分账能力。分账相关操作参见[分账交易管理](../pay-docs/hwzf-dongjiefenzhang-0000001200646822.md)。 |
...
| contractInfo | 是 | [ContractInfo](payment-model.md#contractinfo) | 签约信息。 |
| payer | 否 | [PayerIn](payment-model.md#payerin) | 支付者信息。 |

## 请求示例

```
1. POST /api/v1/partner/aggr/pay-and-sign/preorder/create/app HTTP/1.1
...
7. "subAppId": "5765880207853***",
8. "spMercNo": "10132120***",
9. "subMercNo": "10193600***",
10. "mercOrderNo": "czl00120240705***",
11. "tradeSummary": "xx商城-手机",
12. "totalAmount": 2,
13. "currency": "CNY",
14. "callbackUrl": "https://www.xxxxxx.com/hw/pay/callback",
15. "payload": "example-payload",
16. "expireTime": "2023-03-28T17:50:12.000+0800",
17. "contractInfo": {
18. "planId": "1***",
19. "mercContractCode": "2024020316555432***",
20. "callbackUrl": "https://www.xxxxxx.com/hw/sign/callback"
21. }
22. }
```
...
6. "sign": "MEQCIEIWzdpziRyTi8vhwWHFuDd********************MabeCgTDG77e+2XJItvq/ZkIcCN5/B20pQ==",
