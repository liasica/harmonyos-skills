---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundle-abilityinfo
title: AbilityInfo
...
| permissions | Array<string> | 是 | 否 | 被其他应用Ability调用时需要申请的权限集合。  通过调用[bundle.getAbilityInfo](js-apis-bundle.md#bundlegetabilityinfodeprecated)接口时，传入GET\_ABILITY\_INFO\_WITH\_PERMISSION获取。 |
...
| applicationInfo | [ApplicationInfo](js-apis-bundle-applicationinfo.md) | 是 | 否 | 应用程序的配置信息。  通过调用[bundle.getAbilityInfo](js-apis-bundle.md#bundlegetabilityinfodeprecated)接口时，传入GET\_ABILITY\_INFO\_WITH\_APPLICATION获取。 |
...
| metaData8+ | Array<[CustomizeData](js-apis-bundle-customizedata.md)> | 是 | 否 | Ability的元信息。  通过调用[bundle.getAbilityInfo](js-apis-bundle.md#bundlegetabilityinfodeprecated)接口时，传入GET\_ABILITY\_INFO\_WITH\_METADATA获取。 |
