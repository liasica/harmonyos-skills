...
content_hash: sha256:6791ca4891109d7f58cca8e8a81169a6c5a68d2db40e4664e65c3a232f270f38
---
...
| options12+ | [KeyboardOptions](ts-basic-components-richeditor.md#keyboardoptions12) | undefined23+ | 否 | 设置自定义键盘是否支持避让功能。  传入undefined或省略时默认不支持避让。 |
...
| options | [SelectionMenuOptions](ts-basic-components-richeditor.md#selectionmenuoptions) | 否 | 菜单的选项。  当需要自定义菜单弹出/关闭回调、指定菜单类型等信息时传入此参数；不传入时，使用默认选择菜单选项配置。 |
...
* 仅支持[TextSpan](ts-basic-components-richeditor.md#richeditortextspanoptions)和[ImageSpan](ts-basic-components-richeditor.md#richeditorimagespanoptions)向剪贴板中添加HTML内容，其他Span类型（如[BuilderSpan](ts-basic-components-richeditor.md#richeditorbuilderspanoptions11)、[SymbolSpan](ts-basic-components-richeditor.md#richeditorsymbolspanoptions11)、[CustomSpan](ts-universal-styled-string.md#customspan)）则不能添加。
* 设置RichEditor组件的属性字符串时，请参考属性字符串[toHtml](ts-universal-styled-string.md#tohtml14)接口文档，以了解支持转换为HTML的范围。

copyOptions不为CopyOptions.None时，长按组件内容，会弹出文本选择菜单。如果通过[bindSelectionMenu](ts-basic-components-richeditor.md#bindselectionmenu)等方式自定义文本选择菜单，则会弹出自定义的菜单。

设置copyOptions为CopyOptions.None时，禁用复制、剪切、翻译、分享、搜索、帮写功能，且不支持拖拽操作，同时[enableDataDetector](ts-basic-components-richeditor.md#enabledatadetector11)的实体识别菜单和[enableSelectedDataDetector](ts-basic-components-richeditor.md#enableselecteddatadetector22)的AI菜单功能将受限。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CopyOptions](ts-appendix-enums.md#copyoptions9) | 是 | 文本内容是否支持复制和粘贴。  默认值：CopyOptions.LocalDevice |

### enableDataDetector11+

enableDataDetector(enable: boolean)

设置是否进行文本特殊实体识别，识别的类型包括电话号码、邮箱地址、网址链接、日期、地址等。具体识别类型可通过[dataDetectorConfig](ts-basic-components-richeditor.md#datadetectorconfig11)属性配置。
...
对[addBuilderSpan](ts-basic-components-richeditor.md#addbuilderspan11)的节点文本，该功能不会生效。
...
该接口在CAPI场景使用时默认关闭。可以在工程的module.json5中配置[metadata](../lite-wearable-guides/module-structure.md#metadata对象内部结构)字段控制是否启用预上屏，配置如下：
...
| style | [PlaceholderStyle](ts-basic-components-richeditor.md#placeholderstyle12) | 否 | 提示文本的字体样式。  当需要自定义placeholder的颜色、字体大小等样式时传入此参数；缺省时，默认跟随主题样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](ts-types.md#resourcecolor) | 是 | 文本选中高亮颜色。  默认为20%不透明度。 |
...
与[bindSelectionMenu](ts-basic-components-richeditor.md#bindselectionmenu)的区别：editMenuOptions在系统默认菜单风格基础上添加扩展项，触发条件不变，适合仅需扩展菜单项的场景；bindSelectionMenu完全自定义菜单风格和触发条件，适合需要深度自定义菜单的场景。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [EnterKeyType](ts-basic-components-textinput.md#enterkeytype枚举说明) | 是 | 软键盘输入法回车键类型。  默认为EnterKeyType.NEW\_LINE。  各枚举值适用场景请参考EnterKeyType枚举说明。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [BarState](ts-appendix-enums.md#barstate) | 是 | RichEditor滚动条的显示模式。  默认值：BarState.Auto |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| maxLength | [Optional](ts-universal-attributes-custom-property.md#optionalt)<number> | 是 | 内容的最大输入长度。当内容（包含文本、图片、Symbol和Builder）的总长度达到此值时，将无法继续添加内容。  默认值：Infinity，可以无限输入。  **说明：**  取值范围：[0, +∞)。当不设置该属性或设置为undefined或负数时，取默认值Infinity；设置为0时，无法输入内容；设置小数时，取整数部分。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| maxLines | [Optional](ts-universal-attributes-custom-property.md#optionalt)<number> | 是 | 设置富文本可显示的最大行数。maxLines为可显示行数，当设置maxLines时，超出内容可滚动显示。同时设置组件高度和最大行数，组件高度优先生效。  取值范围：(0, UINT32\_MAX]。  默认值：UINT32\_MAX，可以无限输入。  设置为0、负数、undefined或null时，取默认值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| appearance | [Optional](ts-universal-attributes-custom-property.md#optionalt)<[KeyboardAppearance](ts-text-common.md#keyboardappearance15枚举说明)> | 是 | 键盘外观。  默认值：KeyboardAppearance.NONE\_IMMERSIVE。  各枚举值适用场景请参考KeyboardAppearance枚举说明。  设置为undefined或null时，取默认值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [Optional](ts-universal-attributes-custom-property.md#optionalt)<[UndoStyle](ts-basic-components-richeditor.md#undostyle20-1)> | 是 | 撤销还原是否保留原样式选项。  默认值：UndoStyle.CLEAR\_STYLE。  设置为undefined或null时，取默认值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enable | [Optional](ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否开启中文与西文的自动间距。  true表示开启自动间距，false表示不开启自动间距。  默认值：false |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| include | [Optional](ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否在首行和尾行增加间距以避免文字截断。  true表示在首行和尾行增加间距，false表示在首行和尾行不增加间距。  默认值：false。  设置为undefined或null时，取默认值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 行高是否基于文字实际高度自适应。  true表示行高基于文字实际高度自适应，false表示行高不基于文字实际高度自适应。  默认值：false。  设置为undefined或null时，取默认值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否开启行首标点符号压缩。  true表示开启行首标点符号压缩，false表示不开启行首标点符号压缩。  默认值：false。  设置为undefined或null时，取默认值。 |
...
孤字优化通过更高效地处理孤立字符（段落尾行首字符）来改善文本布局。启用后，它会调整换行点以尽可能避免孤立字符。孤字优化特性需在[RichEditorParagraphStyle](ts-basic-components-richeditor.md#richeditorparagraphstyle11)的wordBreak属性为非BREAK\_ALL并且待排版文本首个[TextStyle](js-apis-graphics-text.md#textstyle)的[locale](js-apis-graphics-text.md#textstyle)为“zh-Hans”或“zh-Hant”时生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 段落最后一行是否启用孤字优化。  true表示启用孤字优化，false表示不启用孤字优化。  默认值：false。设置为undefined或null时，不启用孤字优化。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否启用水平滚动。  true表示启用水平滚动，false表示禁用水平滚动，文本将自动换行。  默认值：false。设置为undefined或null时，不启用水平滚动。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否启用行尾标点符号悬挂。  true表示启用行尾标点符号悬挂，false表示不启用行尾标点符号悬挂。  默认值：false。设置为undefined或null时，不启用标点符号悬挂。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[RichEditorInsertValue](ts-basic-components-richeditor.md#richeditorinsertvalue), boolean> | 是 | [RichEditorInsertValue](ts-basic-components-richeditor.md#richeditorinsertvalue)为输入法将要输入内容信息。  true表示组件执行添加内容操作，false表示组件不执行添加内容操作。  输入法输入内容前的回调。 |
...
适用于需要拦截删除操作的场景，如阻止删除关键内容、删除前保存历史记录以支持撤销等。与[onDeleteComplete](ts-basic-components-richeditor.md#ondeletecomplete)形成will/did时序模式：aboutToDelete在删除前触发，onDeleteComplete在删除完成后触发；aboutToDelete返回false时，组件不执行删除操作，onDeleteComplete不会触发。两者可同时使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[RichEditorDeleteValue](ts-basic-components-richeditor.md#richeditordeletevalue), boolean> | 是 | [RichEditorDeleteValue](ts-basic-components-richeditor.md#richeditordeletevalue)为准备删除的内容所在的文本或者图片Span信息。  true表示组件执行删除操作，false表示组件不执行删除操作。  输入法删除内容前的回调，英文预上屏点击候选词时会执行该回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [SubmitCallback](ts-basic-components-richeditor.md#submitcallback12) | 是 | 按下软键盘回车键时的回调，用于接收回车键类型和提交事件信息。 |

### onWillChange12+

onWillChange(callback: Callback<[RichEditorChangeValue](ts-basic-components-richeditor.md#richeditorchangevalue12) , boolean>)

在组件执行增删操作前，触发回调。与[onDidChange](ts-basic-components-richeditor.md#ondidchange12)形成will/did时序模式：onWillChange在增删操作前触发，onDidChange在增删操作后触发；onWillChange返回false时，组件不执行增删操作，onDidChange不会触发。两者可同时使用。
...
| valueResource11+ | [Resource](ts-types.md#resource) | 否 | 是 | SymbolSpan资源内容。  默认值：undefined。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| paragraphStyle12+ | [RichEditorParagraphStyle](ts-basic-components-richeditor.md#richeditorparagraphstyle11) | 否 | 是 | 段落样式。  省略时，使用系统默认段落样式。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| previewText12+ | string | 否 | 是 | 文本Span预上屏内容。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| urlStyle19+ | [RichEditorUrlStyle](ts-basic-components-richeditor.md#richeditorurlstyle19) | 否 | 是 | url信息。  默认值：undefined。  当需要为文本设置超链接样式时传入此参数。  **元服务API：** 从API version 19开始，该接口支持在元服务中使用。 |
...
| strokeWidth23+ | number | 否 | 是 | 文本描边宽度。  单位为[vp](ts-pixel-units.md#基本像素单位)。  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。 |
| strokeColor23+ | [ResourceColor](ts-types.md#resourcecolor) | 否 | 是 | 文本描边颜色。  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。 |
| strokeJoinStyle | [StrokeJoinStyle](ts-text-common.md#strokejoinstyle) | 否 | 是 | 文本描边拐角样式。  默认值：StrokeJoinStyle.MITER\_JOIN。  **起始版本：** 26.0.0  **模型约束：** 此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
...
| layoutStyle12+ | [RichEditorLayoutStyle](ts-basic-components-richeditor.md#richeditorlayoutstyle11) | 否 | 是 | 图片布局样式。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| margin | [Dimension](ts-types.md#dimension10) | [Margin](ts-types.md#margin) | 否 | 是 | 外边距类型，用于描述组件不同方向的外边距。  默认值：四个方向外边距均为0。  参数为Dimension类型时，四个方向外边距同时生效。 |
| borderRadius | [Dimension](ts-types.md#dimension10) | [BorderRadiuses](ts-types.md#borderradiuses9) | 否 | 是 | 圆角类型，用于描述组件边框圆角半径。  默认值：圆角半径为0。  参数为Dimension类型时，不支持以Percentage形式设置。 |
...
| 类型 | 说明 |
| --- | --- |
| [RichEditorTextStyle](ts-basic-components-richeditor.md#richeditortextstyle) | 用户预设的文本输入样式对象，包含字体颜色、大小、粗细等样式属性，可用于查询当前组件的输入文本样式配置。  当controller未绑定组件或绑定controller的组件被释放时，返回undefined。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [RichEditorTextStyle](ts-basic-components-richeditor.md#richeditortextstyle) | 是 | 预设的文本输入样式，包含字体颜色、大小、粗细等属性，用于设置后续输入文本的默认样式。 |
...
| options12+ | [SelectionOptions](ts-universal-attributes-text-style.md#selectionoptions12对象说明) | 否 | 选择项配置，用于控制选中操作时的菜单弹出策略。  当需要自定义菜单弹出行为（如强制显示或隐藏菜单）时传入此参数；  省略时默认使用MenuPolicy.DEFAULT，遵循系统默认菜单弹出策略。  各MenuPolicy取值的适用场景请参考SelectionOptions对象说明。 |
...
| 类型 | 说明 |
| --- | --- |
| [LayoutManager](ts-text-common.md#layoutmanager12) | 布局管理器对象，可用于获取组件内容的布局位置等信息。  当controller未绑定组件或绑定controller的组件被释放时，返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [PreviewText](ts-text-common.md#previewtext12) | 预上屏文本信息，包含输入法预显示的候选文本内容及起始位置。  当controller未绑定组件或绑定controller的组件被释放时，返回undefined。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| styledString | [StyledString](ts-universal-styled-string.md#styledstring) | 是 | 设置属性字符串样式的提示文本，其优先级高于[placeholder](ts-basic-components-richeditor.md#placeholder12)属性设置的提示文本。  提示文本不支持触发属性字符串[GestureStyle](ts-universal-styled-string.md#gesturestyle)样式绑定的手势事件，以及[UrlStyle](ts-universal-styled-string.md#urlstyle14)样式的超链接跳转能力。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| range | [TextRange](ts-text-common.md#textrange12) | 否 | 滚动到可视区域的内容范围，包括内容起始位置和终止位置。  起始位置应小于等于结束位置，否则接口调用无效。起始位置小于0视为0，结束位置大于全文长度视为全文长度。  未指定范围时，默认为全部内容。未指定起始位置，默认起始位置为0；未指定结束位置，默认结束位置为全文长度。 |
...
| options | [RichEditorTextSpanOptions](ts-basic-components-richeditor.md#richeditortextspanoptions) | 否 | 文本选项。  当需要设置偏移位置、文本样式、段落样式等信息时传入此参数；不传入时，文本将使用默认样式插入到内容末尾。 |
...
| options | [RichEditorImageSpanOptions](ts-basic-components-richeditor.md#richeditorimagespanoptions) | 否 | 图片选项。  当需要设置图片样式、偏移位置或段落样式时传入此参数；不传入时，图片将使用默认样式插入到内容末尾。 |
...
* 对[addBuilderSpan](ts-basic-components-richeditor.md#addbuilderspan11)的节点文本，[enableDataDetector](ts-basic-components-richeditor.md#enabledatadetector11)、[dataDetectorConfig](ts-basic-components-richeditor.md#datadetectorconfig11)、[enableSelectedDataDetector](ts-basic-components-richeditor.md#enableselecteddatadetector22)功能不会生效。
...
| options | [RichEditorBuilderSpanOptions](ts-basic-components-richeditor.md#richeditorbuilderspanoptions11) | 否 | builder选项。当需要设置builder的偏移位置或无障碍属性时传入此参数；省略时，builder添加到所有内容末尾。 |
...
| options | [RichEditorSymbolSpanOptions](ts-basic-components-richeditor.md#richeditorsymbolspanoptions11) | 否 | symbol选项。  当需要设置SymbolSpan的偏移位置或样式时传入此参数；不传入时，SymbolSpan将使用默认样式插入到内容末尾。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [RichEditorRange](ts-basic-components-richeditor.md#richeditorrange) | 否 | 需要获取span的范围。  省略时，获取所有span信息。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Array<[RichEditorImageSpanResult](ts-basic-components-richeditor.md#richeditorimagespanresult) | [RichEditorTextSpanResult](ts-basic-components-richeditor.md#richeditortextspanresult)> | 指定范围内的文本和图片Span详细信息，包含各Span的位置、内容、样式等属性，可用于查询和操作组件内的文本与图片内容。  当controller未绑定组件或绑定controller的组件被释放时，返回undefined。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [RichEditorRange](ts-basic-components-richeditor.md#richeditorrange) | 否 | 需要获取段落的范围。  省略时，获取所有段落信息。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Array<[RichEditorParagraphResult](ts-basic-components-richeditor.md#richeditorparagraphresult11)> | 选中范围内的段落信息，包含各段落的样式和起始结束位置，可用于查询段落排版属性或进行段落样式更新。  当controller未绑定组件或绑定controller的组件被释放时，返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [RichEditorSelection](ts-basic-components-richeditor.md#richeditorselection) | 选中区域起始/结束位置及选中文本和图片的详细信息。  当controller未绑定组件或绑定controller的组件被释放时，返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[RichEditorSpan](ts-basic-components-richeditor.md#richeditorspan12)> | 将属性字符串解析后得到的文本和图片Span信息，可用于查询属性字符串中各Span的内容、样式和位置。  当controller未绑定组件或绑定controller的组件被释放时，返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [StyledString](ts-universal-styled-string.md#styledstring) | 组件指定范围内容转换后的属性字符串，可用于跨组件传递富文本内容或进行样式编辑操作。  当controller未绑定组件或绑定controller的组件被释放时，返回undefined。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| symbolStyle | [RichEditorSymbolSpanStyle](ts-basic-components-richeditor.md#richeditorsymbolspanstyle11) | 否 | 否 | SymbolSpan的样式信息。 |
...
| leadingMargin | [Dimension](ts-types.md#dimension10) | [LeadingMarginPlaceholder](ts-basic-components-richeditor.md#leadingmarginplaceholder11) | 否 | 是 | 设置文本段落缩进，当段落仅存在ImageSpan或BuilderSpan时，此属性值不生效。参数为Dimension类型时，不支持以Percentage形式设置，默认单位为vp。默认值：{"size":["0.00px","0.00px"]}  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| shaderStyle | [ShaderStyle](ts-text-common.md#shaderstyle20) | 否 | 是 | 设置文本着色器效果。  默认值：undefined，不设置着色器效果。  该接口与[RichEditorTextStyle](ts-basic-components-richeditor.md#richeditortextstyle)中的strokeWidth同时设置时，该接口不生效，shaderStyle的优先级高于[RichEditorTextStyle](ts-basic-components-richeditor.md#richeditortextstyle)的fontColor。  **起始版本：** 26.0.0  **模型约束：** 此接口仅可在Stage模型下使用。  **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
...
| size | [[Dimension](ts-types.md#dimension10), [Dimension](ts-types.md#dimension10)] | 否 | 否 | 图片大小，默认单位为vp。不支持设置百分比。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| style | [RichEditorTextStyle](ts-basic-components-richeditor.md#richeditortextstyle) | 否 | 是 | 文本样式信息。当需要设置文本的颜色、字体大小、粗细等自定义样式时传入此参数。省略时，使用系统默认文本信息。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| paragraphStyle11+ | [RichEditorParagraphStyle](ts-basic-components-richeditor.md#richeditorparagraphstyle11) | 否 | 是 | 段落样式。当需要设置文本的对齐方式、缩进、断行规则等段落级排版属性时传入此参数。不传入时，使用系统默认段落样式（左对齐、无缩进、按单词断行）。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| gesture11+ | [RichEditorGesture](ts-basic-components-richeditor.md#richeditorgesture11) | 否 | 是 | 行为触发回调。当需要自定义文本Span的点击或长按交互行为时传入此参数；省略时，仅使用系统默认行为。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| urlStyle19+ | [RichEditorUrlStyle](ts-basic-components-richeditor.md#richeditorurlstyle19) | 否 | 是 | url信息。  默认值：undefined  **元服务API：** 从API version 19开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fontColor | [ResourceColor](ts-types.md#resourcecolor) | 否 | 是 | 文本颜色。  默认值：$r('sys.color.font\_primary')。当[shaderStyle](ts-basic-components-richeditor.md#richeditorparagraphstyle11)同时设置时，shaderStyle优先级高于fontColor。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| fontSize | [Length](ts-types.md#length) | number | 否 | 是 | 设置字体大小，Length为number类型时，使用fp单位。number类型取值范围：(0, +∞)。设置为0或负值时，按默认值处理。字体默认大小为16fp。不支持设置百分比字符串。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| fontStyle | [FontStyle](ts-appendix-enums.md#fontstyle) | 否 | 是 | 字体样式。  默认值：FontStyle.Normal。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| fontWeight | number | [FontWeight](ts-appendix-enums.md#fontweight) | string | 否 | 是 | 字体粗细。  number类型取值[100,900]，取值间隔为100，默认为400，取值越大，字体越粗。超出范围时按默认值400生效。  string类型仅支持number类型取值的字符串形式，例如"400"，以及"bold"、"bolder"、"lighter"、"regular"、"medium"分别对应FontWeight中相应的枚举值。  默认值：FontWeight.Normal。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| fontFamily | [ResourceStr](ts-types.md#resourcestr) | 否 | 是 | 设置字体列表，当前支持'HarmonyOS Sans'字体和[注册自定义字体](js-apis-font.md)。默认字体:'HarmonyOS Sans'。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| textShadow11+ | [ShadowOptions](ts-universal-attributes-image-effect.md#shadowoptions对象说明) | Array<[ShadowOptions](ts-universal-attributes-image-effect.md#shadowoptions对象说明)> | 否 | 是 | 设置文字阴影效果。  默认值：undefined，不设置文字阴影效果。  该接口支持以数组形式入参，实现多重文字阴影。  **说明：**  仅支持设置阴影模糊半径、颜色和偏移量，不支持智能取色。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| lineHeight12+ | number | string | [Resource](ts-types.md#resource) | 否 | 是 | 设置文本的文本行高。  默认值：不设置时自适应字体大小。  number类型取值范围：(0, +∞)，设置值不大于0时，不限制文本行高，自适应字体大小。number类型时单位为fp，不支持设置百分比字符串。当lineHeight设置值小于当前字号下文本渲染出的实际高度时，[fallbackLineSpacing](ts-basic-components-richeditor.md#fallbacklinespacing23)属性将生效。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| letterSpacing12+ | number | string | 否 | 是 | 设置文本字符间距，默认单位为fp。默认值：0。当取值为负值时，文字会发生压缩。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| fontFeature12+ | string | 否 | 是 | 设置文字特性效果，比如数字等宽的特性。如果未设置，默认为变宽数字。设置无效字符保持默认。  格式为：normal | <feature-tag-value>  <feature-tag-value>的格式为：<string> [ <integer> | on | off ]  <feature-tag-value>的个数可以有多个，中间用','隔开。  例如，使用等宽时钟数字的输入格式为："ss01" on。  Font Feature当前支持的属性见[fontFeature](ts-basic-components-text.md#fontfeature12)属性列表。  设置Font Feature属性，Font Feature是OpenType字体的高级排版能力，如支持连字、数字等宽等特性，一般用在自定义字体中，其能力需要字体本身支持。  更多Font Feature能力介绍可参考[font-feature-settings property](https://www.w3.org/TR/css-fonts-3/#font-feature-settings-prop)和[OpenType Features](https://sparanoid.com/lab/opentype-features/)。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| halfLeading18+ | boolean | 否 | 是 | 文本是否将行间距平分至行的顶部与底部。  true表示将行间距平分至行的顶部与底部，false则不平分。  默认值：false。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
...
| strokeWidth23+ | [LengthMetrics](js-apis-arkui-graphics.md#lengthmetrics12) | number | 否 | 是 | 文本描边宽度。如果LengthMetrics的unit值是[PERCENT](js-apis-arkui-graphics.md#lengthunit12)，当前设置不生效，作为0处理。  值小于0时为实体字，大于0时为轮廓字，等于0时无描边效果。  默认值：0。  单位：LengthMetrics类型时跟随LengthMetrics，number类型时是vp。  取值范围：(-∞, +∞)  与[shaderStyle](ts-basic-components-richeditor.md#richeditorparagraphstyle11)同时设置时，shaderStyle不生效。  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。  **模型约束：** 此接口仅可在Stage模型下使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| font | [Font](ts-types.md#font) | 否 | 是 | 设置提示文本样式。  默认值遵循主题设置。 |
| fontColor | [ResourceColor](ts-types.md#resourcecolor) | 否 | 是 | 设置提示文本颜色。  默认值遵循主题设置。 |
...
| imageStyle | [RichEditorImageSpanStyle](ts-basic-components-richeditor.md#richeditorimagespanstyle) | 否 | 是 | 图片样式信息。当需要自定义图片的大小、垂直对齐方式、缩放类型等样式时传入此参数；省略时，使用系统默认图片样式。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| onHover14+ | [OnHoverCallback](ts-basic-components-richeditor.md#onhovercallback14) | 否 | 是 | 鼠标悬停触发回调。省略时，不执行鼠标悬停回调行为。  **元服务API：** 从API version 14开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| size | [[Dimension](ts-types.md#dimension10), [Dimension](ts-types.md#dimension10)] | 否 | 是 | 图片宽度和高度，默认单位为vp。默认值：与objectFit的值相关，不同的objectFit值有不同的默认尺寸。objectFit的值为Cover时，图片高度为组件高度减去组件上下内边距，宽度为组件宽度减去组件左右内边距。不支持以Percentage形式设置。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| layoutStyle11+ | [RichEditorLayoutStyle](ts-basic-components-richeditor.md#richeditorlayoutstyle11) | 否 | 是 | 图片布局样式。默认值：{"borderRadius":"","margin":""}    **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| style | [RichEditorSymbolSpanStyle](ts-basic-components-richeditor.md#richeditorsymbolspanstyle11) | 否 | 是 | SymbolSpan样式信息。当需要自定义SymbolSpan的颜色、大小、粗细、渲染策略等样式时传入此参数；省略时，使用系统默认样式信息。 |
...
| fontSize | number | string | [Resource](ts-types.md#resource) | 否 | 是 | 设置SymbolSpan组件大小，默认单位为fp。  number类型取值范围：(0, +∞)，设置为0时显示默认字体大小。  默认值：跟随主题。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| onAppear | [MenuOnAppearCallback](ts-basic-components-richeditor.md#menuonappearcallback12) | 否 | 是 | 自定义选择菜单弹出时回调。若需在菜单弹出时执行自定义逻辑（如记录用户操作、动态调整菜单内容），可传入此参数；不传入则无额外回调触发。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| onDisappear | Callback<void> | 否 | 是 | 自定义选择菜单关闭时回调。若需在菜单关闭时执行自定义逻辑（如恢复界面状态、清理临时数据），可传入此参数；不传入则无额外回调触发。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| onMenuShow15+ | [MenuCallback](ts-basic-components-richeditor.md#menucallback15) | 否 | 是 | 自定义选择菜单显示时回调。若需在菜单显示时执行自定义逻辑，可传入此参数；不传入则无回调触发。  **元服务API：** 从API version 15开始，该接口支持在元服务中使用。 |
| onMenuHide15+ | [MenuCallback](ts-basic-components-richeditor.md#menucallback15) | 否 | 是 | 自定义选择菜单隐藏时回调。若需在菜单隐藏时执行自定义逻辑，可传入此参数；不传入则无回调触发。  **元服务API：** 从API version 15开始，该接口支持在元服务中使用。 |
| previewMenuOptions18+ | [PreviewMenuOptions](ts-basic-components-richeditor.md#previewmenuoptions18) | 否 | 是 | 预览菜单的选项。该参数只在RichEditor中生效。  从API版本26.0.0开始，该参数在Text组件中也生效。  不传入时，预览菜单使用默认配置。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| hapticFeedbackMode | [HapticFeedbackMode](ts-universal-attributes-menu.md#hapticfeedbackmode18) | 否 | 是 | 菜单弹出时振动效果，当ImageSpan或BuilderSpan绑定预览菜单时生效。  默认值：HapticFeedbackMode.DISABLED，菜单弹出时不振动。  **说明：** 仅当应用具备ohos.permission.VIBRATE权限，用户已启用触感反馈，且系统硬件支持时才会生效。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| preventDefault | Callback<void> | 否 | 是 | 阻止系统默认粘贴事件。  省略时，执行系统默认粘贴行为。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| preventDefault | Callback<void> | 否 | 是 | 阻止系统默认剪切事件。  省略时，执行系统默认剪切行为。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| preventDefault | Callback<void> | 否 | 是 | 阻止系统默认复制事件。  省略时，执行系统默认复制行为。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [PasteEvent](ts-basic-components-richeditor.md#pasteevent11) | 否 | 定义用户粘贴事件。省略时，不接收粘贴事件信息。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/44/v3/zMUWI4mTTVuv6U4zvfOp-Q/zh-cn_image_0000002733436240.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/NUYKpFfGTo67QAgnsPpcpg/zh-cn_image_0000002762995761.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/xm4cKS0hReSlOJdi5Pfy8w/zh-cn_image_0000002762835875.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/NyIK0_D2Qp2VF-5f38vB3A/zh-cn_image_0000002733276366.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/6gtBcHYGRz-_XncLc9DliQ/zh-cn_image_0000002733436242.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/iDUd1Be6Q42J7BmXxWMSHw/zh-cn_image_0000002762995763.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a5/v3/pK_QZfDzTXiVbuq0cnePDA/zh-cn_image_0000002762835877.gif)

### 示例8（设置文本字重与阴影）

通过[updateSpanStyle](ts-basic-components-richeditor.md#updatespanstyle)接口设置文本字重与阴影。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/24/v3/ALulNE7cRQOeakG_uNtf4Q/zh-cn_image_0000002733276368.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/VHzYnhpoS2GAX8aYf8E3sg/zh-cn_image_0000002733436244.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/2M5sC-GPSdqCFA2LjzwqXQ/zh-cn_image_0000002762995765.gif)
...
通过[caretColor](ts-basic-components-richeditor.md#caretcolor12)属性设置输入框光标、手柄颜色，通过[selectedBackgroundColor](ts-basic-components-richeditor.md#selectedbackgroundcolor12)属性设置文本选中高亮颜色。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/vYu7-LNuSBqONZ2PR78J_w/zh-cn_image_0000002762835879.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/iOXIIN1xT-eJVLz07_hLaw/zh-cn_image_0000002733276370.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/01/v3/wtOw-e7NR4iy2t4lYGJVZA/zh-cn_image_0000002733436246.gif)

### 示例15（配置文字特性效果）

该示例通过[addTextSpan](ts-basic-components-richeditor.md#addtextspan)接口设置文字特性效果（[fontFeature](ts-basic-components-richeditor.md#richeditortextstyle)）。当添加“ss01”特性的FontFeature属性时，数字“0”由原来的椭圆形改变为带有倒圆角形。同时通过[RichEditorTextStyle](ts-basic-components-richeditor.md#richeditortextstyle)的strokeJoinStyle接口设置文本描边拐角样式。

从API版本26.0.0开始，[RichEditorTextStyle](ts-basic-components-richeditor.md#richeditortextstyle)新增strokeJoinStyle接口。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/joM1SyVxSHyfpLUNrwaKkQ/zh-cn_image_0000002762995767.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6/v3/8wDjeJ3tR3qTYMZCht9SCw/zh-cn_image_0000002762835881.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/uxF8MOqRQM-EaBjigT1jmA/zh-cn_image_0000002733276372.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/de/v3/6bBvwrp3TheF1rNICrTvsQ/zh-cn_image_0000002733436248.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4c/v3/dY2zw3JeR8qJ2fYKRheEZw/zh-cn_image_0000002762995769.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/1YGyJV9tTmOo8y4dnd63PQ/zh-cn_image_0000002762835883.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/I0HvXUlBQxW3Go-G1q90Nw/zh-cn_image_0000002733276374.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/G8vy-9yZTm2BmLZr7vyPAA/zh-cn_image_0000002733436250.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/oL2P1K3ETiSLmI6cCW5tqg/zh-cn_image_0000002762835885.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/41/v3/v1ssIkFITXaXhs72k0kC4w/zh-cn_image_0000002733276376.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/yrTngV0aSsejC-PlG5S1vg/zh-cn_image_0000002733436252.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/QOMeW9zRQIyfoM7-eQyQUw/zh-cn_image_0000002762995773.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/LP-hSmMzSC-8B-P9_R3uUw/zh-cn_image_0000002762835887.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/8zCJZ5SDTSeHI-v-0Lkrmg/zh-cn_image_0000002733276378.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0c/v3/iQCG35w3StyCAC4jqugfEA/zh-cn_image_0000002733436254.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6a/v3/wbIHnWESRVWbR2jL2ohFdA/zh-cn_image_0000002762995775.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/1Tiv-o98QPajt9VCu9gghA/zh-cn_image_0000002762835889.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b4/v3/25TaprwrR3OCJWWphI9khA/zh-cn_image_0000002733276380.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/slIpnEkzShi2xhM7LlwC-g/zh-cn_image_0000002733436256.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/LvnsF6w8Qt2Hr9j5V0sZ8w/zh-cn_image_0000002762995777.gif)

### 示例36（设置行首标点符号压缩和行尾标点符号悬挂）

本示例通过[compressLeadingPunctuation](ts-basic-components-richeditor.md#compressleadingpunctuation23)设置行首标点符号压缩，通过[punctuationOverflow](ts-basic-components-richeditor.md#punctuationoverflow)设置行尾标点符号悬挂。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1c/v3/uDZJuUrEQKyMPrmxXWoA9w/zh-cn_image_0000002762835891.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2/v3/2CTvzcx3R020j4UdH3h6dA/zh-cn_image_0000002733276382.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/AX5vyTaIQJKDCTY_ijoljA/zh-cn_image_0000002733436258.gif)

### 示例39（设置属性字符串样式的提示文本）

该示例通过[setStyledPlaceholder](ts-basic-components-richeditor.md#setstyledplaceholder24)接口设置属性字符串样式的提示文本。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/07/v3/1kg_30F4TMywPk-w2Yx68A/zh-cn_image_0000002762995779.png)

### 示例40（设置孤立字符不成行）

该示例通过[orphanCharOptimization](ts-basic-components-richeditor.md#orphancharoptimization)接口启用孤字优化，确保段落最后一行不出现孤字。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/O3Xv2e8gThOKWuMns8K5MA/zh-cn_image_0000002762835893.jpg)

### 示例41（设置水平滚动）

本示例通过[horizontalScrolling](ts-basic-components-richeditor.md#horizontalscrolling)设置水平滚动。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/oN0i6017Q8umDWLANWTx_g/zh-cn_image_0000002733276384.gif)

### 示例42（设置文本着色器效果）

该示例通过[RichEditorParagraphStyle](ts-basic-components-richeditor.md#richeditorparagraphstyle11)中shaderStyle接口实现文本着色效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/90/v3/eNMPVUEpRje89zvr5uZXMA/zh-cn_image_0000002733436260.png)

### 示例43（将指定范围的文字滚动到可视区内）

本示例通过[scrollToVisible](ts-basic-components-richeditor.md#scrolltovisible)将可视区外的文本滚动到可视区内。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/w_rD4dtWTWiEcJwa90W0nQ/zh-cn_image_0000002762995781.gif)
