---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-net-http
title: HTTP错误码
breadcrumb: API参考 > 系统 > 网络 > Network Kit（网络服务） > 错误码 > HTTP错误码
category: harmonyos-references
scraped_at: 2026-09-02T15:01:56+08:00
doc_updated_at: 2026-08-29
content_hash: sha256:2a5c9aa5fed7f47fc9528105c77dd7acf822c4b27d369cf62a1bf52385483c23
---
...
1. 建议参考[tls客户端证书验证流程](../harmonyos-guides/http-request.md#tls客户端证书验证流程)自排查问题原因。
...
应用配置network\_config.json文件中设置为明文不允许。

**处理步骤**

排查network\_config.json中cleartextTrafficPermitted字段配置。
...
可参考配置[服务器域名文档](../atomic-guides/agc-help-harmonyos-server-domain.md)完成服务器域名相关配置。服务器域名配置后一般需要等待一天以上才会生效。
...
2. **HTTP3协议问题**：
   ...
   * **日志关键词**：error\_.GetErrorCode()=，且请求协议为HTTP3
3. **全局拦截器校验失败**：
