---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-speech
title: ArkTS API错误码
breadcrumb: API参考 > AI > Speech Kit（场景化语音服务） > ArkTS API错误码
category: harmonyos-references
scraped_at: 2026-09-02T15:03:12+08:00
doc_updated_at: 2026-06-12
content_hash: sha256:2b2d4b9e79c8c4c0acd1c86d0b74580fb27022604d2262ab29cfcd4770aaf17f
---
...
开发者未配置ohos.permission.KEEP\_BACKGROUND\_RUNNING的后台运行权限。
...
1. PC端场景下，拉起朗读详情页面时，需要在初始化前设置好[setWindowStage](speech-windowmanager.md#setwindowstage)。如果是其他设备类型，可以忽略此步骤。
...
需要首先调用[init](speech-textreader-api.md#init)方法初始化TextReader。
...
[AICaptionOptions](speech-aicaptioncomponent.md#aicaptionoptions)的源语言、目标语言、字体大小等参数不在范围之内，初始化参数错误。
