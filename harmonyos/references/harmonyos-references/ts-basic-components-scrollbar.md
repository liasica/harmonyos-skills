...
content_hash: sha256:77189df01cfb349446507ed19c73cfbfe7a3eeb708bed7354d3b87a524477131
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否执行嵌套滚动。当需要在多层滚动容器之间传递滚动事件时设置为true；不需要嵌套滚动时设置为false。  默认值：false |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Optional](ts-universal-attributes-custom-property.md#optionalt)<[ColorMetrics](js-apis-arkui-graphics.md#colormetrics12)> | 是 | 滚动条的颜色，仅滚动条不放置子组件时生效。  默认值：ColorMetrics.numeric(0x66182431) |
...
| direction | [ScrollBarDirection](ts-basic-components-scrollbar.md#scrollbardirection枚举说明) | 否 | 是 | 滚动条的方向，控制可滚动组件对应方向的滚动。可滚动内容为纵向布局时设置为ScrollBarDirection.Vertical；可滚动内容为横向布局时设置为ScrollBarDirection.Horizontal。  默认值：ScrollBarDirection.Vertical |
| state | [BarState](ts-appendix-enums.md#barstate) | 否 | 是 | 滚动条状态。BarState.Auto表示按需显示，BarState.On表示常驻显示，BarState.Off表示不显示。  默认值：BarState.Auto |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/AqBnqGumSI6eQ8LQw9tIBQ/zh-cn_image_0000002717772598.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/Ix3VQmeYQFucNGm65HL_7w/zh-cn_image_0000002717612666.gif)

## 示例3（支持嵌套滚动）

从API version 14开始，可通过[enableNestedScroll](ts-basic-components-scrollbar.md#enablenestedscroll14)属性使ScrollBar组件支持嵌套滚动。本示例同时使用从API version 20开始支持的[scrollBarColor](ts-basic-components-scrollbar.md#scrollbarcolor20)属性设置滚动条颜色。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/rSvs4KzsT0SoSesQH9sKLw/zh-cn_image_0000002747292619.gif)
