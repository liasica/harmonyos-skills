---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-payment
title: ArkTS API错误码
...
2. 请参见[准备证书](../harmonyos-guides/payment-certificates-config.md)、[签名规则](payment-rest-overview.md#签名规则)章节进行检查。
...
1. 登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)，开启服务，具体可参见[开启用户身份验证服务权限开关](../harmonyos-guides/payment-real-name-preparations.md#开启用户身份验证服务权限开关)。
2. 检查profile配置是否正确，参考[申请调试证书和调试Profile文件](../harmonyos-guides/ide-signing-manual.md#section294112511046)。
...
[tradeOrderAmount](payment-promotionservice.md#ordercontext)数量异常。

**处理步骤**

检查[tradeOrderAmount](payment-promotionservice.md#ordercontext)入参是否正常。
...
[authId](payment-promotionservice.md#ordercontext)值无效。

**处理步骤**

检查[authId](payment-promotionservice.md#ordercontext)入参是否正常。
...
[sign](payment-promotionservice.md#ordercontext)值无效。

**处理步骤**

检查[sign](payment-promotionservice.md#ordercontext)入参是否正常。
...
[orderContext](payment-promotionservice.md#ordercontext)值无效。

**处理步骤**

检查[orderContext](payment-promotionservice.md#ordercontext)入参是否正常。
...
[mercNo](payment-promotionservice.md#ordercontext)值无效。

**处理步骤**

检查[mercNo](payment-promotionservice.md#ordercontext)入参是否正常。
