...
content_hash: sha256:551fec044a98c507240a6c480693bf2f0cfd7c2f893c4374b48550a8e53b0e64
---
...
监听[NavDestination](ts-basic-components-navdestination.md)组件的状态变化。监听器通过注册回调函数实现，当NavDestination组件的状态发生变化（如显示、隐藏、销毁等）时，系统会自动调用已注册的回调函数，携带状态变化信息。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'navDestinationUpdate'，即[NavDestination](ts-basic-components-navdestination.md)组件的状态变化。 |
| callback | Callback<observer.[NavDestinationInfo](js-apis-arkui-observer.md#navdestinationinfo)> | 否 | 需要取消的监听回调，不传参数时，取消所有[NavDestination](ts-basic-components-navdestination.md)组件状态变化的监听回调。 |
...
| type | string | 是 | 监听事件，固定为'navDestinationUpdate'，即[NavDestination](ts-basic-components-navdestination.md)组件的状态变化。 |
| options | { navigationId: [ResourceStr](ts-types.md#resourcestr) } | 是 | 指定监听的[Navigation](ts-basic-components-navigation.md)的id。 |
| callback | Callback<observer.[NavDestinationInfo](js-apis-arkui-observer.md#navdestinationinfo)> | 否 | 需要取消的监听回调。不指定具体的回调函数时，取消该[Navigation](ts-basic-components-navigation.md)上所有的监听回调。 |
...
通过[Navigation](ts-basic-components-navigation.md)的uniqueId，可以监听[NavDestination](ts-basic-components-navdestination.md)组件的状态变化。
...
取消通过[Navigation](ts-basic-components-navigation.md)的uniqueId监听[NavDestination](ts-basic-components-navdestination.md)组件的状态变化。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'navDestinationSwitch'，即[Navigation](ts-basic-components-navigation.md)的页面切换事件。 |
| callback | Callback<observer.[NavDestinationSwitchInfo](js-apis-arkui-observer.md#navdestinationswitchinfo12)> | 否 | 需要被注销的回调函数。不传参数时，取消所有[Navigation](ts-basic-components-navigation.md)页面切换事件的监听回调。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'navDestinationSwitch'，即[Navigation](ts-basic-components-navigation.md)的页面切换事件。 |
| observerOptions | observer.[NavDestinationSwitchObserverOptions](js-apis-arkui-observer.md#navdestinationswitchobserveroptions12) | 是 | 页面切换监听选项，用于指定需要监听的[Navigation](ts-basic-components-navigation.md)组件，例如通过navigationId指定Navigation组件的id。 |
| callback | Callback<observer.[NavDestinationSwitchInfo](js-apis-arkui-observer.md#navdestinationswitchinfo12)> | 是 | 回调函数。携带[NavDestinationSwitchInfo](js-apis-arkui-observer.md#navdestinationswitchinfo12)，返回页面切换事件的信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'navDestinationSwitch'，即[Navigation](ts-basic-components-navigation.md)的页面切换事件。 |
| observerOptions | observer.[NavDestinationSwitchObserverOptions](js-apis-arkui-observer.md#navdestinationswitchobserveroptions12) | 是 | 页面切换监听选项，用于指定需要取消监听的[Navigation](ts-basic-components-navigation.md)组件，例如通过navigationId指定Navigation组件的id。 |
...
| callback | [GestureEventListenerCallback](arkts-apis-uicontext-t.md#gestureeventlistenercallback) | 是 | 回调函数。可以获得点击事件的[GestureEvent](ts-gesture-common.md#gestureevent对象说明)和组件的[FrameNode](js-apis-arkui-framenode.md)。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'willClick'，用于监听点击事件指令下发情况，所注册回调将于点击事件触发前触发。 |
| callback | [ClickEventListenerCallback](arkts-apis-uicontext-t.md#clickeventlistenercallback) | 是 | 回调函数。可以获得点击事件的[ClickEvent](ts-universal-events-click.md#clickevent)和组件的[FrameNode](js-apis-arkui-framenode.md)。 |
...
取消[on('beforePanStart')](arkts-apis-uicontext-uiobserver.md#onbeforepanstart19)监听Pan手势[onActionStart](ts-basic-gestures-pangesture.md#onactionstart)事件执行前的callback回调。支持手指滑动、鼠标滑动、鼠标滚轮和触摸板拖动，暂不支持屏幕朗读触控模式。
...
取消[on('afterPanStart')](arkts-apis-uicontext-uiobserver.md#onafterpanstart19)监听Pan手势[onActionStart](ts-basic-gestures-pangesture.md#onactionstart)事件执行后的callback回调。支持手指滑动、鼠标滑动、鼠标滚轮和触摸板拖动，暂不支持屏幕朗读触控模式。
...
取消[on('beforePanEnd')](arkts-apis-uicontext-uiobserver.md#onbeforepanend19)监听Pan手势[onActionEnd](ts-basic-gestures-pangesture.md#onactionend)事件执行前的callback回调。支持手指滑动、鼠标滑动、鼠标滚轮和触摸板拖动，暂不支持屏幕朗读触控模式。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'afterPanEnd'，用于监听Pan手势[onActionEnd](ts-basic-gestures-pangesture.md#onactionend)事件执行后的指令下发情况，所注册回调将于Pan手势[onActionEnd](ts-basic-gestures-pangesture.md#onactionend)事件触发后触发。 |
| callback | [PanListenerCallback](arkts-apis-uicontext-t.md#panlistenercallback19) | 是 | 回调函数。可以获得Pan手势事件的[GestureEvent](ts-gesture-common.md#gestureevent对象说明)，[GestureRecognizer](ts-gesture-common.md#gesturerecognizer12)和组件的[FrameNode](js-apis-arkui-framenode.md)。 |
...
取消[on('afterPanEnd')](arkts-apis-uicontext-uiobserver.md#onafterpanend19)监听Pan手势[onActionEnd](ts-basic-gestures-pangesture.md#onactionend)事件执行后的callback回调。支持手指滑动、鼠标滑动、鼠标滚轮和触摸板拖动，暂不支持屏幕朗读触控模式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bd/v3/aR1xMmBjReCbchS2198Q1w/zh-cn_image_0000002747212257.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/fFdchiV7SLqIlHzExyygnw/zh-cn_image_0000002717772322.gif)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| navigationUniqueId | number | 是 | 需要取消监听的NavDestination所属的Navigation的唯一ID，可以通过[queryNavigationInfo](ts-custom-component-api.md#querynavigationinfo12)获取。 |
