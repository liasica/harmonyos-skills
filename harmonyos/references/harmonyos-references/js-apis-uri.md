---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-uri
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| other | [URI](js-apis-uri.md#uri) | 是 | 需要比较的URI对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [URI](js-apis-uri.md#uri) | 返回一个path被规范化后的URI对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [URI](js-apis-uri.md#uri) | 返回一个已被清除查询部分的URI对象。 |
