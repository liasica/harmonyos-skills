---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-prepay
title: 预下单
...
在接入Payment Kit的单次支付功能前，开发者需要调用该接口获取到预支付ID（prepayId），用prepayId构建[orderStr](payment-model.md#orderstr)参数返回给客户端调用支付接口拉起华为支付收银台。
...
| selectPromotions | 否 | [SelectPromotions](payment-model.md#selectpromotions) | 平台券信息。 |
