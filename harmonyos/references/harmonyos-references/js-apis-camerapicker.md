...
| mediaTypes | Array<[PickerMediaType](js-apis-camerapicker.md#pickermediatype)> | 是 | 媒体类型。 |
| pickerProfile | [PickerProfile](js-apis-camerapicker.md#pickerprofile) | 是 | pickerProfile对象。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<PickerResult> | Promise对象，返回相机选择器的处理结果[PickerResult](js-apis-camerapicker.md#pickerresult)。 |
...
| mediaType | [PickerMediaType](js-apis-camerapicker.md#pickermediatype) | 否 | 否 | 返回的媒体类型。 |
