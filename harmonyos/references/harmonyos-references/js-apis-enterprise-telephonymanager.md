...
本接口通过传入Want查询对应企业设备管理应用设置的策略，如需查询实际生效的策略，请使用[telephonyManager.getOutgoingCallPolicyNumbers](js-apis-enterprise-telephonymanager.md#telephonymanagergetoutgoingcallpolicynumbers-1)接口。
...
本接口通过传入Want查询对应企业设备管理应用设置的策略，如需查询实际生效的策略，请使用[telephonyManager.getIncomingCallPolicyNumbers](js-apis-enterprise-telephonymanager.md#telephonymanagergetincomingcallpolicynumbers-1)接口。
