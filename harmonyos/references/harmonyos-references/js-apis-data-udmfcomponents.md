...
scraped_at: 2026-09-24T06:51:55+08:00
doc_updated_at: 2026-09-01
content_hash: sha256:9e71a141dc705bc2adacddc00798f86ca2cc7fd09b3cbf96b1229de39fffc6d1
---
...
| formWidth | number | 否 | @Prop | 卡片宽度，其范围在设置的内容卡片类型默认宽度的0.8 ~ 1.2倍之间，当formType为TYPE\_SMALL时，其范围在设置的内容卡片类型默认宽度的0.4 ~ 1.2倍之间。单位为vp。省略时使用内容卡片类型的默认宽度。 |
| formHeight | number | 否 | @Prop | 卡片高度，当contentFormData中的title为空字符串时，卡片高度为传入的值，否则其范围在设置的内容卡片类型默认高度的0.8 ~ 1.2倍之间，当formType为TYPE\_SMALL时，其范围在设置的内容卡片类型默认高度的0.4 ~ 1.2倍之间。单位为vp。省略时使用内容卡片类型的默认高度。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| TYPE\_BIG | 0 | 表示 4 x 4 的尺寸。默认卡片宽度为200vp，默认高度为200vp。 |
| TYPE\_MID | 1 | 表示 4 x 2 的尺寸。默认卡片宽度为200vp，默认高度为100vp。 |
| TYPE\_SMALL | 2 | 表示 2 x 1 的尺寸。默认卡片宽度为137vp，默认高度为83vp。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/1sXIi44RRQ2sMqwU6AKXYA/zh-cn_image_0000002769331941.jpeg)
