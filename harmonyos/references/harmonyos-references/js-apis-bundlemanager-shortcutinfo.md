---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundlemanager-shortcutinfo
title: ShortcutInfo
...
| parameters | Array<[ParameterItem](js-apis-bundlemanager-shortcutinfo.md#parameteritem)> | 否 | 是 | 拉起快捷方式时的自定义数据，仅支持配置字符串类型的数据。其中键值均最大支持1024长度的字符串。 |
...
| wants | Array<[ShortcutWant](js-apis-bundlemanager-shortcutinfo.md#shortcutwant)> | 否 | 是 | 快捷方式内定义的目标wants信息集合。 |
