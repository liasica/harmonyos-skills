...
content_hash: sha256:18c8ba838634e0ad1408092e4fa1c4742897be833f5f6b16bea1b099af71015c
---
...
按照历史栈，后退一个页面。建议在调用backward前先调用[accessBackward9+](arkts-apis-webview-webviewcontroller.md#accessbackward)检查当前页面是否可后退。
...
按照历史栈，前进一个页面。建议在调用forward前先调用[accessForward9+](arkts-apis-webview-webviewcontroller.md#accessforward)检查当前页面是否可前进。
...
从API version 8开始支持，从API version 9开始废弃。建议使用[getHitTest(deprecated)](arkts-apis-webview-webviewcontroller.md#gethittestdeprecated)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[onActive9+](arkts-apis-webview-webviewcontroller.md#onactive)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[onInactive9+](arkts-apis-webview-webviewcontroller.md#oninactive)替代。
...
从API version 8开始支持，从API version 9开始废弃。建议使用[zoom9+](arkts-apis-webview-webviewcontroller.md#zoom)替代。
