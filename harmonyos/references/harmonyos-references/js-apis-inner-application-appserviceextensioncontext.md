---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-appserviceextensioncontext
...
content_hash: sha256:d491a535d4a37863ca7aad012646c5cf9bc78b9ce6c978fab00675c75683d282
---
...
| 类型 | 说明 |
| --- | --- |
| number | 返回连接id，客户端可以通过[disconnectServiceExtensionAbility](js-apis-inner-application-appserviceextensioncontext.md#disconnectserviceextensionability)传入该连接id来断开连接。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| connection | number | 是 | 在[connectServiceExtensionAbility](js-apis-inner-application-appserviceextensioncontext.md#connectserviceextensionability)中返回的连接ID。 |
...
参见[connectServiceExtensionAbility](js-apis-inner-application-appserviceextensioncontext.md#connectserviceextensionability)。
