---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cryptoframework
...
scraped_at: 2026-09-15T07:06:20+08:00
doc_updated_at: 2026-09-14
content_hash: sha256:3190c0bf1e8a9e50e4ed53366662719ad70d803eb0017984d0aab061fcb1040c
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| iv | [DataBlob](js-apis-cryptoframework.md#datablob) | 否 | 否 | 指明加解密参数iv，仅支持7字节。若传入iv长度超过7字节，超出范围将被截断。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| COMMON\_PARAMS\_SPEC | 0 | 表示公私钥中包含的公共参数。使用此类型的参数可以调用[generateKeyPair](js-apis-cryptoframework.md#generatekeypair10)随机生成密钥对。 |
| PRIVATE\_KEY\_SPEC | 1 | 表示私钥中包含的参数。使用此类型的参数可以调用[generatePriKey](js-apis-cryptoframework.md#generateprikey10)生成指定的私钥。 |
| PUBLIC\_KEY\_SPEC | 2 | 表示公钥中包含的参数。使用此类型的参数可以调用[generatePubKey](js-apis-cryptoframework.md#generatepubkey10)生成指定的公钥。 |
| KEY\_PAIR\_SPEC | 3 | 表示公私钥中包含的全量参数。使用此类型的参数可以调用[generateKeyPair](js-apis-cryptoframework.md#generatekeypair10)生成指定的密钥对。 |
...
| specType | [AsyKeySpecType](js-apis-cryptoframework.md#asykeyspectype10) | 否 | 否 | 指定密钥参数类型，用于区分公/私钥参数。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| params | [DSACommonParamsSpec](js-apis-cryptoframework.md#dsacommonparamsspec10) | 否 | 否 | 指定DSA算法中公私钥包含的公共参数。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| params | [DSACommonParamsSpec](js-apis-cryptoframework.md#dsacommonparamsspec10) | 否 | 否 | 指定DSA算法中公私钥都包含的公共参数。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| field | [ECField](js-apis-cryptoframework.md#ecfield10) | 否 | 否 | 指定椭圆曲线的域（当前只支持Fp域）。 |
| a | bigint | 否 | 否 | 指定椭圆曲线的第一个系数a。 |
| b | bigint | 否 | 否 | 指定椭圆曲线的第二个系数b。 |
| g | [Point](js-apis-cryptoframework.md#point10) | 否 | 否 | 指定基点g。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| params | [ECCCommonParamsSpec](js-apis-cryptoframework.md#ecccommonparamsspec10) | 否 | 否 | 指定ECC算法中公私钥都包含的公共参数。 |
...
| --- | --- | --- | --- | --- |
| params | [ECCCommonParamsSpec](js-apis-cryptoframework.md#ecccommonparamsspec10) | 否 | 否 | 指定ECC算法中公私钥都包含的公共参数。 |
| pk | [Point](js-apis-cryptoframework.md#point10) | 否 | 否 | 指定ECC算法的公钥pk。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| params | [RSACommonParamsSpec](js-apis-cryptoframework.md#rsacommonparamsspec10) | 否 | 否 | 指定RSA算法中公私钥都包含的公共参数。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| params | [DHCommonParamsSpec](js-apis-cryptoframework.md#dhcommonparamsspec11) | 否 | 否 | 指定DH算法中公私钥都包含的公共参数。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cryptoframework.md#datablob) | 用于查看密钥的具体内容。 |
...
对称密钥通过对称密钥生成器[SymKeyGenerator](js-apis-cryptoframework.md#symkeygenerator)来生成。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| itemType | [AsyKeySpecItem](js-apis-cryptoframework.md#asykeyspecitem10) | 是 | 指定的密钥参数。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cryptoframework.md#datablob) | 返回满足ASN.1语法和DER编码的指定密钥格式的公钥数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| itemType | [AsyKeySpecItem](js-apis-cryptoframework.md#asykeyspecitem10) | 是 | 指定的密钥参数类型。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PubKey](js-apis-cryptoframework.md#pubkey)> | Promise对象，返回公钥对象PubKey。 |
...
| 类型 | 说明 |
| --- | --- |
| [PubKey](js-apis-cryptoframework.md#pubkey) | 公钥对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| priKey | [PriKey](js-apis-cryptoframework.md#prikey) | 是 | 否 | 私钥。 |
| pubKey | [PubKey](js-apis-cryptoframework.md#pubkey) | 是 | 否 | 公钥。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[SymKey](js-apis-cryptoframework.md#symkey)> | 是 | 回调函数。当生成对称密钥成功，err为undefined，data为获取到的SymKey；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[SymKey](js-apis-cryptoframework.md#symkey)> | Promise对象，返回对称密钥SymKey。 |
...
如果在创建对称密钥生成器时没有指定具体哈希算法，如仅指定"HMAC"，则不支持随机生成对称密钥数据，可通过[convertKeySync](js-apis-cryptoframework.md#convertkeysync12)方式生成对称密钥数据。
...
| 类型 | 说明 |
| --- | --- |
| [SymKey](js-apis-cryptoframework.md#symkey) | 返回对称密钥SymKey。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | [DataBlob](js-apis-cryptoframework.md#datablob) | 是 | 指定的对称密钥材料。 |
| callback | AsyncCallback<[SymKey](js-apis-cryptoframework.md#symkey)> | 是 | 回调函数。当生成对称密钥成功，err为undefined，data为获取到的SymKey；否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | [DataBlob](js-apis-cryptoframework.md#datablob) | 是 | 指定的密钥材料数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [SymKey](js-apis-cryptoframework.md#symkey) | 对称密钥。 |
...
| 类型 | 说明 |
| --- | --- |
| [AsyKeyGenerator](js-apis-cryptoframework.md#asykeygenerator) | 返回非对称密钥生成器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[KeyPair](js-apis-cryptoframework.md#keypair)> | 是 | 回调函数。当获取非对称密钥成功，err为undefined，data为获取到的KeyPair；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[KeyPair](js-apis-cryptoframework.md#keypair)> | Promise对象，返回非对称密钥KeyPair。 |
...
| 类型 | 说明 |
| --- | --- |
| [KeyPair](js-apis-cryptoframework.md#keypair) | 非对称密钥。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pubKey | [DataBlob](js-apis-cryptoframework.md#datablob) | null10+ | 是 | 指定的公钥材料。如果公钥不需要转换，请传入null。API 10之前只支持DataBlob， API 10之后增加支持null。 |
| priKey | [DataBlob](js-apis-cryptoframework.md#datablob) | null10+ | 是 | 指定的私钥材料。如果私钥不需要转换，请传入null。API 10之前只支持DataBlob， API 10之后增加支持null。 |
| callback | AsyncCallback<[KeyPair](js-apis-cryptoframework.md#keypair)> | 是 | 回调函数。当获取非对称密钥成功，err为undefined，data为获取到的KeyPair；否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pubKey | [DataBlob](js-apis-cryptoframework.md#datablob) | null10+ | 是 | 指定公钥材料。如果公钥无需转换，请传入null。API 10前仅支持DataBlob，API 10起支持传入null。 |
| priKey | [DataBlob](js-apis-cryptoframework.md#datablob) | null10+ | 是 | 指定私钥材料。如果私钥无需转换，请传入null。API 10前仅支持DataBlob，API 10起支持传入null。 |
...
当使用[COMMON\_PARAMS\_SPEC](js-apis-cryptoframework.md#asykeyspectype10)类型的密钥参数来创建密钥生成器时，可以得到随机生成的密钥对；当使用[KEY\_PAIR\_SPEC](js-apis-cryptoframework.md#asykeyspectype10)类型的密钥参数来创建密钥生成器时，可以得到各项数据与密钥参数一致的密钥对。
...
使用[PRIVATE\_KEY\_SPEC](js-apis-cryptoframework.md#asykeyspectype10)类型密钥参数创建密钥生成器，生成指定私钥。使用[KEY\_PAIR\_SPEC](js-apis-cryptoframework.md#asykeyspectype10)类型密钥参数创建密钥生成器，从生成的密钥对中获取指定私钥。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[PriKey](js-apis-cryptoframework.md#prikey)> | 是 | 回调函数。当获取非对称密钥成功，err为undefined，data为获取到的PriKey；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PriKey](js-apis-cryptoframework.md#prikey)> | Promise对象，返回非对称密钥的私钥PriKey。 |
...
| 类型 | 说明 |
| --- | --- |
| [PriKey](js-apis-cryptoframework.md#prikey) | 非对称密钥。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[PubKey](js-apis-cryptoframework.md#pubkey)> | 是 | 回调函数。当获取非对称密钥成功，err为undefined，data为获取到的PubKey；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PubKey](js-apis-cryptoframework.md#pubkey)> | Promise对象，返回非对称密钥的公钥PubKey。 |
...
| 类型 | 说明 |
| --- | --- |
| [PubKey](js-apis-cryptoframework.md#pubkey) | 非对称密钥。 |
...
| 类型 | 说明 |
| --- | --- |
| [ECCCommonParamsSpec](js-apis-cryptoframework.md#ecccommonparamsspec10) | 返回ECC公共密钥参数。 |
...
| 类型 | 说明 |
| --- | --- |
| [Point](js-apis-cryptoframework.md#point10) | 返回ECC的Point对象。 |
...
| --- | --- | --- | --- |
| curveName | string | 是 | 椭圆曲线的曲线名，即相应的NID（Name Identifier）。 |
| point | [Point](js-apis-cryptoframework.md#point10) | 是 | 椭圆曲线上的Point点对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [DHCommonParamsSpec](js-apis-cryptoframework.md#dhcommonparamsspec11) | 返回DH公共密钥参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| spec | [SM2CipherTextSpec](js-apis-cryptoframework.md#sm2ciphertextspec12) | 是 | 指定的SM2密文参数。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cryptoframework.md#datablob) | 返回符合国密标准的ASN.1格式的SM2密文。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cipherText | [DataBlob](js-apis-cryptoframework.md#datablob) | 是 | 符合国密标准的ASN.1格式的SM2密文。 |
| mode | string | 否 | 可选的密文转换模式，可用于指定密文参数的拼接顺序，当前仅支持默认值"C1C3C2"。为空或空字符串时使用默认值。 |
...
| 类型 | 说明 |
| --- | --- |
| [SM2CipherTextSpec](js-apis-cryptoframework.md#sm2ciphertextspec12) | 返回SM2密文参数。 |
...
初始化加解密的[cipher](js-apis-cryptoframework.md#cipher)对象，使用callback异步回调获取结果。init、update、doFinal为三段式接口，需要成组使用。其中init和doFinal必选，update可选。
...
初始化加解密的[cipher](js-apis-cryptoframework.md#cipher)对象，通过注册回调函数获取结果。initSync、updateSync、doFinalSync为三段式接口，需要成组使用。其中initSync和doFinalSync必选，updateSync可选。
...
| opMode | [CryptoMode](js-apis-cryptoframework.md#cryptomode) | 是 | 加密或者解密模式。 |
| key | [Key](js-apis-cryptoframework.md#key) | 是 | 指定加密或解密的密钥。 |
| params | [ParamsSpec](js-apis-cryptoframework.md#paramsspec) | null | 是 | 指定加密或解密的参数，对于ECB等没有参数的算法模式，请传入null。 |
...
1. 在进行对称加解密操作时，如果开发者对各个分组模式不够熟悉，建议对每次update和doFinal的结果进行判断，确保其不为null，并在结果不为null时取出数据进行拼接，形成完整的密文或明文。这是因选择的分组模式等各项规格可能对update和doFinal的结果产生影响。
   ...
   最后doFinal时，会将剩下的未加解密的数据根据[createCipher](js-apis-cryptoframework.md#cryptoframeworkcreatecipher)时设置的填充模式进行填充，补齐到分组的整数倍长度，再输出剩余的加解密结果。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [DataBlob](js-apis-cryptoframework.md#datablob) | 是 | 需要进行加密或解密的数据。data不能为null。 |
| callback | AsyncCallback<[DataBlob](js-apis-cryptoframework.md#datablob)> | 是 | 回调函数。更新加/解密数据成功时，err为undefined，data为加/解密结果DataBlob；否则为错误对象。 |
...
1. 在进行对称加解密操作时，如果开发者对各分组模式不够熟悉，建议每次调用update和doFinal后，都判断结果是否为null。如果结果不为null，则取出其中的数据进行拼接，以形成完整的密文或明文。这是因为选择的分组模式等各项规格可能会影响update和doFinal的结果。
   ...
   最后doFinal的时候，会把剩下的还没加/解密的数据，根据[createCipher](js-apis-cryptoframework.md#cryptoframeworkcreatecipher)时设置的padding模式进行填充，补齐到分组的整数倍长度，再输出剩余加解密结果。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [DataBlob](js-apis-cryptoframework.md#datablob) | 是 | 加密或者解密的数据。data不能为null。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[DataBlob](js-apis-cryptoframework.md#datablob)> | Promise对象，返回此次更新的加/解密结果DataBlob。 |
...
必须在对[Cipher](js-apis-cryptoframework.md#cipher)实例使用[initSync()](js-apis-cryptoframework.md#initsync12)初始化后，才能使用本函数。
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cryptoframework.md#datablob) | 返回此次更新的加/解密结果DataBlob。 |
...
（1）在对称加解密中doFinal用于处理剩余数据和本次传入的数据，并最终结束加密或解密操作，使用callback异步回调函数获取加密或解密后的数据。如果数据量较小，可以在 doFinal 中一次性传入数据，而不使用update；如果在本次加解密流程中已经使用[update](js-apis-cryptoframework.md#update)传入过数据，可以在doFinal的data参数处传入null。根据对称加解密的模式不同，doFinal的输出有以下区别：

* 在GCM和CCM模式的对称加密中，一次加密流程中，将每次update和doFinal的结果拼接起来，会得到“密文 + authTag”。GCM模式下，authTag为末尾的16字节；CCM模式下，authTag为末尾的12字节。其余部分均为密文。如果doFinal的data参数传入null，则doFinal的结果就是authTag。解密时，authTag需要填入[GcmParamsSpec](js-apis-cryptoframework.md#gcmparamsspec)或[CcmParamsSpec](js-apis-cryptoframework.md#ccmparamsspec)，密文作为解密时的data参数。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [DataBlob](js-apis-cryptoframework.md#datablob) | null10+ | 是 | 加密或解密的数据。在对称加解密中可为null，但不可传入{data: Uint8Array(空) }。API 10前仅支持DataBlob，API 10后增加null支持。 |
| callback | AsyncCallback<[DataBlob](js-apis-cryptoframework.md#datablob)> | 是 | 回调函数。最终加/解密成功时，err为undefined，data为加/解密结果DataBlob；否则为错误对象。 |
...
* 对于GCM和CCM模式的对称加密：一次加密流程中，如果将每一次update和doFinal的结果拼接起来，会得到“密文+authTag”，即末尾的16字节（GCM模式）或12字节（CCM模式）是authTag，而其余部分均为密文。（也就是说，如果doFinal的data参数传入null，则doFinal的结果就是authTag）
  ...
  authTag需要填入解密时的[GcmParamsSpec](js-apis-cryptoframework.md#gcmparamsspec)或[CcmParamsSpec](js-apis-cryptoframework.md#ccmparamsspec)；密文则作为解密时的入参data。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [DataBlob](js-apis-cryptoframework.md#datablob) | null10+ | 是 | 加密或者解密的数据。data参数允许为null，但不允许传入{data: Uint8Array(空) }。API 10之前只支持DataBlob，API 10之后增加支持null。 |
...
如果数据量较小，可以在doFinalSync中一次性传入数据，而不使用updateSync。如果在本次加解密流程中已经使用[updateSync](js-apis-cryptoframework.md#updatesync12)传入过数据，可以在doFinalSync的data参数处传入null。
...
其他注意事项同接口[doFinal()](js-apis-cryptoframework.md#dofinal)说明。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [DataBlob](js-apis-cryptoframework.md#datablob) | null | 是 | 加密或者解密的数据。在对称加解密中允许为null，但不允许传入{data: Uint8Array(空) }。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cryptoframework.md#datablob) | 返回剩余数据的加/解密结果DataBlob。 |
...
设置加解密参数。常用的加解密参数直接通过[createCipher](js-apis-cryptoframework.md#cryptoframeworkcreatecipher) 来指定，剩余参数通过本接口指定。当前只支持RSA算法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| itemType | [CipherSpecItem](js-apis-cryptoframework.md#cipherspecitem10) | 是 | 用于指定需要设置的加解密参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| itemType | [CipherSpecItem](js-apis-cryptoframework.md#cipherspecitem10) | 是 | 用于指定需要获取的加解密参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| priKey | [PriKey](js-apis-cryptoframework.md#prikey) | 是 | 用于Sign的初始化。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [DataBlob](js-apis-cryptoframework.md#datablob) | null10+ | 是 | 传入的消息。API 10之前只支持DataBlob， API 10之后增加支持null。 |
| callback | AsyncCallback<[DataBlob](js-apis-cryptoframework.md#datablob)> | 是 | 回调函数，用于获取签名结果DataBlob数据。当签名成功，err为undefined，data为获取到的签名结果；否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [DataBlob](js-apis-cryptoframework.md#datablob) | null10+ | 是 | 传入的消息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [DataBlob](js-apis-cryptoframework.md#datablob) | null | 是 | 传入的消息。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cryptoframework.md#datablob) | 返回签名结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| itemType | [SignSpecItem](js-apis-cryptoframework.md#signspecitem10) | 是 | 用于指定需要获取的签名参数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[DataBlob](js-apis-cryptoframework.md#datablob) | null> | Promise对象，返回签名恢复的原始数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cryptoframework.md#datablob) | null | 验签恢复的数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| itemType | [SignSpecItem](js-apis-cryptoframework.md#signspecitem10) | 是 | 用于指定需要获取的验签参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| priKey | [PriKey](js-apis-cryptoframework.md#prikey) | 是 | 设置密钥协商的私钥输入。 |
| pubKey | [PubKey](js-apis-cryptoframework.md#pubkey) | 是 | 设置密钥协商的公钥输入。 |
| callback | AsyncCallback<[DataBlob](js-apis-cryptoframework.md#datablob)> | 是 | 回调函数，用于密钥协商。当密钥协商成功，err为undefined，data为协商的共享密钥；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[DataBlob](js-apis-cryptoframework.md#datablob)> | Promise对象，返回密钥协商的共享密钥。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cryptoframework.md#datablob) | 共享密钥。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| algName | string | 是 | 指定摘要算法，支持算法请参考[MD消息摘要算法规格](../harmonyos-guides/crypto-generate-message-digest-overview.md#支持的算法与规格)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| input | [DataBlob](js-apis-cryptoframework.md#datablob) | 是 | 传入的消息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[DataBlob](js-apis-cryptoframework.md#datablob)> | 是 | 回调函数，用于获取摘要的计算结果。当摘要计算成功，err为undefined，data为获取到的摘要结果；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[DataBlob](js-apis-cryptoframework.md#datablob)> | Promise对象，返回摘要计算结果。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cryptoframework.md#datablob) | 表示生成的Md计算结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| algName | string | 是 | 指定摘要算法，支持算法请参考[HMAC消息认证码算法规格](../harmonyos-guides/crypto-compute-mac-overview.md)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | [SymKey](js-apis-cryptoframework.md#symkey) | 是 | 对称密钥。 |
...
| callback | AsyncCallback<[DataBlob](js-apis-cryptoframework.md#datablob)> | 是 | 回调函数，用于获取生成的随机数。当生成随机数成功，err为undefined，data为获取到的随机数；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[DataBlob](js-apis-cryptoframework.md#datablob)> | Promise对象，返回生成的随机数。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cryptoframework.md#datablob) | 表示生成的随机数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| seed | [DataBlob](js-apis-cryptoframework.md#datablob) | 是 | 设置的种子。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [KdfSpec](js-apis-cryptoframework.md#kdfspec11) | 是 | 设置密钥派生函数的参数。 |
| callback | AsyncCallback<[DataBlob](js-apis-cryptoframework.md#datablob)> | 是 | 回调函数，用于获取派生的密钥。当密钥派生成功，err为undefined，data为派生的密钥；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[DataBlob](js-apis-cryptoframework.md#datablob)> | Promise对象，返回派生的密钥。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](js-apis-cryptoframework.md#datablob) | 用于获取派生得到的密钥DataBlob数据。 |
