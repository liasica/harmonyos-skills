...
content_hash: sha256:907d5422f5cdaca3103267105f69b0ce285304538c5a0c505aa85332e7ce11ad
---
...
| uint8\_t bMaxPacketSize0 | 端点零（控制端点）的最大包大小，只有8、16、32、64字节是合法的。 |
| uint16\_t idVendor | 由USB标准化组织（USB-IF）分配的厂商编号。 |
| uint16\_t idProduct | 由厂商分配的产品编号。 |
| uint16\_t bcdDevice | 设备版本编号。 |
| uint8\_t iManufacturer | 厂商字符串描述符的索引。 |
| uint8\_t iProduct | 产品字符串描述符的索引。 |
| uint8\_t iSerialNumber | 设备序列号字符串描述符的索引。 |
