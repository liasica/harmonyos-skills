---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-dataaugmentation
title: ArkTS API错误码
breadcrumb: API参考 > 应用框架 > Data Augmentation Kit（数据增强服务） > ArkTS API > ArkTS API错误码
category: harmonyos-references
scraped_at: 2026-09-02T15:01:33+08:00
doc_updated_at: 2026-08-29
content_hash: sha256:d6d90227a24da7b5b5b42c77a0b56c064ce3dfc5dad456c909f2edbbf552d63e
---
...
参照[知识源配置](dataaugmentation-knowledgeprocessor-api.md#knowledgesourceconfig)类型，正确配置rdbSource字段。
...
参考开发步骤中的[知识schema配置示例](../harmonyos-guides/data-augmentation-knowledge-processing.md#开发步骤)，将knowledge\_schema.json放到指定的entry/src/main/resources/rawfile/arkdata/knowledge目录下。
...
参照[知识schema规格及约束限制](../harmonyos-guides/data-augmentation-knowledge-processing.md#约束限制)修改其中内容。
