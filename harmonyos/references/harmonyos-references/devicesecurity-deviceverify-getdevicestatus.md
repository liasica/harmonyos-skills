---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/devicesecurity-deviceverify-getdevicestatus
title: 查询设备标记状态
breadcrumb: API参考 > 系统 > 安全 > Device Security Kit（设备安全服务） > REST API > 查询设备标记状态
category: harmonyos-references
scraped_at: 2026-04-28T08:07:20+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:3ce885e57a66f3364e13ae1aa43ae2ad7116344063f082a1985240c577a72c0d
---
...
```
1. POST /api/rms/v1/deviceVerify/getDeviceStatus HTTP/1.1
2. Host: xxx
3. Authorization: Bearer eyJr*****OiIx---****.eyJh*****iJodHR--***.QRod*****4Gp---****
4. bundleName: com.huawei.xxx
5. Content-Type: application/json;charset=utf-8

7. {"data":{ "mode":1, "deviceToken":"xxx", "transactionId":"ddc740b9-45bb-424a-bc50-64e8a813acad", "timestamp":1711072205525}}
```
...
4. {"bundleName":"xxx","bit0":true,"bit1":false,"lastUpdateTime":1711072206323,"errorCodes":"OK"}
```
