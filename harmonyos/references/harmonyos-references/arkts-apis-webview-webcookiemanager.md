...
content_hash: sha256:466bfb8951852314678080292ea095839ee6f432ee5075b211b7dc4382f85893
---
...
* cookies每30s周期性保存到磁盘中，也可以使用接口[saveCookieAsync](arkts-apis-webview-webcookiemanager.md#savecookieasync)进行强制落盘。
...
清除所有cookies（包括会话cookies和持久化cookies）。如需仅清除会话cookies，请使用[clearSessionCookieSync](arkts-apis-webview-webcookiemanager.md#clearsessioncookiesync11)。
...
清除所有cookies（包括会话cookies和持久化cookies），使用callback异步回调。如需仅清除会话cookies，请使用[clearSessionCookie](arkts-apis-webview-webcookiemanager.md#clearsessioncookie11)。
...
清除所有cookies（包括会话cookies和持久化cookies），使用Promise异步回调。如需仅清除会话cookies，请使用[clearSessionCookie](arkts-apis-webview-webcookiemanager.md#clearsessioncookie11-1)。
