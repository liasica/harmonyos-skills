---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-cdsm
title: "@ohos.nearlink.cdsm (星闪合作设备集合管理能力)"
breadcrumb: API参考 > 系统 > 网络 > Connectivity Kit（短距通信服务） > ArkTS API > @ohos.nearlink.cdsm (星闪合作设备集合管理能力)
category: harmonyos-references
scraped_at: 2026-09-02T15:01:50+08:00
doc_updated_at: 2026-08-29
content_hash: sha256:98c7a77eb9c03aee6bdec1ebc1eabf7de80af0c7b523559191916ffdc387a426
---
...
| 类型 | 说明 |
| --- | --- |
| [CdsmClient](js-apis-nearlink-cdsm.md#cdsmclient) | 用于查询和订阅远端设备合作设备集合信息的CDSM客户端实例。 |
...
* 使用该类的方法前，需通过[cdsm.createCdsmClient](js-apis-nearlink-cdsm.md#cdsmcreatecdsmclient)方法构造该类的实例。

适用于需要获知一组星闪设备（合作设备集合）的成员组成及连接状态变化并据此进行业务联动的场景。例如，手机与耳机配对后，手机可通过CDSM查询左右耳机信息并感知其连接状态变化。

同一应用针对同一远端设备创建一个 [CdsmClient](js-apis-nearlink-cdsm.md#cdsmclient) 实例即可，重复创建会增加不必要的资源开销。
...
| 类型 | 说明 |
| --- | --- |
| [CdsmInfo](js-apis-nearlink-cdsm.md#cdsminfo) | 远端设备的合作设备集合信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[CdsmInfo](js-apis-nearlink-cdsm.md#cdsminfo)> | 是 | 事件回调类型，返回远端设备合作设备集合信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[CdsmInfo](js-apis-nearlink-cdsm.md#cdsminfo)> | 否 | 事件回调类型，返回远端设备合作设备集合信息。  填写该参数则取消当前callback订阅。不填写该参数则取消远端设备合作设备集合信息变化事件对应的所有回调。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| members | [CdsmMemberInfo](js-apis-nearlink-cdsm.md#cdsmmemberinfo)[] | 否 | 否 | 合作设备集合的成员信息数组，每个成员包含设备地址及其连接状态。 |
...
| state | [CdsmConnectionState](js-apis-nearlink-cdsm.md#cdsmconnectionstate) | 否 | 否 | 成员设备连接状态。 |
