...
breadcrumb: API参考 > 应用框架 > ArkTS（方舟编程语言） > 错误码 > Typescript Compiler错误码介绍
category: harmonyos-references
scraped_at: 2026-04-28T08:00:14+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:f397c6c401321b2984398677562e9c01584282b997b17d39af71c853b5cd8de2
---
...
TSC原生报错：以'001'结尾，是Typescript Compiler检查中已有的原生报错规则。在TSC的编译流程中，常见的TSC原生报错原因包括：关键字或符号的缺失、赋值类型与接收类型不一致、类型或变量未定义等。这些问题通常是未按照[语言规范](../harmonyos-guides/introduction-to-arkts.md)编写代码导致的，开发者可以根据报错描述修改代码。
...
2. export declare let fileJs: number;
```
