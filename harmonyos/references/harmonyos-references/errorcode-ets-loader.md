---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-ets-loader
title: 编译工具链错误码
breadcrumb: API参考 > 应用框架 > ArkTS（方舟编程语言） > 错误码 > 编译工具链错误码
category: harmonyos-references
scraped_at: 2026-09-02T15:00:48+08:00
doc_updated_at: 2026-08-29
content_hash: sha256:d7a4a5e47332c6d482dcd849a40cf2d0918c1976f85fa578fbb43ef562010663
---

**说明** 

编译工具链错误码用于标识ArkTS编译过程中的各类错误，涵盖文件导入限制、模块解析、Kit配置与导入、编译执行及懒加载导入等场景，帮助开发者快速定位并解决编译相关问题。
...
2. 有关Kit API的更多详细信息，请参考[开发说明](development-intro-api.md)。
...
1. 请确保Kit的API与SDK一致。
2. 请确保Kit的API没有被本地修改。
3. 有关Kit API的更多详细信息，请参考[开发说明](development-intro-api.md)。
