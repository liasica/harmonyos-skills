...
content_hash: sha256:252ae86d1a3105330273c4d535b5b60e718655afc9faf3968426d97bed731d2b
---
...
| 类型 | 说明 |
| --- | --- |
| [Vector2](js-apis-arkui-graphics.md#vector2) | 轴心的x和y轴坐标。该参数为浮点数，默认值为0.5，取值范围为[0.0, 1.0]。超出范围时按默认值0.5处理。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/rYhfrC0uSNys78uPAw2XLw/zh-cn_image_0000002762835501.png)
...
| unit | [LengthUnit](js-apis-arkui-graphics.md#lengthunit12) | 否 | 长度属性的单位，默认为VP。 |
...
| 类型 | 说明 |
| --- | --- |
| [LengthMetrics](js-apis-arkui-graphics.md#lengthmetrics12) | 单位为PX的长度属性对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [LengthMetrics](js-apis-arkui-graphics.md#lengthmetrics12) | 单位为VP的长度属性对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [LengthMetrics](js-apis-arkui-graphics.md#lengthmetrics12) | 单位为FP的长度属性对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [LengthMetrics](js-apis-arkui-graphics.md#lengthmetrics12) | 单位为PERCENT的长度属性对象，值为1表示100%。 |
...
| 类型 | 说明 |
| --- | --- |
| [LengthMetrics](js-apis-arkui-graphics.md#lengthmetrics12) | 单位为LPX的长度属性对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Resource](ts-types.md#resource) | 是 | 长度属性的值。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [LengthMetrics](js-apis-arkui-graphics.md#lengthmetrics12) | Resource类型资源的长度属性对象。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/08/v3/VauTchwFSBKymGK5UIhNhw/zh-cn_image_0000002733275992.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | boolean | 是 | 使用[resource](js-apis-arkui-graphics.md#resource12)方法构造的LengthMetrics对象是否在系统配置变化时自动刷新值。  true表示主动监听系统配置变化，在变化时值刷新为对应配置下的资源值。  false表示不主动监听系统配置变化。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [LengthMetrics](js-apis-arkui-graphics.md#lengthmetrics12) | 返回设置自动刷新属性后的LengthMetrics对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [ColorMetrics](js-apis-arkui-graphics.md#colormetrics12) | HEX格式颜色对应的颜色对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [ColorMetrics](js-apis-arkui-graphics.md#colormetrics12) | rgb或rgba格式颜色对应的颜色对象。 |

### colorWithSpace20+

static colorWithSpace(colorSpace: ColorSpace, red: number, green: number, blue: number, alpha?: number): ColorMetrics

使用[ColorSpace](ts-appendix-enums.md#colorspace20)和rgba格式颜色实例化ColorMetrics类。仅red、green、blue属性支持在display-p3色彩空间中设置颜色，alpha属性不受色彩空间影响。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| colorSpace | [ColorSpace](ts-appendix-enums.md#colorspace20) | 是 | 色彩空间，用于指定颜色的色彩空间。使用ColorSpace.DISPLAY\_P3，需要对应窗口调用[setWindowColorSpace](arkts-apis-window-window.md#setwindowcolorspace9-1)接口，将当前窗口设置为广色域模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [ColorMetrics](js-apis-arkui-graphics.md#colormetrics12) | 指定色彩空间下rgba格式颜色对应的颜色对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [ColorMetrics](js-apis-arkui-graphics.md#colormetrics12) | 资源格式颜色对应的颜色对象。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/ZemJPjFgTimrR6bSiqqokQ/zh-cn_image_0000002733435866.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | boolean | 是 | 使用[resourceColor](js-apis-arkui-graphics.md#resourcecolor12)方法构造的ColorMetrics对象是否在系统配置变化时自动刷新颜色值。  true表示主动监听系统配置变化，变化时值刷新为对应配置下的资源值。  false表示不主动监听系统配置变化。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [ColorMetrics](js-apis-arkui-graphics.md#colormetrics12) | 返回设置自动刷新属性后的ColorMetrics对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Corners](js-apis-arkui-graphics.md#cornerst12)<[Vector2](js-apis-arkui-graphics.md#vector2)> | 四个角的圆角x轴与y轴的半轴长。  单位：px |
...
| 类型 | 说明 |
| --- | --- |
| [Corners](js-apis-arkui-graphics.md#cornerst12)<number> | 四个角的圆角半径。  单位：vp |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fillColor | number | 否 | 否 | 遮罩的填充颜色，使用ARGB格式。默认值为0XFF000000。  取值范围：[0, 0xffffffff]  超出范围时按默认值处理。  通过fillColor的透明度和亮度生成一个仅含透明度的颜色。亮度越高，颜色越透明。然后，使用[BlendMode.SRC\_IN](arkts-apis-graphics-drawing-e.md#blendmode)方式与RenderNode本身的颜色混合，生成最终颜色。 |
| strokeColor | number | 否 | 否 | 遮罩的边框颜色，使用ARGB格式。默认值为0XFF000000。  取值范围：[0, 0xffffffff]  超出范围时按默认值处理。  通过strokeColor的透明度和亮度生成一个仅含透明度的颜色。亮度越高，颜色越透明。然后，使用[BlendMode.SRC\_IN](arkts-apis-graphics-drawing-e.md#blendmode)方式与RenderNode本身的颜色混合，生成最终颜色。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/Rjfdam-5QASabqW7SeVzgA/zh-cn_image_0000002762995391.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cf/v3/YRk1ZnZySreOKWnD3mgnfw/zh-cn_image_0000002762835503.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/3SjbrI0RR6KinoC33PAeQA/zh-cn_image_0000002733275994.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/PproDQtWRt2QT1QDjqyqoQ/zh-cn_image_0000002733435868.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/fHnZiwljQ62fZKrHiRC48Q/zh-cn_image_0000002762995393.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f7/v3/rONDxFD4RbSz5jkfnujpEw/zh-cn_image_0000002762835505.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/Xha8Ai7XSzyCwg7ZShpSUg/zh-cn_image_0000002733275996.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/39/v3/YOIgzgsES-SDkHTQfaUUKQ/zh-cn_image_0000002733435870.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/XjEbuZ1oTxy0aPi3rBiTlA/zh-cn_image_0000002762995395.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/321w-LkiS86aY-ezct2glw/zh-cn_image_0000002762835507.png)
