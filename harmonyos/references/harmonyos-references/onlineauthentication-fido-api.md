...
content_hash: sha256:b1cd464176a239db65914c37f2cb8c56721c7f3fc0ddf2817ae4f3733d78b0fc
---
...
| keyProtection | number | 是 | 否 | 密钥保护类型。  目前支持KEY\_PROTECTION\_TEE 0x0004。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.Context](js-apis-inner-application-context.md#context) | 是 | 当前ability的应用上下文信息。 |
...
以下错误码的详细介绍请参见[通用错误码](errorcode-universal.md)和[FIDO免密认证错误码](errorcode-onlineauthentication-fido.md)。
