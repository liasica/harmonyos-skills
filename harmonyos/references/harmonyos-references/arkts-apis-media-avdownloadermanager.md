---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avdownloadermanager
title: Interface (AVDownloaderManager)
breadcrumb: API参考 > 媒体 > Media Kit（媒体服务） > ArkTS API > @ohos.multimedia.media (媒体服务) > Interface (AVDownloaderManager)
category: harmonyos-references
scraped_at: 2026-09-02T15:02:34+08:00
doc_updated_at: 2026-08-29
content_hash: sha256:7421e165d8522d2c5e5c8cc8e1ac717e71afe4a83f390bc434ee74f70cabc70d
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [MediaSource](arkts-apis-media-mediasource.md) | 是 | 媒体资源描述，至少包含资源URL。  值不能为null。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnAVDownloadTaskStateHandle](arkts-apis-media-t.md#onavdownloadtaskstatehandle) | 是 | 状态变化事件的处理函数。由应用实现。  第一个参数为状态变化的任务ID，第二个参数为任务的新状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnAVDownloadProgressChangeHandle](arkts-apis-media-t.md#onavdownloadprogresschangehandle) | 是 | 进度变化事件的处理函数。由应用实现。  第一个参数为下载任务ID，第二个参数为下载进度值。  进度值取值范围为-1或[0.0, 1.0]。-1表示资源大小未知。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnAVDownloadTaskStateHandle](arkts-apis-media-t.md#onavdownloadtaskstatehandle) | 否 | 状态变化事件的处理函数，必须是通过onStatusChange注册过的处理函数。  默认值：不指定此参数时，取消注册该事件的所有处理函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnAVDownloadProgressChangeHandle](arkts-apis-media-t.md#onavdownloadprogresschangehandle) | 否 | 进度变化事件的处理函数，必须是通过onProgressChange注册过的处理函数。  默认值：不指定此参数时，取消注册该事件的所有处理函数。 |
