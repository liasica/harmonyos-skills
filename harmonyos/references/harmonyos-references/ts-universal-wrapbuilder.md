...
content_hash: sha256:c962ad016128795c235809660db180008a61f2159f06383038cb07ec8bd53fcf
---
...
4. .fontSize(size)
5. }
6. let builderVar: WrappedBuilder<[string, number]> = wrapBuilder(MyBuilder);
```
...
4. .fontSize(size)
5. }
6. let builderVar: WrappedBuilder<[string, number]> = new WrappedBuilder<[string, number]>(MyBuilder);
```
