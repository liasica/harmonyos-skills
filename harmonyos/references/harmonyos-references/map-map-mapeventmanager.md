...
| callback | [MassPointOverlayCallback](map-map-types.md#masspointoverlaycallback) | 是 | 回调函数，无返回结果，监听海量点图层点击事件。 |
...
| callback | [MassPointOverlayCallback](map-map-types.md#masspointoverlaycallback) | 否 | 回调函数，无返回结果，取消监听海量点图层点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| callback | Callback<[Marker](map-map-marker.md)> | 是 | 标记长按事件的回调函数，返回[Marker](map-map-marker.md)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| callback | Callback<[Marker](map-map-marker.md)> | 否 | 标记长按事件的回调函数，返回[Marker](map-map-marker.md)。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| callback | Callback<[mapCommon.Poi](map-common.md#poi)> | 是 | 地图上POI长按事件的回调函数，返回[mapCommon.Poi](map-common.md#poi)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| callback | Callback<[mapCommon.Poi](map-common.md#poi)> | 否 | 地图上POI长按事件的回调函数，返回[mapCommon.Poi](map-common.md#poi)。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
