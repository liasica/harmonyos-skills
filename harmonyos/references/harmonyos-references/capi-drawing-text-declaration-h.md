...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_Drawing\_FontCollection](capi-drawing-oh-drawing-fontcollection.md) | OH\_Drawing\_FontCollection | 用于加载字体。 |
| [OH\_Drawing\_Typography](capi-drawing-oh-drawing-typography.md) | OH\_Drawing\_Typography | 用于管理排版的布局和显示等。 |
| [OH\_Drawing\_TextStyle](capi-drawing-oh-drawing-textstyle.md) | OH\_Drawing\_TextStyle | 用于管理字体颜色、装饰等。 |
| [OH\_Drawing\_TypographyStyle](capi-drawing-oh-drawing-typographystyle.md) | OH\_Drawing\_TypographyStyle | 用于管理排版风格，如文字方向等。 |
