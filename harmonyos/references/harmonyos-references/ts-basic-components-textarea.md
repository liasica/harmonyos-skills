...
content_hash: sha256:cbb8ef67e1a1bba42469f0b8e977c4d5cf1e08c3c4f123cb8c940c59888f7d2d
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextAreaOptions](ts-basic-components-textarea.md#textareaoptions对象说明) | 否 | TextArea组件参数。默认值：详见TextAreaOptions。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| placeholder | [ResourceStr](ts-types.md#resourcestr) | 否 | 是 | 设置无输入时的提示文本。输入内容后，提示文本不显示。  仅设置placeholder属性时，手柄依然跟随拖动，手柄松开后光标停留在文字开头位置。  默认值：空字符串，不设置时不显示提示文本。 |
| text | [ResourceStr](ts-types.md#resourcestr) | 否 | 是 | 设置输入框当前的文本内容。默认值：空字符串。  建议通过onChange事件将状态变量与文本实时绑定，  避免组件刷新时TextArea中的文本内容异常。  从API version 10开始，该参数支持[$$](../harmonyos-guides/arkts-two-way-sync.md)双向绑定变量。  从API version 18开始，该参数支持[!!](../harmonyos-guides/arkts-new-binding.md#系统组件参数双向绑定)双向绑定变量。 |
| controller8+ | [TextAreaController](ts-basic-components-textarea.md#textareacontroller8) | 否 | 是 | 设置TextArea控制器。不设置时，组件使用内部默认控制器，但无法调用控制器相关方法。 |
...
以下场景不支持水平滚动：[TextContentStyle](ts-appendix-enums.md#textcontentstyle10)为INLINE，即文本框多态样式为内联模式。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否启用水平滚动。  true表示启用水平滚动；false表示禁用水平滚动，文本将自动换行。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](ts-types.md#resourcecolor) | 是 | 字体颜色，用于自定义输入文本的颜色。  **说明：** 当同时设置[shaderStyle](ts-basic-components-textarea.md#shaderstyle)时，shaderStyle优先级更高，fontColor不生效。 |
...
设置CopyOptions.None时，不支持拖拽操作。[enableSelectedDataDetector](ts-basic-components-textarea.md#enableselecteddatadetector22)功能需要CopyOptions为CopyOptions.LocalDevice或CopyOptions.CROSS\_DEVICE时才生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | 是 | 文本的最大输入字符数。  取值范围：[0, UINT32\_MAX]。当value<0时，不设限制。 |
...
| options11+ | [InputCounterOptions](ts-universal-attributes-text-style.md#inputcounteroptions11对象说明) | 否 | 计数器的配置项，用于自定义计数器的显示阈值（thresholdPercentage）和红色边框（highlightBorder）。不传入时，计数器在输入字符数达到最大字符数时显示，边框和计数器下标默认变为红色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | boolean | 是 | 是否不弹出系统文本选择菜单。  设置为true时，单击输入框光标、长按输入框、双击输入框、三击输入框或者右键输入框，不弹出系统文本选择菜单。  设置为false时，弹出系统文本选择菜单。  **说明：** 设置为true时，即使[setTextSelection](ts-basic-components-textarea.md#settextselection10)方法中options设置为MenuPolicy.SHOW，也不会弹出菜单。 |
...
设置文本可显示的最大行数，可选设置超出最大行数的行为为滚动或截断。未通过该接口设置时，默认内联输入风格编辑态时文本可显示的最大行数为3，非内联模式下默认值为UINT32\_MAX。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | 是 | 内联输入风格编辑态时文本可显示的最大行数。  配置textOverflow时超出截断；未配置textOverflow时，内联模式获焦状态下文本可滚动显示，非获焦状态下不生效；非内联模式按行截断。  取值范围：(0, UINT32\_MAX]。传入0或负数时，按照默认值处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| lines | [Optional](ts-universal-attributes-custom-property.md#optionalt)<number> | 是 | 最小行数。  取值范围：[1, INT32\_MAX]  如果lines的值小于1，取默认值。 |
...
| options12+ | [KeyboardOptions](ts-basic-components-richeditor.md#keyboardoptions12) | 否 | 设置自定义键盘是否支持避让功能。不传入时，默认不支持避让功能。 |
...
不同的TextAreaType会拉起对应类型的键盘，同时限制输入。从API version 11开始，设置[inputFilter](ts-basic-components-textarea.md#inputfilter8)且输入的字符不为空字符时，type接口附带的文本过滤效果失效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextAreaType](ts-basic-components-textarea.md#textareatype11枚举说明) | 是 | 输入框类型。 |

### enterKeyType11+

enterKeyType(value: EnterKeyType)

设置输入法回车键类型。未通过该接口设置时，默认输入法回车键类型为EnterKeyType.NEW\_LINE。
...
设置是否启用自动填充。典型场景参考[密码自动填充服务](../harmonyos-guides/passwordvault.md)、[智能填充服务](../harmonyos-guides/scenario-fusion-intelligent-filling.md)。未通过该接口设置时，默认启用自动填充。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enable | boolean | undefined | 是 | 是否对选中文本进行实体识别。  true：开启识别，false：关闭识别。  需要[CopyOptions](ts-appendix-enums.md#copyoptions9)为CopyOptions.LocalDevice或CopyOptions.CROSS\_DEVICE时本功能才生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](ts-types.md#resource) | 是 | 文本的行高。需要显式指定[像素单位](ts-pixel-units.md)，如'10px'，也可设置百分比字符串，如'100%'。  **说明**：不指定像素单位时，默认单位fp，如'10'，等同于10。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](ts-types.md#resource) | 是 | 文本字符间距。  设置为百分比时按默认值处理；设置为0时使用默认值；负值会导致文字压缩，过小时可能无内容显示。  单位：[fp](ts-pixel-units.md#基本像素单位) |
...
设置文本断行规则。该属性对placeholder文本无效。当设置为WordBreak.BREAK\_ALL时，[lineBreakStrategy](ts-basic-components-textarea.md#linebreakstrategy12)属性不生效，[orphanCharOptimization](ts-basic-components-textarea.md#orphancharoptimization)功能也不生效。未通过该接口设置时，默认文本断行规则为WordBreak.BREAK\_WORD。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextOverflow](ts-appendix-enums.md#textoverflow) | 是 | 文本超长时的显示方式。  内联模式需主动配置才生效，设置为None、Clip、Ellipsis时需配合maxLines使用，单独设置不生效。  不支持TextOverflow.MARQUEE模式，设置为MARQUEE时显示为Clip。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](ts-types.md#resource) | 是 | 文本最小显示字号。  需配合maxFontSize以及maxLines或布局大小限制使用，单独设置不生效。  取值范围：(0, maxFontSize]。超出取值范围时按照fontSize属性值生效。  单位：[fp](ts-pixel-units.md#基本像素单位) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](ts-types.md#resource) | 是 | 文本最大显示字号。  需配合minFontSize以及maxLines或布局大小限制使用，单独设置不生效。  取值范围：(0, +∞)。超出取值范围时按照fontSize属性值生效。  单位：[fp](ts-pixel-units.md#基本像素单位) |

### heightAdaptivePolicy12+

heightAdaptivePolicy(value: TextHeightAdaptivePolicy)

设置文本自适应高度的方式。未通过该接口设置时，默认文本自适应高度的方式为TextHeightAdaptivePolicy.MAX\_LINES\_FIRST。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextHeightAdaptivePolicy](ts-appendix-enums.md#textheightadaptivepolicy10) | 是 | 文本自适应高度的方式。  MAX\_LINES\_FIRST优先使用maxLines调整高度，超出布局约束时在minFontSize和maxFontSize范围内缩小字体；MIN\_FONT\_SIZE\_FIRST优先使用minFontSize调整高度；LAYOUT\_CONSTRAINT\_FIRST优先使用布局约束调整高度，超出约束时缩小字体。 |
...
设置折行规则。适用于需要优化多行文本换行效果的场景，例如GREEDY策略适合一般文本的快速排版，HIGH\_QUALITY策略适合对排版质量要求较高的正式文档，BALANCED策略适合需要各行宽度均衡的展示场景。该属性在[wordBreak](ts-basic-components-textarea.md#wordbreak12)不等于WordBreak.BREAK\_ALL的时候生效，不支持连词符。未通过该接口设置时，默认文本的折行规则为LineBreakStrategy.GREEDY。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| strategy | [LineBreakStrategy](ts-appendix-enums.md#linebreakstrategy12) | 是 | 文本的折行规则。该属性在[wordBreak](ts-basic-components-textarea.md#wordbreak12)不等于WordBreak.BREAK\_ALL时生效，不支持连词符。 |
...
设置输入框拉起的键盘样式，需要输入法适配后生效。具体参考[输入法应用沉浸模式](../harmonyos-guides/inputmethod-immersive-mode-guide.md)。未通过该接口设置时，默认键盘样式为KeyboardAppearance.NONE\_IMMERSIVE。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| appearance | [Optional](ts-universal-attributes-custom-property.md#optionalt)<[KeyboardAppearance](ts-text-common.md#keyboardappearance15枚举说明)> | 是 | 键盘样式。  设置为KeyboardAppearance.NONE\_IMMERSIVE时，显示非沉浸式键盘；设置为KeyboardAppearance.IMMERSIVE时，显示沉浸式键盘。 |

### strokeWidth20+

strokeWidth(width: Optional<LengthMetrics>)

设置文本描边的宽度。当同时设置strokeWidth属性和[shaderStyle](ts-basic-components-textarea.md#shaderstyle)时，shaderStyle不生效。未通过该接口设置时，默认值为0，不做描边处理。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scale | [Optional](ts-universal-attributes-custom-property.md#optionalt)<number | [Resource](ts-types.md#resource)> | 是 | 文本最大的字体缩放倍数，支持undefined类型。  取值范围：[1, +∞)  **说明：**  设置的值小于1时，按值为1处理。异常值默认不生效。  使用前需在工程中配置configuration.json文件和app.json5文件，具体详见[示例17（设置最小字体范围与最大字体范围）](ts-basic-components-textarea.md#示例17设置最小字体范围与最大字体范围)。 |

### ellipsisMode18+

ellipsisMode(mode: Optional<EllipsisMode>)

设置省略位置。ellipsisMode属性需要配合[textOverflow](ts-basic-components-textarea.md#textoverflow12)设置为TextOverflow.Ellipsis以及[maxLines](ts-basic-components-textarea.md#maxlines10)使用，单独设置ellipsisMode属性不生效。未通过该接口设置时，默认省略位置为EllipsisMode.END。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [Optional](ts-universal-attributes-custom-property.md#optionalt)<[EllipsisMode](ts-appendix-enums.md#ellipsismode11)> | 是 | 省略位置。需配合[textOverflow](ts-basic-components-textarea.md#textoverflow12)设置为TextOverflow.Ellipsis以及[maxLines](ts-basic-components-textarea.md#maxlines10)使用，单独设置不生效。  EllipsisMode.START和EllipsisMode.CENTER仅在maxLines设置为1时生效。 |
...
孤字优化通过更高效地处理孤立字符（段落尾行首字符）来改善文本布局。使能后，它会调整换行点以尽可能避免孤立字符。孤字优化特性需在[wordBreak](ts-basic-components-textarea.md#wordbreak12)为非BREAK\_ALL并且待排版文本首个[TextStyle](js-apis-graphics-text.md#textstyle)的[locale](js-apis-graphics-text.md#textstyle)为“zh-Hans”或“zh-Hant”时生效。
...
当同时设置shaderStyle和[strokeWidth](ts-basic-components-textarea.md#strokewidth20)时，shaderStyle不生效。

shaderStyle的优先级高于[fontColor](ts-basic-components-textarea.md#fontcolor)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shader | [ShaderStyle](ts-text-common.md#shaderstyle20) | undefined | 是 | 文本着色器效果，用于设置文本渐变效果（如线性渐变、径向渐变等）。  值为undefined时，无渐变效果。 |
...
| event11+ | [PasteEvent](ts-basic-components-richeditor.md#pasteevent11) | 是 | 用户自定义的粘贴事件。  **模型约束：** 此接口仅可在Stage模型下使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| totalOffsetX | number | 是 | 文本在内容区的横坐标偏移。  单位：[px](ts-pixel-units.md#基本像素单位) |
| totalOffsetY | number | 是 | 文本在内容区的纵坐标偏移。  单位：[px](ts-pixel-units.md#基本像素单位) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[DeleteValue](ts-text-common.md#deletevalue12对象说明), boolean> | 是 | 在将要删除时调用的回调。  在返回true时，表示正常删除，返回false时，表示不删除。  在预上屏和候选词操作时，该回调不触发。点击清除按钮不触发onDidDelete回调。  仅支持系统输入法输入的场景。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[DeleteValue](ts-text-common.md#deletevalue12对象说明)> | 是 | 在删除完成时调用的回调。  点击清除按钮不触发onDidDelete回调。  仅支持系统输入法输入的场景。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/D0iD6VNcTCidW_5aKAHLTg/zh-cn_image_0000002747292723.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0b/v3/KlqVugHSR-agR4xkdISbcA/zh-cn_image_0000002747212639.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/56aMIj8ITriKLY3AptqSWQ/zh-cn_image_0000002717772704.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/20/v3/rtkbrnovRTidnRDKbA7HeQ/zh-cn_image_0000002717612772.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/Tx08uUoLQHeSsqNG9jiRFQ/zh-cn_image_0000002747292725.jpeg)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/mlUi5NbCQW6cS_UObv1n7Q/zh-cn_image_0000002747212641.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/q9GjXndyQE-DU24yrMjHEg/zh-cn_image_0000002717772706.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/6ZiCbqWER2-TxkLgdW934A/zh-cn_image_0000002717612774.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/P_XNjjBAQx6wz586Gz8cRw/zh-cn_image_0000002747292727.png)

### 示例10（设置文本行间距）

从API version 12开始，该示例通过[lineSpacing](ts-basic-components-textarea.md#linespacing12)属性展示了文本在不同行间距下的展示效果，同时，配置[LineSpacingOptions](ts-text-common.md#linespacingoptions20对象说明)中的onlyBetweenLines（从API version 20开始）属性，可以设置文本的行间距是否仅在行与行之间生效。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/rw4v0in5Sl2oa073CAY7Xg/zh-cn_image_0000002747212643.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/-8EHJCofTpyf8ClkZuXsBQ/zh-cn_image_0000002717772708.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b/v3/NFSctv2ZTVuT8uAbxo4aqg/zh-cn_image_0000002717612776.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/MmYPRXHjREWh_Lz1cP8vbQ/zh-cn_image_0000002747292729.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/n_kqv796Rcqj_FUt7YqoMQ/zh-cn_image_0000002747212645.gif)

### 示例16（自定义复制、剪切、粘贴）

该示例通过[onCopy](ts-basic-components-textarea.md#oncopy8)、[onCut](ts-basic-components-textarea.md#oncut8)、[onPaste](ts-basic-components-textarea.md#onpaste)、[onWillCopy](ts-basic-components-textarea.md#onwillcopy)、[onWillCut](ts-basic-components-textarea.md#onwillcut)展示如何监听文本选择菜单的复制、剪切、粘贴按钮、如何屏蔽系统粘贴功能并实现自定义的粘贴能力、如何屏蔽系统复制功能，以及如何屏蔽系统剪切功能，同时，可以通过[maxFontScale](ts-basic-components-textarea.md#maxfontscale18)、[minFontScale](ts-basic-components-textarea.md#minfontscale18)属性设置文本最大和最小的字体缩放倍数。

从API版本26.0.0开始，新增[onWillCopy](ts-basic-components-textarea.md#onwillcopy)、[onWillCut](ts-basic-components-textarea.md#onwillcut)接口。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/_YPdDhbITmeFltFTbcbSPQ/zh-cn_image_0000002717772710.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5b/v3/5zo5oVfCSwGMKc3kpaMSLg/zh-cn_image_0000002717612778.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/22/v3/t9wxNX-KQvaBHnNrf_ygdA/zh-cn_image_0000002747292731.png)
...
从API版本26.0.0开始，新增[strokeJoinStyle](ts-basic-components-textarea.md#strokejoinstyle)接口，支持设置文本描边拐角样式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a9/v3/XofaFpQSQaSexko8bS8P-Q/zh-cn_image_0000002747212647.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/hg7TehZjQ4GXZE8sl5QlIA/zh-cn_image_0000002717772712.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/5pbgY3CHSdKYHHUWiM86KA/zh-cn_image_0000002717612780.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f/v3/CnYkpcLxQrKJjwQffKHGzg/zh-cn_image_0000002747292733.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/2nhgTY7sQ0uY9lJ6sO986Q/zh-cn_image_0000002747212649.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/j6KACEfxSYGOFxY-nevaHQ/zh-cn_image_0000002717772714.jpg)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/74/v3/yTxbEatFSk225XQXGxiCCw/zh-cn_image_0000002717612782.jpg)
...
本示例通过[compressLeadingPunctuation](ts-basic-components-textarea.md#compressleadingpunctuation23)接口设置行首标点符号压缩，通过[punctuationOverflow](ts-basic-components-textarea.md#punctuationoverflow)设置行尾标点符号悬挂。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/rVTqHHp0T0WeAo_0tyPnBw/zh-cn_image_0000002747292735.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/99/v3/jfqgdlyeR8CR3uVw3VUvPg/zh-cn_image_0000002747212651.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/j7w8T12QQvWwxZ2R6hHUgg/zh-cn_image_0000002717772716.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/50/v3/EqHdUUXlQXO24Im_m9143g/zh-cn_image_0000002717612784.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/06/v3/mgFqsodNTG-ZISKFuG8Vag/zh-cn_image_0000002747292737.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/dPrarilYSmyiBs58wj17DA/zh-cn_image_0000002747212653.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/iZOkgXoOTL27tVHvIkoeAQ/zh-cn_image_0000002717772718.png)

### 示例34（设置文本排版时是否使能孤字优化）

该示例通过[orphanCharOptimization](ts-basic-components-textarea.md#orphancharoptimization)接口设置使能孤字优化，确保段落最后一行不出现孤字。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/cHbZrnm8SQydUyYcn2Po8Q/zh-cn_image_0000002717612786.png)

### 示例35（设置文本着色器效果）

该示例通过[shaderStyle](ts-basic-components-textarea.md#shaderstyle)接口实现对TextArea组件内文本着色效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/anI2rI6NQl2Q-SgZStUw1w/zh-cn_image_0000002747292739.png)

### 示例36（设置文本选择的AI菜单）

该示例通过[enableSelectedDataDetector](ts-basic-components-textarea.md#enableselecteddatadetector22)，配置文本选择AI菜单功能。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/OvI1Z14kRimdfaAMYNC9xQ/zh-cn_image_0000002747212655.gif)
