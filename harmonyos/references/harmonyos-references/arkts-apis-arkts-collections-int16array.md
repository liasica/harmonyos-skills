---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-int16array
title: Class (Int16Array)
breadcrumb: API参考 > 应用框架 > ArkTS（方舟编程语言） > ArkTS API > @arkts.collections (ArkTS容器集) > Class (Int16Array)
category: harmonyos-references
scraped_at: 2026-04-28T07:59:53+08:00
doc_updated_at: 2026-04-10
content_hash: sha256:7e41eccbd938156dd62ec1992854165b94ed0b1a0cad58bcb22867fa7da65d9a
---
...
| BYTES\_PER\_ELEMENT | number | 是 | 否 | ArkTS Int16Array中每个元素所占用的字节数。 |
...
```
1. let int16Array: collections.Int16Array = new collections.Int16Array();
```
...
```
1. // 以长度参数构造对象
2. let int16Array: collections.Int16Array = new collections.Int16Array(12);
```
...
3. // Int16Array [1, 2, 3]
4. let array: collections.Int16Array = new collections.Int16Array(set);
```
...
3. let array: collections.Int16Array = new collections.Int16Array(arrayLike);
```

```
1. // 例2 从一个ArrayBuffer构造对象
2. let arrayBuffer: collections.ArrayBuffer = new collections.ArrayBuffer(12);
3. let array: collections.Int16Array = new collections.Int16Array(arrayBuffer);
```

```
1. // 例3 从另一ArkTS Int16Array构造对象
2. let arrayLike = [1, 3, 5];
3. // int16Array1 [1, 3, 5]
4. let int16Array1: collections.Int16Array = new collections.Int16Array(arrayLike);
5. // int16Array2 [1, 3, 5]
6. let int16Array2: collections.Int16Array = new collections.Int16Array(int16Array1);
```
...
```
1. let int16Array: collections.Int16Array = collections.Int16Array.from([1, 2, 3, 4, 5, 6]);
2. console.info("byteLength: " + int16Array.buffer.byteLength); // byteLength: 12
3. // 从int16Array对应buffer第2个字节开始，长度为5
4. let int16Array1: collections.Int16Array = new collections.Int16Array(int16Array.buffer, 2, 5);
5. console.info("[" + int16Array1 + "]"); // [2, 3, 4, 5, 6]
```
...
2. let array: collections.Int16Array = collections.Int16Array.from(arrayLike); // array [1, 3, 5]
```
...
```
1. // 例1 从一个对象创建，Int16Array [0, 1, 2, 3, 4]
2. let array: collections.Int16Array = collections.Int16Array.from<number>(
3. { length: 5 }, (v: Object, k: number) => k);
```

```
1. // 例2 从一个字符数组创建，Int16Array [1, 3, 5]
2. let array: collections.Int16Array = collections.Int16Array.from<string>(
3. ["1", "3", "5"], (v: string, k: number) => parseInt(v));
```

```
1. // 例3 从一个字符串创建，Int16Array [1, 2, 3, 4, 5]
2. let array: collections.Int16Array = collections.Int16Array.from<string>(
...
2. let set: Set<number> = new Set<number>([1, 2, 3]);
3. // Int16Array [1, 2, 3]
4. let array: collections.Int16Array = collections.Int16Array.from(set);
```
...
2. let set: Set<number> = new Set<number>([1, 2, 3]);
3. // Int16Array [1, 3, 5]
4. let array: collections.Int16Array = collections.Int16Array.from(
...
```
1. let arr: collections.Int16Array = collections.Int16Array.of(1, 2, 3, 4);
...
```
1. let array = new collections.Int16Array([1, 2, 3, 4, 5]);
...
```
1. // 当前应用所在系统为法国地区
2. let array = new collections.Int16Array([1000, 2000, 3000]);
...
```
1. let array: collections.Int16Array = collections.Int16Array.from([1, 2, 3, 4, 5, 6, 7, 8]);
2. // Int16Array [1, 2, 3, 2, 3, 6, 7, 8]
3. let copied: collections.Int16Array = array.copyWithin(3, 1, 3);
```
...
2. let int16Array: collections.Int16Array = new collections.Int16Array(arrayLike);
3. int16Array.some((element: number) => element < 0); // true
```
...
1. let arrayLike = [-10, 20, -30, 40, -50];
2. let int16Array: collections.Int16Array = new collections.Int16Array(arrayLike);
3. int16Array.every((element: number) => element > 0);  // false
```
...
2. new collections.Int16Array(arrayLike).fill(4); // Int16Array [4, 4, 4]
3. new collections.Int16Array(arrayLike).fill(4, 1); // Int16Array [1, 4, 4]
4. new collections.Int16Array(arrayLike).fill(4, 1, 2); // Int16Array [1, 4, 3]
```
...
```
1. let array: collections.Int16Array = collections.Int16Array.from([0, 1, 2, 3, 4]);
2. // Int16Array [0, 2, 4]
3. let filtered: collections.Int16Array = array.filter((element: number) => element % 2 == 0);
```
...
```
1. const array: collections.Int16Array = collections.Int16Array.from([1, 2, 3, 4, 5]);
...
```
1. let int16Array: collections.Int16Array = collections.Int16Array.from([1, 2, 3]);
2. int16Array.forEach((value: number, index: number, array: collections.Int16Array) => {
...
```
1. let array: collections.Int16Array = collections.Int16Array.from([3, 5, 9]);
2. array.indexOf(3); // 0
3. array.indexOf(7); // -1
...
```
1. let array: collections.Int16Array = collections.Int16Array.from([1, 2, 3, 4, 5]);
...
```
1. let array: collections.Int16Array = collections.Int16Array.from([25, 36, 49]);
2. const mapped: collections.Int16Array = array.map(Math.sqrt); // Int16Array [5, 6 ,7]
```
...
```
1. let array: collections.Int16Array = collections.Int16Array.from([1, 2, 3, 4, 5]);
2. let reversed: collections.Int16Array = array.reverse(); // Int16Array [5, 4, 3, 2, 1]
```
...
2. let array: collections.Int16Array = new collections.Int16Array(buffer);
3. array.set([1, 2, 3], 3); // Int16Array [0, 0, 0, 1, 2, 3, 0, 0]
```
...
```
1. let array: collections.Int16Array = collections.Int16Array.from([1, 2, 3, 4, 5]);
2. array.slice(); // Int16Array [1, 2, 3, 4, 5]
3. array.slice(1, 3); // Int16Array [2, 3]
4. array.slice(-2); // Int16Array [4, 5]
```
...
```
1. let array: collections.Int16Array = collections.Int16Array.from([1, 3, 5, 4, 2]);
2. array.sort(); // Int16Array [1, 2, 3, 4, 5]
3. array.sort((a: number, b: number) => a - b); // Int16Array [1, 2, 3, 4, 5]
4. array.sort((a: number, b: number) => b - a); // Int16Array [5, 4, 3, 2, 1]
```
...
```
1. let array: collections.Int16Array = collections.Int16Array.from([1, 2, 3, 4, 5]);
2. let subArray: collections.Int16Array = array.subarray(); // Int16Array [1, 2, 3, 4, 5]
3. subArray.set([10, 20, 30]); // Int16Array [10, 20, 30, 4, 5]
```
...
```
1. let array: collections.Int16Array = collections.Int16Array.from([1, 2, 3]);
...
```
1. let array: collections.Int16Array = collections.Int16Array.from([11, 22, 33]);
...
```
1. let int16Array = collections.Int16Array.from([1, 2, 4]);
2. console.info("Element at index 1: ", int16Array[1]);
```
