...
content_hash: sha256:802efee6a735638f0ea086488c20d89d5f3ea9d5f54fc6efd276e6789e8e6c89
---
...
在当前组件由缩放大小或位移变化引起的运动过程中，增加运动模糊效果。与[motionBlur](ts-universal-attributes-motionblur.md#motionblur)相比，motionBlur参数新增了对undefined类型的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| motionBlur | Optional<[MotionBlurOptions](ts-universal-attributes-motionblur.md#motionbluroptions对象说明)> | 是 | 定义运动模糊参数。  当motionBlur的值为undefined时，维持上一次设置的取值不变。 |
...
| anchor | [MotionBlurAnchor](ts-universal-attributes-motionblur.md#motionbluranchor对象说明) | 否 | 否 | 运动模糊锚点坐标，需要与动画缩放[scale](ts-universal-attributes-transformation.md#scale)属性的锚点（centerX/centerY）保持一致，否则会产生非预期效果。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/B45sOdYmQiurX34epp_C7Q/zh-cn_image_0000002742004855.gif)
