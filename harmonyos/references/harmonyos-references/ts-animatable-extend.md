...
content_hash: sha256:c0f3447aecfad9e0aebbe388cedd8c7b91c7337d6fcd0f0c690fcdce14d58e26
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rhs | [AnimatableArithmetic<T>](ts-animatable-extend.md#animatablearithmetict) | 是 | 与自身进行加法运算的另一个数据对象，应与当前对象为相同的具体类型实例。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [AnimatableArithmetic<T>](ts-animatable-extend.md#animatablearithmetict) | 加法运算的结果，用于动画插值过程中计算两个数据之间的中间值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rhs | [AnimatableArithmetic<T>](ts-animatable-extend.md#animatablearithmetict) | 是 | 与自身进行减法运算的另一个数据对象，应与当前对象为相同的具体类型实例。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [AnimatableArithmetic<T>](ts-animatable-extend.md#animatablearithmetict) | 减法运算的结果，用于动画插值过程中计算数据差值以得到中间帧数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [AnimatableArithmetic<T>](ts-animatable-extend.md#animatablearithmetict) | 乘法运算的结果，用于动画插值过程中按系数缩放数据以计算中间帧数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rhs | [AnimatableArithmetic<T>](ts-animatable-extend.md#animatablearithmetict) | 是 | 与当前对象判断是否相等的另一个数据对象。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/OG4czYn7Ra6YCjNsvzytcQ/zh-cn_image_0000002747212987.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/3hz0P3umQAiViKAC8jB0GQ/zh-cn_image_0000002717773054.gif)
