...
content_hash: sha256:f231347924871f9e3e9071b5ad3701ff6ea8d2d00f124de56b6a7cd612b3c7ae
---
...
| 名称 | 描述 |
| --- | --- |
| float [rayTMax](xengine-kit-xeg-rtaoparameters.md#raytmax) | 环境光遮蔽光线的tMax值，必须为非负数。 |
| float [rayTMin](xengine-kit-xeg-rtaoparameters.md#raytmin) | 环境光遮蔽光线的tMin值，必须为非负数。 |
...
| float [aoNormalBias](xengine-kit-xeg-rtaoparameters.md#aonormalbias) = 1.0f | 从着色点位置沿着法线方向偏移的距离，用于解决深度值转世界坐标时因为精度问题导致的自遮挡错误。此参数的值将被限制在[0.0, 1.0]范围内。默认值为1.0。 |
