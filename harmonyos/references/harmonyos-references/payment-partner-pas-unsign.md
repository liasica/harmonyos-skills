---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-partner-pas-unsign
title: 申请解约
breadcrumb: API参考 > 应用服务 > Payment Kit（鸿蒙支付服务） > REST API > 平台类商户/服务商 > 支付并签约 > 申请解约
...
| 400000 | CUST\_NOT\_EXIST | 用户不存在或已销户 | 请切换签约号重试。 |
| 400000 | INVALID\_ARGUMENTS | 参数不合法 | 请检查入参是否正确。 |
| 400000 | INVALID\_MERCNO | 无效商户号 | 请检查商户号是否正确。 |
