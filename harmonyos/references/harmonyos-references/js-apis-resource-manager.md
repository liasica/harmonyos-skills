...
* FA模型需要先导入模块，再调用[getResourceManager](js-apis-resource-manager.md#resourcemanagergetresourcemanager)接口获取资源管理对象。
* 从API version 9开始，Stage模型无需导入模块，支持通过Context获取资源管理resourceManager对象。Context的更多介绍请参考[应用上下文Context](../harmonyos-guides/application-context-stage.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [AsyncCallback](js-apis-resource-manager.md#asynccallbackdeprecated)<[ResourceManager](js-apis-resource-manager.md#resourcemanager)> | 是 | 回调函数，返回资源管理对象。 |
...
| callback | [AsyncCallback](js-apis-resource-manager.md#asynccallbackdeprecated)<[ResourceManager](js-apis-resource-manager.md#resourcemanager)> | 是 | 回调函数，返回应用包名对应的资源管理对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ResourceManager](js-apis-resource-manager.md#resourcemanager)> | Promise对象，返回资源管理对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ResourceManager](js-apis-resource-manager.md#resourcemanager)> | Promise对象，返回应用包名对应的资源管理对象。 |
...
| --- | --- | --- | --- |
| resId | number | 是 | 资源ID值。 |
| args | Array<string | number> | 否 | 格式化字符串资源参数。支持的参数类型包括%d、%f、%s、%%、%数字$d、%数字$f和%数字$s。  **说明：**  - %%转义为%，如%%d格式化后为%d。  - %数字$d中的数字表示参数索引，从1开始计数。如%1$d表示使用args[0]格式化，%2$d表示使用args[1]格式化，依此类推。 |
...
获取指定资源ID对应的[单复数](../harmonyos-guides/l10n-singular-plural.md)字符串，并使用args参数依次替换字符串中的格式化占位符，使用同步方式返回。
...
获取指定资源名称对应的[单复数](../harmonyos-guides/l10n-singular-plural.md)字符串，并使用args参数依次替换字符串中的格式化占位符，使用同步方式返回。
...
| --- | --- | --- | --- |
| resId | number | 是 | 资源ID值。 |
| density | number | 否 | 资源获取需要的屏幕密度，0或缺省表示默认屏幕密度。取值具体请参考枚举[ScreenDensity](js-apis-resource-manager.md#screendensity)。 |
...
| --- | --- | --- | --- |
| resId | number | 是 | 资源ID值。 |
| density | number | 是 | 资源获取需要的屏幕密度，0表示默认屏幕密度。取值具体请参考枚举[ScreenDensity](js-apis-resource-manager.md#screendensity)。 |
| callback | [\_AsyncCallback](js-apis-base.md#asynccallback)<Uint8Array> | 是 | 回调函数，返回资源ID对应的媒体文件内容。 |
...
| --- | --- | --- | --- |
| path | string | 是 | 相对resources/rawfile目录的rawfile子目录路径，如"subdir"，不以"/"开头。  空字符串""表示获取rawfile根目录下的文件夹及文件列表。 |
| callback | [\_AsyncCallback](js-apis-base.md#asynccallback)<Array<string>> | 是 | 回调函数，返回rawfile子目录下的文件夹及文件列表。 |
...
| 类型 | 说明 |
| --- | --- |
| [ResourceManager](js-apis-resource-manager.md#resourcemanager) | 可以加载差异化资源的资源管理对象。 |
...
无论是普通资源管理对象，还是通过[getOverrideResourceManager](js-apis-resource-manager.md#getoverrideresourcemanager12)接口获取的差异化资源管理对象，调用该接口都会返回相同的配置信息。
...
无论是普通资源管理对象，还是通过[getOverrideResourceManager](js-apis-resource-manager.md#getoverrideresourcemanager12)接口获取的差异化资源管理对象，调用该方法均可更新差异化资源管理对象的配置。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[getStringSync](js-apis-resource-manager.md#getstringsync9)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getStringSync](js-apis-resource-manager.md#getstringsync10)替代。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[getStringValue](js-apis-resource-manager.md#getstringvalue9)替代。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[getStringValue](js-apis-resource-manager.md#getstringvalue9-1)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getStringArrayValueSync](js-apis-resource-manager.md#getstringarrayvaluesync10)替代。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[getStringArrayValue](js-apis-resource-manager.md#getstringarrayvalue9)替代。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[getStringArrayValue](js-apis-resource-manager.md#getstringarrayvalue9-1)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getMediaContentSync](js-apis-resource-manager.md#getmediacontentsync10)替代。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[getMediaContent](js-apis-resource-manager.md#getmediacontent9)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getMediaContent](js-apis-resource-manager.md#getmediacontent10)替代。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[getMediaContent](js-apis-resource-manager.md#getmediacontent9-1)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getMediaContent](js-apis-resource-manager.md#getmediacontent10-1)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getMediaContentBase64Sync](js-apis-resource-manager.md#getmediacontentbase64sync10)替代。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[getMediaContentBase64](js-apis-resource-manager.md#getmediacontentbase649)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getMediaContentBase64](js-apis-resource-manager.md#getmediacontentbase6410)替代。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[getMediaContentBase64](js-apis-resource-manager.md#getmediacontentbase649-1)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getMediaContentBase64](js-apis-resource-manager.md#getmediacontentbase6410-1)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getDrawableDescriptor](js-apis-resource-manager.md#getdrawabledescriptor10)替代。
...
获取指定resource对象对应的[单复数](../harmonyos-guides/l10n-singular-plural.md)字符串，并使用args参数依次替换字符串中的格式化占位符，使用同步方式返回。

**说明** 

* 从API version 18开始支持，从API version 20开始废弃，建议使用[getIntPluralStringValueSync](js-apis-resource-manager.md#getintpluralstringvaluesync18)替代。
* 中文环境下，字符串不区分单复数；其他语言环境下，字符串区分单复数，具体规则参考[语言单复数规则](https://www.unicode.org/cldr/charts/45/supplemental/language_plural_rules.html)。
...
* 从API version 18开始支持，从API version 20开始废弃，建议使用[getDoublePluralStringValueSync](js-apis-resource-manager.md#getdoublepluralstringvaluesync18)替代。
* 中文环境下，字符串不区分单复数；其他语言环境下，字符串区分单复数，具体规则参考[语言单复数规则](https://www.unicode.org/cldr/charts/45/supplemental/language_plural_rules.html)。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[getBoolean](js-apis-resource-manager.md#getboolean9)替代。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[getNumber](js-apis-resource-manager.md#getnumber9)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getColorSync](js-apis-resource-manager.md#getcolorsync10)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getColor](js-apis-resource-manager.md#getcolor10)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getColor](js-apis-resource-manager.md#getcolor10-1)替代。
...
从API version 11开始支持，从API version 20开始废弃，建议使用[getSymbol](js-apis-resource-manager.md#getsymbol11)替代。
